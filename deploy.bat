...
set "ERP_SERVICES=discovery-server api-gateway seguridad-service core-service contabilidad-service finanzas-service rrhh-service produccion-service comercializacion-service almacen-service compras-service"
