...
@Component
public class ProduccionJwtAuthenticationFilter extends JwtTenantAuthFilter {

    public ProduccionJwtAuthenticationFilter(JwtDefinitiveTokenResolver tokenResolver, ObjectMapper objectMapper, Optional<TokenUsoLogWriter> tokenUsoLogWriter) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !path.startsWith("/api/produccion");
    }
}
