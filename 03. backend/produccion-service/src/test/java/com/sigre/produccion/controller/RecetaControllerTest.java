...
import com.sigre.produccion.dto.request.RecetaConsumibleRequest;
...
class RecetaControllerTest {
    ...
    void findById_conFichaTecnica_mapeaFicha() {
        ...
        when(consumibleMapper.toResponseList(any())).thenReturn(List.of());
        when(fichaTecnicaMapper.toResponse(ft)).thenReturn(new com.sigre.produccion.dto.response.FichaTecnicaResponse());
        doNothing().when(recetaService).enrichRecetaResponses(any());
