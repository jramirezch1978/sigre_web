...
@DisplayName("Pruebas de Integracion — CosteoProduccionController")
class CosteoProduccionControllerIntegrationTest {

    @Autowired private MockMvc mockMvc;
    private final String authToken = "Bearer mock-token";

    @Test
    @DisplayName("GET /api/produccion/costeos -> retorna lista paginada")
    void listar_retornaPagina() throws Exception {
        mockMvc.perform(get("/api/produccion/costeos")
