...
@DisplayName("Pruebas de Integracion — DocTecnicaController")
class DocTecnicaControllerIntegrationTest {

    @Autowired private MockMvc mockMvc;
    private final String authToken = "Bearer mock-token";

    @Test
    @DisplayName("GET /api/produccion/documentacion-tecnica -> retorna lista paginada")
    void listar_retornaPagina() throws Exception {
        mockMvc.perform(get("/api/produccion/documentacion-tecnica")
