...
import com.sigre.produccion.repository.EjecutorRepository;
...
class EjecutorServiceImplTest {
    ...
    void enrich_sinCentrosCostoId_noHaceQuery() {
        var resp = com.sigre.produccion.dto.response.EjecutorResponse.builder().id(1L).build();
    ...
    void enrich_conCentrosCostoId_enriquece() {
        var resp = com.sigre.produccion.dto.response.EjecutorResponse.builder()
