...
public interface LotePalletRepository extends JpaRepository<LotePallet, Long> {
    ...
    boolean existsByArticuloIdAndNroLoteIgnoreCase(Long articuloId, String nroLote);

    boolean existsByArticuloIdAndNroLoteIgnoreCaseAndIdNot(
            Long articuloId, String nroLote, Long id);
}
