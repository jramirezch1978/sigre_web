...
@NoArgsConstructor
@Entity
@Table(name = "articulo_almacen_posicion", schema = "almacen",
        uniqueConstraints = @UniqueConstraint(columnNames = {"articulo_id", "ubicacion_almacen_id"}))
public class ArticuloAlmacenPosicion {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @Column(name = "ubicacion_almacen_id", nullable = false)
