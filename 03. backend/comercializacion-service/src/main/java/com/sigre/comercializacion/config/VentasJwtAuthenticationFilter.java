package com.sigre.comercializacion.config;
...
@Component
public class VentasJwtAuthenticationFilter extends JwtTenantAuthFilter {

    public VentasJwtAuthenticationFilter(JwtDefinitiveTokenResolver tokenResolver, ObjectMapper objectMapper, Optional<TokenUsoLogWriter> tokenUsoLogWriter) {
