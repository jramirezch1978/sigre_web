...
public interface ZonaDespachoMapper {
    ...
    ZonaDespacho toEntity(ZonaDespachoRequest request);
    ...
    ZonaDespachoResponse toResponse(ZonaDespacho entity);

    List<ZonaDespachoResponse> toResponseList(List<ZonaDespacho> entities);
    ...
    void updateEntity(ZonaDespachoRequest request, @MappingTarget ZonaDespacho entity);
