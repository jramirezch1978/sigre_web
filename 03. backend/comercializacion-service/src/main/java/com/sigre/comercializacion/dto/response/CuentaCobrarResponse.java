...
public class CuentaCobrarResponse {
     ...
     */
    public static CuentaCobrarResponse fromEntity(com.sigre.comercializacion.entity.CuentaCobrar entity) {
    ...
    public static class CuentaCobrarListItemResponse {
        ...
        public static CuentaCobrarListItemResponse fromEntity(com.sigre.comercializacion.entity.CuentaCobrar entity) {
            if (entity == null) return null;
