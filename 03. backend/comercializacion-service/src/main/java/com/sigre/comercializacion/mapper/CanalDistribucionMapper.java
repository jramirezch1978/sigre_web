...
public interface CanalDistribucionMapper {
    ...
    CanalDistribucion toEntity(CanalDistribucionRequest request);
    ...
    List<CanalDistribucionResponse> toResponseList(List<CanalDistribucion> entities);
    ...
    void updateEntity(CanalDistribucionRequest request, @MappingTarget CanalDistribucion entity);
