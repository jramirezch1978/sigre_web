...
@AllArgsConstructor
@Entity
@Table(name = "cntbl_asiento_det", schema = "contabilidad")
@EntityListeners(AuditingEntityListener.class)
public class CntblAsientoDet {
    ...
    @JoinColumn(name = "cntbl_asiento_id", nullable = false)
    private CntblAsiento cntblAsiento;
    ...
    @Column(name = "glosa_detalle", nullable = false, length = 3000)
