...
import com.sigre.finanzas.dto.request.CerrarLiquidacionRequest;
...
import com.sigre.finanzas.service.LiquidacionService;
...
class LiquidacionControllerTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(controller)
                .setControllerAdvice(new com.sigre.common.exception.GlobalExceptionHandler())
