...
import com.sigre.finanzas.service.impl.CuentaBancariaServiceImpl;
...
class CuentaBancariaServiceTest {
    ...
    @Mock
    private com.sigre.finanzas.repository.BancoRepository bancoRepository;
    ...
    void setUp() {
        ...
        com.sigre.finanzas.entity.Banco banco = new com.sigre.finanzas.entity.Banco();
        banco.setId(1L);
