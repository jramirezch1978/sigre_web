...
import com.sigre.finanzas.repository.*;
...
public class CntasPagarServiceImpl implements CntasPagarService {
     ...
     * Convierte los datos de la CxP y sus detalles al formato esperado por contabilidad-service.
     * 
    ...
    /**
     * Genera el asiento contable automáticamente en contabilidad-service.
    ...
    public CntasPagar actualizar(Long id, CntasPagarRequest request) {
        ...
        log.warn("NOTA: La actualización de CxP no regenera el asiento contable. " +
                "Si necesita ajustar el asiento, debe hacerlo directamente en contabilidad-service.");
