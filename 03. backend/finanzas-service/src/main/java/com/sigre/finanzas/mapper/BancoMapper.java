...
public interface BancoMapper {
    ...
    BancoResponse toResponse(Banco entity);

    List<BancoResponse> toResponseList(List<Banco> entities);
    ...
    void updateEntity(BancoRequest request, @MappingTarget Banco entity);
