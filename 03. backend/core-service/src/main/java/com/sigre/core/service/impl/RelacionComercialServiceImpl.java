...
import com.sigre.core.mapper.EntidadTiendaMapper;
import com.sigre.core.mapper.EntidadTransporteMapper;
...
import com.sigre.core.repository.EntidadTransporteRepository;
...
public class RelacionComercialServiceImpl implements RelacionComercialService {
    ...
    private final com.sigre.core.mapper.ArticuloProveedorMapper articuloProveedorMapper;
    ...
    @Override
    public List<com.sigre.core.dto.EntidadTiendaResponse> listTiendas(Long relacionId) {
        getEntity(relacionId);
    ...
    @Override
    @Transactional
    public com.sigre.core.dto.EntidadTiendaResponse createTienda(Long relacionId, com.sigre.core.dto.EntidadTiendaRequest request) {
        getEntity(relacionId);
    ...
    @Override
    public List<com.sigre.core.dto.EntidadTransporteResponse> listTransportes(Long relacionId) {
        getEntity(relacionId);
    ...
    @Override
    @Transactional
    public com.sigre.core.dto.EntidadTransporteResponse createTransporte(Long relacionId, com.sigre.core.dto.EntidadTransporteRequest request) {
        getEntity(relacionId);
    ...
    @Override
    public List<com.sigre.core.dto.ArticuloProveedorResponse> listArticulos(Long relacionId) {
        getEntity(relacionId);
    ...
    @Override
    @Transactional
    public com.sigre.core.dto.ArticuloProveedorResponse createArticulo(Long relacionId, Long articuloId) {
        getEntity(relacionId);
        ...
        com.sigre.core.entity.ArticuloProveedor ap = new com.sigre.core.entity.ArticuloProveedor();
    ...
    @Override
    public List<com.sigre.core.dto.EntidadContribuyenteTelefonoResponse> listTelefonos(Long relacionId) {
        getEntity(relacionId);
    ...
    @Override
    @Transactional
    public com.sigre.core.dto.EntidadContribuyenteTelefonoResponse createTelefono(Long relacionId, com.sigre.core.dto.EntidadContribuyenteTelefonoRequest request) {
        getEntity(relacionId);
    ...
    @Override
    public List<com.sigre.core.dto.EntidadContribuyenteRepresentanteResponse> listRepresentantes(Long relacionId) {
        getEntity(relacionId);
    ...
    @Override
    @Transactional
    public com.sigre.core.dto.EntidadContribuyenteRepresentanteResponse createRepresentante(Long relacionId, com.sigre.core.dto.EntidadContribuyenteRepresentanteRequest request) {
        getEntity(relacionId);
