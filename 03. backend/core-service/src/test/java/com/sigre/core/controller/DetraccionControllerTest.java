...
import com.sigre.core.service.DetraccionService;
...
class DetraccionControllerTest {
    ...
    void listCallsService() {
        Detraccion entity = new Detraccion("001", "Servicios", "02", BigDecimal.ONE, "1", 22001L, BigDecimal.ZERO);
        ...
        when(mapper.toResponse(entity)).thenReturn(
                new DetraccionResponse(1L, "001", "Servicios", "1", "02", BigDecimal.ONE, "1", 22001L, BigDecimal.ZERO)
        );
    ...
    void createCallsService() {
        DetraccionRequest request = new DetraccionRequest("001", "Servicios", "1", "02", BigDecimal.ONE, "1", 22001L, BigDecimal.ZERO);
    ...
    void getByIdCallsService() {
        var resp = new DetraccionResponse(1L, "001", "Servicios", "1", "02", BigDecimal.ONE, "1", 22001L, BigDecimal.ZERO);
    ...
    void updateCallsService() {
        DetraccionRequest request = new DetraccionRequest("001", "Servicios Mod", "1", "02", BigDecimal.ONE, "1", 22001L, BigDecimal.ZERO);
