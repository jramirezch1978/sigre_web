...
/**
 * Tests de integracion REALES para compras-service.
 ...
 * mvn test -pl compras-service -Dcompras.it=true -Dsurefire.excludedGroups=
 */
@ComprasIntegrationTest
@AutoConfigureMockMvc(addFilters = false)
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)
@DisplayName("Integracion - Flujos completos compras-service con validacion JDBC")
