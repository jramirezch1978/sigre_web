...
public final class TipoPlanillaSpecification {
    private TipoPlanillaSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoPlanilla> filtros(String codigo, String nombre, String flagEstado) {
