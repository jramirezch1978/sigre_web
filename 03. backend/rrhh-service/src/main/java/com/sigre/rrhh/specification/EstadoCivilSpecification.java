...
public final class EstadoCivilSpecification {
    private EstadoCivilSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<EstadoCivil> filtros(String codigo, String nombre, String flagEstado) {
