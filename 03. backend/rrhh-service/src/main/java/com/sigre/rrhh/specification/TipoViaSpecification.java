...
public final class TipoViaSpecification {
    private TipoViaSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoVia> filtros(String codigo, String nombre, String flagEstado) {
