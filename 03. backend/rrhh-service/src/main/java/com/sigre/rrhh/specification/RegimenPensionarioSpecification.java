...
public final class RegimenPensionarioSpecification {
    private RegimenPensionarioSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<RegimenPensionario> filtros(String codigo, String nombre, String flagEstado) {
