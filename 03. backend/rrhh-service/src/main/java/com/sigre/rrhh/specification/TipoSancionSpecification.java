...
public final class TipoSancionSpecification {
    private TipoSancionSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoSancion> filtros(String codigo, String nombre, String flagEstado) {
