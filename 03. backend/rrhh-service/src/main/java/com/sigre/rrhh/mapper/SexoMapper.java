...
public interface SexoMapper {
    ...
    SexoResponse toResponse(Sexo entity);

    List<SexoResponse> toResponseList(List<Sexo> entities);
    ...
    Sexo toEntity(SexoCreateRequest request);
    ...
    @Mapping(target = "updatedBy", ignore = true)
    @Mapping(target = "fecModificacion", ignore = true)
    void updateEntity(@MappingTarget Sexo entity, SexoUpdateRequest request);
