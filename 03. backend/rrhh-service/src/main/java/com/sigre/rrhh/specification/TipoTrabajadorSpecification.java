...
public final class TipoTrabajadorSpecification {
    private TipoTrabajadorSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoTrabajador> filtros(String codigo, String nombre, String flagEstado) {
