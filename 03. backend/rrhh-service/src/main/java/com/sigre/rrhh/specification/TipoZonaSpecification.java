...
public final class TipoZonaSpecification {
    private TipoZonaSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoZona> filtros(String codigo, String nombre, String flagEstado) {
