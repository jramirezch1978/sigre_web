...
public final class PeriodoCtsSpecification {
    private PeriodoCtsSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<PeriodoCts> filtros(String codigo, String nombre, String flagEstado) {
