...
public final class PensionRtpsSpecification {
    private PensionRtpsSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<PensionRtps> filtros(String codigo, String nombre, String flagEstado) {
