...
public interface TipoSancionMapper {
    ...
    TipoSancionResponse toResponse(TipoSancion entity);

    List<TipoSancionResponse> toResponseList(List<TipoSancion> entities);
    ...
    TipoSancion toEntity(TipoSancionCreateRequest request);
    ...
    @Mapping(target = "updatedBy", ignore = true)
    @Mapping(target = "fecModificacion", ignore = true)
    void updateEntity(@MappingTarget TipoSancion entity, TipoSancionUpdateRequest request);
