...
public final class TipoConceptoCalculoSpecification {
    private TipoConceptoCalculoSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoConceptoCalculo> filtros(String codigo, String nombre, String flagEstado) {
