...
public final class TipoMovAsistenciaSpecification {
    private TipoMovAsistenciaSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoMovAsistencia> filtros(String codigo, String nombre, String flagEstado) {
