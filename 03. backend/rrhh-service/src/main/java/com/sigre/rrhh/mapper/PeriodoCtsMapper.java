...
public interface PeriodoCtsMapper {
    ...
    PeriodoCtsResponse toResponse(PeriodoCts entity);

    List<PeriodoCtsResponse> toResponseList(List<PeriodoCts> entities);
    ...
    PeriodoCts toEntity(PeriodoCtsCreateRequest request);
    ...
    @Mapping(target = "updatedBy", ignore = true)
    @Mapping(target = "fecModificacion", ignore = true)
    void updateEntity(@MappingTarget PeriodoCts entity, PeriodoCtsUpdateRequest request);
