...
public interface AdminAfpMapper {
    ...
    AdminAfpResponse toResponse(AdminAfp entity);

    List<AdminAfpResponse> toResponseList(List<AdminAfp> entities);
    ...
    AdminAfp toEntity(AdminAfpRequest request);
    ...
    @Mapping(target = "updatedBy", ignore = true)
    @Mapping(target = "fecModificacion", ignore = true)
    void updateEntity(AdminAfpRequest request, @MappingTarget AdminAfp entity);
