...
public final class TipoMovimientoCntaCrrteSpecification {
    private TipoMovimientoCntaCrrteSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoMovimientoCntaCrrte> filtros(String codigo, String nombre, String flagEstado) {
