...
public final class TipoContratoSpecification {
    private TipoContratoSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoContrato> filtros(String codigo, String nombre, String flagEstado) {
