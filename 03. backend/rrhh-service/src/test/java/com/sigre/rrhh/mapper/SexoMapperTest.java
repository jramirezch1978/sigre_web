...
@DisplayName("SexoMapper — Pruebas Unitarias")
class SexoMapperTest {

    private final SexoMapper mapper = Mappers.getMapper(SexoMapper.class);
    ...
    void toResponse_convierteEntidadADTORespuesta() {
        ...
        SexoResponse response = mapper.toResponse(entity);

        assertThat(response.getId()).isEqualTo(1L);
        assertThat(response.getCodigo()).isEqualTo("M");
        assertThat(response.getNombre()).isEqualTo("Sexo M");
    ...
    void toResponseList_convierteListaDeEntidadesAListaDeDTOs() {
        List<Sexo> entities = List.of(
                RrhhTestFixtures.sexo(1L, "M"),
                RrhhTestFixtures.sexo(2L, "F")
        );

        List<SexoResponse> responses = mapper.toResponseList(entities);

        assertThat(responses).hasSize(2);
        assertThat(responses.get(0).getCodigo()).isEqualTo("M");
        assertThat(responses.get(1).getCodigo()).isEqualTo("F");
    }
    ...
    void toEntity_convierteDTORequestAEntidad() {
        ...
        Sexo entity = mapper.toEntity(request);

        assertThat(entity.getId()).isNull();
        assertThat(entity.getCodigo()).isEqualTo("M");
        assertThat(entity.getNombre()).isEqualTo("Masculino");
    ...
    void updateEntity_actualizaEntidadExistente() {
        ...
        assertThat(entity.getCodigo()).isEqualTo("M");
        assertThat(entity.getNombre()).isEqualTo("Femenino");
