...
@DisplayName("Pruebas de Integración - QuintaCategoriaController")
class QuintaCategoriaControllerIntegrationTest {
    ...
    @Test
    @DisplayName("GET /api/rrhh/quinta-categoria/9999 -> 404")
    void obtener_idInexistente_retorna404() throws Exception {
        mockMvc.perform(get("/api/rrhh/quinta-categoria/{id}", 9999)
                        .header("Authorization", authToken))
    ...
    @Test
    @Disabled("Requires seed data: trabajadores activos con contratos vigentes")
    @DisplayName("POST /api/rrhh/quinta-categoria/procesar -> batch (seed data needed)")
