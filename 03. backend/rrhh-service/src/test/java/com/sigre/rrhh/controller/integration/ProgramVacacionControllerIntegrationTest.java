...
@DisplayName("Pruebas de Integración - ProgramVacacionController")
class ProgramVacacionControllerIntegrationTest {
    ...
    @Test
    @DisplayName("GET /api/rrhh/vacaciones/programacion -> retorna lista")
    ...
    @Test
    @DisplayName("GET /api/rrhh/vacaciones/programacion/9999 -> 404")
    void obtenerPorId_idInexistente_retorna404() throws Exception {
        mockMvc.perform(get("/api/rrhh/vacaciones/programacion/{id}", 9999)
                        .header("Authorization", authToken))
    ...
    @Test
    @Disabled("Requires seed data: trabajador with entidad_contribuyente")
    @DisplayName("POST -> GET -> PUT -> PATCH flujo completo CRUD (seed data needed)")
    void flujoCRUD_completo() {
    }

    @Test
    @Disabled("Requires seed data: trabajador with entidad_contribuyente")
    @DisplayName("PUT /api/rrhh/vacaciones/programacion/9999 -> 404 (seed data needed)")
    void actualizar_idInexistente_retorna404() {
    }

    @Test
    @Disabled("Requires seed data: trabajador with entidad_contribuyente")
    @DisplayName("PATCH /api/rrhh/vacaciones/programacion/9999/desactivar -> 404 (seed data needed)")
    void desactivar_idInexistente_retorna404() {
    }
}
