 ...
 * - baseUrl viene del archivo de configuración (AppConfig), no de build config ni de la sesión.
 ...
 */
class ApiClient(private val config: AppConfig, private val session: SessionManager) {
    ...
    private val refreshAuthenticator = Authenticator { _: Route?, response: Response ->
        ...
        val refreshUrl = config.apiBaseUrl.trimEnd('/') + "/auth/refresh"
