...
public class ImplSubLineas extends ImplAncestor {

    private String WSDL = "SigreWebService/ImplSubLineas?wsdl";

    private ImplSubLineas()
    {

    }

    public ImplSubLineas(String empresa){
        this.empresaDefault = empresa;
    }

    public List<BeanZCSubLineas> getActivosByFiltro(String pSubCategoria, String pFiltro) throws Exception {
        List<BeanZCSubLineas> lista = null;

        try {
            String METHOD_NAME = "getActivosByFiltro";
            lista = new ArrayList<BeanZCSubLineas>();
            ...
            if (lsObjects != null) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    BeanZCSubLineas bean = new BeanZCSubLineas();
