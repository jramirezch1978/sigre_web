...
import pe.com.sytco.fastsales.Activities.Almacen.AlmacenTransferenciaPPTTActivity;
...
public class ListViewCajasAdapter  extends ArrayAdapter<BeanCaja> {

    Context context;
    Activity _activity;

    //Controles para la interfaz
    TextView tvCodigoCU, tvFecProduccion, tvUnd, tvSaldoUnd, tvSaldoUnd2, tvUnd2;
    ImageView ivImagen;
    Button btnDelete;

    public ListViewCajasAdapter(@NonNull Context context, int resource) {
        super(context, resource);
    }

    public ListViewCajasAdapter(Context value, List<BeanCaja> objects) {
    ...
    public ListViewCajasAdapter(Context context, List<BeanCaja> objects, Activity pActivity) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            listItemView = inflater.inflate(R.layout.item_row_codigo_cu, parent, false);
        }
