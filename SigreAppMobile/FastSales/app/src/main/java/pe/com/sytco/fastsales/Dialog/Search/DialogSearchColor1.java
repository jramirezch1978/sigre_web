...
public class DialogSearchColor1  extends DialogSearchAncestor {

    private List<BeanColor> listadoColor = null;

    private EditText etColor1;
    private TextView tvDescColor1;

    private DialogSearchColor1(){

    }

    public DialogSearchColor1(View pLayoutReference) {
        ...
        lvListadoItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    etColor1.setText(item.getCodColor());
                    tvDescColor1.setText(item.getDescColor());
