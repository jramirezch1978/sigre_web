...
import pe.com.sytco.fastsales.Controller.ZC.ImplTaco;
...
public class DialogSearchTaco extends DialogSearchAncestor {

    private List<BeanZCTaco> listado = null;

    private EditText etTaco;
    private TextView tvDescTaco;

    private DialogSearchTaco(){

    }

    public DialogSearchTaco(View pLayoutReference) {
    ...
    protected void AsignarEventos() {
        ...
        lvListadoItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    BeanZCTaco item = listado.get(position);

                    etTaco.setText(item.getCodTaco());
                    tvDescTaco.setText(item.getDescTaco());
                    ...
                    ex.printStackTrace();
                    MessageBox.AlertDialog("Ha ocurrido un error al seleccionar un item de TACOS. Exception: " + ex.getMessage(),
    ...
    public void LoadData() {
        ...
        tvTitle.setText("BUSQUEDA DE TACOS DE ZAPATOS");
        etBusqueda.setText("");

        new LoadTacosTask("%%").execute();
    ...
    public void Filtrar() {
        ...
        new LoadTacosTask(lsFiltro).execute();

    }


    //Clase Asincrona para tareas en segundo plano
    private class LoadTacosTask extends AsyncTask<Integer, Void, Boolean> {

        private String mensaje, _filtro;
        private ImplTaco implTaco = null;
        private ArrayAdapter adaptador;

        private ProgressDialog pDialog;

        private LoadTacosTask()
        {

        }

        public LoadTacosTask(String value){
            _filtro = value;
        }
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Cargando TACOS DE ZAPATOS, por favor espere...");
        ...
        protected Boolean doInBackground(Integer... params) {
            try {
                ...
                implTaco = new ImplTaco(ImplEmpresa.empresaDefault.getCodigo());
                listado = implTaco.getActivosByFiltro(_filtro);
        ...
        protected void onPostExecute(Boolean result) {
            try {
                ...
                adaptador = new ListViewSearchAdapter(context, BeanItemSearch.createListFromTacos(listado));
