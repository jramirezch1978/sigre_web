...
public class AsistenciaOpcionesActivity extends AppCompatActivity implements Serializable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asistencia_opciones);
    ...
    private void LoadDataDefault() {
        ...
        {
            MessageBox.AlertDialog(AsistenciaOpcionesActivity.this, "Error en Origen",
    ...
    private void AsignarEventos() {
        ...
        lvMenu.setAdapter(
                new ArrayAdapter(AsistenciaOpcionesActivity.this,
        ...
        lvMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (ls_opcion.substring(0, 2).equals("99")) {
                    ...
                    startActivity(new Intent(getApplicationContext(), AsistenciaGeneralActivity.class));
                    finish();
                }else if (ls_opcion.substring(0, 2).equals("02")) {
                    startActivity(new Intent(getApplicationContext(), AsistenciaComedorActivity.class));
                    finish();
    ...
    private void InitControllers() {
        ...
        OpcionesMenu = getResources().getStringArray(R.array.opciones_asistencia);
    ...
    private void onClickAbout(View v) {
        ...
        Intent intent = new Intent(AsistenciaOpcionesActivity.this, AboutActivity.class);
