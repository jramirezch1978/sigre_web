...
import pe.com.sytco.fastsales.Controller.ImplDocTipo;
...
public class DialogSearchDocTipo extends DialogSearchAncestor {

    private List<BeanDocTipo> listadoDocTipo = null;

    private DialogSearchDocTipo(){

    }

    public DialogSearchDocTipo(Context value) {
        this.context = value;
    }
    ...
    public void LoadData() {
        ...
        tvTitle.setText("BUSQUEDA DE TIPOS DE DOCUMENTO");
        etBusqueda.setText("");

        new LoadDocTiposTask("%%").execute();
    ...
    public void Filtrar() {
        ...
        new LoadDocTiposTask(lsFiltro).execute();

    }


    //Clase Asincrona para tareas en segundo plano
    private class LoadDocTiposTask extends AsyncTask<Integer, Void, Boolean> {

        private String mensaje, _filtro;
        private ImplDocTipo implDocTipo = null;
        ...
        private LoadDocTiposTask()
        {

        }

        public LoadDocTiposTask(String value){
            _filtro = value;
        }
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Cargando TIPOS DE DOCUMENTO segun filtro, por favor espere...");
        ...
        protected Boolean doInBackground(Integer... params) {
            try {
                ...
                implDocTipo = new ImplDocTipo(ImplEmpresa.empresaDefault.getCodigo());
                listadoDocTipo = implDocTipo.getDocTiposByFiltro(_filtro);
        ...
        protected void onPostExecute(Boolean result) {
            try {
                ...
                if (listadoDocTipo.size() == 0) {
                    MessageBox.AlertDialog("No existen TIPOS DE DOCUMENTO alguno que cumpla el filtro " + _filtro, "Error", context);
                    return;
                }

                adaptador = new ListViewSearchAdapter(context, BeanItemSearch.createListFromDocTipos(listadoDocTipo));
