...
public class VentasOpcionesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ventas_opciones);
    ...
    private void LoadDataDefault() {
        ...
        {
            MessageBox.AlertDialog(VentasOpcionesActivity.this, "Error en Origen",
    ...
    private void AsignarEventos() {
        ...
        lvMenu.setAdapter(
                new ArrayAdapter(VentasOpcionesActivity.this,
        ...
        lvMenu.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (ls_opcion.substring(0, 2).equals("99")) {
                    ...
                    startActivity(new Intent(getApplicationContext(), VentasListarProformasActivity.class));
                    finish();
                }
            }
        });
    ...
    private void InitControllers() {
        ...
        OpcionesMenu = getResources().getStringArray(R.array.opciones_venta);
    ...
    private void onClickAbout(View v) {
        ...
        Intent intent = new Intent(VentasOpcionesActivity.this, AboutActivity.class);
