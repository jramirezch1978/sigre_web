-- ============================================================
-- SIGRE ERP - Tenant DB - compras schema
...
--   entidad_detraccion → core.entidad_contribuyente, contabilidad.cntbl_tipo_detraccion
...
CREATE TABLE compras.entidad_detraccion (
    ...
    cntbl_tipo_detraccion_id BIGINT NOT NULL,                                              -- SIGRE: CODIGO_SUNAT. FK diferida → contabilidad.cntbl_tipo_detraccion(id)
