...
export interface GeneracionAsientosIndexacionState {
  asientos:              GeneracionAsientosIndexacionEntity[];
  asientoSeleccionado:   GeneracionAsientosIndexacionEntity | null;
...
export const initialGeneracionAsientosIndexacionState: GeneracionAsientosIndexacionState = {
  asientos:            [],
