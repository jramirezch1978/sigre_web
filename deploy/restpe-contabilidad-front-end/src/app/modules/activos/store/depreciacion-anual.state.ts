...
export interface DepreciacionAnualState {
  depreciaciones:            DepreciacionAnualEntity[];
  depreciacionSeleccionada:  DepreciacionAnualEntity | null;
...
export const initialDepreciacionAnualState: DepreciacionAnualState = {
  depreciaciones:           [],
  depreciacionSeleccionada: null,
