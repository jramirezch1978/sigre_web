...
/**
 * Effects de feedback para Matriz Contable.
 * Muestra toasts de éxito/error tras cada operación CRUD.
 */
@Injectable()
export class MatrizContableFeedbackEffects {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (result?.success) {
        this.toastService.success('Configuración contable guardada correctamente');
      }
    });
    ...
    effect(() => {
      ...
      if (result?.success) {
        this.toastService.success('Configuración contable actualizada correctamente');
      }
    });
    ...
    effect(() => {
      ...
      if (result?.success) {
        this.toastService.success('Configuración contable eliminada correctamente');
      }
    });
