...
import pe.restaurant.almacen.messaging.AlmacenMessagingConstants;
...
/**
 * Emite los pre-asientos de almacén hacia ms-contabilidad por HTTP (Feign), no por RabbitMQ.
