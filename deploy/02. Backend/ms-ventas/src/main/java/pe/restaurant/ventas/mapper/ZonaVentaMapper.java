...
public interface ZonaVentaMapper {
    ...
    ZonaVenta toEntity(ZonaVentaRequest request);
    ...
    ZonaVentaResponse toResponse(ZonaVenta entity);

    List<ZonaVentaResponse> toResponseList(List<ZonaVenta> entities);
    ...
    void updateEntity(ZonaVentaRequest request, @MappingTarget ZonaVenta entity);
