package pe.restaurant.finanzas.config;
...
@Component
public class FinanzasJwtAuthenticationFilter extends JwtTenantAuthFilter {

    public FinanzasJwtAuthenticationFilter(JwtDefinitiveTokenResolver tokenResolver, ObjectMapper objectMapper, Optional<TokenUsoLogWriter> tokenUsoLogWriter) {
