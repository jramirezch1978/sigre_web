...
import pe.restaurant.finanzas.service.TestDataSeedService;
    ...
    public ApiResponse<Map<String, Integer>> seed() {
        if (!testDataEnabled) {
            throw new BusinessException(
                    "Datos de prueba deshabilitados: establezca app.testdata.enabled=true o APP_TESTDATA_ENABLED=true y reinicie ms-finanzas.",
