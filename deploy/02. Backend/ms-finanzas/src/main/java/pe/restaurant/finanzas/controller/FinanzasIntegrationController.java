...
import pe.restaurant.finanzas.client.dto.LiquidacionDTO;
 ...
 * Expone datos de finanzas para consumo vía Feign desde ms-ventas.
 */
@Slf4j
@RestController
...
public class FinanzasIntegrationController {
     ...
     * Endpoint para consumo exclusivo de ms-ventas.
     * 
    ...
    @Operation(summary = "Obtener liquidaciones pendientes por cobrar",
               description = "Endpoint para consumo de ms-ventas. Retorna liquidaciones con saldo positivo.")
    ...
    @Operation(summary = "Obtener órdenes de giro pendientes por cobrar",
               description = "Endpoint para consumo de ms-ventas. Retorna órdenes de giro con devolución aprobada.")
