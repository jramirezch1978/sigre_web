...
import pe.restaurant.finanzas.enums.TipoMovimientoCxP;
...
public class LetraCanjeServiceImpl implements LetraCanjeService {
    ...
    private void validarSaldosSuficientes(List<CntasPagar> origenes, List<pe.restaurant.finanzas.dto.request.OrigenCanjeRequest> origenesReq) {
    ...
    private BigDecimal calcularTotalOrigenes(List<pe.restaurant.finanzas.dto.request.OrigenCanjeRequest> origenes) {
        return origenes.stream()
            .map(pe.restaurant.finanzas.dto.request.OrigenCanjeRequest::getMontoCanjeado)
