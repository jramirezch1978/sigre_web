...
import pe.restaurant.core.dto.PlanContableDetResponse;
import pe.restaurant.core.repository.PlanContableDetRepository;
 ...
 * - {@code GET /api/core/plan-contable-det/{id}} : usado por ms-finanzas (Feign)
...
public class PlanContableDetController {
     ...
     *  ms-finanzas rechazar cuentas inactivas. */
    @GetMapping("/{id}")
