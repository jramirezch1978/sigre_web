...
public class AfIntegracionController {
    ...
    @PostMapping("/contabilidad/traslado/{trasladoId}")
    public ApiResponse<IntegracionContabilidadResult> contabilizarTraslado(@PathVariable Long trasladoId) {
        return ApiResponse.ok(contabilidadIntegracionService.contabilizarTraslado(trasladoId),
