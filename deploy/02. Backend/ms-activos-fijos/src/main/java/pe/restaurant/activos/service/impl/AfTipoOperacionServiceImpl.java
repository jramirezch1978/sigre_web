...
public class AfTipoOperacionServiceImpl implements AfTipoOperacionService {
    ...
    private final AfOperacionesRepository operacionesRepository;
    ...
    public void delete(Long id) {
        if (operacionesRepository.existsByAfTipoOperacionId(id)) {
            throw new BusinessException(
                    "No se puede eliminar: el tipo de operación está en uso",
                    HttpStatus.CONFLICT,
                    ActivosErrorCodes.TIPO_OPERACION_EN_USO);
        }
