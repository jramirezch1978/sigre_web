...
public class AfOperacionesServiceImpl implements AfOperacionesService {
    ...
    private final AfTipoOperacionRepository tipoOperacionRepository;
    ...
    public AfOperaciones create(AfOperaciones entity) {
        ...
        validarTipoOperacion(entity.getAfTipoOperacionId());
    ...
    public AfOperaciones update(Long id, AfOperaciones entity) {
        ...
        existing.setAfTipoOperacionId(entity.getAfTipoOperacionId());
    ...
    private void validarTipoOperacion(Long afTipoOperacionId) {
        if (afTipoOperacionId == null) {
            return;
        }
        tipoOperacionRepository.findById(afTipoOperacionId)
                .filter(t -> ActivosFlagEstado.ACTIVO.equals(t.getFlagEstado()))
                .orElseThrow(() -> new BusinessException(
                        "El tipo de operación con ID " + afTipoOperacionId + " no existe o está inactivo",
                        HttpStatus.BAD_REQUEST,
                        ActivosErrorCodes.TIPO_OPERACION_NO_ENCONTRADO));
    }
}
