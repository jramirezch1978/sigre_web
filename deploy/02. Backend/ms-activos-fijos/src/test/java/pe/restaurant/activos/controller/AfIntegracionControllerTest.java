...
class AfIntegracionControllerTest {
    ...
    @Test
    void contabilizarTraslado() {
        when(contabilidadIntegracionService.contabilizarTraslado(80L)).thenReturn(result(8L));
        var resp = controller.contabilizarTraslado(80L);
        assertThat(resp.isSuccess()).isTrue();
        assertThat(resp.getData().getAsientoId()).isEqualTo(8L);
    }
