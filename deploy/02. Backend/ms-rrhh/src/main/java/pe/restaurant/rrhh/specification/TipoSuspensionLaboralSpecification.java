...
public final class TipoSuspensionLaboralSpecification {

    private TipoSuspensionLaboralSpecification() {
        throw new UnsupportedOperationException("Clase de specification — no instanciable");
    }

    public static Specification<TipoSuspensionLaboral> filtros(String codigo, String nombre, String flagEstado) {
