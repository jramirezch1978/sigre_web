...
public final class TipoSubsidioSpecification {
    private TipoSubsidioSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoSubsidio> filtros(String codigo, String nombre, String flagEstado) {
