...
import pe.restaurant.rrhh.mapper.PermisoLicenciaMapper;
import pe.restaurant.rrhh.repository.PermisoLicenciaRepository;
import pe.restaurant.rrhh.service.PermisoLicenciaService;
import pe.restaurant.rrhh.specification.PermisoLicenciaSpecification;
import pe.restaurant.rrhh.util.RrhhFlagEstadoLegacyNormalizer;
import pe.restaurant.rrhh.validation.PermisoLicenciaValidator;

import java.time.Instant;
import java.time.LocalDate;
import java.util.List;

import static pe.restaurant.rrhh.constants.PermisoLicenciaConstants.*;
