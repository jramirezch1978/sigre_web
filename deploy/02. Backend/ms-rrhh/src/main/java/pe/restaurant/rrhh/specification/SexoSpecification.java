...
public final class SexoSpecification {
    private SexoSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<Sexo> filtros(String codigo, String nombre, String flagEstado) {
