...
public interface ConceptoPlanillaService {
     ...
     * @throws pe.restaurant.common.exception.BusinessException si el código ya existe o el tipo es inválido
     */
     ...
     * @throws pe.restaurant.common.exception.ResourceNotFoundException si no existe el concepto
     * @throws pe.restaurant.common.exception.BusinessException si el tipo es inválido
     */
