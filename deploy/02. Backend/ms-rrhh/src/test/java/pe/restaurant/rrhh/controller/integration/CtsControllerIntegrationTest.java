...
@DisplayName("Pruebas de Integración - CtsController")
class CtsControllerIntegrationTest {
    ...
    @Test
    @DisplayName("GET /api/rrhh/cts/9999 -> 404")
    void obtenerPorId_idInexistente_retorna404() throws Exception {
        mockMvc.perform(get("/api/rrhh/cts/{id}", 9999)
                        .header("Authorization", authToken))
    ...
    @Test
    @Disabled("Requires seed data: periodo_cts, trabajadores activos, contratos")
    @DisplayName("POST /api/rrhh/cts/procesar -> batch (seed data needed)")
