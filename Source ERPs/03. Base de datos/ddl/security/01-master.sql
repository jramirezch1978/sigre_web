-- ============================================================
-- Restaurant.pe ERP - Security DB - master schema
...
--
--   pais (sin dependencias en master)
--   empresa → pais
--   departamento → pais
...
--   2. empresa (CASCADE elimina FK de auth.usuario_empresa)
--   3. pais
-- ============================================================
...
CREATE INDEX IX_EMPRESA_03 ON master.empresa (pais_id);
