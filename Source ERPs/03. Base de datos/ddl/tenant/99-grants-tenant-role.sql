...
--   psql -v ON_ERROR_STOP=1 -v tenant_role=nombre_rol -d restaurant_pe_emp_xxx -f 99-grants-tenant-role.sql
--
-- Antes, en la BD postgres (admin):
--   GRANT CONNECT ON DATABASE restaurant_pe_emp_xxx TO nombre_rol;
