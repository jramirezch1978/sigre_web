 ...
 *
 * <p>Cubre tablas {@code ventas.*} usadas por ms-ventas: POS, OV, proforma, cierre de caja,
...
public class TestDataSeedService {
    ...
    private int seedCarta(JdbcTemplate jdbc) {
        ...
        int cab = jdbc.update("""
            ...
            SELECT s.id, 'SEED-CARTA-DEMO', 'Carta menú generada por test-data seed (ms-ventas).', '1'
