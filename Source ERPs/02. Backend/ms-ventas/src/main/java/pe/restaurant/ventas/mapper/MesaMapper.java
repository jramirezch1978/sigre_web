...
public interface MesaMapper {
    ...
    default pe.restaurant.ventas.entity.Mesa.Zona createZonaFromId(Long zonaId) {
        if (zonaId == null) {
            return null;
        }
        pe.restaurant.ventas.entity.Mesa.Zona zona = new pe.restaurant.ventas.entity.Mesa.Zona();
        zona.setId(zonaId);
        return zona;
    }
    
    // 🎯 UTILIDADES PARA CARGAR DATOS RELACIONADOS
    default String loadZonaNombre(pe.restaurant.ventas.entity.Mesa.Zona zona) {
    ...
    default Long loadSucursalId(pe.restaurant.ventas.entity.Mesa.Zona zona) {
    ...
    default String loadSucursalNombre(pe.restaurant.ventas.entity.Mesa.Zona zona) {
