...
public interface ServiciosCxCMapper {
    ...
    ServiciosCxC toEntity(ServiciosCxCRequest request);
    ...
    ServiciosCxCResponse toResponse(ServiciosCxC entity);

    List<ServiciosCxCResponse> toResponseList(List<ServiciosCxC> entities);
    ...
    void updateEntity(ServiciosCxCRequest request, @MappingTarget ServiciosCxC entity);
