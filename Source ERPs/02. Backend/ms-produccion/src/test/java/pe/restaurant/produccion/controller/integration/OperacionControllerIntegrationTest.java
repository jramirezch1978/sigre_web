...
@DisplayName("Pruebas de Integracion — OperacionController")
class OperacionControllerIntegrationTest {

    @Autowired private MockMvc mockMvc;
    private final String authToken = "Bearer mock-token";

    @Test
    @DisplayName("GET /api/produccion/operaciones -> retorna lista paginada")
    void listar_retornaPagina() throws Exception {
        mockMvc.perform(get("/api/produccion/operaciones")
