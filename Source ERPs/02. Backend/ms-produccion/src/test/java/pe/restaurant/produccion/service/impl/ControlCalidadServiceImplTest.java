...
class ControlCalidadServiceImplTest {
    ...
    void setUp() {
        ...
        var usuarioResponse = mock(pe.restaurant.common.dto.ApiResponse.class);
    ...
    void findAll_conFiltros_retornaPage() {
        ...
        var result = service.findAll(1L, "1", null, null, 1L, pageable);
    ...
    void enrich_sinIds_noConsulta() {
        var resp = pe.restaurant.produccion.dto.response.ControlCalidadResponse.builder().id(1L).build();
    ...
    void enrich_conOrdenTrabajoId_enriquece() {
        var resp = pe.restaurant.produccion.dto.response.ControlCalidadResponse.builder()
    ...
    void spec_conTodosLosFiltros_ejecutaToPredicate() {
        ...
        service.findAll(1L, "1", LocalDate.of(2026, 1, 1), LocalDate.of(2026, 12, 31), 5L, pageable);
