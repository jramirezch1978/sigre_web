...
@Component
public class ActivosJwtAuthenticationFilter extends JwtTenantAuthFilter {

    public ActivosJwtAuthenticationFilter(JwtDefinitiveTokenResolver tokenResolver, ObjectMapper objectMapper, Optional<TokenUsoLogWriter> tokenUsoLogWriter) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !path.startsWith("/api/activos");
    }
}
