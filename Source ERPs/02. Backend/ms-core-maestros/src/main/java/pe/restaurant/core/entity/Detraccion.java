...
public class Detraccion extends BaseEntity {
    ...
    @Column(name = "bien_serv", nullable = false, unique = true, columnDefinition = "char(3)")
    private String bienServ;

    @Column(length = 100)
    private String descripcion;

    @Column(name = "cod_sunat_pdbe", columnDefinition = "char(2)")
    ...
    @Column(name = "flag_ind_imp", columnDefinition = "char(1)")
    private String flagIndImp;

    @Column(name = "codigo_sunat", columnDefinition = "char(6)")
