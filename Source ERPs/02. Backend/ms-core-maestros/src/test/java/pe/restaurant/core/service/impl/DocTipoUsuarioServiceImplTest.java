...
class DocTipoUsuarioServiceImplTest {

    @Mock private DocTipoUsuarioRepository repository;
    @InjectMocks private DocTipoUsuarioServiceImpl service;

    private DocTipoUsuario entity;

    @BeforeEach
    void setUp() {
        entity = new DocTipoUsuario();
        entity.setId(1L);
        entity.setUsuarioId(5L);
        entity.setDocTipoId(7L);
