...
class DetraccionMapperTest {
    ...
    void toResponse_mapsAllFields() {
        ...
        assertThat(response.getCodigoSunat()).isEqualTo("05");
    ...
    void toEntity_mapsAllFields() {
        ...
        assertThat(entity.getCodigoSunat()).isEqualTo("05");
