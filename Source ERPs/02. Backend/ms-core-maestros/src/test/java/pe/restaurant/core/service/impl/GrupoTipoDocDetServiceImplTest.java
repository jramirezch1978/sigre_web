...
class GrupoTipoDocDetServiceImplTest {

    @Mock private GrupoTipoDocDetRepository repository;
    @InjectMocks private GrupoTipoDocDetServiceImpl service;

    private GrupoTipoDocDet entity;

    @BeforeEach
    void setUp() {
        entity = new GrupoTipoDocDet();
        entity.setId(1L);
        entity.setGrupoTipoDocId(10L);
        entity.setDocTipoId(20L);
