...
class DetraccionServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        entity = new Detraccion("001", "Servicios", "02", BigDecimal.valueOf(12), "1", null, BigDecimal.ZERO);
    }
    ...
    class Create {
        @Test
        void success() {
            DetraccionRequest request = new DetraccionRequest("002", "Bienes", null, "03", BigDecimal.TEN, "1", null, BigDecimal.ZERO);
        ...
        @Test
        void throwsConflict() {
            DetraccionRequest request = new DetraccionRequest("001", "Dup", "1", "02", BigDecimal.ONE, "1", null, BigDecimal.ZERO);
    ...
    class Update {
        @Test
        void success() {
            DetraccionRequest request = new DetraccionRequest("001", "Updated", "1", "02", BigDecimal.TEN, "1", null, BigDecimal.ZERO);
            when(repository.findByBienServ("001")).thenReturn(Optional.of(entity));
