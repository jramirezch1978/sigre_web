...
class DocTipoNumSerieServiceImplTest {

    @Mock private DocTipoNumSerieRepository repository;
    @InjectMocks private DocTipoNumSerieServiceImpl service;

    private DocTipoNumSerie entity;

    @BeforeEach
    void setUp() {
        entity = new DocTipoNumSerie();
        entity.setId(1L);
