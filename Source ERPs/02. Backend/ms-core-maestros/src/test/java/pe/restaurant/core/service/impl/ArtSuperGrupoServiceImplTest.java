...
class ArtSuperGrupoServiceImplTest {

    @Mock private ArtSuperGrupoRepository repository;
    @InjectMocks private ArtSuperGrupoServiceImpl service;

    private ArtSuperGrupo entity;

    @BeforeEach
    void setUp() {
        entity = new ArtSuperGrupo();
        entity.setId(1L);
        entity.setCodigo("SG001");
        entity.setNombre("Super grupo");
