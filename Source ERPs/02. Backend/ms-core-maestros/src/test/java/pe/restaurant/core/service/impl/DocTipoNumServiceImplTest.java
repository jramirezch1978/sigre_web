...
class DocTipoNumServiceImplTest {

    @Mock private DocTipoNumRepository repository;
    @InjectMocks private DocTipoNumServiceImpl service;

    private DocTipoNum entity;

    @BeforeEach
    void setUp() {
        entity = new DocTipoNum();
        entity.setId(1L);
