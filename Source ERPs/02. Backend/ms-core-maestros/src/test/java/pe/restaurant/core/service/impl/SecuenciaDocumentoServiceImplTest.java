...
class SecuenciaDocumentoServiceImplTest {

    @Mock private SecuenciaDocumentoRepository repository;
    @InjectMocks private SecuenciaDocumentoServiceImpl service;

    private SecuenciaDocumento entity;

    @BeforeEach
    void setUp() {
        entity = new SecuenciaDocumento();
        entity.setId(1L);
