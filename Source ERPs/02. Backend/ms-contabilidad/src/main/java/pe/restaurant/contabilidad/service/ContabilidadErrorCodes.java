...
public class ContabilidadErrorCodes {
    ...
    public static final String PLAN_CONTABLE_DET_LONGITUD_INVALIDA = "CONT-112";
    ...
    public static final String CUENTA_SIN_MOVIMIENTO = "CONT-113";

    public static final String CUENTA_NO_ES_DETALLE = "CONT-114";

    public static final String CUENTA_TIPO_SALDO_INCOMPATIBLE = "CONT-115";

    public static final String CUENTA_REQUIERE_CENCOS = "CONT-116";

    public static final String CUENTA_REQUIERE_DOC_REF = "CONT-117";

    public static final String CUENTA_REQUIERE_ENTIDAD = "CONT-118";

    public static final String CUENTA_REQUIERE_BANCO = "CONT-119";

    public static final String MONEDA_OBLIGATORIA = "CONT-120";

    public static final String TASA_CAMBIO_OBLIGATORIA = "CONT-121";

    public static final String GLOSA_DETALLE_OBLIGATORIA = "CONT-122";
