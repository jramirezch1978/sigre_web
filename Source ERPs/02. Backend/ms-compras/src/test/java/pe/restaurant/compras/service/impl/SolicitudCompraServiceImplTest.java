...
import pe.restaurant.compras.repository.OrdenCompraRepository;
import pe.restaurant.compras.repository.SolicitudCompraRepository;
import pe.restaurant.compras.repository.UsuarioRefRepository;
...
class SolicitudCompraServiceImplTest {
    ...
    void convertir_aCotizacion_creaDocumentosYCambiaEstado() {
        ...
        pe.restaurant.compras.entity.Cotizacion savedCot = new pe.restaurant.compras.entity.Cotizacion();
        savedCot.setId(50L);
    ...
    void convertir_aOrdenCompra_creaDocumentosYCambiaEstado() {
        ...
        pe.restaurant.compras.entity.OrdenCompra savedOc = new pe.restaurant.compras.entity.OrdenCompra();
        savedOc.setId(60L);
    ...
    void trazabilidad_conOrdenesRelacionadas_retornaLista() {
        ...
        pe.restaurant.compras.entity.OrdenCompra oc = new pe.restaurant.compras.entity.OrdenCompra();
        oc.setId(5L);
