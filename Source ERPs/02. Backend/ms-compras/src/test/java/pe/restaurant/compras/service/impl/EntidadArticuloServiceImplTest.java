...
class EntidadArticuloServiceImplTest {

    @Mock private EntidadArticuloRepository repository;
    @InjectMocks private EntidadArticuloServiceImpl service;

    private EntidadArticulo entity;

    @BeforeEach
    void setUp() {
        entity = new EntidadArticulo();
        entity.setId(1L);
        entity.setEntidadContribuyenteId(100L);
        entity.setArticuloId(200L);
        entity.setPrecioReferencia(new BigDecimal("12.5000"));
