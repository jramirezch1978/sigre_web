...
import pe.restaurant.compras.spec.OrdenServicioSpecifications;
...
public class OrdenServicioServiceImpl implements OrdenServicioService {
    ...
    public DatosServicioResponse datosServicio(Long servicioId, Long proveedorId,
        ...
        BigDecimal tasaIgv = configParameterService.getDec("TASA_IGV", null);
    ...
    private boolean isAprobacionRequerida() {
        ...
        // return configParameterService.isTextFlagOn("COMPRA_APROBACION_OS", "0");
        return true;
    }
