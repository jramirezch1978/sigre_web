package pe.restaurant.compras.testdata;
...
public class ComprasTestDataFactory {
    ...
    public Map<String, Integer> ensureComprasTransactionalData() {
        ...
        out.put("config.configuracion_aprobacion", ensureConfiguracionAprobacion(jdbc));
    ...
    private Integer ensureConfiguracionAprobacion(JdbcTemplate jdbc) {
        ...
        return jdbc.update("""
                INSERT INTO config.configuracion (modulo, parametro, tipo_dato, valor_texto, activo)
