...
import pe.restaurant.compras.dto.OrdenServicioCabeceraRequest;
import pe.restaurant.compras.dto.OrdenServicioLineaRequest;
...
public class OrdenServicioValidator {
    ...
    private boolean isValidaLimiteOs() {
        return configParameterService.isTextFlagOn("FLAG_VALIDA_LIMITE_OS", "0");
    }
    ...
    private boolean isRestriccionCencosActiva() {
        return configParameterService.isTextFlagOn("flag_restr_cencos_usr", "0");
    }
