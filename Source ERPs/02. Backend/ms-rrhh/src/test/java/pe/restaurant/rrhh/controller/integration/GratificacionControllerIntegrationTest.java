...
@DisplayName("Pruebas de Integración - GratificacionController")
class GratificacionControllerIntegrationTest {
    ...
    @Test
    @DisplayName("GET /api/rrhh/gratificaciones/9999 -> 404")
    void obtenerPorId_idInexistente_retorna404() throws Exception {
        mockMvc.perform(get("/api/rrhh/gratificaciones/{id}", 9999)
                        .header("Authorization", authToken))
    ...
    @Test
    @Disabled("Requires seed data: periodo_gratificacion, trabajadores activos, contratos")
    @DisplayName("POST /api/rrhh/gratificaciones/procesar -> batch (seed data needed)")
    void procesar_requiereSeedData() {
    }
}
