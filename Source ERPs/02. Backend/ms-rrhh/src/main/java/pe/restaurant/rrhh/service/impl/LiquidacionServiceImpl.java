...
public Liquidacion anular(Long id) {
    ...
    private void setAuditCreacion(pe.restaurant.common.entity.BaseEntity entity) {
        entity.setCreatedBy(TenantContext.getUsuarioId());
        entity.setFecCreacion(Instant.now());
    }

    /** Setea updated_by y fec_modificacion antes de cada update. */
    private void setAuditModificacion(pe.restaurant.common.entity.BaseEntity entity) {
