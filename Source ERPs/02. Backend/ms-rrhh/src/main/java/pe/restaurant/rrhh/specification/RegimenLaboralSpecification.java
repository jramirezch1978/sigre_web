...
public final class RegimenLaboralSpecification {
    private RegimenLaboralSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<RegimenLaboral> filtros(String codigo, String nombre, String flagEstado) {
