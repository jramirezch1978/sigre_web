...
public final class TipoTrabajadorRtpsSpecification {
    private TipoTrabajadorRtpsSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoTrabajadorRtps> filtros(String codigo, String nombre, String flagEstado) {
