...
public final class MotivoCeseSpecification {
    private MotivoCeseSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<MotivoCese> filtros(String codigo, String nombre, String flagEstado) {
