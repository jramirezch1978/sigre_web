...
public interface ConceptoPlanillaService {
     ...
     * @throws pe.restaurant.common.exception.ResourceNotFoundException si no existe el concepto
     */
     ...
     * @throws pe.restaurant.common.exception.BusinessException si el código ya existe o el grupo de cálculo es inválido
     */
     ...
     * @throws pe.restaurant.common.exception.ResourceNotFoundException si no existe el concepto
     * @throws pe.restaurant.common.exception.BusinessException si el grupo de cálculo es inválido
     */
     ...
     * @throws pe.restaurant.common.exception.ResourceNotFoundException si no existe el concepto
     * @throws pe.restaurant.common.exception.BusinessException si el concepto está en uso
     */
