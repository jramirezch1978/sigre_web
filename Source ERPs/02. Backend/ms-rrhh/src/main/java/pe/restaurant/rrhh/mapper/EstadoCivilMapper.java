...
public interface EstadoCivilMapper {
    ...
    EstadoCivilResponse toResponse(EstadoCivil entity);

    List<EstadoCivilResponse> toResponseList(List<EstadoCivil> entities);
    ...
    EstadoCivil toEntity(EstadoCivilCreateRequest request);
    ...
    @Mapping(target = "updatedBy", ignore = true)
    @Mapping(target = "fecModificacion", ignore = true)
    void updateEntity(@MappingTarget EstadoCivil entity, EstadoCivilUpdateRequest request);
