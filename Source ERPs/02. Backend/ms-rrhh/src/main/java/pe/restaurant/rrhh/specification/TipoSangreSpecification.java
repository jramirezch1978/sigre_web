...
public final class TipoSangreSpecification {
    private TipoSangreSpecification() { throw new UnsupportedOperationException(); }

    public static Specification<TipoSangre> filtros(String codigo, String nombre, String flagEstado) {
