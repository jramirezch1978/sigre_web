...
/**
 * Servicio para inicializar datos de prueba en ms-finanzas.
 *
...
public class TestDataSeedService {
    ...
    // Códigos de matrices contables (deben coincidir con TipoOperacionContable.java en ms-contabilidad)
    ...
    /**
     * Ejecuta la carga completa de datos de prueba para ms-finanzas.
     ...
     * Los códigos deben coincidir exactamente con TipoOperacionContable.java en ms-contabilidad.
     * 
     * Matrices creadas:
     ...
     * 
     * NOTA: Este método ya no se usa. Los datos de RRHH deben insertarse desde ms-rrhh.
     *
     * @param jdbc JdbcTemplate para ejecutar SQL
     * @return Número total de registros insertados
     * @deprecated Usar el seed de ms-rrhh en su lugar
     */
    @Deprecated
        ...
        if (!existeTrabajador(jdbc, "45678901")) {
            total += jdbc.update("""
                ...
                VALUES (
                    ...
                    'Av. Principal 123, Lima', '987654321', 'juan.perez@restaurant.pe',
        ...
        if (!existeTrabajador(jdbc, "87654321")) {
            total += jdbc.update("""
                ...
                VALUES (
                    ...
                    'Jr. Secundaria 456, Lima', '912345678', 'carlos.ramirez@restaurant.pe',
