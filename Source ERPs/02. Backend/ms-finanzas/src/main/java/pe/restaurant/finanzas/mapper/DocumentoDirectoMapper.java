...
public class DocumentoDirectoMapper {
    ...
    public CntasPagar toEntity(DocumentoDirectoRequest request, Long sucursalId) {
        ...
        entity.setFechaRegistro(request.getFecRegistro() != null ? request.getFecRegistro() : LocalDate.now());
        entity.setTasaCambio(request.getTasaCambio() != null ? request.getTasaCambio() : BigDecimal.ONE);
        entity.setCntblAsientoId(null);
        entity.setFlagEstado("1");
        entity.setFlagDetraccion(request.getFlagDetraccion() != null ? request.getFlagDetraccion() : "0");
        entity.setImporteDetraccion(request.getImporteDetraccion() != null ? request.getImporteDetraccion() : BigDecimal.ZERO);
        entity.setFlagRetencion(request.getFlagRetencion() != null ? request.getFlagRetencion() : "0");
