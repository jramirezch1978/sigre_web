...
set "DEPLOY_BACKEND_MODULES=sigre-config-common discovery-server api-gateway asistencia-service"
...
set "ALL_BACKEND_MODULES=sigre-config-common %INFRA_MODULES% asistencia-service %OPTIONAL_MODULES%"
