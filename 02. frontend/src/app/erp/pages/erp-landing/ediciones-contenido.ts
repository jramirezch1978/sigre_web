...
export const EDICIONES_CONTENIDO: Record<string, EdicionContenido> = {
  ...
  HEALTH: {
    ...
    funcionalidades: [
      ...
      'Compras y abastecimiento de medicamentos e insumos con punto de reorden.',
      'Facturación de servicios de salud, paquetes y copagos; integración con caja.',
      'Maestro de pacientes y registro de atenciones/servicios facturables.',
      'Activos fijos: equipamiento médico, depreciación, garantías y mantenimiento.',
      'Contabilidad general, centros de costo por servicio y cierre contable.',
      'Planilla y asistencia del personal asistencial con turnos y guardias.',
      'Seguridad, roles y auditoría sobre datos sensibles.',
    ],
    notaTecnica: 'Edición sectorial salud sobre la base administrativa-contable; los flujos clínicos (historia clínica, citas) se parametrizan/integran en la implementación.',
  },
};
