...
export const ALMACEN_TABLAS: Record<AlmacenTablaKey, AlmacenTablaDef> = {
  almacenes: {
    ...
    columnas: [
      ...
      { key: 'almacenTipoNombre', header: 'Tipo', width: '110px' },
      { key: 'centrosCostoNombre', header: 'Centro costo', width: '140px' },
      { key: 'proveedorNombre', header: 'Proveedor', width: '140px' },
      { key: 'direccion', header: 'Dirección', width: '160px' },
      { key: 'distrito', header: 'Distrito', width: '100px' },
      { key: 'sucursalNombre', header: 'Sucursal', width: '120px' },
