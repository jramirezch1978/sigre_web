$PBExportHeader$w_maxxx_causa_fallas_tbl.srw
forward
global type w_maxxx_causa_fallas_tbl from w_abc
end type
type dw_master from u_dw_abc within w_maxxx_causa_fallas_tbl
end type
end forward
...
integer width = 2912
integer height = 944
string title = "Causas de Fallas (MAXXX)"
string menuname = "m_abc_master_smpl"
dw_master dw_master
end type
global w_maxxx_causa_fallas_tbl w_maxxx_causa_fallas_tbl

on w_maxxx_causa_fallas_tbl.create
int iCurrent
call super::create
...
on w_maxxx_causa_fallas_tbl.destroy
call super::destroy
