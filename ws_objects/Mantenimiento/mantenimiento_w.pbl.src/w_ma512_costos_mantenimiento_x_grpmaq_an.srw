$PBExportHeader$w_ma512_costos_mantenimiento_x_grpmaq_an.srw
forward
global type w_ma512_costos_mantenimiento_x_grpmaq_an from w_cns
end type
type st_1 from statictext within w_ma512_costos_mantenimiento_x_grpmaq_an
end type
type ddlb_1 from dropdownlistbox within w_ma512_costos_mantenimiento_x_grpmaq_an
end type
type dw_ext from datawindow within w_ma512_costos_mantenimiento_x_grpmaq_an
end type
type cb_3 from commandbutton within w_ma512_costos_mantenimiento_x_grpmaq_an
end type
type dw_graph from u_dw_grf within w_ma512_costos_mantenimiento_x_grpmaq_an
end type
type cb_2 from commandbutton within w_ma512_costos_mantenimiento_x_grpmaq_an
end type
type cb_1 from commandbutton within w_ma512_costos_mantenimiento_x_grpmaq_an
end type
type dw_cns from u_dw_cns within w_ma512_costos_mantenimiento_x_grpmaq_an
end type
end forward
...
integer width = 3680
integer height = 2244
string title = "Costos de Mantenimiento Anual x Grupo de Maquina ( MA512)"
...
global w_ma512_costos_mantenimiento_x_grpmaq_an w_ma512_costos_mantenimiento_x_grpmaq_an
...
on w_ma512_costos_mantenimiento_x_grpmaq_an.create
int iCurrent
call super::create
...
on w_ma512_costos_mantenimiento_x_grpmaq_an.destroy
call super::destroy
...
event clicked;String ls_ano,ls_tip_costo,ls_cod_grupo,ls_titulo
...
DECLARE pb_usp_calc_x_tmant_an_pr_x_grp PROCEDURE FOR USP_MTT_COSTO_GRMAQ_AN
(:is_ano,:ls_tip_costo,:ls_cod_grupo)  ;
EXECUTE pb_usp_calc_x_tmant_an_pr_x_grp;	
...
dw_cns.retrieve(ls_ano,ls_tip_costo,ls_cod_grupo,'G',gs_empresa,gs_user)
