$PBExportHeader$w_ma721_doc_tenica_eq.srw
forward
global type w_ma721_doc_tenica_eq from w_rpt
end type
type cb_reporte from commandbutton within w_ma721_doc_tenica_eq
end type
type cb_equipos from commandbutton within w_ma721_doc_tenica_eq
end type
type dw_report from u_dw_rpt within w_ma721_doc_tenica_eq
end type
end forward
...
global w_ma721_doc_tenica_eq w_ma721_doc_tenica_eq
...
on w_ma721_doc_tenica_eq.create
int iCurrent
call super::create
...
on w_ma721_doc_tenica_eq.destroy
call super::destroy
...
integer height = 1464
integer taborder = 60
string dataobject = "d_rpt_desc_tecnica_eq"
