$PBExportHeader$w_ma500_costos_mantenimiento_bkp.srw
forward
global type w_ma500_costos_mantenimiento_bkp from w_rpt
end type
type dw_ext from datawindow within w_ma500_costos_mantenimiento_bkp
end type
type cb_3 from commandbutton within w_ma500_costos_mantenimiento_bkp
end type
type uo_1 from u_ingreso_rango_fechas within w_ma500_costos_mantenimiento_bkp
end type
type dw_report from u_dw_rpt within w_ma500_costos_mantenimiento_bkp
end type
type dw_grp from u_dw_grf within w_ma500_costos_mantenimiento_bkp
end type
type gb_1 from groupbox within w_ma500_costos_mantenimiento_bkp
end type
end forward
...
global w_ma500_costos_mantenimiento_bkp w_ma500_costos_mantenimiento_bkp
...
on w_ma500_costos_mantenimiento_bkp.create
int iCurrent
call super::create
...
on w_ma500_costos_mantenimiento_bkp.destroy
call super::destroy
