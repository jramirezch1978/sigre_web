$PBExportHeader$w_abc_seleccion_estruc.srw
forward
global type w_abc_seleccion_estruc from w_abc_list
end type
type cb_1 from commandbutton within w_abc_seleccion_estruc
end type
type st_campo from statictext within w_abc_seleccion_estruc
end type
type dw_3 from datawindow within w_abc_seleccion_estruc
end type
end forward
...
integer width = 2601
integer height = 1644
string title = "Seleccion de Estructuras"
...
global w_abc_seleccion_estruc w_abc_seleccion_estruc
...
on w_abc_seleccion_estruc.create
int iCurrent
call super::create
...
on w_abc_seleccion_estruc.destroy
call super::destroy
destroy(this.cb_1)
...
type dw_1 from w_abc_list`dw_1 within w_abc_seleccion_estruc
integer x = 0
integer y = 136
integer width = 800
string dataobject = "d_list_estruct_grid"
...
type dw_2 from w_abc_list`dw_2 within w_abc_seleccion_estruc
integer x = 1234
integer y = 148
integer width = 800
...
type pb_1 from w_abc_list`pb_1 within w_abc_seleccion_estruc
integer x = 983
integer y = 440
end type

type pb_2 from w_abc_list`pb_2 within w_abc_seleccion_estruc
integer x = 983
integer y = 688
end type
