$PBExportHeader$w_ma006_mecanicos.srw
forward
global type w_ma006_mecanicos from w_abc_list
end type
type st_1 from statictext within w_ma006_mecanicos
end type
type st_2 from statictext within w_ma006_mecanicos
end type
end forward
...
integer width = 3429
integer height = 1952
string title = "Mantenimiento de Mecanicos   (MA006)"
string menuname = "m_abc_list"
st_1 st_1
st_2 st_2
end type
global w_ma006_mecanicos w_ma006_mecanicos

on w_ma006_mecanicos.create
int iCurrent
call super::create
...
type dw_1 from w_abc_list`dw_1 within w_ma006_mecanicos
integer y = 112
integer width = 1317
integer height = 1600
string dataobject = "d_maestro_no_mecanico_tbl"
...
FOR li_x = 1 to UpperBound(ii_dk)
	...
	ll_rc = idw_det.SetItem(ll_row, idw_det.ii_rk[li_x], la_id) //ll_rc=1 si es ok, -1 error
NEXT
...
type dw_2 from w_abc_list`dw_2 within w_ma006_mecanicos
integer x = 1591
integer y = 112
integer width = 1783
integer height = 1600
string dataobject = "d_abc_mecanicos_tbl"
boolean vscrollbar = true
end type
...
event dw_2::ue_insert_pre(long al_row);call super::ue_insert_pre;String ls_flag_estado
ls_flag_estado='1'
this.SetItem( al_row, 'mecanicos_flag_estado', ls_flag_estado )

end event

type pb_1 from w_abc_list`pb_1 within w_ma006_mecanicos
integer x = 1394
integer y = 560
end type

type pb_2 from w_abc_list`pb_2 within w_ma006_mecanicos
integer x = 1394
integer y = 1168
end type
