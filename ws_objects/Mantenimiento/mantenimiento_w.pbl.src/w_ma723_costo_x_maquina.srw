$PBExportHeader$w_ma723_costo_x_maquina.srw
forward
global type w_ma723_costo_x_maquina from w_report_smpl
end type
type uo_fecha from u_ingreso_rango_fechas within w_ma723_costo_x_maquina
end type
type cb_1 from commandbutton within w_ma723_costo_x_maquina
end type
type rb_1 from radiobutton within w_ma723_costo_x_maquina
end type
type rb_2 from radiobutton within w_ma723_costo_x_maquina
end type
type rb_3 from radiobutton within w_ma723_costo_x_maquina
end type
type rb_4 from radiobutton within w_ma723_costo_x_maquina
end type
type gb_2 from groupbox within w_ma723_costo_x_maquina
end type
type gb_4 from groupbox within w_ma723_costo_x_maquina
end type
end forward
...
integer width = 3744
integer height = 3192
string title = "Costo x Maquina (MA723)"
...
global w_ma723_costo_x_maquina w_ma723_costo_x_maquina

on w_ma723_costo_x_maquina.create
int iCurrent
call super::create
...
on w_ma723_costo_x_maquina.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ma723_costo_x_maquina
integer x = 0
integer y = 356
integer width = 2807
integer height = 1268
string dataobject = "d_rpt_costo_maquina_tab"
end type
...
insert into tt_mtt_ot_adm (ot_adm) 
	SELECT distinct ot_adm
...
// Asigna valores a structura 
sl_param.dw1 = "d_lista_ot_adm_usuario_grd"	
sl_param.tipo = '1S'
sl_param.string1 = gs_user
sl_param.titulo = "Lista de OT_ADM"
sl_param.opcion = 3
