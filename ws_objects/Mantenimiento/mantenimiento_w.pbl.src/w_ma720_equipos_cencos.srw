$PBExportHeader$w_ma720_equipos_cencos.srw
forward
global type w_ma720_equipos_cencos from w_rpt
end type
type cb_reporte from commandbutton within w_ma720_equipos_cencos
end type
type cb_equipos from commandbutton within w_ma720_equipos_cencos
end type
type dw_report from u_dw_rpt within w_ma720_equipos_cencos
end type
end forward
...
integer width = 2226
integer height = 1868
string title = "Programa Ciclico de Mantenimiento (FL709)"
...
global w_ma720_equipos_cencos w_ma720_equipos_cencos
...
on w_ma720_equipos_cencos.create
int iCurrent
call super::create
...
on w_ma720_equipos_cencos.destroy
call super::destroy
...
integer height = 1464
integer taborder = 60
string dataobject = "d_rpt_equipos_cencos"
