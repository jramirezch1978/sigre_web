$PBExportHeader$w_rpt_jramos.srw
forward
global type w_rpt_jramos from w_rpt
end type
type uo_1 from u_ingreso_rango_fechas within w_rpt_jramos
end type
type dw_report from u_dw_rpt within w_rpt_jramos
end type
type cb_4 from commandbutton within w_rpt_jramos
end type
type cb_3 from commandbutton within w_rpt_jramos
end type
type cb_2 from commandbutton within w_rpt_jramos
end type
type cb_1 from commandbutton within w_rpt_jramos
end type
type gb_1 from groupbox within w_rpt_jramos
end type
end forward
...
global w_rpt_jramos w_rpt_jramos

on w_rpt_jramos.create
int iCurrent
call super::create
