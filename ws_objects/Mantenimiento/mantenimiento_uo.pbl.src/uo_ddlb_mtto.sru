$PBExportHeader$uo_ddlb_mtto.sru
$PBExportComments$ddlb que carga desde datawindow
forward
global type uo_ddlb_mtto from dropdownlistbox
end type
end forward
...
global uo_ddlb_mtto uo_ddlb_mtto
...
on uo_ddlb_mtto.create
end on

on uo_ddlb_mtto.destroy
end on
