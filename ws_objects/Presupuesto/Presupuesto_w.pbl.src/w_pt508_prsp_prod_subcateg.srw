$PBExportHeader$w_pt508_prsp_prod_subcateg.srw
forward
global type w_pt508_prsp_prod_subcateg from w_abc_master
end type
type st_1 from statictext within w_pt508_prsp_prod_subcateg
end type
type st_2 from statictext within w_pt508_prsp_prod_subcateg
end type
type st_3 from statictext within w_pt508_prsp_prod_subcateg
end type
type em_ano from editmask within w_pt508_prsp_prod_subcateg
end type
type em_cencos from editmask within w_pt508_prsp_prod_subcateg
end type
type cb_cencos from commandbutton within w_pt508_prsp_prod_subcateg
end type
type cb_2 from commandbutton within w_pt508_prsp_prod_subcateg
end type
type em_subcateg from editmask within w_pt508_prsp_prod_subcateg
end type
type cb_3 from commandbutton within w_pt508_prsp_prod_subcateg
end type
type sle_cencos from singlelineedit within w_pt508_prsp_prod_subcateg
end type
type sle_subcateg from singlelineedit within w_pt508_prsp_prod_subcateg
end type
end forward
...
global w_pt508_prsp_prod_subcateg w_pt508_prsp_prod_subcateg

on w_pt508_prsp_prod_subcateg.create
int iCurrent
call super::create
...
on w_pt508_prsp_prod_subcateg.destroy
call super::destroy
...
type dw_master from w_abc_master`dw_master within w_pt508_prsp_prod_subcateg
integer y = 208
integer width = 3351
integer height = 1320
integer taborder = 40
string dataobject = "d_cns_presup_prod_und_subcateg"
end type
...
//
if li_proy > 0 then
	sl_param.dw1 = 'd_cns_proy_prsp_prod'	
	sl_param.long2 = li_proy
	sl_param.opcion = 1
...
if li_var = 0 then
	sl_param.dw1 = 'd_cns_prod_var_total'	
...
if li_var > 0 then
	sl_param.dw1 = 'd_cns_prod_var_x_mes'	
	sl_param.long2 = li_var
	sl_param.opcion = 2
...
if li_ejec = 0 then
	sl_param.dw1 = 'd_cns_ejec_prsp_prod_total'
...
if li_ejec > 0 then
	sl_param.dw1 = 'd_cns_ejec_prspprod_x_mes'
	sl_param.long2 = li_ejec
	sl_param.opcion = 1  // Ejecucion de Presupuesto Produccion
...
//create or replace procedure USP_PTO_PRSPPROD_EJEC_SUBCATEG(
//       ani_ano         cntbl_asiento.ano%type,
//       asi_cencos      centros_costo.cencos%TYPE,
//       asi_subcateg    articulo_sub_categ.cod_sub_cat%TYPE  
//) is
DECLARE USP_PTO_PRSPPROD_EJEC_SUBCATEG PROCEDURE FOR
	USP_PTO_PRSPPROD_EJEC_SUBCATEG(:ll_ano,
										  	 :ls_cencos,
										  	 :ls_subcateg);
	
EXECUTE USP_PTO_PRSPPROD_EJEC_SUBCATEG;

if sqlca.sqlcode = -1 then   // Fallo
	ls_mensaje = SQLCA.SQLErrText
	rollback ;
	Messagebox( "Error USP_PTO_PRSPPROD_EJEC_SUBCATEG", ls_mensaje, stopsign!)
	return 0
end if

CLOSE USP_PTO_PRSPPROD_EJEC_SUBCATEG;
