$PBExportHeader$w_pt507_var_prsp_ingr.srw
$PBExportComments$Control presupuestario por cuenta presupuestal
forward
global type w_pt507_var_prsp_ingr from w_report_smpl
end type
type cb_1 from commandbutton within w_pt507_var_prsp_ingr
end type
type cb_2 from commandbutton within w_pt507_var_prsp_ingr
end type
type rb_positivas from radiobutton within w_pt507_var_prsp_ingr
end type
type rb_negativas from radiobutton within w_pt507_var_prsp_ingr
end type
type rb_ambas from radiobutton within w_pt507_var_prsp_ingr
end type
type sle_mes1 from singlelineedit within w_pt507_var_prsp_ingr
end type
type sle_mes2 from singlelineedit within w_pt507_var_prsp_ingr
end type
type st_1 from statictext within w_pt507_var_prsp_ingr
end type
type st_2 from statictext within w_pt507_var_prsp_ingr
end type
type gb_1 from groupbox within w_pt507_var_prsp_ingr
end type
end forward
...
integer width = 3182
integer height = 1644
string title = "Variaciones Presupuesto Ingresos (PT507)"
...
global w_pt507_var_prsp_ingr w_pt507_var_prsp_ingr

type variables
Long il_year
end variables

on w_pt507_var_prsp_ingr.create
int iCurrent
call super::create
...
on w_pt507_var_prsp_ingr.destroy
call super::destroy
...
for li_i = 1 to idw_1.RowCount()
	idw_1.Object.flag_estado[li_i] = '0'
next
end event
...
type dw_report from w_report_smpl`dw_report within w_pt507_var_prsp_ingr
integer x = 0
integer y = 220
integer width = 2670
integer height = 1192
...
DECLARE USP_PTO_GEN_VAR_PRSP_INGRESOS PROCEDURE FOR
	USP_PTO_GEN_VAR_PRSP_INGRESOS( :il_year,
							  			:gs_origen,
							  			:gs_user,
										:li_mes1,
										:li_mes2,
