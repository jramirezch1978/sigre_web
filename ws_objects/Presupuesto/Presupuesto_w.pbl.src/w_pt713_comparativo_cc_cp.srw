$PBExportHeader$w_pt713_comparativo_cc_cp.srw
forward
global type w_pt713_comparativo_cc_cp from w_rpt_list
end type
type cb_3 from commandbutton within w_pt713_comparativo_cc_cp
end type
type em_ano from editmask within w_pt713_comparativo_cc_cp
end type
type ddlb_nivelcc from dropdownlistbox within w_pt713_comparativo_cc_cp
end type
type st_11 from statictext within w_pt713_comparativo_cc_cp
end type
type dw_3 from u_dw_abc within w_pt713_comparativo_cc_cp
end type
type dw_4 from u_dw_abc within w_pt713_comparativo_cc_cp
end type
type pb_3 from pb_1 within w_pt713_comparativo_cc_cp
end type
type pb_4 from pb_2 within w_pt713_comparativo_cc_cp
end type
type st_2 from statictext within w_pt713_comparativo_cc_cp
end type
type ddlb_nivelcp from dropdownlistbox within w_pt713_comparativo_cc_cp
end type
type st_1 from statictext within w_pt713_comparativo_cc_cp
end type
type st_3 from statictext within w_pt713_comparativo_cc_cp
end type
type ddlb_del from dropdownlistbox within w_pt713_comparativo_cc_cp
end type
type ddlb_al from dropdownlistbox within w_pt713_comparativo_cc_cp
end type
type st_4 from statictext within w_pt713_comparativo_cc_cp
end type
type gb_3 from groupbox within w_pt713_comparativo_cc_cp
end type
type gb_5 from groupbox within w_pt713_comparativo_cc_cp
end type
end forward
...
global w_pt713_comparativo_cc_cp w_pt713_comparativo_cc_cp

type variables
String is_almacen, is_col = '', is_type
Integer ii_nivel_cc, ii_nivel_cp, ii_delmes, ii_almes


end variables

on w_pt713_comparativo_cc_cp.create
int iCurrent
call super::create
...
this.Control[iCurrent+13]=this.ddlb_del
this.Control[iCurrent+14]=this.ddlb_al
this.Control[iCurrent+15]=this.st_4
this.Control[iCurrent+16]=this.gb_3
this.Control[iCurrent+17]=this.gb_5
end on

on w_pt713_comparativo_cc_cp.destroy
call super::destroy
...
type dw_report from w_rpt_list`dw_report within w_pt713_comparativo_cc_cp
...
integer height = 1960
integer taborder = 30
string dataobject = "d_rpt_comparativo_cc_cp_cmp"
end type

type dw_1 from w_rpt_list`dw_1 within w_pt713_comparativo_cc_cp
integer x = 23
integer y = 224
integer width = 1669
integer height = 796
...
type pb_1 from w_rpt_list`pb_1 within w_pt713_comparativo_cc_cp
integer x = 1733
integer y = 488
...
type pb_2 from w_rpt_list`pb_2 within w_pt713_comparativo_cc_cp
integer x = 1737
integer y = 628
...
type dw_2 from w_rpt_list`dw_2 within w_pt713_comparativo_cc_cp
integer x = 1915
integer y = 224
integer width = 1669
integer height = 796
...
type cb_report from w_rpt_list`cb_report within w_pt713_comparativo_cc_cp
integer x = 3095
integer y = 120
integer width = 334
integer height = 84
			...
			case 1
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						insert into tt_pto_seleccion(niv1, cnta1) 
			...
			case 2	
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, cnta1, cnta2) 
			...
			case 3
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, cnta1, cnta2, cnta3) 
			...
			case 4
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, cnta_prsp) values (:ls_niv1, :ls_cnta4);
					Next
				NEXT
		end choose
	case 2
			...
			case 1
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, niv2, cnta1) 
						  values (:ls_niv1, :ls_niv2, :ls_cnta1);	
					Next
				NEXT
			case 2	
				ls_modo = '2_2'				
			...
			case 3
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, niv2, cnta1, cnta2, cnta3) 
						  values (:ls_niv1, :ls_niv2, :ls_cnta1, :ls_cnta2, :ls_cnta3);	
					Next
				NEXT
			case 4
				ls_modo = '2_4'
			...
			case 1
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, niv2, niv3, cnta1) 
						  values (:ls_niv1, :ls_niv2, :ls_niv3, :ls_cnta1);
					Next
				NEXT
			case 2	
				ls_modo = '3_2'				
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, niv2, niv3, cnta1, cnta2) 
						  values (:ls_niv1, :ls_niv2, :ls_niv3, :ls_cnta1, :ls_cnta2);	
					Next
				NEXT
			case 3
				ls_modo = '3_3'				
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, niv2, niv3, cnta1, cnta2, cnta3) 
						  values (:ls_niv1, :ls_niv2, :ls_niv3, :ls_cnta1, :ls_cnta2, :ls_cnta3);	
					Next
				NEXT
			case 4
				ls_modo = '3_4'
				...
				FOR ll_row = 1 to dw_2.rowcount()
					...
					For ll_row2 = 1 to dw_4.RowCount()
						...
						// Llena tabla temporal con el centro de costo y todas las cuentas
						// presupuestales que tenga segun indicadores
						insert into tt_pto_seleccion(niv1, niv2, niv3, cnta_prsp) values (:ls_niv1, :ls_niv2, :ls_niv3, :ls_cnta4);
					Next
				NEXT
		end choose
	case 4
...
Choose case index
	...
	case 3
		dw_1.dataobject = "d_sel_centro_costo_niv3_2"
		dw_2.dataobject = "d_sel_centro_costo_niv3_2"
	case 4
		dw_1.dataobject = "d_sel_centro_costo_niv4_2"
		dw_2.dataobject = "d_sel_centro_costo_niv4_2"
End Choose
dw_1.SetTransobject(sqlca)
dw_1.Retrieve()
end event
