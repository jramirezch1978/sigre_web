$PBExportHeader$w_pt319_add_edit_record.srw
forward
global type w_pt319_add_edit_record from w_abc
end type
type dw_master from u_dw_abc within w_pt319_add_edit_record
end type
type cb_2 from commandbutton within w_pt319_add_edit_record
end type
type cb_1 from commandbutton within w_pt319_add_edit_record
end type
end forward
...
global w_pt319_add_edit_record w_pt319_add_edit_record
...
if istr_param.accion = 'new' then
	...
	if ll_row > 0 then
		...
		ldw_detail.object.proveedor			[ll_row] = dw_master.object.proveedor 			[1]
		ldw_detail.object.nom_proveedor		[ll_row] = dw_master.object.nom_proveedor 	[1]
		ldw_detail.object.cod_moneda			[ll_row] = dw_master.object.cod_moneda 		[1]
		ldw_detail.object.imp_proyectado		[ll_row] = dw_master.object.imp_proyectado 	[1]
		ldw_detail.object.descripcion			[ll_row] = dw_master.object.descripcion 		[1]
		ldw_detail.object.tipo_doc				[ll_row] = dw_master.object.tipo_doc 			[1]
		ldw_detail.object.nro_doc				[ll_row] = dw_master.object.nro_doc 			[1]
		ldw_detail.object.fec_pago				[ll_row] = dw_master.object.fec_pago 			[1]
		ldw_detail.object.nro_operacion		[ll_row] = dw_master.object.nro_operacion		[1]
		
		if dw_master.object.cod_moneda [1] = gnvo_app.is_soles then
			ldw_detail.object.imp_soles	[ll_row] = dw_master.object.imp_proyectado 	[1]
			ldw_detail.object.imp_dolares	[ll_row] = 0.00
		else
			ldw_detail.object.imp_soles	[ll_row] = 0.00
			ldw_detail.object.imp_dolares	[ll_row] = dw_master.object.imp_proyectado 	[1]
		end if
	...
	if il_find > 0 then
		ldw_detail.object.flag_ing_egr 		[il_find] = dw_master.object.flag_ing_egr 	[1]
		ldw_detail.object.flag_flujo_caja 	[il_find] = dw_master.object.flag_flujo_caja [1]
		ldw_detail.object.cod_seccion 		[il_find] = dw_master.object.cod_seccion 		[1]
		ldw_detail.object.desc_seccion 		[il_find] = dw_master.object.desc_seccion 	[1]
		ldw_detail.object.cod_detalle 		[il_find] = dw_master.object.cod_detalle 		[1]
		ldw_detail.object.desc_detalle 		[il_find] = dw_master.object.desc_detalle 	[1]
		ldw_detail.object.cencos		 		[il_find] = dw_master.object.cencos 			[1]
		ldw_detail.object.cnta_prsp			[il_find] = dw_master.object.cnta_prsp 		[1]
		ldw_detail.object.proveedor			[il_find] = dw_master.object.proveedor 		[1]
		ldw_detail.object.nom_proveedor		[il_find] = dw_master.object.nom_proveedor 	[1]
		ldw_detail.object.cod_moneda			[il_find] = dw_master.object.cod_moneda 		[1]
		ldw_detail.object.imp_proyectado		[il_find] = dw_master.object.imp_proyectado 	[1]
		ldw_detail.object.descripcion			[il_find] = dw_master.object.descripcion 		[1]
		ldw_detail.object.tipo_doc				[il_find] = dw_master.object.tipo_doc 			[1]
		ldw_detail.object.nro_doc				[il_find] = dw_master.object.nro_doc 			[1]
		ldw_detail.object.fec_pago				[il_find] = dw_master.object.fec_pago 			[1]
		ldw_detail.object.nro_operacion		[il_find] = dw_master.object.nro_operacion		[1]
		
		if dw_master.object.cod_moneda [1] = gnvo_app.is_soles then
			ldw_detail.object.imp_soles	[il_find] = dw_master.object.imp_proyectado 	[1]
			ldw_detail.object.imp_dolares	[il_find] = 0.00
		else
			ldw_detail.object.imp_soles	[il_find] = 0.00
			ldw_detail.object.imp_dolares	[il_find] = dw_master.object.imp_proyectado 	[1]
		end if
...
on w_pt319_add_edit_record.create
int iCurrent
call super::create
...
on w_pt319_add_edit_record.destroy
call super::destroy
...
if istr_param.accion = 'new' then
	...
	if il_find > 0 then
		...
		dw_master.object.fec_pago			[1] = ldw_detail.object.fec_pago				[il_find]
		dw_master.object.nro_operacion	[1] = ldw_detail.object.nro_operacion		[il_find]
		...
		dw_master.object.tipo_doc			[1] = ldw_detail.object.tipo_doc				[il_find]
		dw_master.object.nro_doc			[1] = ldw_detail.object.nro_doc				[il_find]
...
integer width = 3232
integer height = 1228
string dataobject = "d_abc_prsp_caja_det_ff"
