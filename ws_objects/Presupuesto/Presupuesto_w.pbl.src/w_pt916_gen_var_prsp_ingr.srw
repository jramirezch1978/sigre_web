$PBExportHeader$w_pt916_gen_var_prsp_ingr.srw
forward
global type w_pt916_gen_var_prsp_ingr from w_abc
end type
type cb_4 from commandbutton within w_pt916_gen_var_prsp_ingr
end type
type cb_unselectall from commandbutton within w_pt916_gen_var_prsp_ingr
end type
type cb_selectall from commandbutton within w_pt916_gen_var_prsp_ingr
end type
type cb_leer from commandbutton within w_pt916_gen_var_prsp_ingr
end type
type pb_1 from picturebutton within w_pt916_gen_var_prsp_ingr
end type
type pb_2 from picturebutton within w_pt916_gen_var_prsp_ingr
end type
type st_1 from statictext within w_pt916_gen_var_prsp_ingr
end type
type st_6 from statictext within w_pt916_gen_var_prsp_ingr
end type
type em_ano from editmask within w_pt916_gen_var_prsp_ingr
end type
type dw_master from u_dw_abc within w_pt916_gen_var_prsp_ingr
end type
end forward
...
integer width = 2953
integer height = 2420
string title = "Generacion de Variacion Presupuesto - Plan de Ventas (PT916)"
...
global w_pt916_gen_var_prsp_ingr w_pt916_gen_var_prsp_ingr

on w_pt916_gen_var_prsp_ingr.create
int iCurrent
call super::create
...
on w_pt916_gen_var_prsp_ingr.destroy
call super::destroy
...
//create or replace procedure USP_PTO_GEN_VAR_PRSP_INGRESOS(
//       ani_year     in number,
...
DECLARE USP_PTO_GEN_VAR_PRSP_INGRESOS PROCEDURE FOR
	USP_PTO_GEN_VAR_PRSP_INGRESOS( :ll_year,
							  				 :gs_origen, 
							  				 :gs_user,
											 :li_nada,
											 :li_nada,
...
EXECUTE USP_PTO_GEN_VAR_PRSP_INGRESOS;

IF SQLCA.sqlcode = -1 THEN
	ls_mensaje = "PROCEDURE USP_PTO_GEN_VAR_PRSP_INGRESOS: " + SQLCA.SQLErrText
	Rollback ;
	MessageBox('SQL error', ls_mensaje, StopSign!)	
	return
END IF

CLOSE USP_PTO_GEN_VAR_PRSP_INGRESOS;
...
OpenSheetWithParm(w_pt507_var_prsp_ingr, lstr_param, w_main, 7, Layered!)
...
string text = "GENERACION DE VARIACIONES A PARTIR DEL PLAN DE VENTAS"
...
integer height = 1164
integer taborder = 50
string dataobject = "d_list_prsp_ingr_ejec"
end type
