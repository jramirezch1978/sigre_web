$PBExportHeader$w_pt305_proyecto_frm.srw
forward
global type w_pt305_proyecto_frm from w_rpt
end type
type dw_report from u_dw_rpt within w_pt305_proyecto_frm
end type
end forward
...
integer width = 3314
integer height = 1696
string title = "Formato de orden de compra"
string menuname = "m_impresion"
long backcolor = 12632256
dw_report dw_report
end type
global w_pt305_proyecto_frm w_pt305_proyecto_frm

type variables
String is_cod_origen, is_nro_oc
end variables

on w_pt305_proyecto_frm.create
int iCurrent
call super::create
...
on w_pt305_proyecto_frm.destroy
call super::destroy
...
event ue_retrieve();Long ll_nro

ll_nro = message.doubleparm

idw_1.Retrieve(ll_nro)
idw_1.Visible = True
...
string dataobject = "d_rpt_form_proyecto"
