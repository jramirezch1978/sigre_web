$PBExportHeader$w_pt915_gen_prsp_ingresos.srw
forward
global type w_pt915_gen_prsp_ingresos from w_abc
end type
type ddlb_cntrl_prsp from dropdownlistbox within w_pt915_gen_prsp_ingresos
end type
type ddlb_cmp_directa from dropdownlistbox within w_pt915_gen_prsp_ingresos
end type
type st_2 from statictext within w_pt915_gen_prsp_ingresos
end type
type st_3 from statictext within w_pt915_gen_prsp_ingresos
end type
type cbx_1 from checkbox within w_pt915_gen_prsp_ingresos
end type
type cb_4 from commandbutton within w_pt915_gen_prsp_ingresos
end type
type cb_unselectall from commandbutton within w_pt915_gen_prsp_ingresos
end type
type cb_selectall from commandbutton within w_pt915_gen_prsp_ingresos
end type
type cb_leer from commandbutton within w_pt915_gen_prsp_ingresos
end type
type pb_1 from picturebutton within w_pt915_gen_prsp_ingresos
end type
type pb_2 from picturebutton within w_pt915_gen_prsp_ingresos
end type
type st_1 from statictext within w_pt915_gen_prsp_ingresos
end type
type st_6 from statictext within w_pt915_gen_prsp_ingresos
end type
type em_ano from editmask within w_pt915_gen_prsp_ingresos
end type
type cbx_revertir from checkbox within w_pt915_gen_prsp_ingresos
end type
type dw_master from u_dw_abc within w_pt915_gen_prsp_ingresos
end type
end forward
...
integer width = 3159
integer height = 2248
string title = "Generacion de Presupuesto de Ingresos (PT915)"
...
global w_pt915_gen_prsp_ingresos w_pt915_gen_prsp_ingresos

on w_pt915_gen_prsp_ingresos.create
int iCurrent
call super::create
...
this.Control[iCurrent+1]=this.ddlb_cntrl_prsp
this.Control[iCurrent+2]=this.ddlb_cmp_directa
...
on w_pt915_gen_prsp_ingresos.destroy
call super::destroy
...
//create or replace procedure USP_PTO_GEN_PRSP_INGRESOS(
//       asi_user             in usuario.cod_usr%TYPE,
//       asi_origen           in origen.cod_origen%TYPE,
//       asi_modo             in VARCHAR2,
//       asi_cntrl_prsp       IN VARCHAR2,
//       asi_cmp_directa      IN VARCHAR2,
//       asi_flag_xdefecto    IN VARCHAR2
//) is


DECLARE USP_PTO_GEN_PRSP_INGRESOS PROCEDURE FOR 
	USP_PTO_GEN_PRSP_INGRESOS (:gs_user,
										:gs_origen,
								  		:ls_modo,
										:ls_cntrl_prsp,
										:ls_cmp_directa,
...
EXECUTE USP_PTO_GEN_PRSP_INGRESOS;

if sqlca.sqlcode = -1 then   // Fallo
	ls_mensaje = SQLCA.SQLErrText
	rollback ;
	Messagebox( "Error USP_PTO_GEN_PRSP_INGRESOS", ls_mensaje, stopsign!)
	return
end if

CLOSE USP_PTO_GEN_PRSP_INGRESOS;
...
long textcolor = 33554432
long backcolor = 67108864
string text = "GENERACION DE PRESUPUESTO DE INGRESOS"
...
integer height = 1508
integer taborder = 50
string dataobject = "d_list_presup_ingresos_plant_prsp"
