$PBExportHeader$w_pt504_prsp_var_ots.srw
$PBExportComments$Control presupuestario por cuenta presupuestal
forward
global type w_pt504_prsp_var_ots from w_report_smpl
end type
type cb_1 from commandbutton within w_pt504_prsp_var_ots
end type
type cb_2 from commandbutton within w_pt504_prsp_var_ots
end type
type rb_positivas from radiobutton within w_pt504_prsp_var_ots
end type
type rb_negativas from radiobutton within w_pt504_prsp_var_ots
end type
type rb_ambas from radiobutton within w_pt504_prsp_var_ots
end type
type sle_mes1 from singlelineedit within w_pt504_prsp_var_ots
end type
type sle_mes2 from singlelineedit within w_pt504_prsp_var_ots
end type
type st_1 from statictext within w_pt504_prsp_var_ots
end type
type st_2 from statictext within w_pt504_prsp_var_ots
end type
type gb_1 from groupbox within w_pt504_prsp_var_ots
end type
end forward
...
global w_pt504_prsp_var_ots w_pt504_prsp_var_ots

type variables
Long il_year
end variables

on w_pt504_prsp_var_ots.create
int iCurrent
call super::create
...
on w_pt504_prsp_var_ots.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_pt504_prsp_var_ots
integer x = 0
integer y = 244
integer width = 2217
integer height = 1168
...
IF SQLCA.sqlcode = -1 THEN
	ls_mensaje = "PROCEDURE USP_PTO_GEN_VAR_OT: " + SQLCA.SQLErrText
	Rollback ;
