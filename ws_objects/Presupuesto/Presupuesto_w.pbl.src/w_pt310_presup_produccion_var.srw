$PBExportHeader$w_pt310_presup_produccion_var.srw
forward
global type w_pt310_presup_produccion_var from w_abc
end type
type sle_nro from singlelineedit within w_pt310_presup_produccion_var
end type
type cb_2 from commandbutton within w_pt310_presup_produccion_var
end type
type st_2 from statictext within w_pt310_presup_produccion_var
end type
type dw_master from u_dw_abc within w_pt310_presup_produccion_var
end type
end forward
...
integer width = 2345
integer height = 1372
string title = "Variaciones Presupuesto Produccion (PT310)"
...
global w_pt310_presup_produccion_var w_pt310_presup_produccion_var
...
if is_action = 'new' then
	ls_table = 'LOCK TABLE num_presup_prod_var IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_nro 
	from num_presup_prod_var
	where origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into num_presup_prod_var (origen, ult_nro)
			values( :gs_origen, 1);
...
on w_pt310_presup_produccion_var.create
int iCurrent
call super::create
...
on w_pt310_presup_produccion_var.destroy
call super::destroy
...
sl_param.dw1 		= "d_lista_presup_produccion_var_tbl"
...
lstr_param.dw1		 = 'd_rpt_prsp_prod_var'
...
integer width = 2313
integer height = 1052
string dataobject = "d_abc_prsp_prod_var_frm"
end type
...
choose case lower(dwo.name)
	case "b_referencia"
		...
		sl_param.dw1 = "d_list_presup_produccion_tbl"
		sl_param.titulo = "PRESUPUESTO DE PRODUCCION"
		sl_param.field_ret_i[1] = 1
