$PBExportHeader$w_pt776_presup_operac_estim.srw
forward
global type w_pt776_presup_operac_estim from w_rpt
end type
type uo_1 from u_ingreso_rango_fechas within w_pt776_presup_operac_estim
end type
type dw_report from u_dw_rpt within w_pt776_presup_operac_estim
end type
type rb_2 from radiobutton within w_pt776_presup_operac_estim
end type
type rb_1 from radiobutton within w_pt776_presup_operac_estim
end type
type cb_2 from commandbutton within w_pt776_presup_operac_estim
end type
type cb_1 from commandbutton within w_pt776_presup_operac_estim
end type
type gb_2 from groupbox within w_pt776_presup_operac_estim
end type
end forward
...
global w_pt776_presup_operac_estim w_pt776_presup_operac_estim
...
on w_pt776_presup_operac_estim.create
int iCurrent
call super::create
...
on w_pt776_presup_operac_estim.destroy
call super::destroy
...
event ue_retrieve;call super::ue_retrieve;String ls_movim_salida, ls_doc_ot
Long   ll_count
...
IF rb_1.checked THEN     // Operaciones
	dw_report.DataObject = 'd_rpt_presup_estim_operacion_grd'
ELSEIF rb_2.checked THEN // Materiales
	dw_report.DataObject = 'd_rpt_presup_estim_material_grd'
END IF
...
ELSE
	SELECT l.oper_cons_interno, l.doc_ot 
	  INTO :ls_movim_salida, :ls_doc_ot
	  FROM logparam l 
	 WHERE l.reckey='1' ;
	 
	dw_report.retrieve(ls_movim_salida, ls_doc_ot, ld_fecha_inicio, ld_fecha_final)
END IF 
...
idw_1.object.t_texto.text = 'Desde ' + string(ld_fecha_inicio, 'dd/mm/yyyy') + ' hasta ' + string(ld_fecha_final, 'dd/mm/yyyy')
...
integer height = 1212
integer taborder = 40
string dataobject = "d_rpt_presup_estim_operacion_grd"
...
long backcolor = 67108864
string text = "Requerimientos (AMP)"
end type
