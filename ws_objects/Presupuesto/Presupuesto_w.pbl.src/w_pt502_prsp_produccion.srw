$PBExportHeader$w_pt502_prsp_produccion.srw
forward
global type w_pt502_prsp_produccion from w_abc_master
end type
type st_1 from statictext within w_pt502_prsp_produccion
end type
type st_2 from statictext within w_pt502_prsp_produccion
end type
type st_3 from statictext within w_pt502_prsp_produccion
end type
type em_ano from editmask within w_pt502_prsp_produccion
end type
type em_cencos from editmask within w_pt502_prsp_produccion
end type
type cb_cencos from commandbutton within w_pt502_prsp_produccion
end type
type cb_2 from commandbutton within w_pt502_prsp_produccion
end type
type em_cod_art from editmask within w_pt502_prsp_produccion
end type
type cb_3 from commandbutton within w_pt502_prsp_produccion
end type
type sle_cencos from singlelineedit within w_pt502_prsp_produccion
end type
type sle_cod_art from singlelineedit within w_pt502_prsp_produccion
end type
end forward
...
integer width = 3630
integer height = 1640
string title = "Presupuesto Produccion (PT502)"
...
global w_pt502_prsp_produccion w_pt502_prsp_produccion

on w_pt502_prsp_produccion.create
int iCurrent
call super::create
...
on w_pt502_prsp_produccion.destroy
call super::destroy
...
type dw_master from w_abc_master`dw_master within w_pt502_prsp_produccion
integer y = 208
integer width = 3351
integer height = 1212
integer taborder = 40
string dataobject = "d_cns_presup_produccion_und"
end type
...
if li_ejec > 0 then
	sl_param.dw1 = 'd_cns_ejecucion_prsp_prod'
...
//create or replace procedure USP_PTO_PRSP_PROD_EJEC_X_ART(
//       ani_ano          cntbl_asiento.ano%type,
//       asi_cencos      centros_costo.cencos%TYPE,
//       asi_cod_art     articulo.cod_art%TYPE                                         
//) is
DECLARE USP_PTO_PRSP_PROD_EJEC_X_ART PROCEDURE FOR
	USP_PTO_PRSP_PROD_EJEC_X_ART(:ll_ano,
										  :ls_cencos,
										  :ls_cod_art);
	
EXECUTE USP_PTO_PRSP_PROD_EJEC_X_ART;

if sqlca.sqlcode = -1 then   // Fallo
	ls_mensaje = SQLCA.SQLErrText
	rollback ;
	Messagebox( "Error USP_PTO_PRSP_PROD_EJEC_X_ART", ls_mensaje, stopsign!)
	return 0
end if

CLOSE USP_PTO_PRSP_PROD_EJEC_X_ART;
