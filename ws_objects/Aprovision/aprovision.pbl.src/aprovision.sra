$PBExportHeader$aprovision.sra
$PBExportComments$Generated Application Object
forward
global type aprovision from application
end type
...
string appicon = "C:\SIGRE\resources\ICO\Aprovisionamiento.ico"
...
global aprovision aprovision

type prototypes
//SUBROUTINE keybd_event( int bVk, int bScan, int dwFlags, int dwExtraInfo) LIBRARY "user32.dll"
end prototypes

on aprovision.create
appname="aprovision"
...
// Parametros
gs_inifile    = "\sigre_exe\aprovision.ini"
