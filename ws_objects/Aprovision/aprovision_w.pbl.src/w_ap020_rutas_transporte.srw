$PBExportHeader$w_ap020_rutas_transporte.srw
forward
global type w_ap020_rutas_transporte from w_abc_master
end type
end forward
...
integer width = 2725
integer height = 1012
string title = "Rutas de Transporte de Materia Prima (ap020) "
string menuname = "m_mantto_smpl"
boolean center = true
end type
global w_ap020_rutas_transporte w_ap020_rutas_transporte

on w_ap020_rutas_transporte.create
call super::create
if this.MenuName = "m_mantto_smpl" then this.MenuID = create m_mantto_smpl
end on

on w_ap020_rutas_transporte.destroy
call super::destroy
...
type dw_master from w_abc_master`dw_master within w_ap020_rutas_transporte
event ue_display ( string as_columna,  long al_row )
integer x = 0
integer y = 0
integer width = 2679
integer height = 812
string dataobject = "d_abc_rutas_transp_mp_tbl"
