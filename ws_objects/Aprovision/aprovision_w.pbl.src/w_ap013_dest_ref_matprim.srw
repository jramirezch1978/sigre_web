$PBExportHeader$w_ap013_dest_ref_matprim.srw
forward
global type w_ap013_dest_ref_matprim from w_abc_master_smpl
end type
end forward
...
integer width = 1979
integer height = 1168
string title = "Destino Referencia (AP013)"
string menuname = "m_mantto_smpl"
end type
global w_ap013_dest_ref_matprim w_ap013_dest_ref_matprim

on w_ap013_dest_ref_matprim.create
call super::create
if this.MenuName = "m_mantto_smpl" then this.MenuID = create m_mantto_smpl
end on

on w_ap013_dest_ref_matprim.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_ap013_dest_ref_matprim
integer width = 1915
integer height = 964
string dataobject = "d_tg_usus_materia_prima_tbl"
