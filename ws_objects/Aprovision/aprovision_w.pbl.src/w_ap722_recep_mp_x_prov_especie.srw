$PBExportHeader$w_ap722_recep_mp_x_prov_especie.srw
$PBExportComments$Record de pesca de embarcaciones
forward
global type w_ap722_recep_mp_x_prov_especie from w_rpt
end type
type cb_2 from commandbutton within w_ap722_recep_mp_x_prov_especie
end type
type st_descrip_especie from statictext within w_ap722_recep_mp_x_prov_especie
end type
type st_1 from statictext within w_ap722_recep_mp_x_prov_especie
end type
type sle_materia from singlelineedit within w_ap722_recep_mp_x_prov_especie
end type
type cb_1 from commandbutton within w_ap722_recep_mp_x_prov_especie
end type
type uo_fecha from u_ingreso_rango_fechas within w_ap722_recep_mp_x_prov_especie
end type
type dw_report from u_dw_rpt within w_ap722_recep_mp_x_prov_especie
end type
end forward
...
integer width = 3136
integer height = 3208
string title = "Recepción de Materia Prima por Proveedor y Especie  (AP722)"
...
global w_ap722_recep_mp_x_prov_especie w_ap722_recep_mp_x_prov_especie

type variables
String  isa_cod_origen[], is_especie
end variables
...
public function integer of_new_sheet (str_cns_pop astr_1);//Override
Integer 			li_rc
...
on w_ap722_recep_mp_x_prov_especie.create
int iCurrent
call super::create
...
on w_ap722_recep_mp_x_prov_especie.destroy
call super::destroy
...
idw_1.Retrieve(ld_fecha_ini, ld_fecha_fin, is_especie)
...
Datawindow ldw
dwobject   dwo1
ls_sql = "Select Distinct apd.especie as codigo, te.descr_especie as descripcion, "&
			+ "te.flag_estado as estado From tg_especies te , ap_pd_descarga_det apd "&
			+ "Where te.especie = apd.especie and Nvl(te.flag_estado,'0')='1'"
...
integer height = 1532
integer taborder = 80
string dataobject = "d_rpt_recepcion_mp_x_especie_prov_crt"
...
This.accepttext ()
lstr_1.DataObject = 'd_rpt_recep_mp_especie_det_tbl'
lstr_1.Width = 4460
lstr_1.Height= 2000
lstr_1.arg [1] = String(Date(This.Object.fecha[row]))
lstr_1.arg [2] =is_especie
lstr_1.title = "Reporte de Recepción de materias al " + lstr_1.arg [1]
