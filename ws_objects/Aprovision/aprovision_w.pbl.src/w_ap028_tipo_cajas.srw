$PBExportHeader$w_ap028_tipo_cajas.srw
forward
global type w_ap028_tipo_cajas from w_abc_master_smpl
end type
end forward
...
integer width = 2697
integer height = 1856
string title = "[AP028] Tipos de Cajas"
string menuname = "m_mantto_smpl"
end type
global w_ap028_tipo_cajas w_ap028_tipo_cajas

on w_ap028_tipo_cajas.create
call super::create
if this.MenuName = "m_mantto_smpl" then this.MenuID = create m_mantto_smpl
end on

on w_ap028_tipo_cajas.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_ap028_tipo_cajas
integer x = 0
integer y = 0
integer width = 2638
integer height = 1544
string dataobject = "d_abc_tipo_cajas_tbl"
end type
