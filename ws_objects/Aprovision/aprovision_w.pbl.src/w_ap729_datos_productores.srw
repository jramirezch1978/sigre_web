$PBExportHeader$w_ap729_datos_productores.srw
$PBExportComments$Record de pesca de embarcaciones
forward
global type w_ap729_datos_productores from w_rpt
end type
type cb_1 from commandbutton within w_ap729_datos_productores
end type
type uo_fecha from u_ingreso_rango_fechas within w_ap729_datos_productores
end type
type dw_report from u_dw_rpt within w_ap729_datos_productores
end type
end forward
...
integer width = 3671
integer height = 3208
string title = "[AP729] Reporte de Validación de Productores"
...
global w_ap729_datos_productores w_ap729_datos_productores
...
on w_ap729_datos_productores.create
int iCurrent
call super::create
...
on w_ap729_datos_productores.destroy
call super::destroy
...
integer height = 1400
integer taborder = 80
string dataobject = "d_rpt_validacion_productores_tbl"
