$PBExportHeader$w_lista_old.srw
forward
global type w_lista_old from w_abc_master_smpl
end type
type st_campo from statictext within w_lista_old
end type
type dw_1 from datawindow within w_lista_old
end type
type cb_3 from commandbutton within w_lista_old
end type
type pb_1 from picturebutton within w_lista_old
end type
type pb_2 from picturebutton within w_lista_old
end type
type pb_3 from picturebutton within w_lista_old
end type
end forward
...
global w_lista_old w_lista_old
...
type dw_master from w_abc_master_smpl`dw_master within w_lista_old
integer x = 0
integer y = 112
integer width = 1623
integer height = 1136
