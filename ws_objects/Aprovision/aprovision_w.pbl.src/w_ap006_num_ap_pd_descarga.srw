$PBExportHeader$w_ap006_num_ap_pd_descarga.srw
forward
global type w_ap006_num_ap_pd_descarga from w_abc
end type
type dw_master from u_dw_abc within w_ap006_num_ap_pd_descarga
end type
end forward
...
integer width = 1207
integer height = 480
string title = "Numerador Partes Diario de Descarga (AP006)"
string menuname = "m_ap_param"
dw_master dw_master
end type
global w_ap006_num_ap_pd_descarga w_ap006_num_ap_pd_descarga

on w_ap006_num_ap_pd_descarga.create
int iCurrent
call super::create
...
on w_ap006_num_ap_pd_descarga.destroy
call super::destroy
...
event ue_insert;call super::ue_insert;Long  ll_row, ll_parte

select count(*) 
	into :ll_parte
	from NUM_AP_PD_DESCARGA napd 
	where napd.cod_origen = :gs_origen;
...
integer width = 1157
integer height = 220
string dataobject = "d_ap_num_pd_descarga_ff"
