$PBExportHeader$w_ap731_volumen_x_productor.srw
$PBExportComments$Record de pesca de embarcaciones
forward
global type w_ap731_volumen_x_productor from w_rpt
end type
type uo_fecha from u_ingreso_rango_fechas within w_ap731_volumen_x_productor
end type
type cb_1 from commandbutton within w_ap731_volumen_x_productor
end type
type rb_1 from radiobutton within w_ap731_volumen_x_productor
end type
type rb_2 from radiobutton within w_ap731_volumen_x_productor
end type
type sle_year1 from singlelineedit within w_ap731_volumen_x_productor
end type
type sle_week1 from singlelineedit within w_ap731_volumen_x_productor
end type
type sle_year2 from singlelineedit within w_ap731_volumen_x_productor
end type
type sle_week2 from singlelineedit within w_ap731_volumen_x_productor
end type
type st_1 from statictext within w_ap731_volumen_x_productor
end type
type dw_report from u_dw_rpt within w_ap731_volumen_x_productor
end type
end forward
...
integer width = 3671
integer height = 3208
string title = "[AP731] Reporte de Volumen x Productor"
...
global w_ap731_volumen_x_productor w_ap731_volumen_x_productor
...
on w_ap731_volumen_x_productor.create
int iCurrent
call super::create
...
this.Control[iCurrent+8]=this.sle_week2
this.Control[iCurrent+9]=this.st_1
this.Control[iCurrent+10]=this.dw_report
end on

on w_ap731_volumen_x_productor.destroy
call super::destroy
...
integer height = 1292
integer taborder = 80
string dataobject = "d_rpt_volumen_productor_cst"
