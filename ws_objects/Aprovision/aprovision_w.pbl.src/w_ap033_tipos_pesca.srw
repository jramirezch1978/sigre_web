$PBExportHeader$w_ap033_tipos_pesca.srw
forward
global type w_ap033_tipos_pesca from w_abc_master_smpl
end type
end forward
...
integer width = 2697
integer height = 2296
string title = "[AP033] Tipos de Pesca"
string menuname = "m_mantto_smpl"
end type
global w_ap033_tipos_pesca w_ap033_tipos_pesca

on w_ap033_tipos_pesca.create
call super::create
if this.MenuName = "m_mantto_smpl" then this.MenuID = create m_mantto_smpl
end on

on w_ap033_tipos_pesca.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_ap033_tipos_pesca
integer width = 2638
integer height = 984
string dataobject = "d_abc_tipos_pesca_tbl"
end type
