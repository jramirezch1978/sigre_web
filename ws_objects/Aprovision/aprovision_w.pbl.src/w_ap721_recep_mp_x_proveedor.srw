$PBExportHeader$w_ap721_recep_mp_x_proveedor.srw
$PBExportComments$Record de pesca de embarcaciones
forward
global type w_ap721_recep_mp_x_proveedor from w_rpt
end type
type cb_1 from commandbutton within w_ap721_recep_mp_x_proveedor
end type
type uo_fecha from u_ingreso_rango_fechas within w_ap721_recep_mp_x_proveedor
end type
type dw_report from u_dw_rpt within w_ap721_recep_mp_x_proveedor
end type
end forward
...
integer width = 2779
integer height = 3208
string title = "Recepción de Materia Prima por Proveedor  (AP721)"
...
global w_ap721_recep_mp_x_proveedor w_ap721_recep_mp_x_proveedor
...
on w_ap721_recep_mp_x_proveedor.create
int iCurrent
call super::create
...
on w_ap721_recep_mp_x_proveedor.destroy
call super::destroy
...
String ls_empresa, ls_nombre, ls_mensaje

ld_fecha_ini 	= date(uo_fecha.of_get_fecha1( ))
ld_fecha_fin 	= date(uo_fecha.of_get_fecha2( ))


DECLARE usp_ap_recep_mp_porc_prove PROCEDURE FOR 
	usp_ap_recep_mp_porc_prove(:ld_fecha_ini, 
										:ld_fecha_fin) ;
EXECUTE usp_ap_recep_mp_porc_prove ;	

IF sqlca.sqlcode = -1 Then
	ls_mensaje = SQLCA.SQlErrtext
	Rollback ;
	MessageBox( 'Error usp_ap_recep_mp_porc_prove', ls_mensaje, StopSign! )
	Return
End If

close usp_ap_recep_mp_porc_prove;

idw_1.SetTransObject(SQLCA)

Select g.cod_empresa, e.nombre 
 Into :ls_empresa, :ls_nombre
 from genparam g,
 		empresa e
...
integer height = 1532
integer taborder = 80
string dataobject = "d_rpt_ap_recepcion_mp_proveedor_cps"
