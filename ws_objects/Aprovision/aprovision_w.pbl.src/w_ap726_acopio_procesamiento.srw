$PBExportHeader$w_ap726_acopio_procesamiento.srw
$PBExportComments$Record de pesca de embarcaciones
forward
global type w_ap726_acopio_procesamiento from w_rpt
end type
type cbx_productores from checkbox within w_ap726_acopio_procesamiento
end type
type st_prov_mp from statictext within w_ap726_acopio_procesamiento
end type
type cb_prov_mp from commandbutton within w_ap726_acopio_procesamiento
end type
type sle_prov_mp from singlelineedit within w_ap726_acopio_procesamiento
end type
type st_1 from statictext within w_ap726_acopio_procesamiento
end type
type sle_week2 from singlelineedit within w_ap726_acopio_procesamiento
end type
type sle_year2 from singlelineedit within w_ap726_acopio_procesamiento
end type
type sle_week1 from singlelineedit within w_ap726_acopio_procesamiento
end type
type sle_year1 from singlelineedit within w_ap726_acopio_procesamiento
end type
type rb_2 from radiobutton within w_ap726_acopio_procesamiento
end type
type rb_1 from radiobutton within w_ap726_acopio_procesamiento
end type
type cb_1 from commandbutton within w_ap726_acopio_procesamiento
end type
type uo_fecha from u_ingreso_rango_fechas within w_ap726_acopio_procesamiento
end type
type dw_report from u_dw_rpt within w_ap726_acopio_procesamiento
end type
end forward
...
integer width = 3671
integer height = 3208
string title = "[AP726] Reporte de Acopio y Procesamiento"
string menuname = "m_rpt"
windowstate windowstate = maximized!
event ue_query_retrieve ( )
cbx_productores cbx_productores
...
global w_ap726_acopio_procesamiento w_ap726_acopio_procesamiento
...
on w_ap726_acopio_procesamiento.create
int iCurrent
call super::create
if this.MenuName = "m_rpt" then this.MenuID = create m_rpt
this.cbx_productores=create cbx_productores
...
this.Control[iCurrent+1]=this.cbx_productores
this.Control[iCurrent+2]=this.st_prov_mp
this.Control[iCurrent+3]=this.cb_prov_mp
this.Control[iCurrent+4]=this.sle_prov_mp
this.Control[iCurrent+5]=this.st_1
this.Control[iCurrent+6]=this.sle_week2
this.Control[iCurrent+7]=this.sle_year2
this.Control[iCurrent+8]=this.sle_week1
this.Control[iCurrent+9]=this.sle_year1
...
on w_ap726_acopio_procesamiento.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
destroy(this.cbx_productores)
...
if cbx_productores.checked then
	ls_productor = '%%'
else
	ls_productor = trim(sle_prov_mp.text) + "%"
end if
...
event clicked;if this.checked then
	sle_prov_mp.enabled = false
else
	sle_prov_mp.enabled = true
end if
end event
...
integer height = 1452
integer taborder = 80
string dataobject = "d_rpt_acopio_procesamiento_tbl"
