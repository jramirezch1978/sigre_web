$PBExportHeader$w_ap311_plantilla_presupuestal.srw
forward
global type w_ap311_plantilla_presupuestal from w_abc_mastdet_smpl
end type
type em_ano from editmask within w_ap311_plantilla_presupuestal
end type
type st_1 from statictext within w_ap311_plantilla_presupuestal
end type
end forward
...
integer width = 1760
integer height = 1788
string title = "Asignacion de Plantillas Presupuestales (AP006)"
string menuname = "m_mantto_smpl"
em_ano em_ano
st_1 st_1
end type
global w_ap311_plantilla_presupuestal w_ap311_plantilla_presupuestal

on w_ap311_plantilla_presupuestal.create
int iCurrent
call super::create
...
on w_ap311_plantilla_presupuestal.destroy
call super::destroy
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_ap311_plantilla_presupuestal
integer x = 0
integer y = 136
integer width = 1705
integer height = 708
string dataobject = "d_proy_aprovis2_grid"
...
ii_dk[3] = 4 	      // columnas que se pasan al detalle
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_ap311_plantilla_presupuestal
