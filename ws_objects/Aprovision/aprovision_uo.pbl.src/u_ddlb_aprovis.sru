$PBExportHeader$u_ddlb_aprovis.sru
$PBExportComments$ddlb que carga desde datawindow
forward
global type u_ddlb_aprovis from dropdownlistbox
end type
end forward
...
global u_ddlb_aprovis u_ddlb_aprovis
...
on u_ddlb_aprovis.create
end on

on u_ddlb_aprovis.destroy
end on
