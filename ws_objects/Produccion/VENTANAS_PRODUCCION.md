# Ventanas del Módulo Producción
...
| w_pr016_prod_ener_param | PR016 | Parametros Generales de Energía |
...
| w_pr021_prod_costos_titulos | PR021 | Costos Titulos |
| w_pr022_prod_grupos_cen_ben | PR022 | Grupos de Centro Beneficio |
| w_pr023_costos_diarios_prod | PR023 | Costos de Produccion |
...
| w_pr028_his_max_demanda | PR318 | Historico de Maximas Demandas |
| w_pr029_estructura_centro_benef | PR029 | Estructura de Centros de Beneficio |
| w_pr030_param_produccion | PR030 | Parametros Producción |
| w_pr031_param_asistencia | PR031 | Parametros de Asistencia |
...
| w_pr038_tareas | PR038 | Tareas de Produccion |
...
| w_pr042_procesos | PR042 | Procesos de Produccion |
| w_pr043_especies | PR043 | Especies para producción |
| w_pr044_tratamientos_quimicos | PR044 | Tratamientos Quimicos PPTT |
| w_pr045_tuneles_frio | PR045 | Tuneles de Frio |
| w_pr046_lugar_empaque | PR046 | Lugares de empaque |
| w_pr047_enrolamiento | PR047 | Registro y enrolamiento de tarjetas |
| w_pr048_alm_apertura_diario | PR048 | Almacen apertura diaria |
...
| w_pr305_control_calidad | PR305 | Control de Calidad de Producots Terminados |
| w_pr309_control_uso | PR309 | Parte de piso |
| w_pr310_asistencia_jornal | PR310 | Asistencia de Jornales |
| w_pr311_lecturas_grafico | PR311 | Lecturas de Partes de Piso - Modo Grafico |
...
| w_pr316_produccion_final | PR316 | Produccion Final |
| w_pr317_produccion_final | PR317 | Producción Final |
| w_pr318_his_max_demanda | PR318 | Historico de Maximas Demandas |
| w_pr319_distribucion_ener | PR319 | Distribucion de Energía |
| w_pr320_consumo_energia | PR320 | Consumo de Energía |
| w_pr321_costos_titulos | PR321 | Costos Titulos |
| w_pr322_plant_costos_art | PR322 | Plantilla de Costo de Ariculo |
...
| w_pr328_parte_detajo_masivo | PR328 | Parte de Desatjo Masivo |
| w_pr329_parte_empaque | PR329 | Parte de Empaque - PRODUCCION |
| w_pr330_parte_recepcion | PR330 | Parte de Recepcion - PRODUCCION |
| w_pr331_parte_transferencia | PR331 | Parte de Transferencia - PRODUCCION |
| w_pr332_parte_recepcion_popup | PR332 | Parte Recepcion |
| w_pr333_parte_transferencia_popup | PR333 | Parte de Transferencia |
| w_pr334_proyecto_destajo | PR334 | Destajo usando balanza |
| w_pr335_parte_envasado | PR335 | Parte de Envasado - PRODUCCION |
| w_pr336_parte_conservas | PR336 | Parte de Empaque CONSERVA - PRODUCCION |
| w_pr337_parte_conservas_popup | PR337 | Parte de Empaque CONSERVA - PRODUCCION |
| w_pr338_empaque_destajo | PR338 | Generacion Partes Empaque - Destajo |
| w_pr339_recepcion_fileteo | PR339 | Generacion Partes Recepcion - Fileteo |
| w_pr340_recepcion_recepcion | PR340 | Generacion Partes Recepcion - Recepcion Destajo |
| w_pr341_envasado_lavado | PR341 | Generacion Partes Envasado - Lavado |
| w_pr500_base | PR500 | Captura de pesca |
| w_pr500_prod_fin | PR500 | Produccion Por Dia |
| w_pr501_atrib_prod_final_new | PR501 | Reporte de Produccion Por Rango de Fechas |
| w_pr501_atrib_prod_final | PR501 | Atributos del Producto |
| w_pr501_base_det | S/C | (título vacío) |
...
| w_pr507_duracion_certificado | w_pr507 | Duración del Certificado de Calidad |
| w_pr508_consulta_destajo | PR508 | Consultas Parte de Destajo |
| w_pr509_ingresos_produccion | PR509 | Consulta Produccion Anual |
...
| w_pr707_full_pd_ot | PR707 | Parte Diario de Produccion - OT |
...
| w_pr716_produccion_por_fechas | PR716 | Produccion por fechas |
| w_pr717_certificados_de_calidad | w_pr717 | Certificados de Calidad |
| w_pr718_partes_de_piso | PR718 | Partes de Piso |
| w_pr719_formato_medicion | PR719 | Partes de Piso |
| w_pr720_costo_produccion | PR720 | Costo de Produccion |
| w_pr721_dias_laborados | PR721 | Reporte de Dias Laborados |
...
| w_pr726_insumos_pptt | PR726 | Insumos por Linea de Producto (US$) |
...
| w_pr730_cencos_por_cenbenef_tbl | PR730 | Relacion Cencos / CenBenef |
...
| w_pr745_detalle_prod | PR745 | Detalle Produccion Destajo y Jornal |
...
| w_pr749_costo_prod_ot | PR749 | Costo de Produccion x OT |
...
| w_pr755_empaque_vs_recepcion | PR755 | Cantidad de Empaque vs Recepcion |
...
| w_pr902_genera_os | PR902 | Genera OS de Trasnporte |
...
| w_pr907_precio_venta_x_art | PR907 | Guardiar Precios de Venta x Artículo |
...
| w_pr911_actualiza_cebe_vales | PR911 | Actualiza CeBe del Movimiento del Almacén, según Referencia |
| w_pr912_actualiza_cebe_os | PR912 | Actualiza Centro Beneficio Segun OperSec |
...
| w_pr915_valor_mensual | PR915 | Valorizion PPTT Mensual |
