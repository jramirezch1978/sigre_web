$PBExportHeader$w_pr716_produccion_por_fechas.srw
forward
global type w_pr716_produccion_por_fechas from w_rpt
end type
type em_origen from singlelineedit within w_pr716_produccion_por_fechas
end type
type em_descripcion from editmask within w_pr716_produccion_por_fechas
end type
type sle_ot_adm from sle_text within w_pr716_produccion_por_fechas
end type
type sle_desc_ot_adm from singlelineedit within w_pr716_produccion_por_fechas
end type
type uo_fecha from u_ingreso_rango_fechas_v within w_pr716_produccion_por_fechas
end type
type pb_1 from picturebutton within w_pr716_produccion_por_fechas
end type
type dw_report from u_dw_rpt within w_pr716_produccion_por_fechas
end type
type gb_2 from groupbox within w_pr716_produccion_por_fechas
end type
type gb_1 from groupbox within w_pr716_produccion_por_fechas
end type
end forward
...
integer width = 3570
integer height = 1784
string title = "Produccion por fechas(PR716)"
...
global w_pr716_produccion_por_fechas w_pr716_produccion_por_fechas

on w_pr716_produccion_por_fechas.create
int iCurrent
call super::create
...
this.Control[iCurrent+4]=this.sle_desc_ot_adm
...
on w_pr716_produccion_por_fechas.destroy
call super::destroy
...
integer width = 2935
integer height = 1272
string dataobject = "d_rpt_produccion_final_1_cst"
