$PBExportHeader$w_pr736_horas_jornal_campo.srw
forward
global type w_pr736_horas_jornal_campo from w_report_smpl
end type
type st_1 from statictext within w_pr736_horas_jornal_campo
end type
type uo_rango from ou_rango_fechas within w_pr736_horas_jornal_campo
end type
type pb_1 from picturebutton within w_pr736_horas_jornal_campo
end type
type cbx_1 from checkbox within w_pr736_horas_jornal_campo
end type
type sle_ot_adm from singlelineedit within w_pr736_horas_jornal_campo
end type
type st_desc_ot_adm from statictext within w_pr736_horas_jornal_campo
end type
type cbx_2 from checkbox within w_pr736_horas_jornal_campo
end type
type sle_labor from singlelineedit within w_pr736_horas_jornal_campo
end type
type st_desc_labor from statictext within w_pr736_horas_jornal_campo
end type
type cbx_3 from checkbox within w_pr736_horas_jornal_campo
end type
type sle_nro_ot from singlelineedit within w_pr736_horas_jornal_campo
end type
type st_desc_ot from statictext within w_pr736_horas_jornal_campo
end type
type cbx_4 from checkbox within w_pr736_horas_jornal_campo
end type
type sle_trabajador from singlelineedit within w_pr736_horas_jornal_campo
end type
type st_nom_trabajador from statictext within w_pr736_horas_jornal_campo
end type
type rb_1 from radiobutton within w_pr736_horas_jornal_campo
end type
type rb_2 from radiobutton within w_pr736_horas_jornal_campo
end type
type rb_3 from radiobutton within w_pr736_horas_jornal_campo
end type
type rb_4 from radiobutton within w_pr736_horas_jornal_campo
end type
type rb_5 from radiobutton within w_pr736_horas_jornal_campo
end type
type rb_6 from radiobutton within w_pr736_horas_jornal_campo
end type
type rb_7 from radiobutton within w_pr736_horas_jornal_campo
end type
type gb_1 from groupbox within w_pr736_horas_jornal_campo
end type
end forward
...
integer width = 3995
integer height = 1820
string title = "Resumen de Horas Trabajadas(PR736)"
...
global w_pr736_horas_jornal_campo w_pr736_horas_jornal_campo

event ue_query_retrieve();this.event ue_retrieve()
end event

on w_pr736_horas_jornal_campo.create
int iCurrent
call super::create
...
this.Control[iCurrent+11]=this.sle_nro_ot
this.Control[iCurrent+12]=this.st_desc_ot
this.Control[iCurrent+13]=this.cbx_4
this.Control[iCurrent+14]=this.sle_trabajador
...
this.Control[iCurrent+22]=this.rb_7
this.Control[iCurrent+23]=this.gb_1
end on

on w_pr736_horas_jornal_campo.destroy
call super::destroy
...
event ue_retrieve;call super::ue_retrieve;String 	ls_ot_adm, ls_titulo, ls_labor, ls_lote, ls_trabajador
...
if rb_1.checked then
	dw_report.dataObject = "d_rpt_diario_jornaleros_campo_t"
elseif rb_2.checked then
	dw_report.dataObject = "d_rpt_resumen_horas_x_labor_campo_tbl"
elseif rb_3.checked then
	dw_report.dataObject = "d_rpt_resumen_horas_x_dia_campo_tbl"
elseif rb_4.checked then
	dw_report.dataObject = "d_rpt_resumen_horas_x_periodo_campo_tbl"
elseif rb_5.checked then
	dw_report.dataObject = "d_rpt_importes_x_labor_lote_t"
elseif rb_6.checked then
	dw_report.dataObject = "d_rpt_importes_x_labor_t"
elseif rb_7.checked then
	dw_report.dataObject = "d_rpt_importes_resumen_t"
end if

//Papel A-4
dw_report.object.datawindow.print.paper.size = 9
if not rb_3.checked and not rb_4.checked then
	dw_report.object.datawindow.print.orientation = 1
else
...
dw_report.retrieve(ls_ot_adm, ls_labor, ls_lote, ls_trabajador, ld_fecha1, ld_fecha2)
...
type dw_report from w_report_smpl`dw_report within w_pr736_horas_jornal_campo
integer x = 0
integer y = 564
integer width = 3314
integer height = 836
...
long textcolor = 8388608
long backcolor = 67108864
string text = "Todos los jornaleros"
boolean checked = true
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Resumen de Horas por Labor y Lote"
boolean checked = true
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Resumen de Horas por Labor "
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Resumen de Horas por Día"
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Resumen de Horas por Periodo"
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Resumen Horas-Costo por Labor y Lote"
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Resumen Horas-Costo por Labor"
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Resumen Horas-Costo resumido"
end type
