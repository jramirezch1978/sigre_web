$PBExportHeader$w_pr913_asiento_contable.srw
forward
global type w_pr913_asiento_contable from w_abc
end type
type st_nro_asiento from statictext within w_pr913_asiento_contable
end type
type st_3 from statictext within w_pr913_asiento_contable
end type
type st_4 from statictext within w_pr913_asiento_contable
end type
type uo_fecha from u_ingreso_fecha within w_pr913_asiento_contable
end type
type ddlb_mes from dropdownlistbox within w_pr913_asiento_contable
end type
type em_desc from editmask within w_pr913_asiento_contable
end type
type em_nro_libro from singlelineedit within w_pr913_asiento_contable
end type
type sle_1 from singlelineedit within w_pr913_asiento_contable
end type
type em_1 from editmask within w_pr913_asiento_contable
end type
type em_descripcion from editmask within w_pr913_asiento_contable
end type
type em_origen from singlelineedit within w_pr913_asiento_contable
end type
type st_1 from statictext within w_pr913_asiento_contable
end type
type st_2 from statictext within w_pr913_asiento_contable
end type
type cb_1 from commandbutton within w_pr913_asiento_contable
end type
type cb_2 from commandbutton within w_pr913_asiento_contable
end type
type em_year from editmask within w_pr913_asiento_contable
end type
type gb_2 from groupbox within w_pr913_asiento_contable
end type
type gb_1 from groupbox within w_pr913_asiento_contable
end type
end forward
...
global w_pr913_asiento_contable w_pr913_asiento_contable
...
on w_pr913_asiento_contable.create
int iCurrent
call super::create
...
on w_pr913_asiento_contable.destroy
call super::destroy
