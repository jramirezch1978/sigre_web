...
event ue_retrieve;idw_1.ii_zoom_actual = 120
...
elseif istr_param.tipo = '1S2S1D' then
	
	idw_1.Retrieve(istr_param.string1, istr_param.string2, &
					   istr_param.fecha1 )
...
elseif istr_param.tipo = '1L2L3S4S' then
	
	idw_1.Retrieve(istr_param.long1, istr_param.long2, istr_param.string1, istr_param.string2)
