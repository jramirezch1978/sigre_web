$PBExportHeader$w_pr024_fondo_transporte.srw
forward
global type w_pr024_fondo_transporte from w_abc_master
end type
end forward
...
integer width = 2592
integer height = 1404
string title = "Fondo de Transporte(PR024)"
string menuname = "m_mantto_consulta"
end type
global w_pr024_fondo_transporte w_pr024_fondo_transporte

on w_pr024_fondo_transporte.create
call super::create
if this.MenuName = "m_mantto_consulta" then this.MenuID = create m_mantto_consulta
end on

on w_pr024_fondo_transporte.destroy
call super::destroy
...
ib_log = TRUE
//idw_query = dw_master
//is_tabla = 'PROD_TRANS_PRSP_FONDO'
end event
...
type dw_master from w_abc_master`dw_master within w_pr024_fondo_transporte
event ue_display ( string as_columna,  long al_row )
integer width = 2501
integer height = 1188
string dataobject = "d_abc_prod_presup_fondo_tbl"
end type
