$PBExportHeader$w_abc_actualiza_costo_c.srw
forward
global type w_abc_actualiza_costo_c from w_abc
end type
type st_2 from statictext within w_abc_actualiza_costo_c
end type
type uo_rango from u_ingreso_rango_fechas_v within w_abc_actualiza_costo_c
end type
type cb_actualizar from commandbutton within w_abc_actualiza_costo_c
end type
type st_1 from statictext within w_abc_actualiza_costo_c
end type
type pb_exit from picturebutton within w_abc_actualiza_costo_c
end type
end forward
...
global w_abc_actualiza_costo_c w_abc_actualiza_costo_c
...
on w_abc_actualiza_costo_c.create
int iCurrent
call super::create
...
on w_abc_actualiza_costo_c.destroy
call super::destroy
destroy(this.st_2)
...
string text = "ACTUALIZA COSTO CONTABLE"
...
DECLARE USP_PROD_ACTUALIZA_COSTO PROCEDURE FOR 
		  USP_PROD_ACTUALIZA_COSTO(:is_articulo,:is_almace,:ildc_costo_articulo,:ld_fecha_1,:ld_fecha_2);

EXECUTE USP_PROD_ACTUALIZA_COSTO;
...
CLOSE USP_PROD_ACTUALIZA_COSTO;
