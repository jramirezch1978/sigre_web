$PBExportHeader$w_pr009_incidencias_ot_adm.srw
forward
global type w_pr009_incidencias_ot_adm from w_abc_master_smpl
end type
end forward
...
integer width = 3063
integer height = 1544
string title = "Incidencias por OT_ADM  (PR009)"
string menuname = "m_prod_mant"
end type
global w_pr009_incidencias_ot_adm w_pr009_incidencias_ot_adm

on w_pr009_incidencias_ot_adm.create
call super::create
if this.MenuName = "m_prod_mant" then this.MenuID = create m_prod_mant
end on

on w_pr009_incidencias_ot_adm.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_pr009_incidencias_ot_adm
integer x = 0
integer y = 4
integer width = 2999
integer height = 1328
