$PBExportHeader$w_pr752_prod_jornal_destajo.srw
forward
global type w_pr752_prod_jornal_destajo from w_report_smpl
end type
type st_1 from statictext within w_pr752_prod_jornal_destajo
end type
type uo_rango from ou_rango_fechas within w_pr752_prod_jornal_destajo
end type
type pb_1 from picturebutton within w_pr752_prod_jornal_destajo
end type
type cbx_4 from checkbox within w_pr752_prod_jornal_destajo
end type
type sle_trabajador from singlelineedit within w_pr752_prod_jornal_destajo
end type
type st_nom_trabajador from statictext within w_pr752_prod_jornal_destajo
end type
type cbx_tarea from checkbox within w_pr752_prod_jornal_destajo
end type
type sle_tarea from singlelineedit within w_pr752_prod_jornal_destajo
end type
type st_desc_tarea from statictext within w_pr752_prod_jornal_destajo
end type
type cbx_clientes from checkbox within w_pr752_prod_jornal_destajo
end type
type sle_cliente from singlelineedit within w_pr752_prod_jornal_destajo
end type
type st_nom_cliente from statictext within w_pr752_prod_jornal_destajo
end type
type cbx_ot_adm from checkbox within w_pr752_prod_jornal_destajo
end type
type sle_ot_adm from singlelineedit within w_pr752_prod_jornal_destajo
end type
type st_desc_ot_adm from statictext within w_pr752_prod_jornal_destajo
end type
end forward
...
integer width = 4457
integer height = 1820
string title = "[PR752] Resumen Valorizado de productos por Tarea"
...
global w_pr752_prod_jornal_destajo w_pr752_prod_jornal_destajo
...
on w_pr752_prod_jornal_destajo.create
int iCurrent
call super::create
...
on w_pr752_prod_jornal_destajo.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_pr752_prod_jornal_destajo
integer x = 0
integer y = 512
integer width = 3314
integer height = 960
integer taborder = 10
string dataobject = "d_rpt_resumen_jornal_destajo_tbl"
string is_dwform = ""
end type
