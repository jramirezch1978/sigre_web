$PBExportHeader$w_pr008_incidencias_clase.srw
forward
global type w_pr008_incidencias_clase from w_abc_master_smpl
end type
end forward
...
integer width = 1801
integer height = 1648
string title = "Clase de incidencias (PR008)"
string menuname = "m_prod_mant"
end type
global w_pr008_incidencias_clase w_pr008_incidencias_clase

on w_pr008_incidencias_clase.create
call super::create
if this.MenuName = "m_prod_mant" then this.MenuID = create m_prod_mant
end on

on w_pr008_incidencias_clase.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_pr008_incidencias_clase
integer x = 0
integer y = 4
integer width = 1737
integer height = 1432
