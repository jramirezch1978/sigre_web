$PBExportHeader$w_pr014_tipo_producto.srw
forward
global type w_pr014_tipo_producto from w_abc_master_smpl
end type
end forward
...
integer width = 3397
integer height = 1000
string title = "Productos(PR014) "
string menuname = "m_mantto_smpl"
end type
global w_pr014_tipo_producto w_pr014_tipo_producto

on w_pr014_tipo_producto.create
call super::create
if this.MenuName = "m_mantto_smpl" then this.MenuID = create m_mantto_smpl
end on

on w_pr014_tipo_producto.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_pr014_tipo_producto
event ue_display ( string as_columna,  long al_row )
integer width = 3291
string dataobject = "d_abc_producto_final_tbl"
end type
