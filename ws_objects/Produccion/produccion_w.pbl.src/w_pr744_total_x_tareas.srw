$PBExportHeader$w_pr744_total_x_tareas.srw
forward
global type w_pr744_total_x_tareas from w_report_smpl
end type
type st_1 from statictext within w_pr744_total_x_tareas
end type
type uo_rango from ou_rango_fechas within w_pr744_total_x_tareas
end type
type pb_1 from picturebutton within w_pr744_total_x_tareas
end type
type cbx_especies from checkbox within w_pr744_total_x_tareas
end type
type sle_especie from singlelineedit within w_pr744_total_x_tareas
end type
type st_desc_especie from statictext within w_pr744_total_x_tareas
end type
type cbx_clientes from checkbox within w_pr744_total_x_tareas
end type
type sle_cliente from singlelineedit within w_pr744_total_x_tareas
end type
type st_nom_cliente from statictext within w_pr744_total_x_tareas
end type
end forward
...
integer width = 4457
integer height = 1820
string title = "[PR744] Total x Tareas de Destajo"
...
global w_pr744_total_x_tareas w_pr744_total_x_tareas
...
on w_pr744_total_x_tareas.create
int iCurrent
call super::create
...
on w_pr744_total_x_tareas.destroy
call super::destroy
...
if is_FLAG_HORA_EXT_35 = '1' then
	dw_report.dataobject = 'd_rpt_total_horas_he35_dst_tbl'
else
	dw_report.dataobject = 'd_rpt_total_horas_dst_tbl'
end if
...
type dw_report from w_report_smpl`dw_report within w_pr744_total_x_tareas
integer x = 0
integer y = 292
integer width = 3314
integer height = 1088
integer taborder = 10
string dataobject = "d_rpt_total_horas_dst_tbl"
string is_dwform = ""
end type
