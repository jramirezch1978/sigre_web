$PBExportHeader$w_ap501_base_det.srw
forward
global type w_ap501_base_det from w_rpt
end type
type st_etiqueta from statictext within w_ap501_base_det
end type
type pb_1 from picturebutton within w_ap501_base_det
end type
type dw_master from u_dw_abc within w_ap501_base_det
end type
end forward
...
global w_ap501_base_det w_ap501_base_det

on w_ap501_base_det.create
int iCurrent
call super::create
