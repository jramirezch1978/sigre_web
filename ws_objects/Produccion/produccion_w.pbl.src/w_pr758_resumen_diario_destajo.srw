$PBExportHeader$w_pr758_resumen_diario_destajo.srw
forward
global type w_pr758_resumen_diario_destajo from w_report_smpl
end type
type st_1 from statictext within w_pr758_resumen_diario_destajo
end type
type uo_rango from ou_rango_fechas within w_pr758_resumen_diario_destajo
end type
type pb_1 from picturebutton within w_pr758_resumen_diario_destajo
end type
type cbx_4 from checkbox within w_pr758_resumen_diario_destajo
end type
type sle_trabajador from singlelineedit within w_pr758_resumen_diario_destajo
end type
type st_nom_trabajador from statictext within w_pr758_resumen_diario_destajo
end type
type cbx_tarea from checkbox within w_pr758_resumen_diario_destajo
end type
type sle_tarea from singlelineedit within w_pr758_resumen_diario_destajo
end type
type st_desc_tarea from statictext within w_pr758_resumen_diario_destajo
end type
type cbx_clientes from checkbox within w_pr758_resumen_diario_destajo
end type
type sle_cliente from singlelineedit within w_pr758_resumen_diario_destajo
end type
type st_nom_cliente from statictext within w_pr758_resumen_diario_destajo
end type
type cbx_ot_adm from checkbox within w_pr758_resumen_diario_destajo
end type
type sle_ot_adm from singlelineedit within w_pr758_resumen_diario_destajo
end type
type st_desc_ot_adm from statictext within w_pr758_resumen_diario_destajo
end type
type rb_1 from radiobutton within w_pr758_resumen_diario_destajo
end type
type rb_2 from radiobutton within w_pr758_resumen_diario_destajo
end type
type gb_1 from groupbox within w_pr758_resumen_diario_destajo
end type
end forward
...
integer width = 4457
integer height = 1820
string title = "[PR758] Reporte resumen de Fileteo Destajo"
...
global w_pr758_resumen_diario_destajo w_pr758_resumen_diario_destajo
...
on w_pr758_resumen_diario_destajo.create
int iCurrent
call super::create
...
on w_pr758_resumen_diario_destajo.destroy
call super::destroy
...
if rb_1.checked then
	dw_report.DataObject = 'd_rpt_resumen_diario_destajo_tbl'
elseif rb_2.checked then
	dw_report.DataObject = 'd_rpt_resumen_fileteo_crt'
else
	MessageBox('Error', 'No ha especificado un tipo de reporte, por favor verifique!', StopSign!)
	return
end if

//REcuperar los datos
dw_report.settransobject( sqlca )
dw_report.retrieve(ls_trabajador, ls_tarea, ls_cliente, ld_fecha1, ld_fecha2, ls_ot_adm)
...
type dw_report from w_report_smpl`dw_report within w_pr758_resumen_diario_destajo
integer x = 0
integer y = 512
integer width = 3314
integer height = 960
integer taborder = 10
string dataobject = "d_rpt_resumen_diario_destajo_tbl"
string is_dwform = ""
end type
