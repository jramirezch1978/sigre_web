$PBExportHeader$w_pr004_atrib_med.srw
forward
global type w_pr004_atrib_med from w_abc_master_smpl
end type
end forward
...
integer width = 3767
integer height = 1772
string title = "Atributos de Medición (PR004)"
string menuname = "m_mantto_smpl"
end type
global w_pr004_atrib_med w_pr004_atrib_med

on w_pr004_atrib_med.create
call super::create
if this.MenuName = "m_mantto_smpl" then this.MenuID = create m_mantto_smpl
end on

on w_pr004_atrib_med.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_pr004_atrib_med
event ue_display ( string as_columna,  long al_row )
integer x = 0
integer y = 0
integer width = 3698
integer height = 1536
string dataobject = "d_ap_atrib_med_tbl"
end type
