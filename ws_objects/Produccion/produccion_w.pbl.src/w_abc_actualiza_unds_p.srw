$PBExportHeader$w_abc_actualiza_unds_p.srw
forward
global type w_abc_actualiza_unds_p from w_abc
end type
type st_2 from statictext within w_abc_actualiza_unds_p
end type
type uo_rango from u_ingreso_rango_fechas_v within w_abc_actualiza_unds_p
end type
type cb_actualizar from commandbutton within w_abc_actualiza_unds_p
end type
type st_1 from statictext within w_abc_actualiza_unds_p
end type
type pb_exit from picturebutton within w_abc_actualiza_unds_p
end type
end forward
...
global w_abc_actualiza_unds_p w_abc_actualiza_unds_p
...
on w_abc_actualiza_unds_p.create
int iCurrent
call super::create
...
on w_abc_actualiza_unds_p.destroy
call super::destroy
destroy(this.st_2)
...
ildc_unidades_p		= ls_param.decimal_1
...
string text = "ACTUALIZAR CANTIDAD PROCESADA"
...
DECLARE USP_PROD_ACT_UNIDADES_P PROCEDURE FOR 
		  USP_PROD_ACT_UNIDADES_P(:is_articulo,:is_almace,:ld_fecha_1,:ld_fecha_2,:ildc_unidades_p,:is_cod_origen);
