$PBExportHeader$w_pr743_importe_labor_lote.srw
forward
global type w_pr743_importe_labor_lote from w_report_smpl
end type
type st_1 from statictext within w_pr743_importe_labor_lote
end type
type uo_rango from ou_rango_fechas within w_pr743_importe_labor_lote
end type
type pb_1 from picturebutton within w_pr743_importe_labor_lote
end type
type cbx_1 from checkbox within w_pr743_importe_labor_lote
end type
type sle_ot_adm from singlelineedit within w_pr743_importe_labor_lote
end type
type st_desc_ot_adm from statictext within w_pr743_importe_labor_lote
end type
type cbx_2 from checkbox within w_pr743_importe_labor_lote
end type
type sle_labor from singlelineedit within w_pr743_importe_labor_lote
end type
type st_desc_labor from statictext within w_pr743_importe_labor_lote
end type
type cbx_3 from checkbox within w_pr743_importe_labor_lote
end type
type sle_lote from singlelineedit within w_pr743_importe_labor_lote
end type
type st_desc_lote from statictext within w_pr743_importe_labor_lote
end type
type cbx_4 from checkbox within w_pr743_importe_labor_lote
end type
type sle_trabajador from singlelineedit within w_pr743_importe_labor_lote
end type
type st_nom_trabajador from statictext within w_pr743_importe_labor_lote
end type
end forward
...
integer width = 3995
integer height = 1820
string title = "[PR743] Resumen por Labor y Lote"
...
global w_pr743_importe_labor_lote w_pr743_importe_labor_lote

event ue_query_retrieve();this.event ue_retrieve()
end event

on w_pr743_importe_labor_lote.create
int iCurrent
call super::create
...
on w_pr743_importe_labor_lote.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_pr743_importe_labor_lote
integer x = 0
integer y = 564
integer width = 3314
integer height = 836
integer taborder = 10
string dataobject = "d_rpt_resumen_x_labor_lote_t"
string is_dwform = ""
end type
