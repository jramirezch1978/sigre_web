$PBExportHeader$w_pr511_adquisicion_mp.srw
forward
global type w_pr511_adquisicion_mp from w_report_smpl
end type
type st_1 from statictext within w_pr511_adquisicion_mp
end type
type cb_proc from commandbutton within w_pr511_adquisicion_mp
end type
type cbx_categorias from checkbox within w_pr511_adquisicion_mp
end type
type sle_categoria from singlelineedit within w_pr511_adquisicion_mp
end type
type st_desc_categoria from statictext within w_pr511_adquisicion_mp
end type
type cbx_articulos from checkbox within w_pr511_adquisicion_mp
end type
type sle_cod_art from singlelineedit within w_pr511_adquisicion_mp
end type
type st_desc_art from statictext within w_pr511_adquisicion_mp
end type
type sle_year from singlelineedit within w_pr511_adquisicion_mp
end type
end forward
...
integer width = 3995
integer height = 1356
string title = "[PR511] Adquisiciones de la materia prima"
...
global w_pr511_adquisicion_mp w_pr511_adquisicion_mp

event ue_query_retrieve();this.event ue_retrieve()
end event

on w_pr511_adquisicion_mp.create
int iCurrent
call super::create
...
on w_pr511_adquisicion_mp.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_pr511_adquisicion_mp
integer x = 0
integer y = 288
integer width = 3314
integer height = 836
integer taborder = 10
string dataobject = "d_cns_adquisicion_mp_anual_tbl"
string is_dwform = ""
end type
