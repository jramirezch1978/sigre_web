$PBExportHeader$w_pr704_asist_dest_pd_ot.srw
forward
global type w_pr704_asist_dest_pd_ot from w_rpt_general
end type
type cb_buscar from cb_aceptar within w_pr704_asist_dest_pd_ot
end type
type sle_parte from singlelineedit within w_pr704_asist_dest_pd_ot
end type
type st_1 from statictext within w_pr704_asist_dest_pd_ot
end type
end forward
...
integer width = 1920
integer height = 1752
string title = "Personal Destajo x Parte Diario (PR704)"
cb_buscar cb_buscar
sle_parte sle_parte
st_1 st_1
end type
global w_pr704_asist_dest_pd_ot w_pr704_asist_dest_pd_ot

on w_pr704_asist_dest_pd_ot.create
int iCurrent
call super::create
...
on w_pr704_asist_dest_pd_ot.destroy
call super::destroy
...
type dw_report from w_rpt_general`dw_report within w_pr704_asist_dest_pd_ot
integer y = 136
integer width = 1833
integer height = 1368
string dataobject = "d_rpt_pd_ot_destajo_tbl"
end type
