$PBExportHeader$w_pr509_ingresos_produccion.srw
forward
global type w_pr509_ingresos_produccion from w_report_smpl
end type
type st_1 from statictext within w_pr509_ingresos_produccion
end type
type cb_proc from commandbutton within w_pr509_ingresos_produccion
end type
type cbx_categorias from checkbox within w_pr509_ingresos_produccion
end type
type sle_categoria from singlelineedit within w_pr509_ingresos_produccion
end type
type st_desc_categoria from statictext within w_pr509_ingresos_produccion
end type
type cbx_articulos from checkbox within w_pr509_ingresos_produccion
end type
type sle_cod_art from singlelineedit within w_pr509_ingresos_produccion
end type
type st_desc_art from statictext within w_pr509_ingresos_produccion
end type
type sle_year from singlelineedit within w_pr509_ingresos_produccion
end type
end forward
...
integer width = 3995
integer height = 1356
string title = "[PR509] Consulta Produccion Anual"
...
global w_pr509_ingresos_produccion w_pr509_ingresos_produccion

event ue_query_retrieve();this.event ue_retrieve()
end event

on w_pr509_ingresos_produccion.create
int iCurrent
call super::create
...
on w_pr509_ingresos_produccion.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_pr509_ingresos_produccion
integer x = 0
integer y = 288
integer width = 3314
integer height = 836
integer taborder = 10
string dataobject = "d_cns_produccion_anual_tbl"
...
choose case lower(dwo.name)
	...
	case "ago1"
		...
		//Año, mes, cod_art, tipo_proceso
		lstr_param.long1	 	= Integer(sle_year.text)
		lstr_param.Long2  	= 08
		lstr_param.string1 	= this.object.cod_art [row]
		lstr_param.string2	= '1'
		lstr_param.dw1 	 	= 'd_cns_consulta_detalle_produccion_tbl'
		lstr_param.tipo 	 	= '1L2L3S4S'
		lstr_param.titulo	 	= 'Cantidad Produccion Agosto'
