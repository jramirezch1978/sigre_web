$PBExportHeader$w_pr331_parte_transferencia.srw
forward
global type w_pr331_parte_transferencia from w_abc_master_smpl
end type
type cb_buscar from commandbutton within w_pr331_parte_transferencia
end type
type uo_fechas from u_ingreso_rango_fechas within w_pr331_parte_transferencia
end type
type gb_2 from groupbox within w_pr331_parte_transferencia
end type
end forward
...
integer width = 4695
integer height = 2292
string title = "[PR331] Parte de Transferencia - PRODUCCION"
...
global w_pr331_parte_transferencia w_pr331_parte_transferencia
...
on w_pr331_parte_transferencia.create
int iCurrent
call super::create
...
on w_pr331_parte_transferencia.destroy
call super::destroy
...
w_pr333_parte_transferencia_popup lw_1
...
type dw_master from w_abc_master_smpl`dw_master within w_pr331_parte_transferencia
