$PBExportHeader$w_pr028_his_max_demanda.srw
forward
global type w_pr028_his_max_demanda from w_abc_master_smpl
end type
end forward
...
global w_pr028_his_max_demanda w_pr028_his_max_demanda

on w_pr028_his_max_demanda.create
call super::create
if this.MenuName = "m_mantto_consulta" then this.MenuID = create m_mantto_consulta
end on

on w_pr028_his_max_demanda.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_pr028_his_max_demanda
