$PBExportHeader$w_pr723_costo_trans_cencos.srw
forward
global type w_pr723_costo_trans_cencos from w_rpt
end type
type pb_2 from picturebutton within w_pr723_costo_trans_cencos
end type
type em_descripcion from editmask within w_pr723_costo_trans_cencos
end type
type em_origen from singlelineedit within w_pr723_costo_trans_cencos
end type
type uo_fecha from u_ingreso_rango_fechas within w_pr723_costo_trans_cencos
end type
type dw_report from u_dw_rpt within w_pr723_costo_trans_cencos
end type
type gb_2 from groupbox within w_pr723_costo_trans_cencos
end type
type gb_3 from groupbox within w_pr723_costo_trans_cencos
end type
end forward
...
integer width = 4402
integer height = 2092
string title = "Reporte de Costo de Transporte(PR723)"
...
global w_pr723_costo_trans_cencos w_pr723_costo_trans_cencos
...
on w_pr723_costo_trans_cencos.create
int iCurrent
call super::create
...
on w_pr723_costo_trans_cencos.destroy
call super::destroy
...
string 	ls_origen, ls_desc_o, ls_nombre_p
...
SELECT nombre INTO :ls_desc_o
FROM origen
WHERE cod_origen =:ls_origen;
 
idw_1.Retrieve(ld_fecha1, ld_fecha2, ls_origen)
...
integer width = 3730
integer height = 1544
string dataobject = "d_rpt_costo_trans_x_cencos_tbl"
