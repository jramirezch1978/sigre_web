$PBExportHeader$w_pr711_asist_destajo_fechas.srw
forward
global type w_pr711_asist_destajo_fechas from w_ap500_base
end type
type sle_ot_adm from sle_text within w_pr711_asist_destajo_fechas
end type
type st_ot_adm from statictext within w_pr711_asist_destajo_fechas
end type
type st_1 from statictext within w_pr711_asist_destajo_fechas
end type
type cbx_turno from cbx_origen within w_pr711_asist_destajo_fechas
end type
type ddlb_turno from u_ddlb within w_pr711_asist_destajo_fechas
end type
type st_2 from statictext within w_pr711_asist_destajo_fechas
end type
end forward
...
integer width = 3095
integer height = 2032
string title = "Asistencia Personal de Destajo (PR711)"
...
global w_pr711_asist_destajo_fechas w_pr711_asist_destajo_fechas

on w_pr711_asist_destajo_fechas.create
int iCurrent
call super::create
...
on w_pr711_asist_destajo_fechas.destroy
call super::destroy
...
type dw_report from w_ap500_base`dw_report within w_pr711_asist_destajo_fechas
integer x = 18
integer y = 408
integer width = 3026
integer height = 1184
string dataobject = "d_rpt_asistencia_destajo_tbl"
end type
...
type uo_fecha from w_ap500_base`uo_fecha within w_pr711_asist_destajo_fechas
integer x = 37
integer y = 92
end type

type ddlb_param from w_ap500_base`ddlb_param within w_pr711_asist_destajo_fechas
integer x = 1344
integer y = 96
integer width = 567
end type
...
type cbx_origen from w_ap500_base`cbx_origen within w_pr711_asist_destajo_fechas
integer x = 1344
integer y = 16
...
type st_title from w_ap500_base`st_title within w_pr711_asist_destajo_fechas
integer x = 850
integer y = 1792
integer height = 84
end type

type st_confirm from w_ap500_base`st_confirm within w_pr711_asist_destajo_fechas
end type

type st_etiqueta from w_ap500_base`st_etiqueta within w_pr711_asist_destajo_fechas
integer x = 2345
integer y = 1808
end type

type cb_1 from w_ap500_base`cb_1 within w_pr711_asist_destajo_fechas
integer x = 2551
integer y = 96
integer height = 100
end type
