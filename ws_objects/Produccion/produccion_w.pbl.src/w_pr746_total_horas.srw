$PBExportHeader$w_pr746_total_horas.srw
forward
global type w_pr746_total_horas from w_report_smpl
end type
type st_1 from statictext within w_pr746_total_horas
end type
type uo_rango from ou_rango_fechas within w_pr746_total_horas
end type
type pb_1 from picturebutton within w_pr746_total_horas
end type
type cbx_trabajador from checkbox within w_pr746_total_horas
end type
type sle_trabajador from singlelineedit within w_pr746_total_horas
end type
type st_nom_trabajador from statictext within w_pr746_total_horas
end type
type cbx_tarea from checkbox within w_pr746_total_horas
end type
type sle_tarea from singlelineedit within w_pr746_total_horas
end type
type st_desc_tarea from statictext within w_pr746_total_horas
end type
type cbx_clientes from checkbox within w_pr746_total_horas
end type
type sle_cliente from singlelineedit within w_pr746_total_horas
end type
type st_nom_cliente from statictext within w_pr746_total_horas
end type
type cbx_ot_adm from checkbox within w_pr746_total_horas
end type
type sle_ot_adm from singlelineedit within w_pr746_total_horas
end type
type st_desc_ot_adm from statictext within w_pr746_total_horas
end type
end forward
...
integer width = 4457
integer height = 1820
string title = "[PR746] Total x Horas (destajo)"
...
global w_pr746_total_horas w_pr746_total_horas

event ue_query_retrieve();this.event ue_retrieve()
end event

on w_pr746_total_horas.create
int iCurrent
call super::create
...
on w_pr746_total_horas.destroy
call super::destroy
...
event ue_retrieve;call super::ue_retrieve;String 	ls_ot_adm, ls_tarea, ls_Cliente, ls_trabajador
...
Else
	if trim(sle_trabajador.text) = '' then 
		gnvo_app.of_mensaje_Error("Debe indicar un codigo de trabajador")
...
dw_report.retrieve(ls_trabajador, ls_tarea, ls_cliente, ls_ot_adm, ld_fecha1, ld_fecha2)
...
type dw_report from w_report_smpl`dw_report within w_pr746_total_horas
integer x = 0
integer y = 512
integer width = 3314
integer height = 1096
integer taborder = 10
string dataobject = "d_rpt_horas_x_trabajador_tbl"
string is_dwform = ""
end type
