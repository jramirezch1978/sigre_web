$PBExportHeader$u_ingreso_rango_fechas_horas_mc.sru
$PBExportComments$Custom Object para ingreso de un rango de fechas
forward
global type u_ingreso_rango_fechas_horas_mc from userobject
end type
type cb_1 from commandbutton within u_ingreso_rango_fechas_horas_mc
end type
type em_1 from editmask within u_ingreso_rango_fechas_horas_mc
end type
type em_2 from editmask within u_ingreso_rango_fechas_horas_mc
end type
type cb_2 from commandbutton within u_ingreso_rango_fechas_horas_mc
end type
end forward
...
global u_ingreso_rango_fechas_horas_mc u_ingreso_rango_fechas_horas_mc
...
on u_ingreso_rango_fechas_horas_mc.create
...
on u_ingreso_rango_fechas_horas_mc.destroy
destroy(this.cb_1)
destroy(this.em_1)
destroy(this.em_2)
destroy(this.cb_2)
