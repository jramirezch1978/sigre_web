$PBExportHeader$u_ingreso_fechas_horas.sru
$PBExportComments$Custom Object para ingreso de un rango de fechas
forward
global type u_ingreso_fechas_horas from userobject
end type
type cb_1 from commandbutton within u_ingreso_fechas_horas
end type
type em_1 from editmask within u_ingreso_fechas_horas
end type
end forward
...
global u_ingreso_fechas_horas u_ingreso_fechas_horas
...
on u_ingreso_fechas_horas.create
...
on u_ingreso_fechas_horas.destroy
destroy(this.cb_1)
destroy(this.em_1)
end on
