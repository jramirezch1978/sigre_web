...
Function Long gzopen ( Ref string Path, Ref String Mode ) Library "zlib.dll" alias for "gzopen;Ansi"
...
Function string gzerror ( long File, Ref long ErrNum ) Library "zlib.dll" alias for "gzerror;Ansi"
Function long gzrewind ( long File ) Library "zlib.dll"
Function long gzeof ( long File ) Library "zlib.dll"
Function string zlibVersion() Library "zlib.dll" alias for "zlibVersion;Ansi"
end prototypes
