$PBExportHeader$w_message_error.srw
forward
global type w_message_error from window
end type
type p_2 from picture within w_message_error
end type
type shl_help from statichyperlink within w_message_error
end type
type shl_1 from statichyperlink within w_message_error
end type
type pb_1 from picturebutton within w_message_error
end type
type st_mensaje from statictext within w_message_error
end type
type p_1 from picture within w_message_error
end type
end forward
...
global w_message_error w_message_error

on w_message_error.create
this.p_2=create p_2
...
integer width = 727
integer height = 568
string picturename = "C:\SIGRE\resources\JPG\Error.jpg"
