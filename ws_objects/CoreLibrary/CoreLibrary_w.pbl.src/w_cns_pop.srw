...
IF IsValid(istr_1.dw) THEN
	...
	END IF
ELSE
	if UpperBound(istr_1.arg) = 1 then
		
		ll_row = of_retrieve(istr_1.arg[1])
		
	elseif UpperBound(istr_1.arg) = 2 then
		
		ll_row = of_retrieve(istr_1.arg[1], istr_1.arg[2])
		
	elseif UpperBound(istr_1.arg) = 3 then
		
		ll_row = of_retrieve(istr_1.arg[1], istr_1.arg[2], istr_1.arg[3])
		
	elseif UpperBound(istr_1.arg) = 4 then
		
		ll_row = of_retrieve(istr_1.arg[1], istr_1.arg[2], istr_1.arg[3], istr_1.arg[4])
		
	elseif UpperBound(istr_1.arg) = 5 then
		
		ll_row = of_retrieve(istr_1.arg[1], istr_1.arg[2], istr_1.arg[3], istr_1.arg[4], istr_1.arg[5])
		
	elseif UpperBound(istr_1.arg) = 6 then
...
if idw_1.of_ExistsText("t_user") then 
	idw_1.object.t_user.text 	  = gs_user
end if
if idw_1.of_ExistsText("t_empresa") then 
