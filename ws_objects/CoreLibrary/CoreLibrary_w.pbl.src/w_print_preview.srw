...
type p_1 from picture within w_print_preview
end type
type rb_preview from radiobutton within w_print_preview
end type
type rb_impresion from radiobutton within w_print_preview
end type
type pb_salir from picturebutton within w_print_preview
end type
type pb_aceptar from picturebutton within w_print_preview
end type
