...
try
	...
	if Pos(ls_json_result, '"success":true') > 0 then
		...
		lnvo_obj.estado      = invo_util.of_json_string(ls_json_result, 'estado')
		lnvo_obj.condicion   = invo_util.of_json_string(ls_json_result, 'condicion')
		lnvo_obj.ubigeo      = invo_util.of_json_string(ls_json_result, 'ubigeo')
		lnvo_obj.tipoVia     = invo_util.of_json_string(ls_json_result, 'tipoVia')
		lnvo_obj.nombreVia   = invo_util.of_json_string(ls_json_result, 'nombreVia')
		lnvo_obj.codigoZona  = invo_util.of_json_string(ls_json_result, 'codigoZona')
		lnvo_obj.tipoZona    = invo_util.of_json_string(ls_json_result, 'tipoZona')
		lnvo_obj.numero      = invo_util.of_json_string(ls_json_result, 'numero')
		lnvo_obj.interior    = invo_util.of_json_string(ls_json_result, 'interior')
		lnvo_obj.lote        = invo_util.of_json_string(ls_json_result, 'lote')
		lnvo_obj.departamento    = invo_util.of_json_string(ls_json_result, 'departamento')
		lnvo_obj.manzana         = invo_util.of_json_string(ls_json_result, 'manzana')
		lnvo_obj.kilometro       = invo_util.of_json_string(ls_json_result, 'kilometro')
		lnvo_obj.codProvincia    = invo_util.of_json_string(ls_json_result, 'codProvincia')
		lnvo_obj.descProvincia   = invo_util.of_json_string(ls_json_result, 'descProvincia')
		lnvo_obj.codDepartamento = invo_util.of_json_string(ls_json_result, 'codDepartamento')
		lnvo_obj.descDepartamento = invo_util.of_json_string(ls_json_result, 'descDepartamento')
		lnvo_obj.descDistrito    = invo_util.of_json_string(ls_json_result, 'descDistrito')
	else
		lnvo_obj.isOk    = false
		lnvo_obj.mensaje  = invo_util.of_json_string(ls_json_result, 'mensaje')
