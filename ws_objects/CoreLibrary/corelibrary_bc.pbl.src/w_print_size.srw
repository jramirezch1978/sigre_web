$PBExportHeader$w_print_size.srw
forward
global type w_print_size from window
end type
type p_1 from picture within w_print_size
end type
type rb_preview from radiobutton within w_print_size
end type
type rb_impresion from radiobutton within w_print_size
end type
type pb_salir from picturebutton within w_print_size
end type
type pb_aceptar from picturebutton within w_print_size
end type
type gb_1 from groupbox within w_print_size
end type
end forward
...
global w_print_size w_print_size

on w_print_size.create
this.p_1=create p_1
