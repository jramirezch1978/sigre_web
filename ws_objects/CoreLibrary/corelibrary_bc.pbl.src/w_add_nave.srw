$PBExportHeader$w_add_nave.srw
forward
global type w_add_nave from w_abc
end type
type cb_cancelar from commandbutton within w_add_nave
end type
type cb_aceptar from commandbutton within w_add_nave
end type
type tab_1 from tab within w_add_nave
end type
...
integer width = 3342
integer height = 2364
string title = "Añadir una nueva nave o embarcacion"
...
global w_add_nave w_add_nave

type variables
boolean 			ib_flota_propia
u_dw_abc			idw_master, idw_sanipes, idw_especies
...
IF lbo_ok THEN
	...
	lstr_param.string1 = idw_master.object.nave [1]
...
for li_row = 1 to idw_master.Rowcount()
	...
	if idw_master.ib_insert_mode	 then
		...
		ls_nave = gnvo_app.invo_flota.of_get_cod_nave()
...
event ue_cancelar;call super::ue_cancelar;istr_param.b_return = false
...
integer height = 1944
integer taborder = 30
string dataobject = "d_abc_naves_ff"
...
integer height = 1736
integer taborder = 30
string dataobject = "d_abc_add_naves_sanipes_tbl"
...
integer width = 3122
integer height = 1784
string dataobject = "d_abc_add_naves_especies_tbl"
borderstyle borderstyle = styleraised!
end type
