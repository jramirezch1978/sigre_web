$PBExportHeader$seguridad.sra
forward
global type seguridad from application
end type
...
Integer gi_nivel, gi_control_db, gi_feriado[], gi_index
Date    gd_fecha
...
string appicon = "C:\SIGRE\resources\ICO\seguridad.ico"
...
// Parametros
gs_inifile    = "\sigre_exe\seguridad.ini"	
