$PBExportHeader$w_sg542_objeto_accesos_usr.srw
forward
global type w_sg542_objeto_accesos_usr from w_report_smpl
end type
type cb_1 from commandbutton within w_sg542_objeto_accesos_usr
end type
type st_1 from statictext within w_sg542_objeto_accesos_usr
end type
type uo_rango from u_ingreso_rango_fechas within w_sg542_objeto_accesos_usr
end type
type ddlb_usuario from u_ddlb within w_sg542_objeto_accesos_usr
end type
end forward
...
integer width = 2885
integer height = 1476
string title = "Acceso a Objetos por Usuario (SG542)"
...
global w_sg542_objeto_accesos_usr w_sg542_objeto_accesos_usr
...
forward prototypes
public function string of_get_name (string as_usuario)
end prototypes

public function string of_get_name (string as_usuario);String ls_nombre

  SELECT "USUARIO"."NOMBRE"  
    INTO :ls_nombre  
    FROM "USUARIO"  
   WHERE "USUARIO"."COD_USR" = :as_usuario   ;


RETURN ls_nombre
end function

on w_sg542_objeto_accesos_usr.create
int iCurrent
call super::create
...
this.Control[iCurrent+4]=this.ddlb_usuario
end on

on w_sg542_objeto_accesos_usr.destroy
call super::destroy
...
ll_rc = idw_1.Retrieve(is_usuario, ld_inicio, ld_fin )

ls_nombre = of_get_name(is_usuario)

idw_1.object.p_logo.filename = gs_logo
idw_1.object.t_nombre.text = gs_empresa
idw_1.object.t_user.text = gs_user
idw_1.object.t_objeto.text = 'SG542'
idw_1.object.t_ventana.text = is_usuario + ' / ' + ls_nombre
...
type dw_report from w_report_smpl`dw_report within w_sg542_objeto_accesos_usr
integer y = 116
string dataobject = "d_objeto_accesos_x_usuario_tbl"
end type
...
event ue_open_pre;call super::ue_open_pre;is_dataobject = 'd_usuarios_accesando_objetos_lista'
...
type dw_cns from w_cns_smpl`dw_cns within w_sg542_objeto_accesos_usr
integer x = 9
integer y = 112
integer width = 1851
integer height = 1164
