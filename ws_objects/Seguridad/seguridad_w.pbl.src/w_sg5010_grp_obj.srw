$PBExportHeader$w_sg5010_grp_obj.srw
forward
global type w_sg5010_grp_obj from w_abc_list
end type
type ddlb_1 from u_ddlb within w_sg5010_grp_obj
end type
type st_1 from statictext within w_sg5010_grp_obj
end type
type cbx_ins from checkbox within w_sg5010_grp_obj
end type
type cbx_eli from checkbox within w_sg5010_grp_obj
end type
type cbx_mod from checkbox within w_sg5010_grp_obj
end type
type cbx_con from checkbox within w_sg5010_grp_obj
end type
type cbx_anu from checkbox within w_sg5010_grp_obj
end type
type cbx_can from checkbox within w_sg5010_grp_obj
end type
type cbx_dup from checkbox within w_sg5010_grp_obj
end type
type cbx_cer from checkbox within w_sg5010_grp_obj
end type
type gb_1 from groupbox within w_sg5010_grp_obj
end type
end forward
...
global w_sg5010_grp_obj w_sg5010_grp_obj

type variables

end variables

on w_sg5010_grp_obj.create
int iCurrent
call super::create
...
type dw_1 from w_abc_list`dw_1 within w_sg5010_grp_obj
integer x = 37
integer y = 192
integer width = 1367
integer height = 1312
...
event dw_1::rowfocuschanged;call super::rowfocuschanged;gnvo_app.of_select_current_row(this)
end event

type dw_2 from w_abc_list`dw_2 within w_sg5010_grp_obj
integer x = 1582
integer y = 192
integer width = 2720
integer height = 1312
...
event dw_2::ue_insert_pre;call super::ue_insert_pre;this.object.grupo[al_row] = ddlb_1.ia_id
...
event dw_2::rowfocuschanged;call super::rowfocuschanged;gnvo_app.of_select_current_row(this)
end event

type pb_1 from w_abc_list`pb_1 within w_sg5010_grp_obj
integer x = 1422
integer y = 556
string text = "  >"
...
type pb_2 from w_abc_list`pb_2 within w_sg5010_grp_obj
integer x = 1422
integer y = 964
integer taborder = 30
end type
