...
public function integer of_set_row (uint ai_row,double ad_height,n_xls_format_v97 anvo_format,boolean ab_hidden)
...
public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,blob ab_unicode_str,n_xls_format anvo_format);integer li_ret = 1
uint li_rwfirst
uint li_colfirst
uint li_rwlast
uint li_collast
...
public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,string as_str,n_xls_format anvo_format);return of_merge_write(ai_first_row,ai_first_col,ai_last_row,ai_last_col,invo_sub.to_unicode(invo_sub.of_str2xls(as_str)),anvo_format)
end function
...
public subroutine of_set_merge_range (long ai_format);invo_workbook.of_get_format(ai_format).of_set_merge_range()
end subroutine
...
public function integer of_set_row (uint ai_row,double ad_height,n_xls_format_v97 anvo_format,boolean ab_hidden);integer li_ret = 1
uint li_record = 520
uint li_length = 16
uint li_colmic
uint li_colmac
...
public function integer of_write (long ai_row,long ai_col,blob aa_value,long ai_format);integer li_ret = 1
uint li_record = 253
uint li_length = 10
uint li_xf
ulong ll_sst_index
...
if li_ret = 1 then
	lb_header = invo_sub.of_pack("v",li_record) + invo_sub.of_pack("v",li_length)
	lb_data = invo_sub.of_pack("v",ai_row) + invo_sub.of_pack("v",ai_col) + invo_sub.of_pack("v",ai_format) + invo_sub.of_pack("V",ll_sst_index)
	of_append_data(lb_header + lb_data)
end if
...
public function integer of_write (uint ai_row,uint ai_col);n_xls_format_v97 lnvo_format

setnull(lnvo_format)
return of_write(ai_row,ai_col,lnvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,blob ab_unicode_str);n_xls_format_v97 lnvo_format

setnull(lnvo_format)
return of_write(ai_row,ai_col,ab_unicode_str,lnvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,blob ab_unicode_str,n_xls_format anvo_format);integer li_ret = 1
uint li_record = 253
uint li_length = 10
uint li_xf
ulong ll_sst_index
...
public function integer of_write (uint ai_row,uint ai_col,date ad_date);n_xls_format_v97 lnvo_format
...
public function integer of_write (uint ai_row,uint ai_col,datetime adt_datetime);n_xls_format_v97 lnvo_format
...
public function integer of_write (uint ai_row,uint ai_col,double adb_num);n_xls_format_v97 lnvo_format
...
public function integer of_write (uint ai_row,uint ai_col,string as_str);n_xls_format_v97 lnvo_format

setnull(lnvo_format)
return of_write(ai_row,ai_col,as_str,lnvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,string as_str,n_xls_format anvo_format);return of_write(ai_row,ai_col,invo_sub.to_unicode(invo_sub.of_str2xls(as_str)),anvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,time at_time);n_xls_format_v97 lnvo_format
