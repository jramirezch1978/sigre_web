...
protected function integer of_check_dimensions (ulong al_row,ulong al_col)
...
public function integer of_set_row (uint ai_row,double ad_height,n_xls_format_v5 anvo_format,boolean ab_hidden)
...
protected function integer of_store_externcount (uint ai_count)
...
protected function integer of_check_dimensions (ulong al_row,ulong al_col);integer li_ret = 1
...
public function integer of_freeze_panes (uint ai_row,uint ai_col,uint ai_rowtop,uint ai_colleft);integer li_ret = 1
...
protected function integer of_merge_cells (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col);integer li_ret = 1
uint li_record = 229
uint li_length = 10
blob lb_header
blob lb_data
...
public function integer of_merge_write (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col,string as_str,n_xls_format anvo_format);integer li_ret = 1
uint li_rwfirst
uint li_colfirst
uint li_rwlast
uint li_collast
...
public function integer of_set_column (uint ai_firstcol,uint ai_lastcol,double ad_width,n_xls_format anvo_format,boolean ab_hidden);integer li_ret = 1
double ld_width
uint li_i
ulong ll_key
...
public function integer of_set_footer (string as_footer,double ad_margin_foot);integer li_ret = 1
...
public function integer of_set_header (string as_header,double ad_margin_head);integer li_ret = 1
...
public function integer of_set_row (uint ai_row,double ad_height,n_xls_format_v5 anvo_format,boolean ab_hidden);integer li_ret = 1
uint li_record = 520
uint li_length = 16
uint li_colmic
uint li_colmac
...
public function integer of_set_selection (uint ai_first_row,uint ai_first_col,uint ai_last_row,uint ai_last_col);integer li_ret = 1
...
public function integer of_set_selection (uint ai_row,uint ai_col);integer li_ret = 1
...
lb_header = invo_sub.of_pack("v",li_record) + invo_sub.of_pack("v",li_length)
lb_data = invo_sub.of_pack("v",li_version) + invo_sub.of_pack("v",ai_type) + invo_sub.of_pack("v",li_build) + invo_sub.of_pack("v",li_year)
...
protected function integer of_store_externcount (uint ai_count);integer li_ret = 1
uint li_record = 22
uint li_length = 2
blob lb_header
blob lb_data
...
lb_header = invo_sub.of_pack("v",li_record) + invo_sub.of_pack("v",li_length)
lb_data = invo_sub.of_pack("v",li_grbit) + invo_sub.of_pack("v",li_rwtop) + invo_sub.of_pack("v",li_colleft) + invo_sub.of_pack("V",ll_rgbhdr)
of_append_data(lb_header + lb_data)
return li_ret
end function
...
public function integer of_thaw_panes (double ad_y,double ad_x,uint ai_rowtop,uint ai_colleft);integer li_ret = 1
...
public function integer of_write (long ai_row,long ai_col,double aa_value,long ai_format);integer li_ret = 1
uint li_record = 515
uint li_length = 14
uint li_xf
blob lb_header
...
if li_ret = 1 then
	lb_header = invo_sub.of_pack("v",li_record) + invo_sub.of_pack("v",li_length)
	lb_data = invo_sub.of_pack("v",ai_row) + invo_sub.of_pack("v",ai_col) + invo_sub.of_pack("v",ai_format) + invo_sub.of_pack("d",aa_value)
	of_append_data(lb_header + lb_data)
end if
...
public function integer of_write (long ai_row,long ai_col,string aa_value,long ai_format);integer li_ret = 1
uint li_record = 516
uint li_length
uint li_strlen
blob lb_header
...
if li_strlen > il_xls_strmax then
...
if li_ret = 1 then
	lb_header = invo_sub.of_pack("v",li_record) + invo_sub.of_pack("v",li_length)
	lb_data = invo_sub.of_pack("v",ai_row) + invo_sub.of_pack("v",ai_col) + invo_sub.of_pack("v",ai_format) + invo_sub.of_pack("v",li_strlen)
...
public function integer of_write (uint ai_row,uint ai_col);n_xls_format_v5 lnvo_format

setnull(lnvo_format)
return of_write(ai_row,ai_col,lnvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,date ad_date);n_xls_format_v5 lnvo_format

setnull(lnvo_format)
return of_write(ai_row,ai_col,ad_date,lnvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,date ad_date,n_xls_format anvo_format);double ld_val

ld_val = daysafter(1899-12-30,ad_date)
return of_write(ai_row,ai_col,ld_val,anvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,datetime adt_datetime);n_xls_format_v5 lnvo_format

setnull(lnvo_format)
return of_write(ai_row,ai_col,adt_datetime,lnvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,datetime adt_datetime,n_xls_format anvo_format);double ld_val
time lt_time
string ls_time
integer li_hour
integer li_minute
...
public function integer of_write (uint ai_row,uint ai_col,double adb_num);n_xls_format_v5 lnvo_format

setnull(lnvo_format)
return of_write(ai_row,ai_col,adb_num,lnvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,double adb_num,n_xls_format anvo_format);integer li_ret = 1
uint li_record = 515
uint li_length = 14
uint li_xf
blob lb_header
...
public function integer of_write (uint ai_row,uint ai_col,n_xls_format anvo_format);integer li_ret = 1
uint li_record = 513
uint li_length = 6
uint li_xf
blob lb_header
...
public function integer of_write (uint ai_row,uint ai_col,string as_str);n_xls_format_v5 lnvo_format

setnull(lnvo_format)
return of_write(ai_row,ai_col,as_str,lnvo_format)
end function

public function integer of_write (uint ai_row,uint ai_col,string as_str,n_xls_format anvo_format);integer li_ret = 1
uint li_record = 516
uint li_length
uint li_xf
uint li_strlen
...
if li_ret = 1 then
	lb_header = invo_sub.of_pack("v",li_record) + invo_sub.of_pack("v",li_length)
	lb_data = invo_sub.of_pack("v",ai_row) + invo_sub.of_pack("v",ai_col) + invo_sub.of_pack("v",li_xf) + invo_sub.of_pack("v",li_strlen)
...
public function integer of_write (uint ai_row,uint ai_col,time at_time);n_xls_format_v5 lnvo_format
...
protected function integer of_xf (uint ai_row,uint ai_col,n_xls_format anvo_format);uint li_xf = 15
ulong ll_key
