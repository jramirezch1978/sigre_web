...
type ole_skin from w_abc_master_log`ole_skin within w_abc_master_tab_log
end type

type uo_h from w_abc_master_log`uo_h within w_abc_master_tab_log
end type

type st_box from w_abc_master_log`st_box within w_abc_master_tab_log
end type

type phl_logonps from w_abc_master_log`phl_logonps within w_abc_master_tab_log
end type

type p_mundi from w_abc_master_log`p_mundi within w_abc_master_tab_log
end type

type p_logo from w_abc_master_log`p_logo within w_abc_master_tab_log
end type
