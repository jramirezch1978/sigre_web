...
type p_pie from w_abc_master`p_pie within w_search
end type

type ole_skin from w_abc_master`ole_skin within w_search
end type

type uo_h from w_abc_master`uo_h within w_search
boolean visible = false
boolean enabled = false
end type

type st_box from w_abc_master`st_box within w_search
boolean visible = false
end type

type phl_logonps from w_abc_master`phl_logonps within w_search
end type

type p_mundi from w_abc_master`p_mundi within w_search
end type

type p_logo from w_abc_master`p_logo within w_search
end type

type st_filter from w_abc_master`st_filter within w_search
end type

type uo_filter from w_abc_master`uo_filter within w_search
end type

type dw_master from w_abc_master`dw_master within w_search
integer x = 0
integer y = 132
integer width = 1925
integer height = 1236
