...
ldt_now = f_fecha_actual(0)

INSERT INTO his_log_diario  
          ( fecha, tabla, operacion, llave, campo,
			   val_anterior, val_nuevo, cod_usr)  
  VALUES ( :ldt_now, :is_tabla, :is_tipo_oper, :is_key, :is_campo,   
             :is_val_anterior, :is_val_nuevo, :gnvo_app.is_user)  ;

IF SQLCA.SQLCode <> 0 then
	ls_mensaje = gnvo_log.of_mensajedb( ls_mensaje )
	ROLLBACK;
...
type ole_skin from w_abc`ole_skin within w_abc_master_log
end type

type uo_h from w_abc`uo_h within w_abc_master_log
end type

type st_box from w_abc`st_box within w_abc_master_log
end type

type phl_logonps from w_abc`phl_logonps within w_abc_master_log
end type

type p_mundi from w_abc`p_mundi within w_abc_master_log
end type

type p_logo from w_abc`p_logo within w_abc_master_log
end type
...
integer height = 100
boolean bringtotop = true
string picturename = "C:\SIGRE\resources\BMP\insert.bmp"
boolean focusrectangle = false
end type
...
integer height = 100
boolean bringtotop = true
string picturename = "C:\SIGRE\resources\BMP\delete.bmp"
boolean focusrectangle = false
end type
...
integer height = 100
boolean bringtotop = true
string picturename = "C:\SIGRE\resources\BMP\update.bmp"
boolean focusrectangle = false
end type
...
integer height = 100
boolean bringtotop = true
string picturename = "C:\SIGRE\resources\BMP\cancel.bmp"
boolean focusrectangle = false
end type
...
integer height = 100
boolean bringtotop = true
string picturename = "C:\SIGRE\resources\BMP\window.bmp"
boolean focusrectangle = false
end type
