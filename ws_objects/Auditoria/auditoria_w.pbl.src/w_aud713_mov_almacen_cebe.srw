$PBExportHeader$w_aud713_mov_almacen_cebe.srw
forward
global type w_aud713_mov_almacen_cebe from w_report_smpl
end type
type st_1 from statictext within w_aud713_mov_almacen_cebe
end type
type uo_1 from u_ingreso_rango_fechas within w_aud713_mov_almacen_cebe
end type
type cb_3 from commandbutton within w_aud713_mov_almacen_cebe
end type
type em_origen from singlelineedit within w_aud713_mov_almacen_cebe
end type
type em_descripcion from editmask within w_aud713_mov_almacen_cebe
end type
type cbx_origen from checkbox within w_aud713_mov_almacen_cebe
end type
type gb_1 from groupbox within w_aud713_mov_almacen_cebe
end type
type gb_2 from groupbox within w_aud713_mov_almacen_cebe
end type
end forward
...
integer width = 3424
integer height = 1856
string title = "Reporte de Movimientos de Almacén/CeBe(AUD713)"
...
global w_aud713_mov_almacen_cebe w_aud713_mov_almacen_cebe

on w_aud713_mov_almacen_cebe.create
int iCurrent
call super::create
...
on w_aud713_mov_almacen_cebe.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_aud713_mov_almacen_cebe
integer x = 14
integer y = 568
integer width = 3314
integer height = 920
integer taborder = 30
string dataobject = "d_rpt_mov_almacen_cebe_tab"
end type
...
long backcolor = 67108864
string text = "MOVIMIENTOS DEL ALMACEN"
