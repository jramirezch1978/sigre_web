$PBExportHeader$w_aud715_facturas_prov_sin_ref_cebe.srw
forward
global type w_aud715_facturas_prov_sin_ref_cebe from w_report_smpl
end type
type uo_1 from u_ingreso_rango_fechas within w_aud715_facturas_prov_sin_ref_cebe
end type
type cb_3 from commandbutton within w_aud715_facturas_prov_sin_ref_cebe
end type
type em_origen from singlelineedit within w_aud715_facturas_prov_sin_ref_cebe
end type
type em_descripcion from editmask within w_aud715_facturas_prov_sin_ref_cebe
end type
type cbx_origen from checkbox within w_aud715_facturas_prov_sin_ref_cebe
end type
type gb_1 from groupbox within w_aud715_facturas_prov_sin_ref_cebe
end type
type gb_2 from groupbox within w_aud715_facturas_prov_sin_ref_cebe
end type
end forward
...
integer width = 3424
integer height = 1856
string title = "Reporte de Facturas Provisionadas(AUD715)"
...
global w_aud715_facturas_prov_sin_ref_cebe w_aud715_facturas_prov_sin_ref_cebe

on w_aud715_facturas_prov_sin_ref_cebe.create
int iCurrent
call super::create
...
on w_aud715_facturas_prov_sin_ref_cebe.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_aud715_facturas_prov_sin_ref_cebe
integer x = 23
integer y = 336
integer width = 3314
integer height = 1300
integer taborder = 30
string dataobject = "d_rpt_fact_provision_sin_ref_tbl"
end type
