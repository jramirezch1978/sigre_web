$PBExportHeader$w_aud716_doc_por_pagar_directo_cebe.srw
forward
global type w_aud716_doc_por_pagar_directo_cebe from w_report_smpl
end type
type st_1 from statictext within w_aud716_doc_por_pagar_directo_cebe
end type
type uo_1 from u_ingreso_rango_fechas within w_aud716_doc_por_pagar_directo_cebe
end type
type cb_3 from commandbutton within w_aud716_doc_por_pagar_directo_cebe
end type
type em_origen from singlelineedit within w_aud716_doc_por_pagar_directo_cebe
end type
type em_descripcion from editmask within w_aud716_doc_por_pagar_directo_cebe
end type
type cbx_origen from checkbox within w_aud716_doc_por_pagar_directo_cebe
end type
type gb_1 from groupbox within w_aud716_doc_por_pagar_directo_cebe
end type
type gb_2 from groupbox within w_aud716_doc_por_pagar_directo_cebe
end type
end forward
...
integer width = 3424
integer height = 1856
string title = "Reporte de Documentos Por Pagar Directos(AUD716)"
...
global w_aud716_doc_por_pagar_directo_cebe w_aud716_doc_por_pagar_directo_cebe

on w_aud716_doc_por_pagar_directo_cebe.create
int iCurrent
call super::create
...
on w_aud716_doc_por_pagar_directo_cebe.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_aud716_doc_por_pagar_directo_cebe
integer x = 14
integer y = 568
integer width = 3314
integer height = 996
integer taborder = 30
string dataobject = "d_rpt_doc_por_directo_cebe_tbl"
end type
...
long backcolor = 67108864
string text = "DOCUMENTOS POR PAGAR DIRECTOS"
