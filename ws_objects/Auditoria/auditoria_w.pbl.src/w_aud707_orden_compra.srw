$PBExportHeader$w_aud707_orden_compra.srw
forward
global type w_aud707_orden_compra from w_report_smpl
end type
type uo_1 from u_ingreso_rango_fechas within w_aud707_orden_compra
end type
type cb_3 from commandbutton within w_aud707_orden_compra
end type
type em_origen from singlelineedit within w_aud707_orden_compra
end type
type em_descripcion from editmask within w_aud707_orden_compra
end type
type cbx_origen from checkbox within w_aud707_orden_compra
end type
type gb_1 from groupbox within w_aud707_orden_compra
end type
type gb_2 from groupbox within w_aud707_orden_compra
end type
end forward
...
integer width = 3424
integer height = 1856
string title = "[AUD707] Control de Compras"
...
global w_aud707_orden_compra w_aud707_orden_compra

on w_aud707_orden_compra.create
int iCurrent
call super::create
...
on w_aud707_orden_compra.destroy
call super::destroy
...
DECLARE USP_AUD_RPT_ORDEN_COMPRA PROCEDURE FOR 
	USP_AUD_RPT_ORDEN_COMPRA( :ld_fec_desde, 
									  :ld_fec_hasta, 
									  :ls_origen) ;
Execute USP_AUD_RPT_ORDEN_COMPRA ;

IF SQLCA.sqlcode = -1 THEN
	ls_mensaje = "PROCEDURE USP_AUD_RPT_ORDEN_COMPRA: " + SQLCA.SQLErrText
	Rollback ;
	MessageBox('SQL error', ls_mensaje, StopSign!)	
	return
END IF

CLOSE USP_AUD_RPT_ORDEN_COMPRA;
...
type dw_report from w_report_smpl`dw_report within w_aud707_orden_compra
integer x = 0
integer y = 228
integer width = 3314
integer height = 920
integer taborder = 30
string dataobject = "d_rpt_orden_compra_tbl"
end type
