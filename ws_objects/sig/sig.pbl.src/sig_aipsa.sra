$PBExportHeader$sig_aipsa.sra
forward
global type sig_aipsa from application
end type
...
String  gs_estacion, gs_user, gs_help, gs_origen, gs_empresa, gs_logo, gs_sistema, &
		gs_ruc, gs_esquema, gs_lpp, gs_db, gs_sig, gs_inifile, gs_firma_digital
...
string appicon = "C:\SIGRE\resources\ICO\sig.ico"
