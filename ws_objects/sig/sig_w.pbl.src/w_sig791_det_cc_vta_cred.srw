$PBExportHeader$w_sig791_det_cc_vta_cred.srw
forward
global type w_sig791_det_cc_vta_cred from w_rpt
end type
type dw_report from u_dw_rpt within w_sig791_det_cc_vta_cred
end type
end forward
...
global w_sig791_det_cc_vta_cred w_sig791_det_cc_vta_cred
...
on w_sig791_det_cc_vta_cred.create
int iCurrent
call super::create
...
on w_sig791_det_cc_vta_cred.destroy
call super::destroy
...
IF ls_tipo = 'C' THEN
	...
	idw_1.DataObject='d_rpt_cc_venta_cred_clase_tbl'
	idw_1.SetTransObject(sqlca)
	...
	idw_1.Retrieve(is_grp_codrel, ls_clase, ld_fecha_ini, ld_fecha_fin)
END IF
...
string dataobject = "d_rpt_cc_venta_cred_clase_tbl"
