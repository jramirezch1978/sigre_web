$PBExportHeader$w_sig781_det_fce_variacion.srw
forward
global type w_sig781_det_fce_variacion from w_rpt
end type
type dw_report from u_dw_rpt within w_sig781_det_fce_variacion
end type
end forward
...
integer width = 3365
integer height = 1912
string title = "Ratio de variaciones vs presupuesto (SIG781)"
string menuname = "m_rpt_simple"
long backcolor = 12632256
dw_report dw_report
end type
global w_sig781_det_fce_variacion w_sig781_det_fce_variacion

type variables

end variables

on w_sig781_det_fce_variacion.create
int iCurrent
call super::create
...
on w_sig781_det_fce_variacion.destroy
call super::destroy
...
idw_1.dataobject = 'd_rpt_fce_variac_x_detalle_tbl'
...
END IF
//	ls_texto = 'RATIO DE VARIACION Y PRESUPUESTO'
//	idw_1.dataobject = 'd_rpt_fce_variac_x_detalle_tbl'	
//ELSE
//	ls_texto = 'RATIO DE EJECUCION Y PRESUPUESTO AUTORIZADO'
...
string dataobject = "d_rpt_fce_variac_x_detalle_tbl"
