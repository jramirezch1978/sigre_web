$PBExportHeader$w_fi720_rpt_ventas_x_prod_x_fec.srw
forward
global type w_fi720_rpt_ventas_x_prod_x_fec from w_rpt
end type
type uo_1 from u_ingreso_rango_fechas within w_fi720_rpt_ventas_x_prod_x_fec
end type
type cb_3 from commandbutton within w_fi720_rpt_ventas_x_prod_x_fec
end type
type dw_report from u_dw_rpt within w_fi720_rpt_ventas_x_prod_x_fec
end type
type cb_1 from commandbutton within w_fi720_rpt_ventas_x_prod_x_fec
end type
type gb_1 from groupbox within w_fi720_rpt_ventas_x_prod_x_fec
end type
end forward
...
integer width = 3589
integer height = 1504
string title = "Reporte de Ventas de Productos x Fechas  (FI720)"
...
global w_fi720_rpt_ventas_x_prod_x_fec w_fi720_rpt_ventas_x_prod_x_fec

type variables
str_seleccionar istr_seleccionar
end variables

on w_fi720_rpt_ventas_x_prod_x_fec.create
int iCurrent
call super::create
...
on w_fi720_rpt_ventas_x_prod_x_fec.destroy
call super::destroy
