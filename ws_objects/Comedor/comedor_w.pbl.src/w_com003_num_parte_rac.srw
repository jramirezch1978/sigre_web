$PBExportHeader$w_com003_num_parte_rac.srw
forward
global type w_com003_num_parte_rac from w_abc_master_smpl
end type
end forward
...
integer width = 1326
integer height = 408
string title = "Numerador de Parte de Racion (COM003)"
string menuname = "m_mantto_smpl"
boolean minbox = false
boolean maxbox = false
boolean resizable = false
end type
global w_com003_num_parte_rac w_com003_num_parte_rac

on w_com003_num_parte_rac.create
call super::create
if this.MenuName = "m_mantto_smpl" then this.MenuID = create m_mantto_smpl
end on

on w_com003_num_parte_rac.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_com003_num_parte_rac
integer x = 0
integer y = 0
integer width = 1271
integer height = 192
string dataobject = "d_num_parte_rac_ff"
