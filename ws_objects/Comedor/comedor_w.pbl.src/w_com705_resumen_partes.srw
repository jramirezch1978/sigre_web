$PBExportHeader$w_com705_resumen_partes.srw
forward
global type w_com705_resumen_partes from w_rpt_general
end type
type uo_fecha from u_ingreso_rango_fechas within w_com705_resumen_partes
end type
type em_origen from singlelineedit within w_com705_resumen_partes
end type
type em_descripcion from editmask within w_com705_resumen_partes
end type
type pb_1 from picturebutton within w_com705_resumen_partes
end type
type gb_2 from groupbox within w_com705_resumen_partes
end type
end forward
...
integer width = 2683
integer height = 1232
string title = "Raciones por Partes de Raciones (COM705)"
uo_fecha uo_fecha
em_origen em_origen
...
global w_com705_resumen_partes w_com705_resumen_partes

on w_com705_resumen_partes.create
int iCurrent
call super::create
...
on w_com705_resumen_partes.destroy
call super::destroy
...
type dw_report from w_rpt_general`dw_report within w_com705_resumen_partes
integer y = 240
integer width = 2574
integer height = 740
string dataobject = "d_rpt_resumen_partes_cmp"
end type
