$PBExportHeader$w_com701_costo_ot_resumen.srw
forward
global type w_com701_costo_ot_resumen from w_rpt_general
end type
type sle_orden from singlelineedit within w_com701_costo_ot_resumen
end type
type st_2 from statictext within w_com701_costo_ot_resumen
end type
type uo_fecha from u_ingreso_rango_fechas_v within w_com701_costo_ot_resumen
end type
type sle_origen from singlelineedit within w_com701_costo_ot_resumen
end type
type st_1 from statictext within w_com701_costo_ot_resumen
end type
type pb_1 from picturebutton within w_com701_costo_ot_resumen
end type
type gb_1 from groupbox within w_com701_costo_ot_resumen
end type
type gb_3 from groupbox within w_com701_costo_ot_resumen
end type
end forward
...
integer width = 2702
integer height = 2312
string title = "Costo Orden Trabajo (Comedores) - Resumen (COM701)"
...
global w_com701_costo_ot_resumen w_com701_costo_ot_resumen

on w_com701_costo_ot_resumen.create
int iCurrent
call super::create
...
on w_com701_costo_ot_resumen.destroy
call super::destroy
...
event ue_retrieve;call super::ue_retrieve;string 	ls_nro_orden, ls_origen
...
type dw_report from w_rpt_general`dw_report within w_com701_costo_ot_resumen
integer y = 348
integer width = 2354
integer height = 1364
string dataobject = "d_rpt_costo_ot_com_resumen_tbl"
end type
