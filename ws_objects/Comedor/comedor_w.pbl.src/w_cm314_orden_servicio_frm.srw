...
event ue_retrieve;call super::ue_retrieve;String ls_cod_rel, ls_nro_os
...
idw_1.Retrieve(gs_origen, ls_nro_os)
idw_1.Visible = True
...
idw_1.object.t_tel_prov.text 	= f_telefono_codrel(ls_cod_rel, 't')
end event
