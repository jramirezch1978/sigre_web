$PBExportHeader$w_com703_costo_fechas.srw
forward
global type w_com703_costo_fechas from w_rpt_general
end type
type uo_fecha from u_ingreso_rango_fechas within w_com703_costo_fechas
end type
type em_origen from singlelineedit within w_com703_costo_fechas
end type
type em_descripcion from editmask within w_com703_costo_fechas
end type
type pb_1 from picturebutton within w_com703_costo_fechas
end type
type gb_2 from groupbox within w_com703_costo_fechas
end type
end forward
...
integer width = 2715
integer height = 1232
string title = "Costo x Raciones (Rango Fechas) (COM703)"
uo_fecha uo_fecha
em_origen em_origen
...
global w_com703_costo_fechas w_com703_costo_fechas

on w_com703_costo_fechas.create
int iCurrent
call super::create
...
on w_com703_costo_fechas.destroy
call super::destroy
...
type dw_report from w_rpt_general`dw_report within w_com703_costo_fechas
integer y = 224
integer width = 2624
integer height = 840
string dataobject = "d_rpt_costo_fechas_cmp"
end type
