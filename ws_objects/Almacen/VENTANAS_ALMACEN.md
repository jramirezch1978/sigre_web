# Ventanas PowerBuilder del Módulo Almacén

Análisis de todas las ventanas (.srw) del módulo Almacen.
...
| w_al014_unidades_conversion | S/C | Unidades de conversión (título incorrecto: Motivos de traslado) |
...
| w_al315_orden_traslado_frm | S/C | Formato orden de venta |
| w_al316_orden_tras_aprobar | AL316 | Aprobación de orden de traslado |
| w_al317_ov_cerrar | AL317 | Movimientos proyectados a no atenderse (cierre OV) |
...
| w_al509_guias_pend_ticket | AL509 | Guías de remisión faltantes de ticket de balanza |
...
| w_al511_rpt_transporte_combustible | AL511 | Cuenta por cobrar transportista de caña (combustible) |
...
| w_al701_movimiento_x_cencos_bk | AL701 | Movimiento de almacén por centro de costo (backup) |
...
| w_al729_mov_alm_sldo_neg | AL729 | Movimientos de almacén con saldo o valor negativo |
| w_al730_mov_alm_x_mov_proy | AL729 | Movimientos de almacén por mov proyectado |
| w_al731_mov_alm_x_tipo_doc | AL731 | Movimientos de almacén por tipo de documento |
| w_al732_desc_valor_mov_almacen | AL732 | Descuadres de valorización en movimientos de almacén |
...
| w_al742_pend_ingreso | AL742 | Salidas por transporte pendientes de ingreso |
