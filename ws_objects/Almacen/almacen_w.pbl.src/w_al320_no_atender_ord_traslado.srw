$PBExportHeader$w_al320_no_atender_ord_traslado.srw
forward
global type w_al320_no_atender_ord_traslado from w_abc_master
end type
type st_1 from statictext within w_al320_no_atender_ord_traslado
end type
type sle_tipo_doc from singlelineedit within w_al320_no_atender_ord_traslado
end type
type st_2 from statictext within w_al320_no_atender_ord_traslado
end type
type cb_1 from commandbutton within w_al320_no_atender_ord_traslado
end type
type uo_1 from u_ingreso_fecha within w_al320_no_atender_ord_traslado
end type
end forward
...
integer width = 3657
integer height = 1544
string title = "Ordenes de Traslado a no atenderse (AL320)"
...
global w_al320_no_atender_ord_traslado w_al320_no_atender_ord_traslado
...
on w_al320_no_atender_ord_traslado.create
int iCurrent
call super::create
...
on w_al320_no_atender_ord_traslado.destroy
call super::destroy
...
event ue_open_pre;call super::ue_open_pre;String ls_doc_otr
//ii_help = 101           					// help topic
ii_pregunta_delete = 1   				// 1 = si pregunta, 0 = no pregunta (default)

//idw_1.Retrieve(TODAY())

select doc_otr into :ls_doc_otr from logparam where reckey='1' ;

sle_tipo_doc.text = ls_doc_otr
end event
...
type dw_master from w_abc_master`dw_master within w_al320_no_atender_ord_traslado
integer x = 41
integer y = 380
integer width = 3442
integer height = 752
string dataobject = "d_abc_no_atender_ord_trasl"
...
string text = "MOVIMIENTOS PROYECTADOS NO ATENDIDOS - ORDEN DE TRASLADO"
