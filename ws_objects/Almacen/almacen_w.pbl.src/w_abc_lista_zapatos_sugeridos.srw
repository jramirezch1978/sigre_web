...
string 			ls_cod_suela, ls_desc_suela,  ls_cod_acabado, ls_desc_acabado, &
					...
					ls_Cod_clase, ls_desc_clase, ls_cod_sub_linea, ls_cod_linea,ls_abrev_linea, ls_estilo, ls_desc_sub_linea
u_dw_abc		ldw_master					
...
ls_cod_sub_linea		= dw_master.object.cod_sub_linea		[ll_row]
ls_cod_linea				= dw_master.object.cod_linea		[ll_row]
ls_abrev_linea			= dw_master.object.cod_linea		[ll_row]
ls_desc_sub_linea		= dw_master.object.desc_sub_linea		[ll_row]
...
select abreviatura 
into :ls_abrev_linea
from zc_linea where cod_linea =:ls_cod_linea;
