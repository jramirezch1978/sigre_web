$PBExportHeader$w_al515_precios_acc_ni.srw
forward
global type w_al515_precios_acc_ni from w_report_smpl
end type
type uo_fecha from u_ingreso_rango_fechas within w_al515_precios_acc_ni
end type
type cb_3 from commandbutton within w_al515_precios_acc_ni
end type
type cb_procesar from commandbutton within w_al515_precios_acc_ni
end type
type hpb_1 from hprogressbar within w_al515_precios_acc_ni
end type
end forward
...
integer width = 2930
integer height = 1836
string title = "Descuadre entre Partes de Cosecha y NI (AL515)"
...
global w_al515_precios_acc_ni w_al515_precios_acc_ni
...
for ll_i = 1 to idw_1.RowCount()
	...
	ld_fecha			= Date(idw_1.object.fec_parte[ll_i])
	ldc_precio_real= Dec(idw_1.object.imp_org[ll_i])
...
on w_al515_precios_acc_ni.create
int iCurrent
call super::create
...
on w_al515_precios_acc_ni.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_al515_precios_acc_ni
integer x = 0
integer y = 152
integer width = 1906
integer height = 1424
string dataobject = "d_rpt_precio_acc_ni_grd"
end type
