$PBExportHeader$w_al324_repr_mov_proy.srw
forward
global type w_al324_repr_mov_proy from w_abc
end type
type dw_master from u_dw_abc within w_al324_repr_mov_proy
end type
type st_1 from statictext within w_al324_repr_mov_proy
end type
type sle_dias from singlelineedit within w_al324_repr_mov_proy
end type
type cb_1 from commandbutton within w_al324_repr_mov_proy
end type
type gb_1 from groupbox within w_al324_repr_mov_proy
end type
type rb_logeado from radiobutton within w_al324_repr_mov_proy
end type
type sle_usr from singlelineedit within w_al324_repr_mov_proy
end type
type rb_todos from radiobutton within w_al324_repr_mov_proy
end type
type rb_otros from radiobutton within w_al324_repr_mov_proy
end type
end forward
...
integer width = 2350
integer height = 1812
string title = "Reprogramación de Movimientos Atrazados (AL324)"
...
global w_al324_repr_mov_proy w_al324_repr_mov_proy
...
on w_al324_repr_mov_proy.create
int iCurrent
call super::create
...
on w_al324_repr_mov_proy.destroy
call super::destroy
...
event ue_open_pos;call super::ue_open_pos;in_log = Create n_cst_log_diario
