$PBExportHeader$w_al754_resumen_diario.srw
forward
global type w_al754_resumen_diario from w_report_smpl
end type
type cb_1 from commandbutton within w_al754_resumen_diario
end type
type uo_1 from u_ingreso_rango_fechas_v within w_al754_resumen_diario
end type
type cbx_1 from checkbox within w_al754_resumen_diario
end type
type sle_almacen from singlelineedit within w_al754_resumen_diario
end type
type sle_descrip from singlelineedit within w_al754_resumen_diario
end type
type st_2 from statictext within w_al754_resumen_diario
end type
type gb_fechas from groupbox within w_al754_resumen_diario
end type
type gb_1 from groupbox within w_al754_resumen_diario
end type
end forward
...
integer width = 3570
integer height = 1740
string title = "[AL754] Resumen Diario por Comprobante"
...
global w_al754_resumen_diario w_al754_resumen_diario
...
on w_al754_resumen_diario.create
int iCurrent
call super::create
...
on w_al754_resumen_diario.destroy
call super::destroy
...
dw_report.Object.t_objeto.text = 'AL728'	

end event

type dw_report from w_report_smpl`dw_report within w_al754_resumen_diario
integer x = 0
integer y = 324
integer width = 3035
integer height = 1092
string dataobject = "d_rpt_resumen_diario_comprobantes_tbl"
end type
