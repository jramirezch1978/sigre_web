$PBExportHeader$w_al724_imp_xtipo_mov.srw
forward
global type w_al724_imp_xtipo_mov from w_report_smpl
end type
type cb_1 from commandbutton within w_al724_imp_xtipo_mov
end type
type uo_1 from u_ingreso_rango_fechas_v within w_al724_imp_xtipo_mov
end type
type cbx_1 from checkbox within w_al724_imp_xtipo_mov
end type
type sle_almacen from singlelineedit within w_al724_imp_xtipo_mov
end type
type sle_descrip from singlelineedit within w_al724_imp_xtipo_mov
end type
type st_2 from statictext within w_al724_imp_xtipo_mov
end type
type gb_fechas from groupbox within w_al724_imp_xtipo_mov
end type
type gb_1 from groupbox within w_al724_imp_xtipo_mov
end type
end forward
...
integer width = 3570
integer height = 1740
string title = "Importe x Tipo Mov (AL724)"
...
global w_al724_imp_xtipo_mov w_al724_imp_xtipo_mov
...
on w_al724_imp_xtipo_mov.create
int iCurrent
call super::create
...
on w_al724_imp_xtipo_mov.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_al724_imp_xtipo_mov
integer x = 0
integer y = 324
integer width = 3035
integer height = 1092
string dataobject = "d_rpt_importe_tipo_mov_tbl"
end type
