$PBExportHeader$w_al765_cierre_mensual.srw
forward
global type w_al765_cierre_mensual from w_report_smpl
end type
type cb_reporte from commandbutton within w_al765_cierre_mensual
end type
type cb_procesar from commandbutton within w_al765_cierre_mensual
end type
type st_1 from statictext within w_al765_cierre_mensual
end type
type sle_year from singlelineedit within w_al765_cierre_mensual
end type
type sle_mes from singlelineedit within w_al765_cierre_mensual
end type
type st_2 from statictext within w_al765_cierre_mensual
end type
type gb_fechas from groupbox within w_al765_cierre_mensual
end type
end forward
...
integer width = 4791
integer height = 1740
string title = "[AL765] Cierre Mensual Almacén"
...
global w_al765_cierre_mensual w_al765_cierre_mensual
...
DECLARE sp_cierre_mensual PROCEDURE FOR
	  pkg_almacen.sp_cierre_mensual(:li_year,
                                	  :li_mes,
                                	  :gs_user);

EXECUTE sp_cierre_mensual;

IF SQLCA.sqlcode = -1 THEN
	ls_mensaje = "PROCEDURE pkg_almacen.sp_cierre_mensual(). Error:" &
			  + SQLCA.SQLErrText
	Rollback;
...
on w_al765_cierre_mensual.create
int iCurrent
call super::create
...
on w_al765_cierre_mensual.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_al765_cierre_mensual
integer x = 0
integer y = 312
integer width = 3429
integer height = 1128
string dataobject = "d_rpt_cierre_mensual_tbl"
end type
...
event modified;cb_reporte.enabled = true
cb_procesar.enabled = false
end event
