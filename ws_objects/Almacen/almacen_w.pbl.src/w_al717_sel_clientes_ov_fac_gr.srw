$PBExportHeader$w_al717_sel_clientes_ov_fac_gr.srw
forward
global type w_al717_sel_clientes_ov_fac_gr from w_abc_list
end type
type cb_4 from commandbutton within w_al717_sel_clientes_ov_fac_gr
end type
type st_1 from statictext within w_al717_sel_clientes_ov_fac_gr
end type
type dw_text from datawindow within w_al717_sel_clientes_ov_fac_gr
end type
end forward
...
global w_al717_sel_clientes_ov_fac_gr w_al717_sel_clientes_ov_fac_gr
...
on w_al717_sel_clientes_ov_fac_gr.create
int iCurrent
call super::create
...
on w_al717_sel_clientes_ov_fac_gr.destroy
call super::destroy
destroy(this.cb_4)
destroy(this.st_1)
...
type dw_1 from w_abc_list`dw_1 within w_al717_sel_clientes_ov_fac_gr
integer y = 144
integer width = 974
integer height = 868
integer taborder = 30
...
type dw_2 from w_abc_list`dw_2 within w_al717_sel_clientes_ov_fac_gr
integer x = 1202
integer y = 144
integer width = 974
integer height = 868
...
type pb_1 from w_abc_list`pb_1 within w_al717_sel_clientes_ov_fac_gr
...
type pb_2 from w_abc_list`pb_2 within w_al717_sel_clientes_ov_fac_gr
integer x = 1029
integer y = 636
integer taborder = 50
end type
