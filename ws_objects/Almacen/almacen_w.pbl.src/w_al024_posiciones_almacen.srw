$PBExportHeader$w_al024_posiciones_almacen.srw
forward
global type w_al024_posiciones_almacen from w_abc_master_smpl
end type
end forward
...
integer width = 3442
integer height = 2176
string title = "[AL024] Posiciones por Almacen"
string menuname = "m_mantenimiento_sl"
end type
global w_al024_posiciones_almacen w_al024_posiciones_almacen

on w_al024_posiciones_almacen.create
call super::create
if this.MenuName = "m_mantenimiento_sl" then this.MenuID = create m_mantenimiento_sl
end on

on w_al024_posiciones_almacen.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_al024_posiciones_almacen
event ue_display ( string as_columna,  long al_row )
integer width = 3168
integer height = 1652
string dataobject = "d_abc_posiciones_tbl"
end type
