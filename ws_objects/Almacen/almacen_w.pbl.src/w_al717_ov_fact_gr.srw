$PBExportHeader$w_al717_ov_fact_gr.srw
forward
global type w_al717_ov_fact_gr from w_report_smpl
end type
type gb_1 from groupbox within w_al717_ov_fact_gr
end type
type uo_fechas from u_ingreso_rango_fechas within w_al717_ov_fact_gr
end type
type cb_4 from commandbutton within w_al717_ov_fact_gr
end type
end forward
...
integer width = 3456
integer height = 1956
string title = "Movimientos por tipo de Operación (AL717)"
...
global w_al717_ov_fact_gr w_al717_ov_fact_gr

type variables
Integer ii_index
end variables

on w_al717_ov_fact_gr.create
int iCurrent
call super::create
...
type dw_report from w_report_smpl`dw_report within w_al717_ov_fact_gr
integer x = 32
integer y = 240
integer width = 3342
integer height = 1316
...
OpenWithParm( w_al717_sel_clientes_ov_fac_gr, sl_param)
