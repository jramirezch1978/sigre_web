$PBExportHeader$w_al728_ingresos_x_alm.srw
forward
global type w_al728_ingresos_x_alm from w_report_smpl
end type
type cb_1 from commandbutton within w_al728_ingresos_x_alm
end type
type uo_1 from u_ingreso_rango_fechas_v within w_al728_ingresos_x_alm
end type
type cbx_1 from checkbox within w_al728_ingresos_x_alm
end type
type sle_almacen from singlelineedit within w_al728_ingresos_x_alm
end type
type sle_descrip from singlelineedit within w_al728_ingresos_x_alm
end type
type st_2 from statictext within w_al728_ingresos_x_alm
end type
type gb_fechas from groupbox within w_al728_ingresos_x_alm
end type
type gb_1 from groupbox within w_al728_ingresos_x_alm
end type
end forward
...
integer width = 3570
integer height = 1740
string title = "INGRESOS x ALMACEN (AL728)"
...
global w_al728_ingresos_x_alm w_al728_ingresos_x_alm
...
on w_al728_ingresos_x_alm.create
int iCurrent
call super::create
...
on w_al728_ingresos_x_alm.destroy
call super::destroy
...
idw_1.Object.t_objeto.text = 'AL728'	

end event

type dw_report from w_report_smpl`dw_report within w_al728_ingresos_x_alm
integer x = 0
integer y = 324
integer width = 3035
integer height = 1092
string dataobject = "d_rpt_ingresos_alm_tbl"
end type
