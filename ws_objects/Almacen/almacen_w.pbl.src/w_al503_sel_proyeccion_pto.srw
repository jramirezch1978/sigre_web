$PBExportHeader$w_al503_sel_proyeccion_pto.srw
forward
global type w_al503_sel_proyeccion_pto from w_abc_list
end type
type cb_4 from commandbutton within w_al503_sel_proyeccion_pto
end type
type st_1 from statictext within w_al503_sel_proyeccion_pto
end type
type dw_text from datawindow within w_al503_sel_proyeccion_pto
end type
end forward
...
global w_al503_sel_proyeccion_pto w_al503_sel_proyeccion_pto

type variables
u_dw_abc  idw_otro
integer ii_tipo, ii_mes_del, ii_mes_al, ii_ano
String is_col = '', is_type
end variables

on w_al503_sel_proyeccion_pto.create
int iCurrent
call super::create
...
on w_al503_sel_proyeccion_pto.destroy
call super::destroy
destroy(this.cb_4)
destroy(this.st_1)
...
ii_tipo = ls_param.int1
ii_mes_del = ls_param.int2
ii_mes_al  = ls_param.int3
ii_ano = ls_param.long1

Choose case ii_tipo 
	case 1 
		dw_1.dataobject = 'd_sel_mov_proy_x_tipo_doc'	
		dw_2.dataobject = 'd_sel_mov_proy_x_tipo_doc'
	case 2
		dw_1.dataobject = 'd_dddw_cencos'	//  'd_sel_mov_proy_x_ccosto'  //
		dw_2.dataobject = 'd_dddw_cencos'
	case 3
		dw_1.dataobject = 'd_sel_mov_proy_x_partida'	
		dw_2.dataobject = 'd_sel_mov_proy_x_partida'	
end choose
...
//		dw_1.Retrieve(TODAY())
//	case 2
		dw_1.Retrieve(ii_mes_del, ii_ano)
//end choose
end event
...
type dw_1 from w_abc_list`dw_1 within w_al503_sel_proyeccion_pto
integer y = 144
integer width = 974
integer height = 868
integer taborder = 30
...
type dw_2 from w_abc_list`dw_2 within w_al503_sel_proyeccion_pto
integer x = 1202
integer y = 144
integer width = 974
integer height = 868
...
type pb_1 from w_abc_list`pb_1 within w_al503_sel_proyeccion_pto
...
type pb_2 from w_abc_list`pb_2 within w_al503_sel_proyeccion_pto
integer x = 1029
integer y = 636
integer taborder = 50
end type
...
CHOOSE CASE ii_tipo 
	CASE 1 
		FOR ll_row = 1 to dw_2.rowcount()
			ls_dato1 = dw_2.object.tipo_doc[ll_row]
			ls_dato2 = dw_2.object.nro_doc[ll_row]
			Insert into tt_alm_seleccion(tipo_doc, nro_doc) 
	...
	CASE 2
		FOR ll_row = 1 to dw_2.rowcount()
			ls_dato1 = dw_2.object.cencos[ll_row]			
	...
	CASE 3
		FOR ll_row = 1 to dw_2.rowcount()
			ls_dato1 = dw_2.object.cencos[ll_row]
			ls_dato2 = dw_2.object.cnta_prsp[ll_row]
			Insert into tt_alm_seleccion(cencos, nro_doc) 
	   		values ( :ls_dato1, :ls_dato2);	
			If sqlca.sqlcode = -1 then
				messagebox("Error al insertar registro",sqlca.sqlerrtext)
			END IF
...
DECLARE proc1 PROCEDURE FOR USP_ALM_PROYECCION_PTO(:ii_tipo, :ii_mes_del, :ii_mes_al, :ii_ano);
EXECUTE proc1;
