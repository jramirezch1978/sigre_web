$PBExportHeader$w_al723_mov_atrazados.srw
forward
global type w_al723_mov_atrazados from w_report_smpl
end type
type cb_1 from commandbutton within w_al723_mov_atrazados
end type
type rb_todos from radiobutton within w_al723_mov_atrazados
end type
type rb_logeado from radiobutton within w_al723_mov_atrazados
end type
type sle_dias from singlelineedit within w_al723_mov_atrazados
end type
type st_1 from statictext within w_al723_mov_atrazados
end type
type rb_otros from radiobutton within w_al723_mov_atrazados
end type
type sle_usr from singlelineedit within w_al723_mov_atrazados
end type
type gb_1 from groupbox within w_al723_mov_atrazados
end type
end forward
...
integer width = 2455
integer height = 1644
string title = "Movimientos Atrazados(AL723)"
...
global w_al723_mov_atrazados w_al723_mov_atrazados

type variables
String	is_dw = 'D'
end variables

on w_al723_mov_atrazados.create
int iCurrent
call super::create
...
on w_al723_mov_atrazados.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_al723_mov_atrazados
integer x = 0
integer y = 208
integer width = 2016
integer height = 1196
