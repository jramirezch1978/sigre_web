...
//idw_1.object.t_ruc.text = 'Ruc: ' + f_ruc_empresa(gs_empresa)
//idw_1.object.t_dir_prov.text = f_direccion_codrel(dw_report.object.proveedor[dw_report.getrow()])
//idw_1.object.t_ruc_prov.text = f_ruc_proveedor(dw_report.object.proveedor[dw_report.getrow()])
//idw_1.object.t_tel_prov.text = f_telefono_codrel(dw_report.object.proveedor[dw_report.getrow()], 't')

string ls_ruc, ls_nom_empresa, ls_empresa, ls_dua, ls_band
