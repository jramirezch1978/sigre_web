$PBExportHeader$w_cw009_versiones.srw
forward
global type w_cw009_versiones from window
end type
type pb_cancel from picturebutton within w_cw009_versiones
end type
type pb_save from picturebutton within w_cw009_versiones
end type
type dw_master from u_dw_abc within w_cw009_versiones
end type
end forward
...
global w_cw009_versiones w_cw009_versiones

type variables
str_parametros ist_datos
end variables

on w_cw009_versiones.create
...
if sqlca.sqlCode < 0 then
	...
	ROLLBACK;
	MessageBox('Error al insertar Version', ls_mensaje)
	return
end if
...
integer width = 1783
integer height = 412
string dataobject = "d_abc_versiones_ff"
