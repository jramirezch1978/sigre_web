$PBExportHeader$w_search_tiptra.srw
forward
global type w_search_tiptra from w_abc_master_smpl
end type
type st_campo from statictext within w_search_tiptra
end type
type dw_1 from datawindow within w_search_tiptra
end type
type cb_1 from commandbutton within w_search_tiptra
end type
end forward
...
global w_search_tiptra w_search_tiptra
...
type dw_master from w_abc_master_smpl`dw_master within w_search_tiptra
integer x = 37
integer y = 140
integer width = 1326
integer height = 468
