...
type uo_deldia from u_ingreso_fecha within w_prueba
end type
type pb_1 from picturebutton within w_prueba
end type
type pb_2 from picturebutton within w_prueba
end type
type st_1 from statictext within w_prueba
end type
type gb_1 from groupbox within w_prueba
end type
type mle_1 from multilineedit within w_prueba
end type
end forward
