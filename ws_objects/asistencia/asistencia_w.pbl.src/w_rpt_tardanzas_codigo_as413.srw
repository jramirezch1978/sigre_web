$PBExportHeader$w_rpt_tardanzas_codigo_as413.srw
forward
global type w_rpt_tardanzas_codigo_as413 from w_report_smpl
end type
type uo_1 from u_ingreso_rango_fechas within w_rpt_tardanzas_codigo_as413
end type
type cb_1 from commandbutton within w_rpt_tardanzas_codigo_as413
end type
type gb_trabajador from groupbox within w_rpt_tardanzas_codigo_as413
end type
type gb_3 from groupbox within w_rpt_tardanzas_codigo_as413
end type
type st_1 from statictext within w_rpt_tardanzas_codigo_as413
end type
type sle_codtra from singlelineedit within w_rpt_tardanzas_codigo_as413
end type
type st_cod_trabajador from statictext within w_rpt_tardanzas_codigo_as413
end type
end forward
...
integer width = 3461
integer height = 1644
string title = "Minutos Acumulados de Tardanzas (AS413)"
...
global w_rpt_tardanzas_codigo_as413 w_rpt_tardanzas_codigo_as413

on w_rpt_tardanzas_codigo_as413.create
int iCurrent
call super::create
...
on w_rpt_tardanzas_codigo_as413.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_rpt_tardanzas_codigo_as413
integer x = 9
integer y = 432
integer width = 3410
integer height = 1028
integer taborder = 40
string dataobject = "d_rpt_tardanzas_codigo_tbl"
end type
...
event clicked;w_rpt_tardanzas_codigo_as413.Event ue_retrieve()
end event
