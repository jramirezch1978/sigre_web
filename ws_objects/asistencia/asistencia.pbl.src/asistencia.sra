$PBExportHeader$asistencia.sra
forward
global type asistencia from application
end type
...
String 		gs_estacion, gs_user, gs_help, gs_origen, gs_empresa, gs_logo, gs_sistema, gs_ruc, &
				gs_esquema, gs_lpp ,gs_remoto, gs_db, gs_inifile, gs_firma_digital
...
global asistencia asistencia

on asistencia.create
appname="asistencia"
