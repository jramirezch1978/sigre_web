...
type dw_arg from datawindow within w_fi700_rpt_libro_bancos
end type
...
integer width = 3589
integer height = 1364
string title = "Reporte de Libro - Bancos (FI700)"
...
type ole_skin from w_rpt`ole_skin within w_fi700_rpt_libro_bancos
end type
...
ld_fecha_inicio = Date(dw_arg.object.ad_fecha_inicio [1])
ld_fecha_final  = Date(dw_arg.object.ad_fecha_final  [1])

delete TT_FIN_RPT_LIBRO_BANCOS_DET;
delete TT_FIN_RPT_LIBRO_BANCOS;
...
dw_report.Retrieve(String(ld_fecha_inicio),String(ld_fecha_final),gnvo_app.invo_empresa.is_empresa,gnvo_app.is_user)
