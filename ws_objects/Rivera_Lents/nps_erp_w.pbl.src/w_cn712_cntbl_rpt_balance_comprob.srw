...
type ddlb_2 from dropdownlistbox within w_cn712_cntbl_rpt_balance_comprob
end type
...
event ue_retrieve;call super::ue_retrieve;String 	ls_ano, ls_mes_desde, ls_mes_hasta, ls_moneda, &
			ls_nombre_mes_desde, ls_nombre_mes_hasta, ls_mensaje
...
DECLARE USP_CNTBL_RPT_BALANCE_COMPROB PROCEDURE FOR 
	USP_CNTBL_RPT_BALANCE_COMPROB( :ls_mes_desde, 
											 :ls_mes_hasta, 
											 :ls_ano, 
											 :ls_moneda, 
											 :ln_nivel,
		    								 :ln_niveles ) ;
Execute USP_CNTBL_RPT_BALANCE_COMPROB ;

IF SQLCA.SQLCode < 0 then
	ls_mensaje = SQLCA.SQLErrText
	
	ROLLBACK;
	MessageBox('Error en USP_CNTBL_RPT_BALANCE_COMPROB', ls_mensaje)
	return
end if

CLOSE USP_CNTBL_RPT_BALANCE_COMPROB;
...
dw_report.object.t_ruc.text      = gnvo_app.is_ruc
