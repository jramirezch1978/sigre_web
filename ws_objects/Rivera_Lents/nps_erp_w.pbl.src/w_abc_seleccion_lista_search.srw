...
FOR j=1 TO ids_art_a_vender.Rowcount()
	 ...
	 IF is_param.dw_d.Rowcount () = w_ve310_cnts_x_cobrar.ii_lin_x_doc	THEN
...
// Recoge parametro enviado
	...
	CHOOSE CASE is_param.String1
			 ...
			 CASE	'1ARTF' //ARTICULOS VENDIDODS POR FECHAS	
				   is_col = 'codigo'
			 CASE '1FP'   //Facturacion Pesca / Cantidad/Aparejos
					is_col = 'nro_parte'
	END CHOOSE
...
type ole_skin from w_abc_list`ole_skin within w_abc_seleccion_lista_search
end type
						 ...
						 is_param.dw_d.Object.matriz_cntbl 	  [ll_ins_row] = ls_matriz
					 	 ...
					 	 For ll_inicio = 1 to ids_imp_x_cobrar.Rowcount()
						     ...
						     is_param.dw_c.Object.desc_impuesto [ll_ins_row_det] = ls_desc_impuesto
							  ...
							  is_param.dw_c.Object.flag_tipo	  	 [ll_ins_row_det] = '1' 
