...
type p_pie from w_abc_list`p_pie within w_abc_seleccion_md2
end type

type ole_skin from w_abc_list`ole_skin within w_abc_seleccion_md2
end type
...
Choose case ist_datos.opcion
	CASE 1    // grupo y concepto financiero
	...
	CASE 2   // grupo y concepto financiero exportacion
