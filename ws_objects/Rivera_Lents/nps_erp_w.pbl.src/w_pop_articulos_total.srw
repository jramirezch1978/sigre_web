$PBExportHeader$w_pop_articulos_total.srw
forward
global type w_pop_articulos_total from w_cns
end type
type st_2 from statictext within w_pop_articulos_total
end type
type dw_master from u_dw_cns within w_pop_articulos_total
end type
type dw_1 from datawindow within w_pop_articulos_total
end type
type cb_1 from commandbutton within w_pop_articulos_total
end type
end forward
...
global w_pop_articulos_total w_pop_articulos_total
...
on w_pop_articulos_total.create
int iCurrent
call super::create
...
on w_pop_articulos_total.destroy
call super::destroy
destroy(this.st_2)
...
type p_pie from w_cns`p_pie within w_pop_articulos_total
integer x = 0
integer y = 1496
end type

type ole_skin from w_cns`ole_skin within w_pop_articulos_total
integer x = 2277
end type
...
string dataobject = "d_sel_articulo_total_tbl"
