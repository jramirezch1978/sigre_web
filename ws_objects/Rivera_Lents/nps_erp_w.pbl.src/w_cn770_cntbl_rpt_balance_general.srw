$PBExportHeader$w_cn770_cntbl_rpt_balance_general.srw
forward
global type w_cn770_cntbl_rpt_balance_general from w_report_smpl
end type
type sle_ano from singlelineedit within w_cn770_cntbl_rpt_balance_general
end type
type sle_mes_desde from singlelineedit within w_cn770_cntbl_rpt_balance_general
end type
type cb_1 from commandbutton within w_cn770_cntbl_rpt_balance_general
end type
type st_3 from statictext within w_cn770_cntbl_rpt_balance_general
end type
type st_4 from statictext within w_cn770_cntbl_rpt_balance_general
end type
type ddlb_2 from dropdownlistbox within w_cn770_cntbl_rpt_balance_general
end type
type st_2 from statictext within w_cn770_cntbl_rpt_balance_general
end type
type st_7 from statictext within w_cn770_cntbl_rpt_balance_general
end type
type st_1 from statictext within w_cn770_cntbl_rpt_balance_general
end type
type sle_mes_hasta from singlelineedit within w_cn770_cntbl_rpt_balance_general
end type
type em_nivel from editmask within w_cn770_cntbl_rpt_balance_general
end type
type cbx_1 from checkbox within w_cn770_cntbl_rpt_balance_general
end type
type gb_1 from groupbox within w_cn770_cntbl_rpt_balance_general
end type
type gb_2 from groupbox within w_cn770_cntbl_rpt_balance_general
end type
end forward
...
integer width = 4443
integer height = 2020
string title = "(CN770) Balance General - Contable"
...
global w_cn770_cntbl_rpt_balance_general w_cn770_cntbl_rpt_balance_general

on w_cn770_cntbl_rpt_balance_general.create
int iCurrent
call super::create
...
on w_cn770_cntbl_rpt_balance_general.destroy
call super::destroy
...
if isnull(ln_mes_hasta) or ln_mes_hasta = 0 then
	MessageBox('Aviso','Debe seleccionar mes de proceso')
	return
end if

if ln_mes_desde > ln_mes_hasta then
	MessageBox('Aviso','Rango de meses no es correcto, Verifique')
	return
end if

SetPointer(hourglass!)
  
DECLARE pb_usp_cntbl_rpt_balance PROCEDURE FOR USP_CNTBL_RPT_BALANCE
        ( :ln_mes_desde, :ln_mes_hasta, :ln_ano, :ls_moneda, :ln_nivel ) ;
Execute pb_usp_cntbl_rpt_balance ;
...
type ole_skin from w_report_smpl`ole_skin within w_cn770_cntbl_rpt_balance_general
integer x = 4119
integer y = 76
end type

type uo_h from w_report_smpl`uo_h within w_cn770_cntbl_rpt_balance_general
end type

type st_box from w_report_smpl`st_box within w_cn770_cntbl_rpt_balance_general
end type

type uo_filter from w_report_smpl`uo_filter within w_cn770_cntbl_rpt_balance_general
boolean visible = false
boolean enabled = false
end type

type st_filtro from w_report_smpl`st_filtro within w_cn770_cntbl_rpt_balance_general
boolean visible = false
boolean enabled = false
end type

type dw_report from w_report_smpl`dw_report within w_cn770_cntbl_rpt_balance_general
integer y = 360
integer width = 3291
integer height = 1116
integer taborder = 70
string dataobject = "d_rpt_balance_general_tbl"
end type
