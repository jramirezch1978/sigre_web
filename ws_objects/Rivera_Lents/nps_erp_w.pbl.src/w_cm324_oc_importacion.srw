...
type p_pie from w_abc`p_pie within w_cm324_oc_importacion
integer x = 279
integer y = 1252
end type

type ole_skin from w_abc`ole_skin within w_cm324_oc_importacion
end type

type uo_h from w_abc`uo_h within w_cm324_oc_importacion
end type

type st_box from w_abc`st_box within w_cm324_oc_importacion
integer height = 1748
end type

type phl_logonps from w_abc`phl_logonps within w_cm324_oc_importacion
end type

type p_mundi from w_abc`p_mundi within w_cm324_oc_importacion
end type

type p_logo from w_abc`p_logo within w_cm324_oc_importacion
integer x = 2295
end type
