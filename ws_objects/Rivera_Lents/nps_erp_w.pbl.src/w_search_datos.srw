...
type ole_skin from w_abc_master_smpl`ole_skin within w_search_datos
end type

type st_filter from w_abc_master_smpl`st_filter within w_search_datos
end type

type uo_filter from w_abc_master_smpl`uo_filter within w_search_datos
boolean visible = false
boolean enabled = false
end type

type st_box from w_abc_master_smpl`st_box within w_search_datos
boolean visible = false
end type

type uo_h from w_abc_master_smpl`uo_h within w_search_datos
boolean visible = false
boolean enabled = false
end type
