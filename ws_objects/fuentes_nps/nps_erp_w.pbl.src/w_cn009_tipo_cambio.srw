...
type p_pie from w_abc_master`p_pie within w_cn009_tipo_cambio
end type

type ole_skin from w_abc_master`ole_skin within w_cn009_tipo_cambio
end type

type uo_h from w_abc_master`uo_h within w_cn009_tipo_cambio
end type

type st_box from w_abc_master`st_box within w_cn009_tipo_cambio
end type

type phl_logonps from w_abc_master`phl_logonps within w_cn009_tipo_cambio
end type

type p_mundi from w_abc_master`p_mundi within w_cn009_tipo_cambio
end type

type p_logo from w_abc_master`p_logo within w_cn009_tipo_cambio
end type

type st_filter from w_abc_master`st_filter within w_cn009_tipo_cambio
boolean visible = false
boolean enabled = false
end type

type uo_filter from w_abc_master`uo_filter within w_cn009_tipo_cambio
boolean visible = false
integer y = 160
boolean enabled = false
end type
...
event dw_master::ue_insert_pre;call super::ue_insert_pre;this.SetItem(al_row, 'fecha', gnvo_app.id_fecha)
