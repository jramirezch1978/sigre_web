$PBExportHeader$w_sg070_grp_obj.srw
forward
global type w_sg070_grp_obj from w_abc_list_new
end type
type gb_1 from groupbox within w_sg070_grp_obj
end type
type ddlb_1 from u_ddlb within w_sg070_grp_obj
end type
type st_1 from statictext within w_sg070_grp_obj
end type
type cbx_can from checkbox within w_sg070_grp_obj
end type
type cbx_anu from checkbox within w_sg070_grp_obj
end type
type cbx_con from checkbox within w_sg070_grp_obj
end type
type cbx_mod from checkbox within w_sg070_grp_obj
end type
type cbx_eli from checkbox within w_sg070_grp_obj
end type
type cbx_ins from checkbox within w_sg070_grp_obj
end type
end forward
...
integer width = 3662
integer height = 2228
string title = "Mantenimiento de Objetos Asignados x Rol  (SG5010)"
...
global w_sg070_grp_obj w_sg070_grp_obj

type variables

end variables

on w_sg070_grp_obj.create
int iCurrent
call super::create
...
type p_pie from w_abc_list_new`p_pie within w_sg070_grp_obj
end type

type ole_skin from w_abc_list_new`ole_skin within w_sg070_grp_obj
end type

type dw_1 from w_abc_list_new`dw_1 within w_sg070_grp_obj
integer x = 0
integer y = 292
integer width = 1769
integer height = 1312
string dataobject = "d_obj_no_grp"
...
type dw_2 from w_abc_list_new`dw_2 within w_sg070_grp_obj
integer x = 1957
integer y = 292
integer width = 1646
integer height = 1312
...
event dw_2::ue_insert_pre;call super::ue_insert_pre;Long ll_row
Any la_id
...
type pb_1 from w_abc_list_new`pb_1 within w_sg070_grp_obj
integer x = 1792
integer y = 640
string text = "  >"
end type

type pb_2 from w_abc_list_new`pb_2 within w_sg070_grp_obj
integer x = 1792
integer y = 1048
integer taborder = 30
end type
...
type uo_h from w_abc_list_new`uo_h within w_sg070_grp_obj
end type

type st_box from w_abc_list_new`st_box within w_sg070_grp_obj
end type

type phl_logonps from w_abc_list_new`phl_logonps within w_sg070_grp_obj
end type

type p_mundi from w_abc_list_new`p_mundi within w_sg070_grp_obj
end type

type p_logo from w_abc_list_new`p_logo within w_sg070_grp_obj
end type

type st_filter from w_abc_list_new`st_filter within w_sg070_grp_obj
end type

type uo_filter from w_abc_list_new`uo_filter within w_sg070_grp_obj
end type
...
event ue_output;call super::ue_output;dw_1.Retrieve(aa_key)
