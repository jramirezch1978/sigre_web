...
DECLARE pb_usp_cntbl_rpt_gyp_funcion PROCEDURE FOR USP_CNTBL_RPT_GYP_FUNCION
        ( :ln_mes_desde, :ln_mes_hasta, :ln_ano, :ls_moneda, :ln_nivel ) ;
Execute pb_usp_cntbl_rpt_gyp_funcion ;
...
type ole_skin from w_report_smpl`ole_skin within w_cn771_cntbl_rpt_gyp_funcion
end type

type uo_h from w_report_smpl`uo_h within w_cn771_cntbl_rpt_gyp_funcion
integer height = 156
end type

type st_box from w_report_smpl`st_box within w_cn771_cntbl_rpt_gyp_funcion
end type

type uo_filter from w_report_smpl`uo_filter within w_cn771_cntbl_rpt_gyp_funcion
boolean visible = false
boolean enabled = false
end type

type st_filtro from w_report_smpl`st_filtro within w_cn771_cntbl_rpt_gyp_funcion
boolean visible = false
boolean enabled = false
end type
