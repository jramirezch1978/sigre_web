...
integer width = 3314
integer height = 1696
string title = "[CM311] Formato de orden de compra "
...
type p_pie from w_rpt`p_pie within w_cm305_programa_compras_frm
end type

type ole_skin from w_rpt`ole_skin within w_cm305_programa_compras_frm
end type

type uo_h from w_rpt`uo_h within w_cm305_programa_compras_frm
end type

type st_box from w_rpt`st_box within w_cm305_programa_compras_frm
end type

type phl_logonps from w_rpt`phl_logonps within w_cm305_programa_compras_frm
end type

type p_mundi from w_rpt`p_mundi within w_cm305_programa_compras_frm
end type

type p_logo from w_rpt`p_logo within w_cm305_programa_compras_frm
end type
