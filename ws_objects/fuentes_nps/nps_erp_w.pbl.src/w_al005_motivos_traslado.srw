...
type p_pie from w_abc_master_smpl`p_pie within w_al005_motivos_traslado
end type

type ole_skin from w_abc_master_smpl`ole_skin within w_al005_motivos_traslado
end type

type uo_h from w_abc_master_smpl`uo_h within w_al005_motivos_traslado
end type

type st_box from w_abc_master_smpl`st_box within w_al005_motivos_traslado
end type

type phl_logonps from w_abc_master_smpl`phl_logonps within w_al005_motivos_traslado
end type

type p_mundi from w_abc_master_smpl`p_mundi within w_al005_motivos_traslado
end type

type p_logo from w_abc_master_smpl`p_logo within w_al005_motivos_traslado
end type

type st_filter from w_abc_master_smpl`st_filter within w_al005_motivos_traslado
end type

type uo_filter from w_abc_master_smpl`uo_filter within w_al005_motivos_traslado
end type
