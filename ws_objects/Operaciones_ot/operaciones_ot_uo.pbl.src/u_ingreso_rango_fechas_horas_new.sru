$PBExportHeader$u_ingreso_rango_fechas_horas_new.sru
$PBExportComments$Custom Object para ingreso de un rango de fechas
forward
global type u_ingreso_rango_fechas_horas_new from userobject
end type
type cb_1 from commandbutton within u_ingreso_rango_fechas_horas_new
end type
type em_1 from editmask within u_ingreso_rango_fechas_horas_new
end type
type em_2 from editmask within u_ingreso_rango_fechas_horas_new
end type
type cb_2 from commandbutton within u_ingreso_rango_fechas_horas_new
end type
end forward
...
global u_ingreso_rango_fechas_horas_new u_ingreso_rango_fechas_horas_new
...
on u_ingreso_rango_fechas_horas_new.create
...
on u_ingreso_rango_fechas_horas_new.destroy
destroy(this.cb_1)
destroy(this.em_1)
destroy(this.em_2)
destroy(this.cb_2)
