$PBExportHeader$operaciones.sra
$PBExportComments$Generated Application Object
forward
global type operaciones from application
end type
...
String  	gs_estacion, gs_user, gs_help, gs_origen, gs_empresa, gs_logo, gs_sistema, &
			gs_ruc, gs_esquema,gs_lpp, gs_inifile, gs_db, gs_firma_digital
...
string appicon = "C:\SIGRE\resources\ICO\ot.ico"
...
global operaciones operaciones

type prototypes

end prototypes

on operaciones.create
appname="operaciones"
...
gnvo_almacen = CREATE n_cst_almacen
...
// Parametros
gs_inifile    = "\sigre_exe\oper_ot.ini"
