$PBExportHeader$w_ope016_incidencias.srw
forward
global type w_ope016_incidencias from w_abc_master_smpl
end type
end forward
...
integer width = 3118
integer height = 1612
string title = "Maestro de incidencias (OPE016)"
string menuname = "m_master_sin_lista"
end type
global w_ope016_incidencias w_ope016_incidencias

on w_ope016_incidencias.create
call super::create
if this.MenuName = "m_master_sin_lista" then this.MenuID = create m_master_sin_lista
end on

on w_ope016_incidencias.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_ope016_incidencias
integer x = 0
integer y = 0
integer width = 3063
integer height = 1308
