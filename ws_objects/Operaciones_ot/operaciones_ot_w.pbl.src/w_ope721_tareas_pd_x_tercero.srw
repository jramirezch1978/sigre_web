$PBExportHeader$w_ope721_tareas_pd_x_tercero.srw
forward
global type w_ope721_tareas_pd_x_tercero from w_rpt_list
end type
type uo_1 from u_ingreso_rango_fechas within w_ope721_tareas_pd_x_tercero
end type
type dw_text from datawindow within w_ope721_tareas_pd_x_tercero
end type
type pb_3 from picturebutton within w_ope721_tareas_pd_x_tercero
end type
type st_campo from statictext within w_ope721_tareas_pd_x_tercero
end type
type gb_1 from groupbox within w_ope721_tareas_pd_x_tercero
end type
end forward
...
integer width = 3305
integer height = 1984
string title = "Tareas de terceros por campo (ope721)"
...
global w_ope721_tareas_pd_x_tercero w_ope721_tareas_pd_x_tercero
...
on w_ope721_tareas_pd_x_tercero.create
int iCurrent
call super::create
...
on w_ope721_tareas_pd_x_tercero.destroy
call super::destroy
...
DECLARE pb_usp_ope_labor_proveed_campo PROCEDURE FOR usp_ope_labor_proveed_campo
        ( :ld_fec_ini, :ld_fec_fin ) ;
Execute pb_usp_ope_labor_proveed_campo ;
...
type dw_report from w_rpt_list`dw_report within w_ope721_tareas_pd_x_tercero
boolean visible = false
integer x = 87
integer y = 436
integer width = 3154
string dataobject = "d_rpt_tareas_tercero_campo_tbl"
end type

type dw_1 from w_rpt_list`dw_1 within w_ope721_tareas_pd_x_tercero
integer x = 64
integer y = 336
integer width = 1307
integer height = 1476
...
type pb_1 from w_rpt_list`pb_1 within w_ope721_tareas_pd_x_tercero
integer x = 1403
integer y = 724
end type

type pb_2 from w_rpt_list`pb_2 within w_ope721_tareas_pd_x_tercero
integer x = 1403
integer y = 1048
end type

type dw_2 from w_rpt_list`dw_2 within w_ope721_tareas_pd_x_tercero
integer x = 1577
integer y = 336
integer width = 1307
integer height = 1480
...
type cb_report from w_rpt_list`cb_report within w_ope721_tareas_pd_x_tercero
integer x = 2953
integer y = 68
integer width = 293
string text = "Generar"
