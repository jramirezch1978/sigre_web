$PBExportHeader$w_ope025_aut_cencos.srw
forward
global type w_ope025_aut_cencos from w_abc_master_smpl
end type
end forward
...
integer width = 1371
integer height = 1576
string title = "Autorizaciones de Solic. de Orden de Trabajo por Centro Costo (OPE025)"
string menuname = "m_master_sin_lista"
boolean minbox = false
boolean maxbox = false
end type
global w_ope025_aut_cencos w_ope025_aut_cencos

on w_ope025_aut_cencos.create
call super::create
if this.MenuName = "m_master_sin_lista" then this.MenuID = create m_master_sin_lista
end on

on w_ope025_aut_cencos.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_ope025_aut_cencos
integer width = 1298
integer height = 1332
