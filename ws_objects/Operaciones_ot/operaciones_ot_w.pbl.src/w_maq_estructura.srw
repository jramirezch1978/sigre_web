...
event ue_salir();sg_parametros_est  lstr_param
...
if Message.PowerObjectParm.ClassName() <> 'sg_parametros' then
	MessageBox('Aviso', 'Parametros Incorrectos no son del tipo SG_PARAMETROS')
	close(this)
end if
...
integer width = 1010
integer height = 464
string dataobject = "d_maq_estructura_ff"
end type
