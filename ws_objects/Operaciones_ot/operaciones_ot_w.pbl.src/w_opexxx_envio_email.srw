$PBExportHeader$w_opexxx_envio_email.srw
forward
global type w_opexxx_envio_email from window
end type
type pb_2 from picturebutton within w_opexxx_envio_email
end type
type p_1 from picture within w_opexxx_envio_email
end type
type st_4 from statictext within w_opexxx_envio_email
end type
type sle_para from singlelineedit within w_opexxx_envio_email
end type
type st_3 from statictext within w_opexxx_envio_email
end type
type st_2 from statictext within w_opexxx_envio_email
end type
type sle_asunto from singlelineedit within w_opexxx_envio_email
end type
type st_1 from statictext within w_opexxx_envio_email
end type
type mle_mensaje from multilineedit within w_opexxx_envio_email
end type
type pb_1 from picturebutton within w_opexxx_envio_email
end type
type gb_1 from groupbox within w_opexxx_envio_email
end type
end forward
...
string title = "Envio Correo Elec"
...
global w_opexxx_envio_email w_opexxx_envio_email

on w_opexxx_envio_email.create
...
on w_opexxx_envio_email.destroy
destroy(this.pb_2)
destroy(this.p_1)
destroy(this.st_4)
