$PBExportHeader$w_ope764_costo_actividad.srw
forward
global type w_ope764_costo_actividad from w_report_smpl
end type
type cb_1 from commandbutton within w_ope764_costo_actividad
end type
type uo_1 from u_ingreso_fecha within w_ope764_costo_actividad
end type
type st_1 from statictext within w_ope764_costo_actividad
end type
type sle_producto from singlelineedit within w_ope764_costo_actividad
end type
type cb_2 from commandbutton within w_ope764_costo_actividad
end type
type sle_desc_producto from singlelineedit within w_ope764_costo_actividad
end type
type cbx_1 from checkbox within w_ope764_costo_actividad
end type
type gb_1 from groupbox within w_ope764_costo_actividad
end type
end forward
...
global w_ope764_costo_actividad w_ope764_costo_actividad

on w_ope764_costo_actividad.create
int iCurrent
call super::create
...
on w_ope764_costo_actividad.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ope764_costo_actividad
integer x = 27
integer y = 456
integer width = 3109
integer height = 1284
string dataobject = "d_rpt_productividad_x_costo_actividad_tb"
end type
...
ls_fecha = String(ld_fecha,'yyyymmdd')
...
dw_report.retrieve(ld_fecha,ldc_tasa_cambio,ls_prod)
