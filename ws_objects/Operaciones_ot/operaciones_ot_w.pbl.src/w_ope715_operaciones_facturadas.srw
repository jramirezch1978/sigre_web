$PBExportHeader$w_ope715_operaciones_facturadas.srw
forward
global type w_ope715_operaciones_facturadas from w_rpt
end type
type uo_1 from u_ingreso_rango_fechas within w_ope715_operaciones_facturadas
end type
type cb_2 from commandbutton within w_ope715_operaciones_facturadas
end type
type sle_descripcion from singlelineedit within w_ope715_operaciones_facturadas
end type
type cb_1 from commandbutton within w_ope715_operaciones_facturadas
end type
type sle_ot from singlelineedit within w_ope715_operaciones_facturadas
end type
type st_1 from statictext within w_ope715_operaciones_facturadas
end type
type dw_report from u_dw_rpt within w_ope715_operaciones_facturadas
end type
end forward
...
integer width = 2930
integer height = 1648
string title = "Operaciones facturadas (OPE715)"
...
global w_ope715_operaciones_facturadas w_ope715_operaciones_facturadas

on w_ope715_operaciones_facturadas.create
int iCurrent
call super::create
...
on w_ope715_operaciones_facturadas.destroy
call super::destroy
...
integer width = 1426
integer height = 704
string dataobject = "d_operac_facturadas_tbl"
