$PBExportHeader$w_ope762_productividad_trabajador.srw
forward
global type w_ope762_productividad_trabajador from w_report_smpl
end type
type cb_1 from commandbutton within w_ope762_productividad_trabajador
end type
type uo_1 from u_ingreso_rango_fechas within w_ope762_productividad_trabajador
end type
type cbx_trabajador from checkbox within w_ope762_productividad_trabajador
end type
type st_nombre from statictext within w_ope762_productividad_trabajador
end type
type pb_1 from picturebutton within w_ope762_productividad_trabajador
end type
type sle_trabajador from singlelineedit within w_ope762_productividad_trabajador
end type
type st_1 from statictext within w_ope762_productividad_trabajador
end type
type gb_1 from groupbox within w_ope762_productividad_trabajador
end type
end forward
...
integer width = 3214
integer height = 1948
string title = "(OPE762) Productividad x Trabajador (Costo)"
...
global w_ope762_productividad_trabajador w_ope762_productividad_trabajador

on w_ope762_productividad_trabajador.create
int iCurrent
call super::create
...
on w_ope762_productividad_trabajador.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ope762_productividad_trabajador
integer x = 27
integer y = 456
integer width = 3109
integer height = 1284
