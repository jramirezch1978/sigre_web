$PBExportHeader$w_ope707_material_planeado.srw
forward
global type w_ope707_material_planeado from w_report_smpl
end type
type sle_codigo from singlelineedit within w_ope707_material_planeado
end type
type rb_cc from radiobutton within w_ope707_material_planeado
end type
type rb_ej from radiobutton within w_ope707_material_planeado
end type
type sle_nombre from singlelineedit within w_ope707_material_planeado
end type
type uo_1 from u_ingreso_rango_fechas within w_ope707_material_planeado
end type
type cb_3 from commandbutton within w_ope707_material_planeado
end type
type pb_1 from picturebutton within w_ope707_material_planeado
end type
type gb_1 from groupbox within w_ope707_material_planeado
end type
end forward
...
integer width = 3269
integer height = 1356
string title = "Materiales planeado (ope707)"
...
global w_ope707_material_planeado w_ope707_material_planeado

on w_ope707_material_planeado.create
int iCurrent
call super::create
...
on w_ope707_material_planeado.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ope707_material_planeado
integer x = 50
integer y = 428
integer width = 3145
integer height = 784
...
IF rb_cc.checked=true then
	idw_1.DataObject='d_rpt_artic_planeados_x_cc_rsp_tbl'
	idw_1.SetTransObject(sqlca)
	idw_1.retrieve(ls_codigo, ld_fec_ini, ld_fec_fin)
ELSEIF rb_ej.checked=true then
	idw_1.DataObject='d_rpt_artic_planeados_tbl'
	idw_1.SetTransObject(sqlca)
