$PBExportHeader$w_ope020_labores_x_tipo_maquina.srw
forward
global type w_ope020_labores_x_tipo_maquina from w_abc_mastdet_smpl
end type
type st_2 from statictext within w_ope020_labores_x_tipo_maquina
end type
type st_campo from statictext within w_ope020_labores_x_tipo_maquina
end type
type dw_1 from datawindow within w_ope020_labores_x_tipo_maquina
end type
end forward
...
integer width = 2505
integer height = 2132
string title = "Costo de labor por tipo de máquina (OPE020)"
string menuname = "m_master_sin_lista"
st_2 st_2
st_campo st_campo
dw_1 dw_1
end type
global w_ope020_labores_x_tipo_maquina w_ope020_labores_x_tipo_maquina
...
on w_ope020_labores_x_tipo_maquina.create
int iCurrent
call super::create
...
on w_ope020_labores_x_tipo_maquina.destroy
call super::destroy
...
ls_protect=dw_detail.Describe("cod_labor.protect")
IF ls_protect='0' THEN
   dw_detail.of_column_protect("cod_labor")
END IF
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_ope020_labores_x_tipo_maquina
integer x = 0
integer y = 188
integer width = 2085
integer height = 992
string dataobject = "d_lista_tipo_maquina_tbl"
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_ope020_labores_x_tipo_maquina
integer x = 0
integer y = 1304
integer width = 2427
integer height = 576
string dataobject = "d_costo_labor_x_tipo_maq_tbl"
boolean vscrollbar = true
boolean livescroll = false
end type
...
CHOOSE CASE dwo.name
	 CASE 'cod_labor'
			...
			IF lstr_seleccionar.s_action = "aceptar" THEN
				...
				Setitem(row,'labor_desc_labor',lstr_seleccionar.param2[1])
...
string text = "Costo de labores por tipo de máquina"
