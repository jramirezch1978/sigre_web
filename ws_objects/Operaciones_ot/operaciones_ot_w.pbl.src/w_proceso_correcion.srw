$PBExportHeader$w_proceso_correcion.srw
forward
global type w_proceso_correcion from w_abc
end type
type cb_2 from commandbutton within w_proceso_correcion
end type
type sle_prov from singlelineedit within w_proceso_correcion
end type
type st_prov from statictext within w_proceso_correcion
end type
type st_1 from statictext within w_proceso_correcion
end type
type cb_prov from commandbutton within w_proceso_correcion
end type
type uo_1 from u_ingreso_rango_fechas within w_proceso_correcion
end type
type dw_master from u_dw_abc within w_proceso_correcion
end type
type gb_1 from groupbox within w_proceso_correcion
end type
end forward
...
integer width = 3067
integer height = 1504
string title = "Correción de Facturación de Operaciones"
...
global w_proceso_correcion w_proceso_correcion

on w_proceso_correcion.create
int iCurrent
call super::create
...
this.Control[iCurrent+3]=this.st_prov
this.Control[iCurrent+4]=this.st_1
this.Control[iCurrent+5]=this.cb_prov
this.Control[iCurrent+6]=this.uo_1
this.Control[iCurrent+7]=this.dw_master
this.Control[iCurrent+8]=this.gb_1
end on

on w_proceso_correcion.destroy
call super::destroy
