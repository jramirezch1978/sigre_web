$PBExportHeader$w_ope706_oper_plan_x_cc_rsp.srw
forward
global type w_ope706_oper_plan_x_cc_rsp from w_report_smpl
end type
type sle_codigo from singlelineedit within w_ope706_oper_plan_x_cc_rsp
end type
type rb_cc from radiobutton within w_ope706_oper_plan_x_cc_rsp
end type
type rb_ej from radiobutton within w_ope706_oper_plan_x_cc_rsp
end type
type sle_nombre from singlelineedit within w_ope706_oper_plan_x_cc_rsp
end type
type uo_1 from u_ingreso_rango_fechas within w_ope706_oper_plan_x_cc_rsp
end type
type cb_3 from commandbutton within w_ope706_oper_plan_x_cc_rsp
end type
type pb_1 from picturebutton within w_ope706_oper_plan_x_cc_rsp
end type
type gb_1 from groupbox within w_ope706_oper_plan_x_cc_rsp
end type
end forward
...
integer width = 3269
integer height = 1428
string title = "Operaciones Proyectadas talleres (ope706)"
...
global w_ope706_oper_plan_x_cc_rsp w_ope706_oper_plan_x_cc_rsp

on w_ope706_oper_plan_x_cc_rsp.create
int iCurrent
call super::create
...
on w_ope706_oper_plan_x_cc_rsp.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ope706_oper_plan_x_cc_rsp
integer x = 50
integer y = 428
integer width = 3145
integer height = 784
...
IF rb_cc.checked=true then
	idw_1.DataObject='d_rpt_operac_proy_x_cc_rsp_tbl'
ELSEIF rb_ej.checked=true then
	idw_1.DataObject='d_rpt_operac_proy_x_ejecutor_tbl'
