$PBExportHeader$w_ope750_saldos_libres.srw
forward
global type w_ope750_saldos_libres from w_report_smpl
end type
type sle_codigo from singlelineedit within w_ope750_saldos_libres
end type
type rb_gen from radiobutton within w_ope750_saldos_libres
end type
type rb_maq from radiobutton within w_ope750_saldos_libres
end type
type sle_nombre from singlelineedit within w_ope750_saldos_libres
end type
type cb_3 from commandbutton within w_ope750_saldos_libres
end type
type pb_1 from picturebutton within w_ope750_saldos_libres
end type
type rb_ot_adm from radiobutton within w_ope750_saldos_libres
end type
type rb_ot from radiobutton within w_ope750_saldos_libres
end type
type gb_1 from groupbox within w_ope750_saldos_libres
end type
end forward
...
integer width = 3269
integer height = 2040
string title = "Saldos libres requerimeinto (OPE750)"
...
global w_ope750_saldos_libres w_ope750_saldos_libres

on w_ope750_saldos_libres.create
int iCurrent
call super::create
...
on w_ope750_saldos_libres.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ope750_saldos_libres
integer x = 50
integer y = 396
integer width = 3145
integer height = 1272
