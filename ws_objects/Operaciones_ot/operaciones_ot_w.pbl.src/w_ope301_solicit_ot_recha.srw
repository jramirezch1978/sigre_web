$PBExportHeader$w_ope301_solicit_ot_recha.srw
forward
global type w_ope301_solicit_ot_recha from window
end type
type dw_1 from datawindow within w_ope301_solicit_ot_recha
end type
type cb_1 from commandbutton within w_ope301_solicit_ot_recha
end type
type sle_respuesta from singlelineedit within w_ope301_solicit_ot_recha
end type
type st_1 from statictext within w_ope301_solicit_ot_recha
end type
end forward
...
global w_ope301_solicit_ot_recha w_ope301_solicit_ot_recha
...
ll_row_master    = w_ope301_solicit_ot.dw_master.GetRow()
ls_nro_solicitud = w_ope301_solicit_ot.dw_master.GetItemString( ll_row_master, 'nro_solicitud')
...
ll_row_master = w_ope301_solicit_ot.dw_master.GetRow()
w_ope301_solicit_ot.dw_master.SetItem( ll_row_master, 'respuesta', sle_respuesta.Text )
w_ope301_solicit_ot.dw_master.SetItem( ll_row_master, 'flag_estado', '3' )
w_ope301_solicit_ot.dw_master.ii_update = 1
dw_1.Retrieve( ls_nro_solicitud )
...
on w_ope301_solicit_ot_recha.create
...
on w_ope301_solicit_ot_recha.destroy
destroy(this.dw_1)
destroy(this.cb_1)
...
event clicked;String ls_archivo, ls_email, ls_cencos_slc
mailSession mSes
mailReturnCode mRet
mailMessage mMsg
...
close ( w_ope301_solicit_ot_recha )
end event
