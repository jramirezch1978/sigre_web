$PBExportHeader$w_ope708_material_program_det.srw
forward
global type w_ope708_material_program_det from w_report_smpl
end type
type sle_codigo from singlelineedit within w_ope708_material_program_det
end type
type rb_ccr from radiobutton within w_ope708_material_program_det
end type
type rb_fec from radiobutton within w_ope708_material_program_det
end type
type sle_nombre from singlelineedit within w_ope708_material_program_det
end type
type uo_1 from u_ingreso_rango_fechas within w_ope708_material_program_det
end type
type cb_3 from commandbutton within w_ope708_material_program_det
end type
type pb_1 from picturebutton within w_ope708_material_program_det
end type
type rb_eje from radiobutton within w_ope708_material_program_det
end type
type rb_ota from radiobutton within w_ope708_material_program_det
end type
type gb_1 from groupbox within w_ope708_material_program_det
end type
end forward
...
integer width = 3269
integer height = 1356
string title = "Materiales programados detalle (ope708)"
...
global w_ope708_material_program_det w_ope708_material_program_det

on w_ope708_material_program_det.create
int iCurrent
call super::create
...
on w_ope708_material_program_det.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ope708_material_program_det
integer x = 50
integer y = 464
integer width = 3145
integer height = 748
...
event clicked;String ls_codigo, ls_tipo, ls_msj
...
IF rb_ccr.checked=true then
	ls_tipo = 'C'
	idw_1.DataObject='d_rpt_prog_mat_cencos_tbl'
ELSEIF rb_eje.checked=true then
	ls_tipo = 'E'
	idw_1.DataObject='d_rpt_prog_mat_ejecutor_tbl'
ELSEIF rb_ota.checked=true then
	ls_tipo = 'O'
	idw_1.DataObject='d_rpt_prog_mat_ot_adm_tbl'
ELSEIF rb_fec.checked=true then
	ls_tipo = 'F'
	idw_1.DataObject='d_rpt_prog_mat_fecha_tbl'
END IF

DECLARE PB_USP_OPE_MATERIAL_PROG_PROY PROCEDURE FOR USP_OPE_MATERIAL_PROG_PROY
		  ( 'P', :ls_tipo, :ls_codigo, :ld_fec_ini, :ld_fec_fin ) ;
