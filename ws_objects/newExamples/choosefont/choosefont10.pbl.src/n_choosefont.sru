$PBExportHeader$n_choosefont.sru
forward
...
Integer li_Underline, li_Italic, li_Strikeout
Long ll_LogFont
...
choose case lstr_LogFont.lfitalic_lfunderline
	case 1
		iItalic = True
		iUnderline = False
	case 256
...
iStrikeout = (lstr_LogFont.lfstrikeout_lfcharset > 0)
