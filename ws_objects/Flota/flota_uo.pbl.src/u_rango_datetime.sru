$PBExportHeader$u_rango_datetime.sru
$PBExportComments$Custom Object para ingreso de un rango de fechas
forward
global type u_rango_datetime from userobject
end type
type cb_1 from commandbutton within u_rango_datetime
end type
type em_1 from editmask within u_rango_datetime
end type
type em_2 from editmask within u_rango_datetime
end type
type cb_2 from commandbutton within u_rango_datetime
end type
end forward
...
global u_rango_datetime u_rango_datetime
...
event constructor;// of_set_label('Desde:','Hasta:') //para setear la fecha inicial
