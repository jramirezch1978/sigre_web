$PBExportHeader$w_fl039_conceptos_flota.srw
forward
global type w_fl039_conceptos_flota from w_abc_master_smpl
end type
end forward
...
integer width = 2469
integer height = 1052
string title = "Aportaciones y descuentos para Tripulantes (FL039)"
string menuname = "m_mto_smpl"
boolean maxbox = false
boolean resizable = false
long backcolor = 67108864
end type
global w_fl039_conceptos_flota w_fl039_conceptos_flota

on w_fl039_conceptos_flota.create
call super::create
if this.MenuName = "m_mto_smpl" then this.MenuID = create m_mto_smpl
end on

on w_fl039_conceptos_flota.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_fl039_conceptos_flota
event ue_display ( string as_columna,  long al_row )
integer width = 2423
integer height = 824
string dataobject = "d_abc_conceptos_flota_tbl"
end type
...
this.object.flag_declarar_cbssp 	[al_row] = '0'
this.object.ratio						[al_row] = 0
this.object.flag_porc_importe		[al_row] = 'P'
