$PBExportHeader$w_fl712_compr_egre_trip.srw
forward
global type w_fl712_compr_egre_trip from w_rpt
end type
type cb_1 from commandbutton within w_fl712_compr_egre_trip
end type
type em_ano from editmask within w_fl712_compr_egre_trip
end type
type em_mes from editmask within w_fl712_compr_egre_trip
end type
type st_3 from statictext within w_fl712_compr_egre_trip
end type
type st_2 from statictext within w_fl712_compr_egre_trip
end type
type dw_report from u_dw_rpt within w_fl712_compr_egre_trip
end type
end forward
...
integer width = 2962
integer height = 3652
string title = "Comprobantes de Egreso Tripulantes (FL712)"
...
global w_fl712_compr_egre_trip w_fl712_compr_egre_trip

type variables
uo_parte_pesca iuo_parte
end variables

on w_fl712_compr_egre_trip.create
int iCurrent
call super::create
...
on w_fl712_compr_egre_trip.destroy
call super::destroy
...
integer height = 1524
integer taborder = 70
string dataobject = "d_rpt_comprob_egreso_tbl"
