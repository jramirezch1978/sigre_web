$PBExportHeader$w_fl029_num_posib_arribo.srw
forward
global type w_fl029_num_posib_arribo from w_abc_master_smpl
end type
end forward
...
integer width = 1326
integer height = 408
string title = "Num. Posibles Arribos (FL029)"
...
global w_fl029_num_posib_arribo w_fl029_num_posib_arribo

on w_fl029_num_posib_arribo.create
call super::create
if this.MenuName = "m_mto_smpl" then this.MenuID = create m_mto_smpl
end on

on w_fl029_num_posib_arribo.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_fl029_num_posib_arribo
integer x = 0
integer y = 0
integer width = 1271
integer height = 192
string dataobject = "d_num_posib_arribos_ff"
