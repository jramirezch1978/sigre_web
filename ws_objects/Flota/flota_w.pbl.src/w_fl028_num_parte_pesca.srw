$PBExportHeader$w_fl028_num_parte_pesca.srw
forward
global type w_fl028_num_parte_pesca from w_abc_master_smpl
end type
end forward
...
integer width = 1326
integer height = 408
string title = "Numerador de Parte de Pesca (FL028)"
...
global w_fl028_num_parte_pesca w_fl028_num_parte_pesca

on w_fl028_num_parte_pesca.create
call super::create
if this.MenuName = "m_mto_smpl" then this.MenuID = create m_mto_smpl
end on

on w_fl028_num_parte_pesca.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_fl028_num_parte_pesca
integer x = 0
integer y = 0
integer width = 1271
integer height = 192
string dataobject = "d_num_parte_pesca_ff"
