$PBExportHeader$w_fl915_anular_asiento_trip.srw
forward
global type w_fl915_anular_asiento_trip from w_abc_master_smpl
end type
type cb_1 from commandbutton within w_fl915_anular_asiento_trip
end type
type em_ano from editmask within w_fl915_anular_asiento_trip
end type
type em_mes from editmask within w_fl915_anular_asiento_trip
end type
type st_3 from statictext within w_fl915_anular_asiento_trip
end type
type st_2 from statictext within w_fl915_anular_asiento_trip
end type
type hpb_1 from hprogressbar within w_fl915_anular_asiento_trip
end type
type cb_2 from commandbutton within w_fl915_anular_asiento_trip
end type
end forward
...
integer width = 3237
integer height = 1980
string title = "Anular Asientos de Bonific. de Tripulantes (FL915)"
...
global w_fl915_anular_asiento_trip w_fl915_anular_asiento_trip
...
on w_fl915_anular_asiento_trip.create
int iCurrent
call super::create
...
on w_fl915_anular_asiento_trip.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_fl915_anular_asiento_trip
event ue_display ( string as_columna,  long al_row )
integer x = 0
integer y = 224
integer width = 2693
integer height = 1112
string dataobject = "d_abc_anular_asiento_trip_tbl"
end type
