$PBExportHeader$w_fl520_venta_mp.srw
forward
global type w_fl520_venta_mp from w_rpt
end type
type rb_1 from radiobutton within w_fl520_venta_mp
end type
type rb_2 from radiobutton within w_fl520_venta_mp
end type
type dw_report from u_dw_rpt within w_fl520_venta_mp
end type
type uo_fecha from u_ingreso_rango_fechas within w_fl520_venta_mp
end type
type pb_recuperar from u_pb_std within w_fl520_venta_mp
end type
end forward
...
integer width = 2226
integer height = 1872
string title = "Venta de Materia Prima Por Cliente (FL511)"
...
global w_fl520_venta_mp w_fl520_venta_mp
...
dw_report.object.gr_1.Title = "Venta Materia Prima - Flota Propia: " &
...
event close;call super::close;destroy im_graph
end event
...
integer height = 1464
integer taborder = 60
string dataobject = "d_venta_mp_cliente_graph"
end type
...
event rbuttondown;call super::rbuttondown;im_graph.PopMenu(w_main.PointerX(), w_main.PointerY())
end event
