$PBExportHeader$w_fl723_rpt_diario_arribos.srw
forward
global type w_fl723_rpt_diario_arribos from w_rpt
end type
type uo_fecha from u_ingreso_rango_fechas within w_fl723_rpt_diario_arribos
end type
type cb_1 from commandbutton within w_fl723_rpt_diario_arribos
end type
type dw_report from u_dw_rpt within w_fl723_rpt_diario_arribos
end type
end forward
...
integer width = 2656
integer height = 2392
string title = "Reporte Diario de Arribos (FL723)"
...
global w_fl723_rpt_diario_arribos w_fl723_rpt_diario_arribos
...
on w_fl723_rpt_diario_arribos.create
int iCurrent
call super::create
...
on w_fl723_rpt_diario_arribos.destroy
call super::destroy
...
integer height = 1464
integer taborder = 60
string dataobject = "d_rpt_diario_arribo_pesca"
