$PBExportHeader$w_fl916_gen_asiento_adm.srw
forward
global type w_fl916_gen_asiento_adm from w_abc_master_smpl
end type
type cb_1 from commandbutton within w_fl916_gen_asiento_adm
end type
type em_ano from editmask within w_fl916_gen_asiento_adm
end type
type em_mes from editmask within w_fl916_gen_asiento_adm
end type
type st_3 from statictext within w_fl916_gen_asiento_adm
end type
type st_2 from statictext within w_fl916_gen_asiento_adm
end type
type hpb_1 from hprogressbar within w_fl916_gen_asiento_adm
end type
type cb_2 from commandbutton within w_fl916_gen_asiento_adm
end type
end forward
...
integer width = 3163
integer height = 1620
string title = "Asientos de Incentivos de Administrativos  (FL916)"
...
global w_fl916_gen_asiento_adm w_fl916_gen_asiento_adm
...
on w_fl916_gen_asiento_adm.create
int iCurrent
call super::create
...
on w_fl916_gen_asiento_adm.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_fl916_gen_asiento_adm
event ue_display ( string as_columna,  long al_row )
integer x = 0
integer y = 224
integer width = 2693
integer height = 1112
string dataobject = "d_abc_gen_asiento_adm_tbl"
end type
