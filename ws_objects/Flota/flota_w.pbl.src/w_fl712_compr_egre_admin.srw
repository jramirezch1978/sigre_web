$PBExportHeader$w_fl712_compr_egre_admin.srw
forward
global type w_fl712_compr_egre_admin from w_rpt
end type
type cb_1 from commandbutton within w_fl712_compr_egre_admin
end type
type em_ano from editmask within w_fl712_compr_egre_admin
end type
type em_mes from editmask within w_fl712_compr_egre_admin
end type
type st_3 from statictext within w_fl712_compr_egre_admin
end type
type st_2 from statictext within w_fl712_compr_egre_admin
end type
type dw_report from u_dw_rpt within w_fl712_compr_egre_admin
end type
end forward
...
global w_fl712_compr_egre_admin w_fl712_compr_egre_admin

type variables
uo_parte_pesca iuo_parte
end variables

on w_fl712_compr_egre_admin.create
int iCurrent
call super::create
...
on w_fl712_compr_egre_admin.destroy
call super::destroy
