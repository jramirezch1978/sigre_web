$PBExportHeader$w_fl314_asist_anterior.srw
forward
global type w_fl314_asist_anterior from w_abc
end type
type cb_copiar from commandbutton within w_fl314_asist_anterior
end type
type st_2 from statictext within w_fl314_asist_anterior
end type
type st_1 from statictext within w_fl314_asist_anterior
end type
type dw_1 from u_dw_abc within w_fl314_asist_anterior
end type
type dw_2 from u_dw_abc within w_fl314_asist_anterior
end type
end forward
...
integer width = 2231
integer height = 1672
string title = "Asistencias Anteriores (FL314)"
...
global w_fl314_asist_anterior w_fl314_asist_anterior
...
on w_fl314_asist_anterior.create
int iCurrent
call super::create
...
on w_fl314_asist_anterior.destroy
call super::destroy
...
event clicked;date ld_destino[], ld_origen
long ll_x
boolean lb_result
...
ld_origen = Date(dw_2.object.fecha[ll_x])

for ll_x =1 to dw_1.RowCount()
	ld_destino[ll_x] = Date(dw_1.object.fecha[ll_x])
next

lb_result = iuo_asistencia.of_copy_asist( ld_origen, ld_destino, is_nave )
...
string text = "Asistencias Anteriores"
...
integer width = 1065
integer height = 1228
string dataobject = "d_asist_anterior_grid"
boolean vscrollbar = true
end type
