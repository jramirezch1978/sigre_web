$PBExportHeader$w_fl706_declar_jurada_sem.srw
forward
global type w_fl706_declar_jurada_sem from w_rpt
end type
type em_ano from editmask within w_fl706_declar_jurada_sem
end type
type em_semana from editmask within w_fl706_declar_jurada_sem
end type
type st_3 from statictext within w_fl706_declar_jurada_sem
end type
type st_2 from statictext within w_fl706_declar_jurada_sem
end type
type dw_report from u_dw_rpt within w_fl706_declar_jurada_sem
end type
type sle_nave from singlelineedit within w_fl706_declar_jurada_sem
end type
type st_1 from statictext within w_fl706_declar_jurada_sem
end type
type st_nomb_nave from statictext within w_fl706_declar_jurada_sem
end type
type pb_recuperar from u_pb_std within w_fl706_declar_jurada_sem
end type
end forward
...
integer width = 2528
integer height = 2032
string title = "Declaracion Jurada Semanal (FL706)"
...
global w_fl706_declar_jurada_sem w_fl706_declar_jurada_sem

type variables
uo_parte_pesca iuo_parte
end variables

on w_fl706_declar_jurada_sem.create
int iCurrent
call super::create
...
on w_fl706_declar_jurada_sem.destroy
call super::destroy
...
string ls_nave, ls_mensaje, ls_ruc, ls_empresa
...
//create or replace procedure USP_FL_DLJUR_SEM(
...
DECLARE USP_FL_DLJUR_SEM PROCEDURE FOR
	USP_FL_DLJUR_SEM( :ls_nave, :li_semana, :li_ano );

EXECUTE USP_FL_DLJUR_SEM;

IF SQLCA.sqlcode = -1 THEN
	ls_mensaje = "PROCEDURE USP_FL_DLJUR_SEM: " + SQLCA.SQLErrText
	Rollback ;
	MessageBox('SQL error', ls_mensaje, StopSign!)	
	return
END IF

FETCH USP_FL_DLJUR_SEM INTO :ls_mensaje, :li_ok;
CLOSE USP_FL_DLJUR_SEM;

if li_ok <> 1 then
	MessageBox('Error USP_FL_DLJUR_SEM', ls_mensaje, StopSign!)	
	return
end if
...
idw_1.object.Datos.text = ls_empresa + ' R.U.C.: ' + ls_ruc
idw_1.Retrieve()
...
integer height = 1524
integer taborder = 70
string dataobject = "d_rpt_asistencia_trip_composite"
