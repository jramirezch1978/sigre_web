$PBExportHeader$w_fl512_eficiencia_cala.srw
forward
global type w_fl512_eficiencia_cala from w_report_smpl
end type
type st_1 from statictext within w_fl512_eficiencia_cala
end type
type ddlb_ano_inicio from u_ddlb within w_fl512_eficiencia_cala
end type
type ddlb_mes_inicio from u_ddlb within w_fl512_eficiencia_cala
end type
type st_2 from statictext within w_fl512_eficiencia_cala
end type
type ddlb_ano_fin from u_ddlb within w_fl512_eficiencia_cala
end type
type ddlb_mes_fin from u_ddlb within w_fl512_eficiencia_cala
end type
end forward
...
integer width = 2400
integer height = 1352
string title = "Eficiencia de Calas (FL512)"
...
global w_fl512_eficiencia_cala w_fl512_eficiencia_cala

event ue_copiar();dw_report.Clipboard("gr_1")

end event

on w_fl512_eficiencia_cala.create
int iCurrent
call super::create
...
on w_fl512_eficiencia_cala.destroy
call super::destroy
...
ll_perinicio = long(trim(ddlb_ano_inicio.text)+left(trim(ddlb_mes_inicio.text),2))
ll_perfin = long(trim(ddlb_ano_fin.text) + left(trim(ddlb_mes_fin.text),2))
...
dw_report.object.gr_1.title = Upper('Eficiencia de calas de la flota propia para el periodo '+ls_inicio+' - '+ls_fin)

dw_report.Object.p_1.filename = gs_logo
end event

type dw_report from w_report_smpl`dw_report within w_fl512_eficiencia_cala
integer x = 0
integer y = 200
integer width = 2327
integer height = 908
string dataobject = "d_eficiencia_cala_grf"
end type
