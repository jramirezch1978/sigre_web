$PBExportHeader$w_fl710_pesca_periodo.srw
forward
global type w_fl710_pesca_periodo from w_rpt
end type
type uo_fecha from u_ingreso_rango_fechas within w_fl710_pesca_periodo
end type
type cb_1 from commandbutton within w_fl710_pesca_periodo
end type
type dw_report from u_dw_rpt within w_fl710_pesca_periodo
end type
end forward
...
integer width = 2299
integer height = 2212
string title = "Resumen Pesca x Periodo (FL710)"
...
global w_fl710_pesca_periodo w_fl710_pesca_periodo
...
on w_fl710_pesca_periodo.create
int iCurrent
call super::create
...
on w_fl710_pesca_periodo.destroy
call super::destroy
...
integer height = 1464
integer taborder = 60
string dataobject = "d_rpt_pesca_periodo_composite"
