$PBExportHeader$w_fl501_buscar_arribo.srw
forward
global type w_fl501_buscar_arribo from window
end type
type st_nomb_nave from statictext within w_fl501_buscar_arribo
end type
type st_1 from statictext within w_fl501_buscar_arribo
end type
type sle_nave from singlelineedit within w_fl501_buscar_arribo
end type
type dw_master from u_dw_abc within w_fl501_buscar_arribo
end type
type cb_2 from commandbutton within w_fl501_buscar_arribo
end type
type cb_1 from commandbutton within w_fl501_buscar_arribo
end type
end forward
...
global w_fl501_buscar_arribo w_fl501_buscar_arribo
...
on w_fl501_buscar_arribo.create
...
on w_fl501_buscar_arribo.destroy
...
integer width = 2350
integer height = 920
string dataobject = "d_buscar_arribo_grid"
end type
