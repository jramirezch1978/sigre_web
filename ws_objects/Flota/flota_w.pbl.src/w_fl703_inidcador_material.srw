$PBExportHeader$w_fl703_inidcador_material.srw
forward
global type w_fl703_inidcador_material from w_report_smpl
end type
type ddlb_articulo from u_ddlb within w_fl703_inidcador_material
end type
type st_1 from statictext within w_fl703_inidcador_material
end type
type st_2 from statictext within w_fl703_inidcador_material
end type
type ddlb_ano from u_ddlb within w_fl703_inidcador_material
end type
type st_3 from statictext within w_fl703_inidcador_material
end type
type ddlb_ini from u_ddlb within w_fl703_inidcador_material
end type
type st_4 from statictext within w_fl703_inidcador_material
end type
type ddlb_fin from u_ddlb within w_fl703_inidcador_material
end type
type st_status from statictext within w_fl703_inidcador_material
end type
end forward
...
global w_fl703_inidcador_material w_fl703_inidcador_material

on w_fl703_inidcador_material.create
int iCurrent
call super::create
...
on w_fl703_inidcador_material.destroy
call super::destroy
...
declare usp_fl_ind_material procedure for
	usp_fl_ind_material(:li_tipo, :ls_inicio,:ls_fin, :ls_cod_art);

execute usp_fl_ind_material;

fetch usp_fl_ind_material into :li_cuenta;

idw_1.Retrieve()

close usp_fl_ind_material;
commit;
...
type dw_report from w_report_smpl`dw_report within w_fl703_inidcador_material
integer y = 148
integer width = 3406
integer height = 1548
...
event ue_output;call super::ue_output;dw_report.Retrieve()
end event
