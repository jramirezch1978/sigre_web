$PBExportHeader$w_fl519_compara_pesca.srw
forward
global type w_fl519_compara_pesca from w_report_smpl
end type
type st_1 from statictext within w_fl519_compara_pesca
end type
type ddlb_ano_inicio from u_ddlb within w_fl519_compara_pesca
end type
type ddlb_mes_inicio from u_ddlb within w_fl519_compara_pesca
end type
type st_2 from statictext within w_fl519_compara_pesca
end type
type ddlb_ano_fin from u_ddlb within w_fl519_compara_pesca
end type
type ddlb_mes_fin from u_ddlb within w_fl519_compara_pesca
end type
end forward
...
global w_fl519_compara_pesca w_fl519_compara_pesca

event ue_copiar();dw_report.Clipboard("gr_1")

end event

on w_fl519_compara_pesca.create
int iCurrent
call super::create
...
on w_fl519_compara_pesca.destroy
call super::destroy
...
dw_report.object.gr_1.title = Upper('proyecciones de pesca para flota propia, para el periodo '+ls_inicio+ls_fin)

dw_report.Object.p_1.filename = gs_logo
end event

type dw_report from w_report_smpl`dw_report within w_fl519_compara_pesca
integer x = 0
integer y = 200
integer width = 2327
integer height = 908
string dataobject = "d_pesca_compara_grf"
end type
...
event ue_open_pre;call super::ue_open_pre;is_dataobject = 'd_pesca_proy_ano'
...
event ue_open_pre;call super::ue_open_pre;is_dataobject = 'd_pesca_proy_mes'
ii_cn1 = 1                     // Nro del campo 1
...
ll_rows = ids_Data.Retrieve(long(trim(ddlb_ano_inicio.text)))
