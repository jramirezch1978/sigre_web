$PBExportHeader$w_fi740_rpt_cartera_pagos.srw
forward
global type w_fi740_rpt_cartera_pagos from w_rpt
end type
type uo_fechas from u_ingreso_rango_fechas within w_fi740_rpt_cartera_pagos
end type
type cb_2 from commandbutton within w_fi740_rpt_cartera_pagos
end type
type dw_report from u_dw_rpt within w_fi740_rpt_cartera_pagos
end type
type cb_reporte from commandbutton within w_fi740_rpt_cartera_pagos
end type
type gb_1 from groupbox within w_fi740_rpt_cartera_pagos
end type
end forward
...
integer width = 3589
integer height = 1364
string title = "[FI740] Detalle de Cartera de Pagos"
...
global w_fi740_rpt_cartera_pagos w_fi740_rpt_cartera_pagos

on w_fi740_rpt_cartera_pagos.create
int iCurrent
call super::create
...
on w_fi740_rpt_cartera_pagos.destroy
call super::destroy
...
integer height = 800
integer taborder = 20
string dataobject = "d_rpt_cartera_pagos_tbl"
end type
