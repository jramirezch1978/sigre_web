$PBExportHeader$w_fi742_rpt_cartera_cobros.srw
forward
global type w_fi742_rpt_cartera_cobros from w_rpt
end type
type uo_fechas from u_ingreso_rango_fechas within w_fi742_rpt_cartera_cobros
end type
type cb_2 from commandbutton within w_fi742_rpt_cartera_cobros
end type
type dw_report from u_dw_rpt within w_fi742_rpt_cartera_cobros
end type
type cb_reporte from commandbutton within w_fi742_rpt_cartera_cobros
end type
type gb_1 from groupbox within w_fi742_rpt_cartera_cobros
end type
end forward
...
integer width = 3589
integer height = 1364
string title = "[FI742] Detalle de Cartera de Cobros"
...
global w_fi742_rpt_cartera_cobros w_fi742_rpt_cartera_cobros

on w_fi742_rpt_cartera_cobros.create
int iCurrent
call super::create
...
on w_fi742_rpt_cartera_cobros.destroy
call super::destroy
...
integer height = 800
integer taborder = 20
string dataobject = "d_rpt_cartera_cobros_tbl"
end type
