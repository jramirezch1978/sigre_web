$PBExportHeader$w_fi507_cns_cntas_x_cobrar_x_venc.srw
forward
global type w_fi507_cns_cntas_x_cobrar_x_venc from w_cns
end type
type cbx_cli from checkbox within w_fi507_cns_cntas_x_cobrar_x_venc
end type
type cb_2 from commandbutton within w_fi507_cns_cntas_x_cobrar_x_venc
end type
type cb_1 from commandbutton within w_fi507_cns_cntas_x_cobrar_x_venc
end type
type dw_1 from datawindow within w_fi507_cns_cntas_x_cobrar_x_venc
end type
type gb_1 from groupbox within w_fi507_cns_cntas_x_cobrar_x_venc
end type
type dw_cns from u_dw_cns within w_fi507_cns_cntas_x_cobrar_x_venc
end type
end forward
...
global w_fi507_cns_cntas_x_cobrar_x_venc w_fi507_cns_cntas_x_cobrar_x_venc

event ue_saveas();
dw_cns.Event ue_saveas()
end event

on w_fi507_cns_cntas_x_cobrar_x_venc.create
int iCurrent
call super::create
...
on w_fi507_cns_cntas_x_cobrar_x_venc.destroy
call super::destroy
