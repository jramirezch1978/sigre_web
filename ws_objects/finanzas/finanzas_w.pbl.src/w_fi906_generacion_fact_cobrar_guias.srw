$PBExportHeader$w_fi906_generacion_fact_cobrar_guias.srw
forward
global type w_fi906_generacion_fact_cobrar_guias from w_rpt
end type
type dw_report from u_dw_rpt within w_fi906_generacion_fact_cobrar_guias
end type
end forward
...
integer width = 914
integer height = 912
string title = "[FI905] Reporte de Guias a Facturar"
string menuname = "m_reporte_filter"
long backcolor = 67108864
dw_report dw_report
end type
global w_fi906_generacion_fact_cobrar_guias w_fi906_generacion_fact_cobrar_guias
...
on w_fi906_generacion_fact_cobrar_guias.create
int iCurrent
call super::create
...
on w_fi906_generacion_fact_cobrar_guias.destroy
call super::destroy
