$PBExportHeader$w_fi026_tipo_deuda_financiera.srw
forward
global type w_fi026_tipo_deuda_financiera from w_abc
end type
type dw_master from u_dw_abc within w_fi026_tipo_deuda_financiera
end type
end forward
...
integer width = 3945
integer height = 992
string title = "Tipos de Deuda Financiera (FI026)"
string menuname = "m_mantenimiento_sl"
dw_master dw_master
end type
global w_fi026_tipo_deuda_financiera w_fi026_tipo_deuda_financiera

on w_fi026_tipo_deuda_financiera.create
int iCurrent
call super::create
...
on w_fi026_tipo_deuda_financiera.destroy
call super::destroy
...
integer width = 3826
integer height = 764
string dataobject = "d_abc_tipo_deuda_financiera_tbl"
