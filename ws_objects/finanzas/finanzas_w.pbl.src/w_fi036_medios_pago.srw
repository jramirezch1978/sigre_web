$PBExportHeader$w_fi036_medios_pago.srw
forward
global type w_fi036_medios_pago from w_abc
end type
type dw_master from u_dw_abc within w_fi036_medios_pago
end type
end forward
...
integer width = 3072
integer height = 1372
string title = "[FI036] Medios de PAGO"
string menuname = "m_mantenimiento_sl"
dw_master dw_master
end type
global w_fi036_medios_pago w_fi036_medios_pago

on w_fi036_medios_pago.create
int iCurrent
call super::create
...
on w_fi036_medios_pago.destroy
call super::destroy
...
integer width = 3003
integer height = 800
string dataobject = "d_abc_medios_pago_tbl"
end type
...
event ue_insert_pre;call super::ue_insert_pre;this.object.flag_mercado 	[al_row] = 'L'
