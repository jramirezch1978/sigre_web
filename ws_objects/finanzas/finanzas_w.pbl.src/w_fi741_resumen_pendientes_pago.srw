$PBExportHeader$w_fi741_resumen_pendientes_pago.srw
forward
global type w_fi741_resumen_pendientes_pago from w_rpt
end type
type cbx_origenes from checkbox within w_fi741_resumen_pendientes_pago
end type
type cb_3 from commandbutton within w_fi741_resumen_pendientes_pago
end type
type sle_origen from singlelineedit within w_fi741_resumen_pendientes_pago
end type
type st_2 from statictext within w_fi741_resumen_pendientes_pago
end type
type uo_1 from u_ingreso_rango_fechas within w_fi741_resumen_pendientes_pago
end type
type cb_1 from commandbutton within w_fi741_resumen_pendientes_pago
end type
type dw_report from u_dw_rpt within w_fi741_resumen_pendientes_pago
end type
type gb_1 from groupbox within w_fi741_resumen_pendientes_pago
end type
end forward
...
integer width = 3799
integer height = 2404
string title = "[FI741] Resumen Pendientes de Pago"
...
global w_fi741_resumen_pendientes_pago w_fi741_resumen_pendientes_pago

on w_fi741_resumen_pendientes_pago.create
int iCurrent
call super::create
...
on w_fi741_resumen_pendientes_pago.destroy
call super::destroy
...
integer width = 3310
integer height = 1748
string dataobject = "d_rpt_resumen_pendientes_pago_tbl"
