...
integer width = 3433
integer height = 1936
string title = "Documento por Pagar Directo"
...
event ue_retrieve;call super::ue_retrieve;Integer	li_print_size
//istr_1.arg[1],istr_1.arg[2],gs_empresa,gs_user,istr_1.arg[3]

// Verifica el tipo de doc  cml

IF istr_1.arg[2] = istr_1.arg[5] THEN
	//El documento es una planilla de gastos de movilidad
	li_print_size 		= gnvo_app.of_get_print_size( )
	
	if li_print_size < 0 then 
		event post close()
		return
	end if
	...
	idw_1.dataobject = 'd_rpt_planilla_gastos_movilidad_tbl'
	idw_1.SetTransObject( SQLCA)
	...
	//Si ha elegido un tamaño pequeño entonces lo imprimo pequeño
	if li_print_size = 1 then
		//TAmaño ala mitad
		idw_1.Object.DataWindow.Print.Paper.Size 			= 256 
		idw_1.Object.DataWindow.Print.CustomPage.Width 	= 210
		idw_1.Object.DataWindow.Print.CustomPage.Length = 148
...
ELSE
	...
	idw_1.SetTransObject( SQLCA)
	idw_1.Retrieve(istr_1.arg[1],istr_1.arg[2],istr_1.arg[3],istr_1.arg[4],gs_empresa)
	idw_1.object.p_logo.filename 		= gs_logo
END IF
