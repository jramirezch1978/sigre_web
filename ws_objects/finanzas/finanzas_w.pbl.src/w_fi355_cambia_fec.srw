$PBExportHeader$w_fi355_cambia_fec.srw
forward
global type w_fi355_cambia_fec from w_abc_master
end type
type em_tipo_doc from editmask within w_fi355_cambia_fec
end type
type em_nro_doc from editmask within w_fi355_cambia_fec
end type
type st_1 from statictext within w_fi355_cambia_fec
end type
type cb_1 from commandbutton within w_fi355_cambia_fec
end type
end forward
...
integer width = 2949
integer height = 900
string title = "FI355 Cambio de fecha de presentación"
...
global w_fi355_cambia_fec w_fi355_cambia_fec

on w_fi355_cambia_fec.create
int iCurrent
call super::create
...
type dw_master from w_abc_master`dw_master within w_fi355_cambia_fec
integer x = 18
integer y = 172
integer width = 2848
integer height = 520
