$PBExportHeader$w_fi905_generacion_fact_cobrar.srw
forward
global type w_fi905_generacion_fact_cobrar from w_prc
end type
type sle_desc_forma_pago from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type pb_4 from picturebutton within w_fi905_generacion_fact_cobrar
end type
type sle_forma_pago from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type st_6 from statictext within w_fi905_generacion_fact_cobrar
end type
type cb_1 from commandbutton within w_fi905_generacion_fact_cobrar
end type
type uo_1 from u_ingreso_rango_fechas within w_fi905_generacion_fact_cobrar
end type
type pb_3 from picturebutton within w_fi905_generacion_fact_cobrar
end type
type st_5 from statictext within w_fi905_generacion_fact_cobrar
end type
type sle_origen from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type sle_desc_movimiento from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type sle_movimiento from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type st_4 from statictext within w_fi905_generacion_fact_cobrar
end type
type em_fecha from n_ingreso_fecha within w_fi905_generacion_fact_cobrar
end type
type st_3 from statictext within w_fi905_generacion_fact_cobrar
end type
type sle_desc_factura from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type pb_2 from picturebutton within w_fi905_generacion_fact_cobrar
end type
type sle_factura from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type st_2 from statictext within w_fi905_generacion_fact_cobrar
end type
type sle_desc_boleta from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type pb_1 from picturebutton within w_fi905_generacion_fact_cobrar
end type
type sle_boleta from singlelineedit within w_fi905_generacion_fact_cobrar
end type
type st_1 from statictext within w_fi905_generacion_fact_cobrar
end type
type cb_procesar from commandbutton within w_fi905_generacion_fact_cobrar
end type
type gb_1 from groupbox within w_fi905_generacion_fact_cobrar
end type
type gb_2 from groupbox within w_fi905_generacion_fact_cobrar
end type
end forward
...
integer width = 2130
integer height = 1336
string title = "[FI905] Generacion de Facturas de Materiales"
...
global w_fi905_generacion_fact_cobrar w_fi905_generacion_fact_cobrar

type variables
string is_cod_boleta, is_cod_factura
end variables

on w_fi905_generacion_fact_cobrar.create
int iCurrent
call super::create
...
on w_fi905_generacion_fact_cobrar.destroy
call super::destroy
...
opensheetwithparm(w_fi906_generacion_fact_cobrar_guias, sgt_parametros, parent, 0 , Layered! )
end event
