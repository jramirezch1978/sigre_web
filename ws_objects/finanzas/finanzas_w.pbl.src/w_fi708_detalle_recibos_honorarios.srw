$PBExportHeader$w_fi708_detalle_recibos_honorarios.srw
forward
global type w_fi708_detalle_recibos_honorarios from w_rpt
end type
type cbx_origenes from checkbox within w_fi708_detalle_recibos_honorarios
end type
type cb_3 from commandbutton within w_fi708_detalle_recibos_honorarios
end type
type sle_origen from singlelineedit within w_fi708_detalle_recibos_honorarios
end type
type st_2 from statictext within w_fi708_detalle_recibos_honorarios
end type
type uo_1 from u_ingreso_rango_fechas within w_fi708_detalle_recibos_honorarios
end type
type cb_1 from commandbutton within w_fi708_detalle_recibos_honorarios
end type
type dw_report from u_dw_rpt within w_fi708_detalle_recibos_honorarios
end type
type gb_1 from groupbox within w_fi708_detalle_recibos_honorarios
end type
end forward
...
integer width = 3799
integer height = 2404
string title = "[FI708] Detalle de Recibo por honorarios"
...
global w_fi708_detalle_recibos_honorarios w_fi708_detalle_recibos_honorarios

on w_fi708_detalle_recibos_honorarios.create
int iCurrent
call super::create
...
on w_fi708_detalle_recibos_honorarios.destroy
call super::destroy
...
integer width = 3310
integer height = 1748
string dataobject = "d_rpt_detalle_recibos_honorarios_tbl"
