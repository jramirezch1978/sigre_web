$PBExportHeader$w_fi027_concepto_deuda.srw
forward
global type w_fi027_concepto_deuda from w_abc
end type
type dw_master from u_dw_abc within w_fi027_concepto_deuda
end type
end forward
...
integer width = 2309
integer height = 992
string title = "Conceptos de Deuda Financiera (FI027)"
string menuname = "m_mantenimiento_sl"
dw_master dw_master
end type
global w_fi027_concepto_deuda w_fi027_concepto_deuda

on w_fi027_concepto_deuda.create
int iCurrent
call super::create
...
on w_fi027_concepto_deuda.destroy
call super::destroy
...
integer width = 2245
integer height = 764
string dataobject = "d_abc_deuda_concepto_tbl"
