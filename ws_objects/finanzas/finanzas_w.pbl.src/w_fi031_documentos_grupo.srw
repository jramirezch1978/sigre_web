$PBExportHeader$w_fi031_documentos_grupo.srw
forward
global type w_fi031_documentos_grupo from w_abc
end type
type dw_detail from u_dw_abc within w_fi031_documentos_grupo
end type
type dw_master from u_dw_abc within w_fi031_documentos_grupo
end type
end forward
...
integer width = 2949
integer height = 2512
string title = "[FI031] Grupos y relacion con tipos de documentos"
string menuname = "m_mantenimiento_sl"
dw_detail dw_detail
dw_master dw_master
end type
global w_fi031_documentos_grupo w_fi031_documentos_grupo

on w_fi031_documentos_grupo.create
int iCurrent
call super::create
...
on w_fi031_documentos_grupo.destroy
call super::destroy
