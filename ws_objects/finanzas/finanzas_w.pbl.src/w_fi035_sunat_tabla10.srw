$PBExportHeader$w_fi035_sunat_tabla10.srw
forward
global type w_fi035_sunat_tabla10 from w_abc_master_smpl
end type
end forward
...
integer width = 3803
integer height = 1616
string title = "[FI035] Documentos de SUNAT (Tabla 10)"
string menuname = "m_mantenimiento_sl"
end type
global w_fi035_sunat_tabla10 w_fi035_sunat_tabla10

on w_fi035_sunat_tabla10.create
call super::create
if this.MenuName = "m_mantenimiento_sl" then this.MenuID = create m_mantenimiento_sl
end on

on w_fi035_sunat_tabla10.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_fi035_sunat_tabla10
event ue_display ( string as_columna,  long al_row )
integer width = 3630
integer height = 1224
string dataobject = "d_abc_sunat_tabla10_tbl"
end type
...
CHOOSE CASE dwo.name
	...
	CASE 'cod_sunat'
			...
			IF SQLCA.SQLCode = 100 THEN
				Messagebox('Error','CODIGO de Tipo de Documento de SUNAT no existe o no esta activo, por favor verifique!')
