$PBExportHeader$w_fi729_inf_sunat.srw
forward
global type w_fi729_inf_sunat from w_rpt
end type
type cbx_1 from checkbox within w_fi729_inf_sunat
end type
type st_3 from statictext within w_fi729_inf_sunat
end type
type cb_2 from commandbutton within w_fi729_inf_sunat
end type
type sle_origen from singlelineedit within w_fi729_inf_sunat
end type
type sle_desc from singlelineedit within w_fi729_inf_sunat
end type
type ddlb_mes from dropdownlistbox within w_fi729_inf_sunat
end type
type st_2 from statictext within w_fi729_inf_sunat
end type
type st_1 from statictext within w_fi729_inf_sunat
end type
type em_ano from editmask within w_fi729_inf_sunat
end type
type cb_1 from commandbutton within w_fi729_inf_sunat
end type
type dw_report from u_dw_rpt within w_fi729_inf_sunat
end type
type gb_1 from groupbox within w_fi729_inf_sunat
end type
end forward
...
integer width = 3438
integer height = 2060
string title = "Registros de Compras y Pagos (FI729)"
...
global w_fi729_inf_sunat w_fi729_inf_sunat
...
DECLARE PB_usp_fin_rpt_sunat PROCEDURE FOR usp_fin_rpt_sunat
(:ll_ano,:ll_mes,:ls_origen);
EXECUTE PB_usp_fin_rpt_sunat ;
...
integer width = 3355
integer height = 1400
string dataobject = "d_rpt_sunat_pagos_tbl"
