$PBExportHeader$w_fi914_cierre_documentos.srw
forward
global type w_fi914_cierre_documentos from w_report_smpl
end type
end forward

global type w_fi914_cierre_documentos from w_report_smpl
integer height = 1120
string title = "[FI914] Cierre de Documentos de Cntas x Pagar"
string menuname = "m_impresion"
end type
global w_fi914_cierre_documentos w_fi914_cierre_documentos
...
on w_fi914_cierre_documentos.create
call super::create
if this.MenuName = "m_impresion" then this.MenuID = create m_impresion
end on

on w_fi914_cierre_documentos.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_report from w_report_smpl`dw_report within w_fi914_cierre_documentos
string dataobject = "d_abc_cerrar_docs_tbl"
end type
