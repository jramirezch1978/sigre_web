...
dw_1.InsertRow(0)
dw_1.object.ano [1] = Integer(string(gnvo_app.of_fecha_actual(), 'yyyy'))
dw_1.object.mes [1] = Integer(string(gnvo_app.of_fecha_actual(), 'mm'))
...
ll_ano = Long(dw_1.object.ano [1])
ll_mes = Long(dw_1.object.mes [1])
...
IF Isnull(ll_mes) THEN
	Messagebox('Aviso','Debe Ingresar Un Mes A Procesar')
	Return
END IF	
...
IF SQLCA.SQLCode = -1 THEN 
	ls_mensaje = 'PROCEDURE USP_FIN_RPT_CB_DETALLE: ' + SQLCA.SQLErrText
	ROLLBACK;
...
dw_report.retrieve(ll_ano,ll_mes,gs_empresa,gs_user)
