$PBExportHeader$u_ingreso_rango_fechas_horas_local.sru
$PBExportComments$Custom Object para ingreso de un rango de fechas
forward
global type u_ingreso_rango_fechas_horas_local from userobject
end type
type cb_1 from commandbutton within u_ingreso_rango_fechas_horas_local
end type
type em_1 from editmask within u_ingreso_rango_fechas_horas_local
end type
type em_2 from editmask within u_ingreso_rango_fechas_horas_local
end type
type cb_2 from commandbutton within u_ingreso_rango_fechas_horas_local
end type
end forward
...
global u_ingreso_rango_fechas_horas_local u_ingreso_rango_fechas_horas_local
...
on u_ingreso_rango_fechas_horas_local.create
...
on u_ingreso_rango_fechas_horas_local.destroy
destroy(this.cb_1)
destroy(this.em_1)
destroy(this.em_2)
destroy(this.cb_2)
