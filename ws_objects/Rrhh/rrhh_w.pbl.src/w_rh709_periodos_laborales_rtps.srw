$PBExportHeader$w_rh709_periodos_laborales_rtps.srw
forward
global type w_rh709_periodos_laborales_rtps from w_rpt
end type
type st_nro_reg from statictext within w_rh709_periodos_laborales_rtps
end type
type st_3 from statictext within w_rh709_periodos_laborales_rtps
end type
type pb_1 from picturebutton within w_rh709_periodos_laborales_rtps
end type
type dw_origen from u_dw_abc within w_rh709_periodos_laborales_rtps
end type
type st_ext from statictext within w_rh709_periodos_laborales_rtps
end type
type sle_file from singlelineedit within w_rh709_periodos_laborales_rtps
end type
type dw_report from u_dw_rpt within w_rh709_periodos_laborales_rtps
end type
type gb_1 from groupbox within w_rh709_periodos_laborales_rtps
end type
end forward
...
integer width = 3227
integer height = 1336
string title = "[RH709] Datos de Periodos Laborales"
...
global w_rh709_periodos_laborales_rtps w_rh709_periodos_laborales_rtps
...
on w_rh709_periodos_laborales_rtps.create
int iCurrent
call super::create
...
this.Control[iCurrent+6]=this.sle_file
this.Control[iCurrent+7]=this.dw_report
this.Control[iCurrent+8]=this.gb_1
end on

on w_rh709_periodos_laborales_rtps.destroy
call super::destroy
...
integer width = 3095
integer height = 660
string dataobject = "dw_rpt_periodos_laborales_text_rtps"
