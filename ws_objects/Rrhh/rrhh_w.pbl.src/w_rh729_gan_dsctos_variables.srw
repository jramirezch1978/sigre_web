$PBExportHeader$w_rh729_gan_dsctos_variables.srw
forward
global type w_rh729_gan_dsctos_variables from w_report_smpl
end type
type cb_3 from commandbutton within w_rh729_gan_dsctos_variables
end type
type em_descripcion from editmask within w_rh729_gan_dsctos_variables
end type
type em_origen from editmask within w_rh729_gan_dsctos_variables
end type
type em_desc_tipo from editmask within w_rh729_gan_dsctos_variables
end type
type em_tipo from editmask within w_rh729_gan_dsctos_variables
end type
type cb_2 from commandbutton within w_rh729_gan_dsctos_variables
end type
type cb_1 from commandbutton within w_rh729_gan_dsctos_variables
end type
type cb_4 from commandbutton within w_rh729_gan_dsctos_variables
end type
type em_desc_concep from editmask within w_rh729_gan_dsctos_variables
end type
type em_concepto from editmask within w_rh729_gan_dsctos_variables
end type
type em_fec_proceso from editmask within w_rh729_gan_dsctos_variables
end type
type st_1 from statictext within w_rh729_gan_dsctos_variables
end type
type gb_2 from groupbox within w_rh729_gan_dsctos_variables
end type
type gb_3 from groupbox within w_rh729_gan_dsctos_variables
end type
type gb_1 from groupbox within w_rh729_gan_dsctos_variables
end type
end forward
...
integer width = 4233
integer height = 1500
string title = "(RH729) Ganancias y Descuentos Variables por Concepto"
...
global w_rh729_gan_dsctos_variables w_rh729_gan_dsctos_variables

on w_rh729_gan_dsctos_variables.create
int iCurrent
call super::create
...
on w_rh729_gan_dsctos_variables.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_rh729_gan_dsctos_variables
integer x = 0
integer y = 188
integer width = 3561
integer height = 1036
integer taborder = 60
string dataobject = "d_rpt_gan_dsctos_variable_tbl"
end type
