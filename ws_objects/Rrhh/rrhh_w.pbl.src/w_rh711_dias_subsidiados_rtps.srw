$PBExportHeader$w_rh711_dias_subsidiados_rtps.srw
forward
global type w_rh711_dias_subsidiados_rtps from w_rpt
end type
type st_nro_form from statictext within w_rh711_dias_subsidiados_rtps
end type
type st_4 from statictext within w_rh711_dias_subsidiados_rtps
end type
type em_year from editmask within w_rh711_dias_subsidiados_rtps
end type
type em_mes from editmask within w_rh711_dias_subsidiados_rtps
end type
type st_1 from statictext within w_rh711_dias_subsidiados_rtps
end type
type st_2 from statictext within w_rh711_dias_subsidiados_rtps
end type
type pb_1 from picturebutton within w_rh711_dias_subsidiados_rtps
end type
type st_3 from statictext within w_rh711_dias_subsidiados_rtps
end type
type st_nro_reg from statictext within w_rh711_dias_subsidiados_rtps
end type
type sle_ruc from singlelineedit within w_rh711_dias_subsidiados_rtps
end type
type st_ext from statictext within w_rh711_dias_subsidiados_rtps
end type
type dw_origen from u_dw_abc within w_rh711_dias_subsidiados_rtps
end type
type dw_report from u_dw_rpt within w_rh711_dias_subsidiados_rtps
end type
type gb_1 from groupbox within w_rh711_dias_subsidiados_rtps
end type
end forward
...
integer width = 3227
integer height = 1740
string title = "[RH711] Dias Subsidiados del Trabajador"
...
global w_rh711_dias_subsidiados_rtps w_rh711_dias_subsidiados_rtps
...
on w_rh711_dias_subsidiados_rtps.create
int iCurrent
call super::create
...
on w_rh711_dias_subsidiados_rtps.destroy
call super::destroy
...
sle_ruc.text = trim(st_nro_form.text) + Trim(String(li_year, '0000')) + &
...
integer width = 3095
integer height = 1032
string dataobject = "dw_rpt_dias_subsidiados_text_rtps"
