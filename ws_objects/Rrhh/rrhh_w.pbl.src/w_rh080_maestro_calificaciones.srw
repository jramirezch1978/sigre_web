$PBExportHeader$w_rh080_maestro_calificaciones.srw
forward
global type w_rh080_maestro_calificaciones from w_abc
end type
type dw_master from u_dw_abc within w_rh080_maestro_calificaciones
end type
end forward
...
integer width = 2149
integer height = 900
string title = "Tipos de Calificaciones (RH080)"
string menuname = "m_master_simple"
dw_master dw_master
end type
global w_rh080_maestro_calificaciones w_rh080_maestro_calificaciones

on w_rh080_maestro_calificaciones.create
int iCurrent
call super::create
...
on w_rh080_maestro_calificaciones.destroy
call super::destroy
...
integer width = 2085
integer height = 696
string dataobject = "d_abc_maestro_calificaciones_tbl"
