$PBExportHeader$w_rh300_reportes_alimentista.srw
forward
global type w_rh300_reportes_alimentista from w_cns
end type
type tab_reporte from tab within w_rh300_reportes_alimentista
end type
...
type cb_1 from commandbutton within w_rh300_reportes_alimentista
end type
type mle_1 from multilineedit within w_rh300_reportes_alimentista
end type
type uo_fecha from u_fecha within w_rh300_reportes_alimentista
end type
type rb_fecha from radiobutton within w_rh300_reportes_alimentista
end type
type ddlb_tipo_trabajador from u_ddlb_lista within w_rh300_reportes_alimentista
end type
type em_ano_m from editmask within w_rh300_reportes_alimentista
end type
type st_ano_m from statictext within w_rh300_reportes_alimentista
end type
type ddlb_mes_m from dropdownlistbox within w_rh300_reportes_alimentista
end type
type st_mes_m from statictext within w_rh300_reportes_alimentista
end type
type rb_mes from radiobutton within w_rh300_reportes_alimentista
end type
type p_8 from picture within w_rh300_reportes_alimentista
end type
type p_6 from picture within w_rh300_reportes_alimentista
end type
type p_5 from picture within w_rh300_reportes_alimentista
end type
type p_4 from picture within w_rh300_reportes_alimentista
end type
type st_etiqueta from statictext within w_rh300_reportes_alimentista
end type
type cbx_periodo from checkbox within w_rh300_reportes_alimentista
end type
type cbx_tipo_trabajador from checkbox within w_rh300_reportes_alimentista
end type
type p_2 from picture within w_rh300_reportes_alimentista
end type
type p_1 from picture within w_rh300_reportes_alimentista
end type
type uo_rango from u_rango_fechas within w_rh300_reportes_alimentista
end type
type rb_semana from radiobutton within w_rh300_reportes_alimentista
end type
type rb_semana_fecha from radiobutton within w_rh300_reportes_alimentista
end type
type rb_rango_fecha from radiobutton within w_rh300_reportes_alimentista
end type
type cbx_origen from checkbox within w_rh300_reportes_alimentista
end type
type rb_grafico from radiobutton within w_rh300_reportes_alimentista
end type
type rb_texto from radiobutton within w_rh300_reportes_alimentista
end type
type gb_1 from groupbox within w_rh300_reportes_alimentista
end type
type gb_2 from groupbox within w_rh300_reportes_alimentista
end type
type ddlb_origen from u_ddlb_lista within w_rh300_reportes_alimentista
end type
type st_sem from statictext within w_rh300_reportes_alimentista
end type
type em_sem from editmask within w_rh300_reportes_alimentista
end type
type st_ano from statictext within w_rh300_reportes_alimentista
end type
type em_ano from editmask within w_rh300_reportes_alimentista
end type
type uo_semana from u_semana_fecha within w_rh300_reportes_alimentista
end type
type gb_3 from groupbox within w_rh300_reportes_alimentista
end type
type gb_8 from groupbox within w_rh300_reportes_alimentista
end type
type st_procesando from statictext within w_rh300_reportes_alimentista
end type
type p_procesando from picture within w_rh300_reportes_alimentista
end type
type st_procesando_title from statictext within w_rh300_reportes_alimentista
end type
type st_procesando_status from statictext within w_rh300_reportes_alimentista
end type
end forward
...
global w_rh300_reportes_alimentista w_rh300_reportes_alimentista
...
tab_reporte.tp_1.dw_master.object.t_10.text = ls_titulo
tab_reporte.tp_1.dw_master.object.t_11.text = ls_titulo
end event
...
if tab_reporte.tp_1.dw_master.rowcount() >= 1 then
	...
	tab_reporte.tp_1.dw_master.object.p_logo1.filename = gs_logo
	tab_reporte.tp_1.dw_master.object.st_empresa1.text = gs_empresa
...
on w_rh300_reportes_alimentista.create
int iCurrent
call super::create
...
this.Control[iCurrent+6]=this.ddlb_tipo_trabajador
this.Control[iCurrent+7]=this.em_ano_m
this.Control[iCurrent+8]=this.st_ano_m
this.Control[iCurrent+9]=this.ddlb_mes_m
this.Control[iCurrent+10]=this.st_mes_m
this.Control[iCurrent+11]=this.rb_mes
this.Control[iCurrent+12]=this.p_8
this.Control[iCurrent+13]=this.p_6
this.Control[iCurrent+14]=this.p_5
this.Control[iCurrent+15]=this.p_4
this.Control[iCurrent+16]=this.st_etiqueta
this.Control[iCurrent+17]=this.cbx_periodo
this.Control[iCurrent+18]=this.cbx_tipo_trabajador
this.Control[iCurrent+19]=this.p_2
this.Control[iCurrent+20]=this.p_1
this.Control[iCurrent+21]=this.uo_rango
this.Control[iCurrent+22]=this.rb_semana
this.Control[iCurrent+23]=this.rb_semana_fecha
this.Control[iCurrent+24]=this.rb_rango_fecha
this.Control[iCurrent+25]=this.cbx_origen
this.Control[iCurrent+26]=this.rb_grafico
this.Control[iCurrent+27]=this.rb_texto
this.Control[iCurrent+28]=this.gb_1
this.Control[iCurrent+29]=this.gb_2
this.Control[iCurrent+30]=this.ddlb_origen
this.Control[iCurrent+31]=this.st_sem
this.Control[iCurrent+32]=this.em_sem
this.Control[iCurrent+33]=this.st_ano
this.Control[iCurrent+34]=this.em_ano
this.Control[iCurrent+35]=this.uo_semana
this.Control[iCurrent+36]=this.gb_3
this.Control[iCurrent+37]=this.gb_8
this.Control[iCurrent+38]=this.st_procesando
this.Control[iCurrent+39]=this.p_procesando
this.Control[iCurrent+40]=this.st_procesando_title
this.Control[iCurrent+41]=this.st_procesando_status
end on

on w_rh300_reportes_alimentista.destroy
call super::destroy
