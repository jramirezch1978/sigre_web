$PBExportHeader$w_rh733_dias_vacaciones.srw
forward
global type w_rh733_dias_vacaciones from w_report_smpl
end type
type cb_1 from commandbutton within w_rh733_dias_vacaciones
end type
type st_3 from statictext within w_rh733_dias_vacaciones
end type
type st_4 from statictext within w_rh733_dias_vacaciones
end type
type em_tipo from editmask within w_rh733_dias_vacaciones
end type
type cb_2 from commandbutton within w_rh733_dias_vacaciones
end type
type em_desc_tipo from editmask within w_rh733_dias_vacaciones
end type
type em_descripcion from editmask within w_rh733_dias_vacaciones
end type
type cb_3 from commandbutton within w_rh733_dias_vacaciones
end type
type em_origen from editmask within w_rh733_dias_vacaciones
end type
type em_cod_trabajador from editmask within w_rh733_dias_vacaciones
end type
type cb_4 from commandbutton within w_rh733_dias_vacaciones
end type
type em_nom_trabajador from editmask within w_rh733_dias_vacaciones
end type
type st_5 from statictext within w_rh733_dias_vacaciones
end type
type gb_1 from groupbox within w_rh733_dias_vacaciones
end type
end forward
...
global w_rh733_dias_vacaciones w_rh733_dias_vacaciones

on w_rh733_dias_vacaciones.create
int iCurrent
call super::create
...
on w_rh733_dias_vacaciones.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_rh733_dias_vacaciones
integer x = 0
integer y = 332
integer width = 3438
integer height = 1444
