$PBExportHeader$w_rh003_tipo_trabajador_user.srw
forward
global type w_rh003_tipo_trabajador_user from w_abc_master_smpl
end type
end forward

global type w_rh003_tipo_trabajador_user from w_abc_master_smpl
integer height = 1064
string title = "[RH003] TIPO TRABAJADOR - USUARIO"
string menuname = "m_master_simple"
end type
global w_rh003_tipo_trabajador_user w_rh003_tipo_trabajador_user

on w_rh003_tipo_trabajador_user.create
call super::create
if this.MenuName = "m_master_simple" then this.MenuID = create m_master_simple
end on

on w_rh003_tipo_trabajador_user.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_rh003_tipo_trabajador_user
event ue_display ( string as_columna,  long al_row )
string dataobject = "d_abc_tipo_trabajador_user_tbl"
end type
