$PBExportHeader$w_rh722_jornada_laboral_rtps.srw
forward
global type w_rh722_jornada_laboral_rtps from w_rpt
end type
type em_mes from editmask within w_rh722_jornada_laboral_rtps
end type
type em_year from editmask within w_rh722_jornada_laboral_rtps
end type
type st_2 from statictext within w_rh722_jornada_laboral_rtps
end type
type st_1 from statictext within w_rh722_jornada_laboral_rtps
end type
type st_nro_reg from statictext within w_rh722_jornada_laboral_rtps
end type
type st_3 from statictext within w_rh722_jornada_laboral_rtps
end type
type pb_1 from picturebutton within w_rh722_jornada_laboral_rtps
end type
type dw_origen from u_dw_abc within w_rh722_jornada_laboral_rtps
end type
type st_ext from statictext within w_rh722_jornada_laboral_rtps
end type
type sle_file from singlelineedit within w_rh722_jornada_laboral_rtps
end type
type dw_report from u_dw_rpt within w_rh722_jornada_laboral_rtps
end type
type gb_1 from groupbox within w_rh722_jornada_laboral_rtps
end type
end forward
...
integer width = 3227
integer height = 1336
string title = "[RH722] Datos de Jornada Laboral"
...
global w_rh722_jornada_laboral_rtps w_rh722_jornada_laboral_rtps
...
on w_rh722_jornada_laboral_rtps.create
int iCurrent
call super::create
...
this.Control[iCurrent+5]=this.st_nro_reg
...
on w_rh722_jornada_laboral_rtps.destroy
call super::destroy
...
sle_file.text = '0601' + string(li_year) + string(li_mes, '00') + is_ruc_emp
...
integer width = 3095
integer height = 660
string dataobject = "dw_rpt_jornada_laboral_text_rtps"
end type
