$PBExportHeader$w_rh908_transferencia_vacaciones.srw
forward
global type w_rh908_transferencia_vacaciones from w_prc
end type
type st_2 from statictext within w_rh908_transferencia_vacaciones
end type
type st_1 from statictext within w_rh908_transferencia_vacaciones
end type
type cb_1 from commandbutton within w_rh908_transferencia_vacaciones
end type
type em_descripcion from editmask within w_rh908_transferencia_vacaciones
end type
type em_origen from editmask within w_rh908_transferencia_vacaciones
end type
type em_tipo from editmask within w_rh908_transferencia_vacaciones
end type
type em_fecha from editmask within w_rh908_transferencia_vacaciones
end type
type st_3 from statictext within w_rh908_transferencia_vacaciones
end type
type cb_2 from commandbutton within w_rh908_transferencia_vacaciones
end type
type cb_3 from commandbutton within w_rh908_transferencia_vacaciones
end type
type em_desc_tipo from editmask within w_rh908_transferencia_vacaciones
end type
type gb_1 from groupbox within w_rh908_transferencia_vacaciones
end type
end forward
...
global w_rh908_transferencia_vacaciones w_rh908_transferencia_vacaciones

on w_rh908_transferencia_vacaciones.create
int iCurrent
call super::create
...
on w_rh908_transferencia_vacaciones.destroy
call super::destroy
destroy(this.st_2)
destroy(this.st_1)
destroy(this.cb_1)
...
event clicked;String ls_origen, ls_tipo, ls_mensaje,ls_veda,ls_tipo_trip,ls_tipo_doc
Long	 ll_count
Date ld_fec_proceso
...
select tipo_trab_tripulante,doc_reg_automatico 
  into :ls_tipo_trip,:ls_tipo_doc
  from rrhhparam where reckey = '1' ;
...
if ls_tipo <> ls_tipo_trip then
	...
	DECLARE pb_USP_RRHH_CALC_VAC_MENSUAL_TRIP PROCEDURE FOR USP_RRHH_CALC_VAC_MENSUAL_TRIP
	        (:ld_fec_proceso , :ls_tipo, :ls_origen ,:gs_user ,:ls_tipo_doc) ;
	EXECUTE pb_USP_RRHH_CALC_VAC_MENSUAL_TRIP ;
	...
	CLOSE pb_USP_RRHH_CALC_VAC_MENSUAL_TRIP ;
end if	
