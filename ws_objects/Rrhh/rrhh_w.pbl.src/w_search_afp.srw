$PBExportHeader$w_search_afp.srw
forward
global type w_search_afp from w_abc_master_smpl
end type
type st_campo from statictext within w_search_afp
end type
type dw_1 from datawindow within w_search_afp
end type
type cb_1 from commandbutton within w_search_afp
end type
end forward
...
global w_search_afp w_search_afp
...
type dw_master from w_abc_master_smpl`dw_master within w_search_afp
integer x = 37
integer y = 140
integer width = 1477
integer height = 476
