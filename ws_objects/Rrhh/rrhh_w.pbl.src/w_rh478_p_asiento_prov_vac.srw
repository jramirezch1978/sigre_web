$PBExportHeader$w_rh478_p_asiento_prov_vac.srw
forward
global type w_rh478_p_asiento_prov_vac from w_prc
end type
type rb_veda from radiobutton within w_rh478_p_asiento_prov_vac
end type
type rb_produc from radiobutton within w_rh478_p_asiento_prov_vac
end type
type uo_fechas from u_ingreso_rango_fechas within w_rh478_p_asiento_prov_vac
end type
type uo_fecha from u_ingreso_fecha within w_rh478_p_asiento_prov_vac
end type
type cb_1 from commandbutton within w_rh478_p_asiento_prov_vac
end type
type em_descripcion from editmask within w_rh478_p_asiento_prov_vac
end type
type em_origen from editmask within w_rh478_p_asiento_prov_vac
end type
type cb_2 from commandbutton within w_rh478_p_asiento_prov_vac
end type
type gb_1 from groupbox within w_rh478_p_asiento_prov_vac
end type
type gb_2 from groupbox within w_rh478_p_asiento_prov_vac
end type
type gb_3 from groupbox within w_rh478_p_asiento_prov_vac
end type
type gb_4 from groupbox within w_rh478_p_asiento_prov_vac
end type
end forward
...
integer width = 2802
integer height = 752
string title = "(RH478) Asientos de provisión de Vacaciones"
rb_veda rb_veda
rb_produc rb_produc
uo_fechas uo_fechas
uo_fecha uo_fecha
...
global w_rh478_p_asiento_prov_vac w_rh478_p_asiento_prov_vac

on w_rh478_p_asiento_prov_vac.create
int iCurrent
call super::create
...
on w_rh478_p_asiento_prov_vac.destroy
call super::destroy
...
Parent.SetMicroHelp('Procesando Asientos Contables de Provisiones de Vacaciones')
...
DECLARE pb_usp_rh_asiento_prov_vac PROCEDURE FOR USP_RH_ASIENTO_PROV_VAC
        ( :ls_origen, :ls_usuario, :ls_tipo, :ld_fec_proceso, :ld_fec_desde, :ld_fec_hasta ) ;
EXECUTE pb_usp_rh_asiento_prov_vac ;
...
CLOSE pb_usp_rh_asiento_prov_vac ;
end event
