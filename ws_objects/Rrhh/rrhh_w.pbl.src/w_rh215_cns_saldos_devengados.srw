$PBExportHeader$w_rh215_cns_saldos_devengados.srw
forward
global type w_rh215_cns_saldos_devengados from w_cns
end type
type cb_2 from commandbutton within w_rh215_cns_saldos_devengados
end type
type em_tipo from editmask within w_rh215_cns_saldos_devengados
end type
type em_desc_tipo from editmask within w_rh215_cns_saldos_devengados
end type
type em_origen from editmask within w_rh215_cns_saldos_devengados
end type
type em_descripcion from editmask within w_rh215_cns_saldos_devengados
end type
type cb_3 from commandbutton within w_rh215_cns_saldos_devengados
end type
type em_fecha from editmask within w_rh215_cns_saldos_devengados
end type
type st_1 from statictext within w_rh215_cns_saldos_devengados
end type
type cb_1 from commandbutton within w_rh215_cns_saldos_devengados
end type
type dw_admin from u_dw_cns within w_rh215_cns_saldos_devengados
end type
type gb_2 from groupbox within w_rh215_cns_saldos_devengados
end type
type gb_3 from groupbox within w_rh215_cns_saldos_devengados
end type
end forward
...
integer width = 2990
integer height = 1776
string title = "(RH215) Saldos por Devengados"
...
global w_rh215_cns_saldos_devengados w_rh215_cns_saldos_devengados

on w_rh215_cns_saldos_devengados.create
int iCurrent
call super::create
...
this.Control[iCurrent+10]=this.dw_admin
this.Control[iCurrent+11]=this.gb_2
this.Control[iCurrent+12]=this.gb_3
end on

on w_rh215_cns_saldos_devengados.destroy
call super::destroy
...
DECLARE pb_usp_rh_cons_saldos_devengados PROCEDURE FOR USP_RH_CONS_SALDOS_DEVENGADOS
        ( :ls_tiptra, :ls_origen, :ld_fecha ) ;

dw_admin.SetTransObject(sqlca)
EXECUTE pb_usp_rh_cons_saldos_devengados ;
dw_admin.retrieve()
...
integer taborder = 0
boolean bringtotop = true
string dataobject = "d_cons_sldo_deveng_admin_tbl"
...
CHOOSE CASE dwo.Name
	CASE "cod_area"  
		lstr_1.DataObject = 'd_cons_sldo_deveng_seccion_tbl'
		lstr_1.Width = 3200
		lstr_1.Height= 1300
