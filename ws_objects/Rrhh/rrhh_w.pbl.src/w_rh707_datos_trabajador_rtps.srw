$PBExportHeader$w_rh707_datos_trabajador_rtps.srw
forward
global type w_rh707_datos_trabajador_rtps from w_rpt
end type
type st_nro_reg from statictext within w_rh707_datos_trabajador_rtps
end type
type st_3 from statictext within w_rh707_datos_trabajador_rtps
end type
type dw_origen from u_dw_abc within w_rh707_datos_trabajador_rtps
end type
type dw_report from u_dw_rpt within w_rh707_datos_trabajador_rtps
end type
type st_ext from statictext within w_rh707_datos_trabajador_rtps
end type
type st_2 from statictext within w_rh707_datos_trabajador_rtps
end type
type st_1 from statictext within w_rh707_datos_trabajador_rtps
end type
type pb_1 from picturebutton within w_rh707_datos_trabajador_rtps
end type
type cbx_reproceso from checkbox within w_rh707_datos_trabajador_rtps
end type
type sle_ruc from singlelineedit within w_rh707_datos_trabajador_rtps
end type
type em_mes from editmask within w_rh707_datos_trabajador_rtps
end type
type em_year from editmask within w_rh707_datos_trabajador_rtps
end type
type gb_1 from groupbox within w_rh707_datos_trabajador_rtps
end type
end forward
...
integer width = 3310
integer height = 2344
string title = "[RH707] Datos de Trabajador"
...
global w_rh707_datos_trabajador_rtps w_rh707_datos_trabajador_rtps
...
DECLARE USP_RRHH_RPTS_MAESTRO_TEXT PROCEDURE FOR
 USP_RRHH_RPTS_MAESTRO_TEXT(  :ai_year,
 										:ai_mes,
										:is_cod_origen,
										:as_flag);
 
EXECUTE USP_RRHH_RPTS_MAESTRO_TEXT;
 
IF SQLCA.sqlcode = -1 THEN
  ls_mensaje = "PROCEDURE USP_RRHH_RPTS_MAESTRO_TEXT: " + SQLCA.SQLErrText
  Rollback ;
...
CLOSE USP_RRHH_RPTS_MAESTRO_TEXT;
...
on w_rh707_datos_trabajador_rtps.create
int iCurrent
call super::create
...
on w_rh707_datos_trabajador_rtps.destroy
call super::destroy
...
integer height = 1644
integer taborder = 40
string dataobject = "dw_rpt_datos_trabajador_text_rtps"
