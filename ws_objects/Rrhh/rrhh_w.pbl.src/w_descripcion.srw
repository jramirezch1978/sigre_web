$PBExportHeader$w_descripcion.srw
forward
global type w_descripcion from w_abc
end type
type pb_2 from picturebutton within w_descripcion
end type
type pb_1 from picturebutton within w_descripcion
end type
type st_1 from statictext within w_descripcion
end type
type mle_descripcion from multilineedit within w_descripcion
end type
end forward
...
global w_descripcion w_descripcion
