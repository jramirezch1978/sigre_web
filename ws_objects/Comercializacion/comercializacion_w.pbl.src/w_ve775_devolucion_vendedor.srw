$PBExportHeader$w_ve775_devolucion_vendedor.srw
forward
global type w_ve775_devolucion_vendedor from w_report_smpl
end type
type uo_fechas from u_ingreso_rango_fechas_v within w_ve775_devolucion_vendedor
end type
type cb_3 from commandbutton within w_ve775_devolucion_vendedor
end type
type cbx_vendedor from checkbox within w_ve775_devolucion_vendedor
end type
type cb_vendedor from commandbutton within w_ve775_devolucion_vendedor
end type
type gb_1 from groupbox within w_ve775_devolucion_vendedor
end type
type gb_2 from groupbox within w_ve775_devolucion_vendedor
end type
end forward
...
integer width = 3831
integer height = 1980
string title = "[VE775] Consolidado Devolución por Vendedor"
...
global w_ve775_devolucion_vendedor w_ve775_devolucion_vendedor

type variables
Integer ii_index
end variables

on w_ve775_devolucion_vendedor.create
int iCurrent
call super::create
...
on w_ve775_devolucion_vendedor.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ve775_devolucion_vendedor
integer x = 0
integer y = 276
integer width = 3259
integer height = 1036
string dataobject = "d_rpt_devolucion_vendedor_tbl"
end type
