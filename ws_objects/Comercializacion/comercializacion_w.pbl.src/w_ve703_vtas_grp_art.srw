$PBExportHeader$w_ve703_vtas_grp_art.srw
forward
global type w_ve703_vtas_grp_art from w_report_smpl
end type
type uo_fecha from u_ingreso_rango_fechas_v within w_ve703_vtas_grp_art
end type
type cb_1 from commandbutton within w_ve703_vtas_grp_art
end type
type rb_1 from radiobutton within w_ve703_vtas_grp_art
end type
type rb_2 from radiobutton within w_ve703_vtas_grp_art
end type
type gb_fechas from groupbox within w_ve703_vtas_grp_art
end type
type gb_2 from groupbox within w_ve703_vtas_grp_art
end type
end forward
...
integer width = 3250
integer height = 2068
string title = "Ventas x Grupo de Articulos(VE703)"
...
global w_ve703_vtas_grp_art w_ve703_vtas_grp_art

type variables
string is_doc_ov
end variables

on w_ve703_vtas_grp_art.create
int iCurrent
call super::create
...
on w_ve703_vtas_grp_art.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_ve703_vtas_grp_art
integer x = 0
integer y = 328
integer width = 2089
integer height = 992
string dataobject = "d_rpt_ventas_x_grp_art"
end type
