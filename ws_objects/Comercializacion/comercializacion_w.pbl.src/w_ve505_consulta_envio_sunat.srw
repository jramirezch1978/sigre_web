$PBExportHeader$w_ve505_consulta_envio_sunat.srw
forward
global type w_ve505_consulta_envio_sunat from w_abc
end type
type uo_fechas from u_ingreso_rango_fechas within w_ve505_consulta_envio_sunat
end type
type dw_master from u_dw_abc within w_ve505_consulta_envio_sunat
end type
type cb_2 from commandbutton within w_ve505_consulta_envio_sunat
end type
type gb_1 from groupbox within w_ve505_consulta_envio_sunat
end type
end forward
...
integer width = 5051
integer height = 2552
string title = "[VE505] Consulta envio masivo a SUNAT"
...
global w_ve505_consulta_envio_sunat w_ve505_consulta_envio_sunat
...
on w_ve505_consulta_envio_sunat.create
int iCurrent
call super::create
...
on w_ve505_consulta_envio_sunat.destroy
call super::destroy
...
integer width = 4475
integer height = 1848
string dataobject = "d_cns_ce_envio_sunat_tbl"
end type
