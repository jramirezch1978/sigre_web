$PBExportHeader$w_ve770_cntas_cobrar_vencidos.srw
forward
global type w_ve770_cntas_cobrar_vencidos from w_rpt
end type
type st_nom_proveedor from statictext within w_ve770_cntas_cobrar_vencidos
end type
type cbx_todos from checkbox within w_ve770_cntas_cobrar_vencidos
end type
type cb_reporte from commandbutton within w_ve770_cntas_cobrar_vencidos
end type
type sle_moneda from singlelineedit within w_ve770_cntas_cobrar_vencidos
end type
type rb_detalle from radiobutton within w_ve770_cntas_cobrar_vencidos
end type
type rb_resumen from radiobutton within w_ve770_cntas_cobrar_vencidos
end type
type sle_proveedor from singlelineedit within w_ve770_cntas_cobrar_vencidos
end type
type st_1 from statictext within w_ve770_cntas_cobrar_vencidos
end type
type st_2 from statictext within w_ve770_cntas_cobrar_vencidos
end type
type em_1 from editmask within w_ve770_cntas_cobrar_vencidos
end type
type st_3 from statictext within w_ve770_cntas_cobrar_vencidos
end type
type em_2 from editmask within w_ve770_cntas_cobrar_vencidos
end type
type st_4 from statictext within w_ve770_cntas_cobrar_vencidos
end type
type cbx_1 from checkbox within w_ve770_cntas_cobrar_vencidos
end type
type dw_reporte from u_dw_rpt within w_ve770_cntas_cobrar_vencidos
end type
type gb_1 from groupbox within w_ve770_cntas_cobrar_vencidos
end type
type gb_3 from groupbox within w_ve770_cntas_cobrar_vencidos
end type
type gb_2 from groupbox within w_ve770_cntas_cobrar_vencidos
end type
end forward
...
integer width = 4379
integer height = 2188
string title = "[VE770] Reporte de Saldos por Cobrar Vencidos"
...
global w_ve770_cntas_cobrar_vencidos w_ve770_cntas_cobrar_vencidos

type variables

end variables

on w_ve770_cntas_cobrar_vencidos.create
int iCurrent
call super::create
...
on w_ve770_cntas_cobrar_vencidos.destroy
call super::destroy
...
if rb_detalle.checked then
	if sle_moneda.text = gnvo_app.is_soles then
		dw_reporte.DataObject = 'd_rpt_clientes_sol_vencidos_tbl'
	else
		dw_reporte.DataObject = 'd_rpt_clientes_dol_vencidos_tbl'
	end if
else
	if sle_moneda.text = gnvo_app.is_soles then
		dw_reporte.DataObject = 'd_rpt_total_sol_vencidos_tbl'
	else
		dw_reporte.DataObject = 'd_rpt_total_dol_vencidos_tbl'
	end if
end if
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Detalle por Cliente"
boolean checked = true
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Resumen por Cliente"
end type
...
integer height = 1544
integer taborder = 30
string dataobject = "d_rpt_clientes_soles_tbl"
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Filtrar por saldo del cliente"
end type
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Filtrar Cliente y Moneda"
end type
