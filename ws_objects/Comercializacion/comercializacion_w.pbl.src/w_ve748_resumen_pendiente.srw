$PBExportHeader$w_ve748_resumen_pendiente.srw
forward
global type w_ve748_resumen_pendiente from w_rpt
end type
type cb_1 from commandbutton within w_ve748_resumen_pendiente
end type
type uo_1 from u_ingreso_rango_fechas within w_ve748_resumen_pendiente
end type
type st_2 from statictext within w_ve748_resumen_pendiente
end type
type sle_origen from singlelineedit within w_ve748_resumen_pendiente
end type
type cb_3 from commandbutton within w_ve748_resumen_pendiente
end type
type cbx_origenes from checkbox within w_ve748_resumen_pendiente
end type
type rb_1 from radiobutton within w_ve748_resumen_pendiente
end type
type rb_2 from radiobutton within w_ve748_resumen_pendiente
end type
type st_1 from statictext within w_ve748_resumen_pendiente
end type
type sle_moneda from singlelineedit within w_ve748_resumen_pendiente
end type
type cb_2 from commandbutton within w_ve748_resumen_pendiente
end type
type dw_report from u_dw_rpt within w_ve748_resumen_pendiente
end type
type gb_1 from groupbox within w_ve748_resumen_pendiente
end type
type gb_2 from groupbox within w_ve748_resumen_pendiente
end type
end forward
...
integer width = 3799
integer height = 2404
string title = "[VE748] Resumen de pendientes por Cliente y por Mes"
...
global w_ve748_resumen_pendiente w_ve748_resumen_pendiente

on w_ve748_resumen_pendiente.create
int iCurrent
call super::create
...
this.Control[iCurrent+10]=this.sle_moneda
...
on w_ve748_resumen_pendiente.destroy
call super::destroy
...
integer width = 3310
integer height = 1748
string dataobject = "d_rpt_pendientes_cobro_resumen_tbl"
