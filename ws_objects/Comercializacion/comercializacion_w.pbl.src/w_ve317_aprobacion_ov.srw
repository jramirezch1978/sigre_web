$PBExportHeader$w_ve317_aprobacion_ov.srw
forward
global type w_ve317_aprobacion_ov from w_abc
end type
type cb_1 from commandbutton within w_ve317_aprobacion_ov
end type
type rb_2 from radiobutton within w_ve317_aprobacion_ov
end type
type rb_1 from radiobutton within w_ve317_aprobacion_ov
end type
type sle_origen from singlelineedit within w_ve317_aprobacion_ov
end type
type st_1 from statictext within w_ve317_aprobacion_ov
end type
type p_help from picture within w_ve317_aprobacion_ov
end type
type st_help from statictext within w_ve317_aprobacion_ov
end type
type pb_aceptar from picturebutton within w_ve317_aprobacion_ov
end type
type pb_salir from picturebutton within w_ve317_aprobacion_ov
end type
type dw_master from u_dw_abc within w_ve317_aprobacion_ov
end type
end forward
...
integer width = 3589
integer height = 1816
string title = "Aprobacion de Ordenes de Venta (VE317)"
...
global w_ve317_aprobacion_ov w_ve317_aprobacion_ov
...
on w_ve317_aprobacion_ov.create
int iCurrent
call super::create
...
on w_ve317_aprobacion_ov.destroy
call super::destroy
...
event ue_update_pre;call super::ue_update_pre;String ls_nro_orden_venta, ls_flag_estado 
Integer li
...
IF ls_flag_estado = '3' THEN 
	...
	END IF 
ELSE 
	MessageBox('Aviso','Indicador de aprobacion de Orden de Venta es directo')
	Return
END IF 

IF dw_master.RowCount() > 0 THEN
	FOR li=1 TO dw_master.RowCount()
		IF dw_master.Object.flag_estado[li]='1' THEN
			ls_nro_orden_venta = dw_master.Object.nro_doc[li]
			
			UPDATE orden_venta o 
			   SET flag_estado = :ls_flag_estado 
			 WHERE nro_ov = :ls_nro_orden_venta ; 
...
if rb_1.checked = true then
	dw_master.dataobject = 'd_lista_ov_sin_aprobar_grd'
else
	dw_master.dataobject = 'd_lista_ov_aprobados_grd'
end if
...
integer height = 1212
integer taborder = 20
string dataobject = "d_lista_ov_sin_aprobar_grd"
...
String  	ls_estado_act, ls_estado_pos, ls_mensaje
...
IF ls_estado_act = '3' THEN //Generado Pasara Aprobarse

	ls_estado_pos = 'Aprobar'
	ls_estado_act = '1'
	
ELSEIF ls_estado_act = '1' THEN //Aprobado Pasar a Pendiente
		 
	ls_estado_pos = 'Revertir Aprobacion de'	
 	ls_estado_act = '3'
END IF	

li_opcion = MessageBox('Pregunta' ,'Desea '+ls_estado_pos &
			+ ' la Orden de Venta?', Question!, YesNo!, 2)
