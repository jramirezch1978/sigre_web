$PBExportHeader$w_ve753_reporte_vencimiento.srw
forward
global type w_ve753_reporte_vencimiento from w_rpt
end type
type cbx_2 from checkbox within w_ve753_reporte_vencimiento
end type
type sle_desc_art from singlelineedit within w_ve753_reporte_vencimiento
end type
type pb_lote from picturebutton within w_ve753_reporte_vencimiento
end type
type sle_cod_art from singlelineedit within w_ve753_reporte_vencimiento
end type
type st_2 from statictext within w_ve753_reporte_vencimiento
end type
type cbx_1 from checkbox within w_ve753_reporte_vencimiento
end type
type st_3 from statictext within w_ve753_reporte_vencimiento
end type
type em_fecha from n_ingreso_fecha within w_ve753_reporte_vencimiento
end type
type sle_nom_cliente from singlelineedit within w_ve753_reporte_vencimiento
end type
type pb_cliente from picturebutton within w_ve753_reporte_vencimiento
end type
type sle_cliente from singlelineedit within w_ve753_reporte_vencimiento
end type
type st_1 from statictext within w_ve753_reporte_vencimiento
end type
type cb_1 from commandbutton within w_ve753_reporte_vencimiento
end type
type dw_report from u_dw_rpt within w_ve753_reporte_vencimiento
end type
type gb_1 from groupbox within w_ve753_reporte_vencimiento
end type
end forward
...
integer width = 3799
integer height = 2404
string title = "[VE753] Letras vencidas a una fecha determinada"
...
global w_ve753_reporte_vencimiento w_ve753_reporte_vencimiento

on w_ve753_reporte_vencimiento.create
int iCurrent
call super::create
...
on w_ve753_reporte_vencimiento.destroy
call super::destroy
...
integer width = 3310
integer height = 1660
string dataobject = "d_rpt_vencimiento_cronograma_tbl"
