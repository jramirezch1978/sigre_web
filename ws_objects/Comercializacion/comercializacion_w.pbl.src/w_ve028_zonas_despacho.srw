$PBExportHeader$w_ve028_zonas_despacho.srw
forward
global type w_ve028_zonas_despacho from w_abc_master_smpl
end type
end forward
...
integer width = 3465
integer height = 1340
string title = "[VE028] Zonas de Despacho"
string menuname = "m_mantenimiento_sl"
long backcolor = 67108864
integer ii_x = 0
boolean ib_update_check = false
end type
global w_ve028_zonas_despacho w_ve028_zonas_despacho
...
on w_ve028_zonas_despacho.create
call super::create
if this.MenuName = "m_mantenimiento_sl" then this.MenuID = create m_mantenimiento_sl
end on

on w_ve028_zonas_despacho.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_ve028_zonas_despacho
integer width = 3401
integer height = 1108
string dataobject = "d_abc_zonas_despacho_tbl"
end type
