...
Choose case ist_datos.opcion
	...
	CASE 3   // grupo y concepto financiero exportacion
	...
	CASE 4    // grupo y concepto financiero
		ldw_master.object.confin_nacional		[ldw_master.getrow()] = dw_1.Object.confin		[dw_1.getrow()]
		ldw_master.object.desc_confin_nacional [ldw_master.GetRow()] = dw_1.Object.descripcion	[dw_1.getrow()]
		ldw_master.ii_update = 1
		ist_datos.titulo = 's' 
