$PBExportHeader$w_ve754_letras_bloqueadas.srw
forward
global type w_ve754_letras_bloqueadas from w_rpt
end type
type cbx_2 from checkbox within w_ve754_letras_bloqueadas
end type
type sle_desc_art from singlelineedit within w_ve754_letras_bloqueadas
end type
type pb_lote from picturebutton within w_ve754_letras_bloqueadas
end type
type sle_cod_art from singlelineedit within w_ve754_letras_bloqueadas
end type
type st_2 from statictext within w_ve754_letras_bloqueadas
end type
type cbx_1 from checkbox within w_ve754_letras_bloqueadas
end type
type st_3 from statictext within w_ve754_letras_bloqueadas
end type
type em_fecha from n_ingreso_fecha within w_ve754_letras_bloqueadas
end type
type sle_nom_cliente from singlelineedit within w_ve754_letras_bloqueadas
end type
type pb_cliente from picturebutton within w_ve754_letras_bloqueadas
end type
type sle_cliente from singlelineedit within w_ve754_letras_bloqueadas
end type
type st_1 from statictext within w_ve754_letras_bloqueadas
end type
type cb_1 from commandbutton within w_ve754_letras_bloqueadas
end type
type dw_report from u_dw_rpt within w_ve754_letras_bloqueadas
end type
type gb_1 from groupbox within w_ve754_letras_bloqueadas
end type
end forward
...
integer width = 3799
integer height = 2404
string title = "[VE754] LETRAS BLOQUEADAS POR CLIENTE"
...
global w_ve754_letras_bloqueadas w_ve754_letras_bloqueadas

on w_ve754_letras_bloqueadas.create
int iCurrent
call super::create
...
on w_ve754_letras_bloqueadas.destroy
call super::destroy
...
integer width = 3310
integer height = 1660
string dataobject = "d_rpt_cuotas_bloqueadas_tbl"
