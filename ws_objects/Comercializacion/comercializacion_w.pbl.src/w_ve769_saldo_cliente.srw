$PBExportHeader$w_ve769_saldo_cliente.srw
forward
global type w_ve769_saldo_cliente from w_rpt
end type
type st_nom_proveedor from statictext within w_ve769_saldo_cliente
end type
type cbx_todos from checkbox within w_ve769_saldo_cliente
end type
type cb_reporte from commandbutton within w_ve769_saldo_cliente
end type
type sle_moneda from singlelineedit within w_ve769_saldo_cliente
end type
type rb_detalle from radiobutton within w_ve769_saldo_cliente
end type
type rb_resumen from radiobutton within w_ve769_saldo_cliente
end type
type sle_proveedor from singlelineedit within w_ve769_saldo_cliente
end type
type st_1 from statictext within w_ve769_saldo_cliente
end type
type st_2 from statictext within w_ve769_saldo_cliente
end type
type em_1 from editmask within w_ve769_saldo_cliente
end type
type st_3 from statictext within w_ve769_saldo_cliente
end type
type em_2 from editmask within w_ve769_saldo_cliente
end type
type st_4 from statictext within w_ve769_saldo_cliente
end type
type cbx_1 from checkbox within w_ve769_saldo_cliente
end type
type dw_reporte from u_dw_rpt within w_ve769_saldo_cliente
end type
type gb_1 from groupbox within w_ve769_saldo_cliente
end type
type gb_3 from groupbox within w_ve769_saldo_cliente
end type
type gb_2 from groupbox within w_ve769_saldo_cliente
end type
end forward
...
integer width = 4379
integer height = 2188
string title = "[VE769] Cronograma Cobros por Fecha Vencimiento "
...
global w_ve769_saldo_cliente w_ve769_saldo_cliente

type variables

end variables

on w_ve769_saldo_cliente.create
int iCurrent
call super::create
...
on w_ve769_saldo_cliente.destroy
call super::destroy
...
if rb_detalle.checked then
	if sle_moneda.text = gnvo_app.is_soles then
		dw_reporte.DataObject = 'd_rpt_clientes_soles_tbl'
	else
		dw_reporte.DataObject = 'd_rpt_clientes_dolares_tbl'
	end if
else
	if sle_moneda.text = gnvo_app.is_soles then
