$PBExportHeader$w_ve772_ov_vendedor.srw
forward
global type w_ve772_ov_vendedor from w_report_smpl
end type
type uo_fechas from u_ingreso_rango_fechas_v within w_ve772_ov_vendedor
end type
type cb_3 from commandbutton within w_ve772_ov_vendedor
end type
type cbx_vendedor from checkbox within w_ve772_ov_vendedor
end type
type cb_vendedor from commandbutton within w_ve772_ov_vendedor
end type
type gb_1 from groupbox within w_ve772_ov_vendedor
end type
type gb_2 from groupbox within w_ve772_ov_vendedor
end type
end forward
...
integer width = 3831
integer height = 1980
string title = "[VE772] Consolidado OV por Vendedor"
...
global w_ve772_ov_vendedor w_ve772_ov_vendedor

type variables
Integer ii_index
end variables

on w_ve772_ov_vendedor.create
int iCurrent
call super::create
...
on w_ve772_ov_vendedor.destroy
call super::destroy
...
if cbx_vendedor.checked then
	...
	select distinct
	 ...
	 where ov.nro_ov        = amp.nro_doc
		...
		and ov.vendedor      = v.vendedor
		and amp.cod_art      = a.cod_art
		and amp.almacen      = al.almacen
		and a.sub_cat_art    = a2.cod_sub_cat
		and v.cod_trabajador = m.COD_TRABAJADOR (+) 
		and ov.flag_estado   <> '0'
		and trunc(amp.fec_proyect) between trunc(:ld_desde) and trunc(:ld_hasta)
...
type dw_report from w_report_smpl`dw_report within w_ve772_ov_vendedor
integer x = 0
integer y = 276
integer width = 3630
integer height = 1320
string dataobject = "d_rpt_consolidado_ov_vendedor_tbl"
end type
...
lstr_param.dw1			= 'd_lista_ov_vendedores_tbl'
lstr_param.titulo		= 'Listado de Vendedores por OV'
