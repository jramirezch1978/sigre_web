$PBExportHeader$w_ve025_servicios_venta.srw
forward
global type w_ve025_servicios_venta from w_abc_master_smpl
end type
end forward
...
integer width = 3465
integer height = 1340
string title = "[VE025] Servicios de Venta"
string menuname = "m_mantenimiento_sl"
long backcolor = 67108864
integer ii_x = 0
boolean ib_update_check = false
end type
global w_ve025_servicios_venta w_ve025_servicios_venta
...
on w_ve025_servicios_venta.create
call super::create
if this.MenuName = "m_mantenimiento_sl" then this.MenuID = create m_mantenimiento_sl
end on

on w_ve025_servicios_venta.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_ve025_servicios_venta
integer width = 3401
integer height = 1108
string dataobject = "d_abc_servicios_venta_tbl"
end type

event dw_master::ue_insert_pre;call super::ue_insert_pre;this.object.flag_estado			[al_row] = '1'
this.object.tarifa				[al_row] = 0.00
