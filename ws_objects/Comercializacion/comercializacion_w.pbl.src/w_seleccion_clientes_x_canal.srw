$PBExportHeader$w_seleccion_clientes_x_canal.srw
forward
global type w_seleccion_clientes_x_canal from w_abc_list
end type
type cb_1 from commandbutton within w_seleccion_clientes_x_canal
end type
type st_1 from statictext within w_seleccion_clientes_x_canal
end type
end forward
...
integer width = 3118
integer height = 1480
string title = "Seleccione de Ordenes de Venta"
...
global w_seleccion_clientes_x_canal w_seleccion_clientes_x_canal

on w_seleccion_clientes_x_canal.create
int iCurrent
call super::create
...
on w_seleccion_clientes_x_canal.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.st_1)
end on
...
type dw_1 from w_abc_list`dw_1 within w_seleccion_clientes_x_canal
integer x = 37
integer y = 32
integer width = 1394
integer height = 1188
string dataobject = "d_lista_clientes_x_canal"
...
type dw_2 from w_abc_list`dw_2 within w_seleccion_clientes_x_canal
integer x = 1646
integer y = 32
integer width = 1394
integer height = 1188
...
type pb_1 from w_abc_list`pb_1 within w_seleccion_clientes_x_canal
integer x = 1463
integer y = 396
integer width = 151
end type

event pb_1::clicked;call super::clicked;dw_2.groupcalc( )
end event

type pb_2 from w_abc_list`pb_2 within w_seleccion_clientes_x_canal
integer x = 1463
integer y = 532
integer width = 151
string text = " <"
...
if ll_nbrow > 0 then
	...
	for i=1 to ll_nbrow
		...
		ls_cod  = trim(dw_2.object.cliente[i])
		ls_desc = trim(dw_2.object.nom_proveedor[i])
		insert into tt_proveedor (proveedor, nom_proveedor) values (:ls_cod, :ls_desc);
