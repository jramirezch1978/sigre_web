$PBExportHeader$w_cam340_inspeccion_no_anunciada.srw
forward
global type w_cam340_inspeccion_no_anunciada from w_abc_master
end type
type tab_1 from tab within w_cam340_inspeccion_no_anunciada
end type
...
integer width = 3337
integer height = 3280
string title = "[CM340] Inspección No Anunciada"
string menuname = "m_abc_anular_lista"
tab_1 tab_1
end type
global w_cam340_inspeccion_no_anunciada w_cam340_inspeccion_no_anunciada
...
if is_action = 'new' then
	...
	ls_table = 'LOCK TABLE NUM_SIC_INSPECCION_NO_ANUNC IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_ult_nro 
	from NUM_SIC_INSPECCION_NO_ANUNC
	where cod_origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into NUM_SIC_INSPECCION_NO_ANUNC (cod_origen, ult_nro)
			values( :gs_origen, 1);
	...
	// Incrementa contador
	Update NUM_SIC_INSPECCION_NO_ANUNC 
...
on w_cam340_inspeccion_no_anunciada.create
int iCurrent
call super::create
...
on w_cam340_inspeccion_no_anunciada.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_insp_no_anunciada_tbl'
...
type dw_master from w_abc_master`dw_master within w_cam340_inspeccion_no_anunciada
integer width = 3150
integer height = 1008
string dataobject = "d_abc_ins_na_cab"
end type
...
integer height = 1360
integer taborder = 20
string dataobject = "d_abc_sic_insp_na_control_tbl"
...
integer width = 2162
integer height = 1224
string dataobject = "d_abc_ins_na_insumos_tbl"
boolean hscrollbar = true
boolean vscrollbar = true
borderstyle borderstyle = styleraised!
end type
...
this.object.fec_registro	[al_row] = f_fecha_actual()
this.object.cod_usr 		[al_row] = gs_user
this.object.fec_ult_apl		[al_row] = date(f_fecha_actual())
end event
...
integer height = 1108
integer taborder = 30
string dataobject = "d_abc_insp_na_registro"
boolean hscrollbar = true
boolean vscrollbar = true
borderstyle borderstyle = styleraised!
end type
...
event ue_insert_pre;call super::ue_insert_pre;this.object.nro_item			[al_Row] = of_nro_item(this)
this.object.enfunde			[al_Row] = 0
this.object.recepcion			[al_Row] = 0
this.object.factura				[al_Row] = 0
this.object.corte				[al_Row] = 0
this.object.fec_registro		[al_row] = f_fecha_actual()
this.object.cod_usr 			[al_row] = gs_user
