$PBExportHeader$w_cam362_control_contenedor.srw
forward
global type w_cam362_control_contenedor from w_abc_master
end type
type dw_detalle from u_dw_abc within w_cam362_control_contenedor
end type
end forward
...
integer width = 3337
integer height = 3280
string title = "[CAM362] RG 23 Control de Calidad en Contenedor"
string menuname = "m_abc_anular_lista"
dw_detalle dw_detalle
end type
global w_cam362_control_contenedor w_cam362_control_contenedor
...
if is_action = 'new' then
	...
	ls_table = 'LOCK TABLE NUM_SIC_REG_CC_CONT IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_ult_nro 
	from NUM_SIC_REG_CC_CONT
	where cod_origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into NUM_SIC_REG_CC_CONT (cod_origen, ult_nro)
			values( :gs_origen, 1);
...
on w_cam362_control_contenedor.create
int iCurrent
call super::create
...
on w_cam362_control_contenedor.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_reg_cc_contenedor_tbl'
sl_param.titulo = 'Registro de Control de Calidad de Contenedor'
...
type dw_master from w_abc_master`dw_master within w_cam362_control_contenedor
integer width = 3195
integer height = 768
string dataobject = "d_abc_sic_reg_cc_contenedor_cab_ff"
end type
...
choose case lower(as_columna)
	...
	case "tipo_caja"
		ls_sql = "SELECT a.tipo_caja AS cod_caja, " &
				 + "a.cod_art as cod_art, " &
				 + "a.DESC_TIPO_CAJA AS DESC_TIPO_CAJA, " &
				 + "a.FLAG_ESTADO AS FLAG_ESTADO " &
				 + "FROM ap_tipo_caja  a " &
				 + "WHERE  a.flag_estado = '1'"
		...
		if ls_codigo <> '' then
			...
			this.object.DESC_TIPO_CAJA[al_row] = ls_data2
...
string dataobject = "d_abc_sic_reg_cc_contenedor_det_tbl"
...
this.object.par_4 	[al_row] = 0
this.object.par_6 	[al_row] = 0
this.object.par_8 	[al_row] = 0
this.object.impar_3 	[al_row] = 0
this.object.impar_5 	[al_row] = 0
this.object.impar_7 	[al_row] = 0
this.object.total_defect 	[al_row] = 0
this.object.total_gajos 	[al_row] = 0
this.object.porc_pcm 	[al_row] = 0
this.object.x_pcm 	[al_row] = 0
