$PBExportHeader$w_cam015_tipo_contrato.srw
forward
global type w_cam015_tipo_contrato from w_abc_master_smpl
end type
end forward

global type w_cam015_tipo_contrato from w_abc_master_smpl
integer height = 1064
string title = "[CAM015] Tipos de Contratos"
string menuname = "m_abc_master_smpl"
end type
global w_cam015_tipo_contrato w_cam015_tipo_contrato

on w_cam015_tipo_contrato.create
call super::create
if this.MenuName = "m_abc_master_smpl" then this.MenuID = create m_abc_master_smpl
end on

on w_cam015_tipo_contrato.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_cam015_tipo_contrato
string dataobject = "d_abc_tipo_contrato_tbl"
end type
