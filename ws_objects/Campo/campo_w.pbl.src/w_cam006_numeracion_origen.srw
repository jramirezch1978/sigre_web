$PBExportHeader$w_cam006_numeracion_origen.srw
forward
global type w_cam006_numeracion_origen from w_abc_master
end type
end forward
...
string menuname = "m_abc_save_exit"
long backcolor = 67108864
end type
global w_cam006_numeracion_origen w_cam006_numeracion_origen

on w_cam006_numeracion_origen.create
call super::create
if this.MenuName = "m_abc_save_exit" then this.MenuID = create m_abc_save_exit
end on

on w_cam006_numeracion_origen.destroy
call super::destroy
...
type dw_master from w_abc_master`dw_master within w_cam006_numeracion_origen
integer x = 0
integer y = 0
integer width = 1129
integer height = 372
