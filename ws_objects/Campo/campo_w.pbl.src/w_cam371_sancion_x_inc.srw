$PBExportHeader$w_cam371_sancion_x_inc.srw
forward
global type w_cam371_sancion_x_inc from w_abc_master
end type
type dw_detalle from u_dw_abc within w_cam371_sancion_x_inc
end type
end forward
...
integer width = 3337
integer height = 3280
string title = "[CM371] RG-39 Sanciones por Incumplimientos"
string menuname = "m_abc_anular_lista"
dw_detalle dw_detalle
end type
global w_cam371_sancion_x_inc w_cam371_sancion_x_inc
...
on w_cam371_sancion_x_inc.create
int iCurrent
call super::create
...
on w_cam371_sancion_x_inc.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_san_x_inc_tbl'
sl_param.titulo = 'Registro de Sanciones x Incumplimiento'
...
type dw_master from w_abc_master`dw_master within w_cam371_sancion_x_inc
integer width = 3150
integer height = 652
string dataobject = "d_abc_sic_sanc_x_inc_cab_ff"
end type
...
string dataobject = "d_abc_sic_sanc_x_inc_det_tbl"
