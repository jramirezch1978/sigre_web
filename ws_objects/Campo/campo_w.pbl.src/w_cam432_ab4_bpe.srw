$PBExportHeader$w_cam432_ab4_bpe.srw
forward
global type w_cam432_ab4_bpe from w_abc_mastdet_smpl
end type
end forward
...
integer width = 2629
integer height = 2268
string title = "[CAM432] AB4-BPE"
string menuname = "m_abc_anular_lista"
end type
global w_cam432_ab4_bpe w_cam432_ab4_bpe
...
if is_action = 'new' then
	...
	Select count(*) 
		into :ll_count
	from NUM_SIC_AB4_BPE_010511 
	where cod_origen = :gs_origen;
	
	IF ll_count = 0 then
		Insert into NUM_SIC_AB4_BPE_010511 (cod_origen, ult_nro)
			values( :gs_origen, 1);
	end if
...
sl_param.dw1    = 'd_list_sic_ab4_bpe_tbl'
sl_param.titulo = 'Registro AB4-BPE'
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_cam432_ab4_bpe
integer x = 0
integer y = 0
integer width = 2533
integer height = 896
string dataobject = "d_abc_sic_ab4_bpe_cab_ff"
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_cam432_ab4_bpe
integer x = 0
integer y = 916
integer width = 2542
integer height = 1084
string dataobject = "d_abc_sic_ab4_bpe_det_tbl"
end type
