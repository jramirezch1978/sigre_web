$PBExportHeader$w_cam311_ctacte_credito.srw
forward
global type w_cam311_ctacte_credito from w_abc_mastdet_smpl
end type
type uo_fechas from u_ingreso_rango_fechas within w_cam311_ctacte_credito
end type
type cb_1 from commandbutton within w_cam311_ctacte_credito
end type
end forward
...
integer width = 2802
integer height = 2312
string title = "[CM311] Cuenta Corriente Creditos"
string menuname = "m_abc_anular_lista"
uo_fechas uo_fechas
cb_1 cb_1
end type
global w_cam311_ctacte_credito w_cam311_ctacte_credito
...
on w_cam311_ctacte_credito.create
int iCurrent
call super::create
...
on w_cam311_ctacte_credito.destroy
call super::destroy
...
dw_master.retrieve(uo_fechas.of_get_fecha1(), uo_Fechas.of_get_fecha2())
dw_master.ii_update = 0
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_cam311_ctacte_credito
event ue_leftbuttonup pbm_dwnlbuttonup
integer x = 0
integer y = 128
integer width = 2651
integer height = 1196
string dataobject = "d_list_prestamos_tbl"
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_cam311_ctacte_credito
integer x = 0
integer y = 1344
integer width = 2651
integer height = 616
...
of_set_fecha(RelativeDate(date(f_fecha_actual()), -30), date(f_fecha_actual())) //para setear la fecha inicial
