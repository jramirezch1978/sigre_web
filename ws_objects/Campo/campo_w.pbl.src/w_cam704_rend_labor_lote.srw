$PBExportHeader$w_cam704_rend_labor_lote.srw
forward
global type w_cam704_rend_labor_lote from w_report_smpl
end type
type uo_fechas from u_ingreso_rango_fechas within w_cam704_rend_labor_lote
end type
type cb_reporte from commandbutton within w_cam704_rend_labor_lote
end type
type sle_campana from singlelineedit within w_cam704_rend_labor_lote
end type
type sle_desc_campana from singlelineedit within w_cam704_rend_labor_lote
end type
type st_1 from statictext within w_cam704_rend_labor_lote
end type
type st_2 from statictext within w_cam704_rend_labor_lote
end type
type st_3 from statictext within w_cam704_rend_labor_lote
end type
type sle_labor from singlelineedit within w_cam704_rend_labor_lote
end type
type sle_desc_labor from singlelineedit within w_cam704_rend_labor_lote
end type
type sle_lote from singlelineedit within w_cam704_rend_labor_lote
end type
type sle_desc_lote from singlelineedit within w_cam704_rend_labor_lote
end type
end forward
...
global w_cam704_rend_labor_lote w_cam704_rend_labor_lote

on w_cam704_rend_labor_lote.create
int iCurrent
call super::create
...
on w_cam704_rend_labor_lote.destroy
call super::destroy
...
idw_1.Retrieve(ls_lote, ls_labor, ld_fecha1, ld_Fecha2)
...
idw_1.Object.t_titulo3.text = 'Lote: ' + sle_lote.text + " Labor: " + sle_desc_labor.text
									 
end event

type dw_report from w_report_smpl`dw_report within w_cam704_rend_labor_lote
integer x = 0
integer y = 388
integer width = 2711
integer height = 976
string dataobject = "d_rpt_rend_jornal_labor_lote_tbl"
end type
