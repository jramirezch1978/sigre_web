$PBExportHeader$w_cam353_calibracion_mnt.srw
forward
global type w_cam353_calibracion_mnt from w_abc_master
end type
type dw_detalle from u_dw_abc within w_cam353_calibracion_mnt
end type
end forward
...
integer width = 3337
integer height = 3280
string title = "[CM353] RG 37 Registro de Calibracion  y Mantenimiento de Equipos"
string menuname = "m_abc_anular_lista"
dw_detalle dw_detalle
end type
global w_cam353_calibracion_mnt w_cam353_calibracion_mnt
...
if is_action = 'new' then
	...
	ls_table = 'LOCK TABLE NUM_SIC_REG_CALIBR_MNT_E IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_ult_nro 
	from NUM_SIC_REG_CALIBR_MNT_E
	where cod_origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into NUM_SIC_REG_CALIBR_MNT_E (cod_origen, ult_nro)
			values( :gs_origen, 1);
	...
	// Incrementa contador
	Update NUM_SIC_REG_CALIBR_MNT_E 
...
on w_cam353_calibracion_mnt.create
int iCurrent
call super::create
...
on w_cam353_calibracion_mnt.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_reg_calib_mnt_tbl'
sl_param.titulo = 'Registro de Calibración'
...
type dw_master from w_abc_master`dw_master within w_cam353_calibracion_mnt
integer width = 3150
integer height = 844
string dataobject = "d_abc_sic_reg_calib_cab_ff"
end type
...
string dataobject = "d_abc_sic_reg_calib_mnt_det_tbl"
