$PBExportHeader$w_cam423_ch3.srw
forward
global type w_cam423_ch3 from w_abc_mastdet_smpl
end type
end forward
...
integer width = 2629
integer height = 2268
string title = "[CAM423] CH3-010511"
string menuname = "m_abc_anular_lista"
end type
global w_cam423_ch3 w_cam423_ch3
...
if is_action = 'new' then
	...
	Select count(*) 
		into :ll_count
	from NUM_SIC_CH3_010511 
	where cod_origen = :gs_origen;
	
	IF ll_count = 0 then
		Insert into NUM_SIC_CH3_010511 (cod_origen, ult_nro)
			values( :gs_origen, 1);
	end if
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_cam423_ch3
integer x = 0
integer y = 0
integer width = 2533
integer height = 896
string dataobject = "d_abc_sic_ch3_cab_ff"
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_cam423_ch3
integer x = 0
integer y = 916
integer width = 2542
integer height = 1084
string dataobject = "d_abc_sic_ch3_det_tbl"
end type
