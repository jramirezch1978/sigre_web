$PBExportHeader$w_cam372_entrega_documento.srw
forward
global type w_cam372_entrega_documento from w_abc_master
end type
type dw_detalle from u_dw_abc within w_cam372_entrega_documento
end type
end forward
...
integer width = 3337
integer height = 3280
string title = "[CAM372] RG-40 Entrega de Documentos"
string menuname = "m_abc_anular_lista"
dw_detalle dw_detalle
end type
global w_cam372_entrega_documento w_cam372_entrega_documento
...
if is_action = 'new' then
	...
	ls_table = 'LOCK TABLE NUM_SIC_SANCIONES_INCUMP IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_ult_nro 
	from NUM_SIC_SANCIONES_INCUMP
	where cod_origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into NUM_SIC_SANCIONES_INCUMP (cod_origen, ult_nro)
			values( :gs_origen, 1);
	...
	// Incrementa contador
	Update NUM_SIC_SANCIONES_INCUMP 
...
on w_cam372_entrega_documento.create
int iCurrent
call super::create
...
on w_cam372_entrega_documento.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_entrega_doc_tbl'
sl_param.titulo = 'Registro de Entrega de Documentos'
...
type dw_master from w_abc_master`dw_master within w_cam372_entrega_documento
integer width = 3150
integer height = 652
string dataobject = "d_abc_sic_entrega_doc_cab_ff"
end type
...
this.object.fec_documento	[al_row] = Date(ldt_fec_oracle)
...
string dataobject = "d_abc_sic_entrega_doc_det_tbl"
...
this.object.fec_ent		[al_row] = date(f_fecha_actual())
