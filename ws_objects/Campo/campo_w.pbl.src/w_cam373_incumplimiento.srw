$PBExportHeader$w_cam373_incumplimiento.srw
forward
global type w_cam373_incumplimiento from w_abc_master
end type
type dw_detalle from u_dw_abc within w_cam373_incumplimiento
end type
end forward
...
integer width = 3337
integer height = 3280
string title = "[CAM373] RG-41 Incumplimientos - Reclamaciones"
string menuname = "m_abc_anular_lista"
dw_detalle dw_detalle
end type
global w_cam373_incumplimiento w_cam373_incumplimiento
...
if is_action = 'new' then
	...
	ls_table = 'LOCK TABLE num_sic_reclamacion_inc IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_ult_nro 
	from num_sic_reclamacion_inc
	where cod_origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into num_sic_reclamacion_inc (cod_origen, ult_nro)
			values( :gs_origen, 1);
	...
	// Incrementa contador
	Update num_sic_reclamacion_inc 
...
on w_cam373_incumplimiento.create
int iCurrent
call super::create
...
on w_cam373_incumplimiento.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_reclamacion_inc_tbl'
sl_param.titulo = 'Registro de Reclamación - Incumplimiento'
...
type dw_master from w_abc_master`dw_master within w_cam373_incumplimiento
integer width = 3150
integer height = 652
string dataobject = "d_abc_sic_reclamac_inc_cab_ff"
end type
...
string dataobject = "d_abc_sic_sancion_inc_det_tbl"
