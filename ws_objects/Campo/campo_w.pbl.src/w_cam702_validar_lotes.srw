$PBExportHeader$w_cam702_validar_lotes.srw
forward
global type w_cam702_validar_lotes from w_report_smpl
end type
type uo_fechas from u_ingreso_rango_fechas within w_cam702_validar_lotes
end type
type cb_reporte from commandbutton within w_cam702_validar_lotes
end type
type cb_1 from commandbutton within w_cam702_validar_lotes
end type
end forward
...
integer width = 2811
integer height = 1704
string title = "[CAM702] Validar Labores x Lotes"
string menuname = "m_rpt_smpl"
uo_fechas uo_fechas
cb_reporte cb_reporte
cb_1 cb_1
end type
global w_cam702_validar_lotes w_cam702_validar_lotes

on w_cam702_validar_lotes.create
int iCurrent
call super::create
...
on w_cam702_validar_lotes.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_cam702_validar_lotes
integer x = 0
integer y = 160
integer width = 2711
integer height = 1252
string dataobject = "d_rpt_validar_labores_lotes_tbl"
end type
