$PBExportHeader$w_cam307_plantilla_consumo.srw
forward
global type w_cam307_plantilla_consumo from w_abc_mastdet_smpl
end type
end forward
...
global w_cam307_plantilla_consumo w_cam307_plantilla_consumo
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_cam307_plantilla_consumo
integer x = 0
integer y = 0
integer width = 2405
integer height = 684
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_cam307_plantilla_consumo
integer x = 0
integer y = 696
integer width = 2542
integer height = 1360
