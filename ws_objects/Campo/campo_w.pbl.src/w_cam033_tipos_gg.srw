$PBExportHeader$w_cam033_tipos_gg.srw
forward
global type w_cam033_tipos_gg from w_abc_master_smpl
end type
end forward

global type w_cam033_tipos_gg from w_abc_master_smpl
integer height = 1064
string title = "[CAM033] Tipos de Módulos de GG"
string menuname = "m_abc_master_smpl"
end type
global w_cam033_tipos_gg w_cam033_tipos_gg
...
on w_cam033_tipos_gg.create
call super::create
if this.MenuName = "m_abc_master_smpl" then this.MenuID = create m_abc_master_smpl
end on

on w_cam033_tipos_gg.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_cam033_tipos_gg
string dataobject = "d_abc_sic_tipos_gg"
end type
...
this.object.fec_ini_vig[al_row] = today()
this.object.fec_fin_vig[al_row] = today()
