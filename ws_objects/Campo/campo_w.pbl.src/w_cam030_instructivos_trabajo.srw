$PBExportHeader$w_cam030_instructivos_trabajo.srw
forward
global type w_cam030_instructivos_trabajo from w_abc_master_smpl
end type
end forward
...
global w_cam030_instructivos_trabajo w_cam030_instructivos_trabajo

type variables

end variables

on w_cam030_instructivos_trabajo.create
call super::create
if this.MenuName = "m_abc_master_smpl" then this.MenuID = create m_abc_master_smpl
end on

on w_cam030_instructivos_trabajo.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_cam030_instructivos_trabajo
integer width = 2368
string dataobject = "d_abc_sic_instructivos"
end type
...
this.object.flag_tipo[al_row] = '2'
this.object.cod_usr[al_row] = gs_user
this.object.fec_registro [ al_row] = f_fecha_actual()
this.object.cod_usr.protect = '1'
