$PBExportHeader$w_cam349_reg_capacitacion.srw
forward
global type w_cam349_reg_capacitacion from w_abc_master
end type
type dw_detalle from u_dw_abc within w_cam349_reg_capacitacion
end type
end forward
...
integer width = 3337
integer height = 3280
string title = "[CAM349] RG-42 Capacitaciones"
string menuname = "m_abc_anular_lista"
dw_detalle dw_detalle
end type
global w_cam349_reg_capacitacion w_cam349_reg_capacitacion
...
if is_action = 'new' then
	...
	ls_table = 'LOCK TABLE NUM_SIC_REG_CAPACITACION_GEN IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_ult_nro 
	from NUM_SIC_REG_CAPACITACION_GEN
	where cod_origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into NUM_SIC_REG_CAPACITACION_GEN (cod_origen, ult_nro)
			values( :gs_origen, 1);
	...
	// Incrementa contador
	Update NUM_SIC_REG_CAPACITACION_GEN 
...
on w_cam349_reg_capacitacion.create
int iCurrent
call super::create
...
on w_cam349_reg_capacitacion.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_reg_capat_gen_tbl'
sl_param.titulo = 'Registro de Capacitaciones'
...
type dw_master from w_abc_master`dw_master within w_cam349_reg_capacitacion
integer width = 3150
integer height = 796
string dataobject = "d_abc_sic_reg_capacitacion_cab_ff"
end type
...
this.object.fec_inicio 			[al_row] = ldt_fec_oracle
this.object.fec_fin	 			[al_row] = ldt_fec_oracle
...
string dataobject = "d_abc_sic_capacitacion_det_tbl"
