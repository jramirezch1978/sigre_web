$PBExportHeader$w_cam424_ch2.srw
forward
global type w_cam424_ch2 from w_abc_mastdet_smpl
end type
end forward
...
integer width = 2629
integer height = 2268
string title = "[CAM424] CH2"
string menuname = "m_abc_anular_lista"
end type
global w_cam424_ch2 w_cam424_ch2
...
if is_action = 'new' then
	...
	Select count(*) 
		into :ll_count
	from NUM_SIC_CH2_180612 
	where cod_origen = :gs_origen;
	
	IF ll_count = 0 then
		Insert into NUM_SIC_CH2_180612 (cod_origen, ult_nro)
			values( :gs_origen, 1);
	end if
...
sl_param.dw1    = 'd_list_sic_ch2_tbl'
sl_param.titulo = 'Registro CH2'
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_cam424_ch2
integer x = 0
integer y = 0
integer width = 2533
integer height = 896
string dataobject = "d_abc_sic_ch2_cab_ff"
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_cam424_ch2
integer x = 0
integer y = 916
integer width = 2542
integer height = 1084
string dataobject = "d_abc_sic_ch2_det_tbl"
end type
