$PBExportHeader$w_cam351_limpieza_almacen.srw
forward
global type w_cam351_limpieza_almacen from w_abc_master
end type
type tab_1 from tab within w_cam351_limpieza_almacen
end type
...
type dw_limpieza from u_dw_abc within tabpage_2
end type
type tabpage_2 from userobject within tab_1
dw_limpieza dw_limpieza
end type
type tabpage_3 from userobject within tab_1
end type
type dw_alumbre from u_dw_abc within tabpage_3
end type
type tabpage_3 from userobject within tab_1
dw_alumbre dw_alumbre
end type
type tab_1 from tab within w_cam351_limpieza_almacen
tabpage_1 tabpage_1
tabpage_2 tabpage_2
...
integer width = 3337
integer height = 3280
string title = "[CM351] RG 35 Limpieza Almacen y Dosificacion de Insumos"
string menuname = "m_abc_anular_lista"
tab_1 tab_1
end type
global w_cam351_limpieza_almacen w_cam351_limpieza_almacen

type variables
u_dw_abc idw_detalle, idw_limpieza, idw_alumbre
end variables
...
idw_limpieza 		= tab_1.tabpage_2.dw_limpieza
idw_alumbre 		= tab_1.tabpage_3.dw_alumbre
...
if is_action = 'new' then
	...
	ls_table = 'LOCK TABLE NUM_SIC_REG_LIMPIEZA_ALMACEN IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_ult_nro 
	from NUM_SIC_REG_LIMPIEZA_ALMACEN
	where cod_origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into NUM_SIC_REG_LIMPIEZA_ALMACEN (cod_origen, ult_nro)
			values( :gs_origen, 1);
	...
	// Incrementa contador
	Update NUM_SIC_REG_LIMPIEZA_ALMACEN 
...
idw_limpieza.width  = tab_1.tabpage_2.width  - tab_1.tabpage_2.x - 10
idw_limpieza.height = tab_1.tabpage_2.height  - tab_1.tabpage_2.y - 10

idw_alumbre.width  = tab_1.tabpage_3.width  - tab_1.tabpage_3.x - 10
idw_alumbre.height = tab_1.tabpage_3.height  - tab_1.tabpage_3.y - 10

end event

on w_cam351_limpieza_almacen.create
int iCurrent
call super::create
...
on w_cam351_limpieza_almacen.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_reg_limpieza_tbl'
sl_param.titulo = 'Registro de Limpieza'
...
type dw_master from w_abc_master`dw_master within w_cam351_limpieza_almacen
integer width = 3150
integer height = 844
string dataobject = "d_abc_sic_registro_limp_cab_ff"
end type
...
integer height = 1504
long backcolor = 79741120
string text = "Limpieza de Almacen"
...
integer taborder = 20
boolean bringtotop = true
string dataobject = "d_abc_sic_reg_limpieza_alm_det_tbl"
...
if dwo.name = 'b_imp' then
		...
		ds_imp.DataObject = 'd_abc_sic_areas_almacen_tbl'
		...
		for li_i=1 to ds_imp.RowCount()
				...
				if li_row > 0 then
					...
					this.object.area_almacen			[li_row] = ds_imp.object.descripcion [li_i]
					this.object.lun			[li_row] = '0'
					this.object.mar			[li_row] = '0'
					this.object.mie			[li_row] = '0'
					this.object.jue			[li_row] = '0'
					this.object.vie			[li_row] = '0'
					this.object.sab			[li_row] = '0'
					this.object.dom			[li_row] = '0'
				end if
		next
		destroy ds_imp
end if
...
integer height = 1504
long backcolor = 79741120
string text = "Limpieza de Material~r~nde Empaque"
long tabtextcolor = 33554432
long tabbackcolor = 79741120
long picturemaskcolor = 536870912
dw_limpieza dw_limpieza
...
on tabpage_2.create
this.dw_limpieza=create dw_limpieza
this.Control[]={this.dw_limpieza}
end on

on tabpage_2.destroy
destroy(this.dw_limpieza)
end on
...
integer height = 836
boolean bringtotop = true
string dataobject = "d_abc_sic_reg_limp_mat_tbl"
boolean hscrollbar = true
boolean vscrollbar = true
borderstyle borderstyle = styleraised!
end type
...
integer height = 1504
long backcolor = 79741120
string text = "Preparación Solución~r~nAlumbre"
long tabtextcolor = 33554432
long tabbackcolor = 79741120
long picturemaskcolor = 536870912
dw_alumbre dw_alumbre
...
on tabpage_3.create
this.dw_alumbre=create dw_alumbre
this.Control[]={this.dw_alumbre}
end on

on tabpage_3.destroy
destroy(this.dw_alumbre)
end on
...
integer height = 836
boolean bringtotop = true
string dataobject = "d_abc_sic_reg_prep_alumbre_tbl"
boolean hscrollbar = true
boolean vscrollbar = true
borderstyle borderstyle = styleraised!
end type
