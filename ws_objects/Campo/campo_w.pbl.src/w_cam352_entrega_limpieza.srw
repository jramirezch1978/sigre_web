$PBExportHeader$w_cam352_entrega_limpieza.srw
forward
global type w_cam352_entrega_limpieza from w_abc_master
end type
type dw_detalle from u_dw_abc within w_cam352_entrega_limpieza
end type
end forward
...
integer width = 3337
integer height = 3280
string title = "[CM352] RG 36 Entrega Limpieza y Estado de Materiales de Empaque"
string menuname = "m_abc_anular_lista"
dw_detalle dw_detalle
end type
global w_cam352_entrega_limpieza w_cam352_entrega_limpieza
...
if is_action = 'new' then
	...
	ls_table = 'LOCK TABLE NUM_SIC_REG_ENTREGA_ESTADO_MAT IN EXCLUSIVE MODE'
	EXECUTE IMMEDIATE :ls_table ;
	
	Select ult_nro 
		into :ll_ult_nro 
	from NUM_SIC_REG_ENTREGA_ESTADO_MAT
	where cod_origen = :gs_origen;
	
	IF SQLCA.SQLCode = 100 then
		Insert into NUM_SIC_REG_ENTREGA_ESTADO_MAT (cod_origen, ult_nro)
			values( :gs_origen, 1);
	...
	// Incrementa contador
	Update NUM_SIC_REG_ENTREGA_ESTADO_MAT 
...
on w_cam352_entrega_limpieza.create
int iCurrent
call super::create
...
on w_cam352_entrega_limpieza.destroy
call super::destroy
...
sl_param.dw1    = 'd_list_sic_reg_entrega_tbl'
sl_param.titulo = 'Registro de Entrega'
...
type dw_master from w_abc_master`dw_master within w_cam352_entrega_limpieza
integer width = 3150
integer height = 844
string dataobject = "d_abc_sic_reg_entrega_cab_ff"
end type
...
string dataobject = "d_abc_sic_reg_entrega_det_tbl"
...
this.object.cant_ent [al_row] = 0
this.object.cant_uti [al_row] = 0
this.object.cant_ret [al_row] = 0
this.object.cant_fal [al_row] = 0
