$PBExportHeader$w_cam020_documentos.srw
forward
global type w_cam020_documentos from w_abc_master_smpl
end type
end forward

global type w_cam020_documentos from w_abc_master_smpl
integer height = 1064
string title = "[CAM020] Documentos de Registros de Productor"
string menuname = "m_abc_master_smpl"
end type
global w_cam020_documentos w_cam020_documentos
...
on w_cam020_documentos.create
call super::create
if this.MenuName = "m_abc_master_smpl" then this.MenuID = create m_abc_master_smpl
end on

on w_cam020_documentos.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_cam020_documentos
string dataobject = "d_abc_cam_doc_productor"
end type

event dw_master::ue_insert_pre;call super::ue_insert_pre;this.object.flag_estado[al_row] = '1'
this.object.flag_antecedentes[al_row] = '0'
this.object.flag_cert_anterior[al_row] = '0'
end event
