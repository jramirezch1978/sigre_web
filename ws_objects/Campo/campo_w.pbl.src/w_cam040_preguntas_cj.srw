$PBExportHeader$w_cam040_preguntas_cj.srw
forward
global type w_cam040_preguntas_cj from w_abc_master_smpl
end type
end forward

global type w_cam040_preguntas_cj from w_abc_master_smpl
integer height = 1064
string title = "[CAM040] Preguntas de Comercio Justo"
string menuname = "m_abc_master_smpl"
end type
global w_cam040_preguntas_cj w_cam040_preguntas_cj

on w_cam040_preguntas_cj.create
call super::create
if this.MenuName = "m_abc_master_smpl" then this.MenuID = create m_abc_master_smpl
end on

on w_cam040_preguntas_cj.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_cam040_preguntas_cj
string dataobject = "d_abc_sic_comercio_justo_preg_tbl"
end type
...
this.object.flag_preg[al_row] = 'N'
