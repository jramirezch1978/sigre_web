$PBExportHeader$w_cam200_global_gap.srw
forward
global type w_cam200_global_gap from w_abc_mastdet_smpl
end type
end forward
...
integer width = 2629
integer height = 2268
string title = "[CM200] Inspección Global GAP"
string menuname = "m_abc_anular_lista"
end type
global w_cam200_global_gap w_cam200_global_gap
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_cam200_global_gap
integer x = 0
integer y = 0
integer width = 2533
integer height = 936
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_cam200_global_gap
integer x = 0
integer y = 956
integer width = 2542
integer height = 1044
