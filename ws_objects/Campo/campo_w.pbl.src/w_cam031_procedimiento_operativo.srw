$PBExportHeader$w_cam031_procedimiento_operativo.srw
forward
global type w_cam031_procedimiento_operativo from w_abc_master_smpl
end type
end forward
...
integer width = 2487
integer height = 1064
string title = "[CAM031] Procedimientos Operativos"
string menuname = "m_abc_master_smpl"
end type
global w_cam031_procedimiento_operativo w_cam031_procedimiento_operativo

type variables

end variables

on w_cam031_procedimiento_operativo.create
call super::create
if this.MenuName = "m_abc_master_smpl" then this.MenuID = create m_abc_master_smpl
end on

on w_cam031_procedimiento_operativo.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_cam031_procedimiento_operativo
integer width = 2368
string dataobject = "d_abc_sic_procedimiento"
end type
...
this.object.flag_tipo[al_row] = '1'
