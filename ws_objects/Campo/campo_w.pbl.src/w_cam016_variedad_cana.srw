$PBExportHeader$w_cam016_variedad_cana.srw
forward
global type w_cam016_variedad_cana from w_abc_master_smpl
end type
end forward

global type w_cam016_variedad_cana from w_abc_master_smpl
integer height = 1064
string title = "[CAM016] Variedad de Caña"
string menuname = "m_abc_master_smpl"
end type
global w_cam016_variedad_cana w_cam016_variedad_cana

on w_cam016_variedad_cana.create
call super::create
if this.MenuName = "m_abc_master_smpl" then this.MenuID = create m_abc_master_smpl
end on

on w_cam016_variedad_cana.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_cam016_variedad_cana
string dataobject = "d_abc_variedad_cana_tbl"
end type
