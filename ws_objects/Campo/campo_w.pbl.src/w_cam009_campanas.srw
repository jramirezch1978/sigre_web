$PBExportHeader$w_cam009_campanas.srw
forward
global type w_cam009_campanas from w_abc_master_smpl
end type
end forward
...
global w_cam009_campanas w_cam009_campanas

on w_cam009_campanas.create
call super::create
if this.MenuName = "m_abc_master_smpl" then this.MenuID = create m_abc_master_smpl
end on

on w_cam009_campanas.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_master from w_abc_master_smpl`dw_master within w_cam009_campanas
string dataobject = "d_abc_campanas_tbl"
end type
