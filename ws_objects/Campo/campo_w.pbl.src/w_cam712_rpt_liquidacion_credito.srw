$PBExportHeader$w_cam712_rpt_liquidacion_credito.srw
forward
global type w_cam712_rpt_liquidacion_credito from w_rpt
end type
type cb_1 from commandbutton within w_cam712_rpt_liquidacion_credito
end type
type uo_fecha from u_ingreso_rango_fechas within w_cam712_rpt_liquidacion_credito
end type
type dw_report from u_dw_rpt within w_cam712_rpt_liquidacion_credito
end type
end forward
...
integer width = 3314
integer height = 1792
string title = "Reporte de Liquidaciones de Prestamo  (CAM712)"
string menuname = "m_rpt_smpl"
cb_1 cb_1
uo_fecha uo_fecha
dw_report dw_report
end type
global w_cam712_rpt_liquidacion_credito w_cam712_rpt_liquidacion_credito
...
on w_cam712_rpt_liquidacion_credito.create
int iCurrent
call super::create
...
on w_cam712_rpt_liquidacion_credito.destroy
call super::destroy
...
string dataobject = "d_rpt_liquidacion_credito"
