$PBExportHeader$w_cn817_f51_libro_diario.srw
forward
global type w_cn817_f51_libro_diario from w_report_smpl
end type
type sle_ano from singlelineedit within w_cn817_f51_libro_diario
end type
type sle_mes from singlelineedit within w_cn817_f51_libro_diario
end type
type cb_1 from commandbutton within w_cn817_f51_libro_diario
end type
type st_3 from statictext within w_cn817_f51_libro_diario
end type
type st_4 from statictext within w_cn817_f51_libro_diario
end type
type cbx_fecha from checkbox within w_cn817_f51_libro_diario
end type
type gb_1 from groupbox within w_cn817_f51_libro_diario
end type
end forward
...
integer width = 3369
integer height = 1604
string title = "[CN817] Formato 51. Libro de Diario"
...
global w_cn817_f51_libro_diario w_cn817_f51_libro_diario

on w_cn817_f51_libro_diario.create
int iCurrent
call super::create
...
on w_cn817_f51_libro_diario.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_cn817_f51_libro_diario
integer x = 0
integer y = 184
integer width = 3291
integer height = 1116
integer taborder = 40
string dataobject = "d_f51_LIBRO_dIARIO_tbl"
end type
