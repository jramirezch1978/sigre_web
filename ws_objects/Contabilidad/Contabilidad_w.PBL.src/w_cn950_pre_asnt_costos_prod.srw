$PBExportHeader$w_cn950_pre_asnt_costos_prod.srw
forward
global type w_cn950_pre_asnt_costos_prod from w_prc
end type
type cb_revertir from commandbutton within w_cn950_pre_asnt_costos_prod
end type
type st_5 from statictext within w_cn950_pre_asnt_costos_prod
end type
type sle_libro from singlelineedit within w_cn950_pre_asnt_costos_prod
end type
type sle_mes from singlelineedit within w_cn950_pre_asnt_costos_prod
end type
type sle_ano from singlelineedit within w_cn950_pre_asnt_costos_prod
end type
type cb_cancelar from commandbutton within w_cn950_pre_asnt_costos_prod
end type
type cb_generar from commandbutton within w_cn950_pre_asnt_costos_prod
end type
type cb_test from commandbutton within w_cn950_pre_asnt_costos_prod
end type
type st_4 from statictext within w_cn950_pre_asnt_costos_prod
end type
type st_3 from statictext within w_cn950_pre_asnt_costos_prod
end type
type st_2 from statictext within w_cn950_pre_asnt_costos_prod
end type
type st_1 from statictext within w_cn950_pre_asnt_costos_prod
end type
type r_1 from rectangle within w_cn950_pre_asnt_costos_prod
end type
end forward
...
integer width = 1477
integer height = 1116
string title = "Generacion de pre asientos de costos de produccion (CN950)"
...
global w_cn950_pre_asnt_costos_prod w_cn950_pre_asnt_costos_prod

on w_cn950_pre_asnt_costos_prod.create
int iCurrent
call super::create
...
on w_cn950_pre_asnt_costos_prod.destroy
call super::destroy
...
string text = "Costos de producción"
