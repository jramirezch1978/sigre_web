$PBExportHeader$w_cn791_costo_plant_ctro_benef.srw
forward
global type w_cn791_costo_plant_ctro_benef from w_report_smpl
end type
type sle_grupo from singlelineedit within w_cn791_costo_plant_ctro_benef
end type
type sle_descripcion from singlelineedit within w_cn791_costo_plant_ctro_benef
end type
type pb_1 from picturebutton within w_cn791_costo_plant_ctro_benef
end type
type cb_1 from commandbutton within w_cn791_costo_plant_ctro_benef
end type
type st_1 from statictext within w_cn791_costo_plant_ctro_benef
end type
type st_2 from statictext within w_cn791_costo_plant_ctro_benef
end type
type st_3 from statictext within w_cn791_costo_plant_ctro_benef
end type
type st_4 from statictext within w_cn791_costo_plant_ctro_benef
end type
type sle_nivel_c from singlelineedit within w_cn791_costo_plant_ctro_benef
end type
type st_5 from statictext within w_cn791_costo_plant_ctro_benef
end type
type sle_nivel_p from singlelineedit within w_cn791_costo_plant_ctro_benef
end type
type em_ano from editmask within w_cn791_costo_plant_ctro_benef
end type
type em_mes_ini from editmask within w_cn791_costo_plant_ctro_benef
end type
type em_mes_fin from editmask within w_cn791_costo_plant_ctro_benef
end type
type gb_1 from groupbox within w_cn791_costo_plant_ctro_benef
end type
end forward
...
integer width = 3191
integer height = 2060
string title = "CN791 - Costo segun plantilla de centros de beneficio"
...
global w_cn791_costo_plant_ctro_benef w_cn791_costo_plant_ctro_benef

on w_cn791_costo_plant_ctro_benef.create
int iCurrent
call super::create
...
on w_cn791_costo_plant_ctro_benef.destroy
call super::destroy
...
DECLARE PB_usp_cnt_rpt_gastos_cb_produc PROCEDURE FOR usp_cnt_rpt_gastos_cb_produc
        ( :ll_ano, :ll_mes_ini, :ll_mes_fin, :ls_plant, :ll_nivelc ) ;
		  
Execute PB_usp_cnt_rpt_gastos_cb_produc ;

//SELECT count(*) INTO :ll_count FROM tt_cnt_gastos_cb_produc ;
...
type dw_report from w_report_smpl`dw_report within w_cn791_costo_plant_ctro_benef
integer x = 46
integer y = 416
integer width = 987
integer height = 1436
string dataobject = "d_rpt_gtos_centro_benef_ctb"
end type
...
lstr_seleccionar.s_sql = 'SELECT cnt_plant_ctro_benef.cod_plantilla AS CODIGO, '&
										 +'cnt_plant_ctro_benef.desc_plantilla AS DESCRIPCION '&
								 +'FROM cnt_plant_ctro_benef ' 
...
select count(*) into :ll_count from cnt_plant_ctro_benef where cod_plantilla=:ls_grupo ;
