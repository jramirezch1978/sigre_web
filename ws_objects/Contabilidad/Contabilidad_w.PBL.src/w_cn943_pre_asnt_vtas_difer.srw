$PBExportHeader$w_cn943_pre_asnt_vtas_difer.srw
forward
global type w_cn943_pre_asnt_vtas_difer from w_prc
end type
type st_5 from statictext within w_cn943_pre_asnt_vtas_difer
end type
type sle_libro from singlelineedit within w_cn943_pre_asnt_vtas_difer
end type
type sle_mes from singlelineedit within w_cn943_pre_asnt_vtas_difer
end type
type sle_ano from singlelineedit within w_cn943_pre_asnt_vtas_difer
end type
type cb_cancelar from commandbutton within w_cn943_pre_asnt_vtas_difer
end type
type cb_generar from commandbutton within w_cn943_pre_asnt_vtas_difer
end type
type st_4 from statictext within w_cn943_pre_asnt_vtas_difer
end type
type st_3 from statictext within w_cn943_pre_asnt_vtas_difer
end type
type st_2 from statictext within w_cn943_pre_asnt_vtas_difer
end type
type st_1 from statictext within w_cn943_pre_asnt_vtas_difer
end type
type r_1 from rectangle within w_cn943_pre_asnt_vtas_difer
end type
end forward
...
integer width = 1477
integer height = 1116
string title = "Generacion de pre asientos de ventas diferidas (CN943)"
st_5 st_5
sle_libro sle_libro
sle_mes sle_mes
sle_ano sle_ano
...
global w_cn943_pre_asnt_vtas_difer w_cn943_pre_asnt_vtas_difer

on w_cn943_pre_asnt_vtas_difer.create
int iCurrent
call super::create
...
on w_cn943_pre_asnt_vtas_difer.destroy
call super::destroy
destroy(this.st_5)
