$PBExportHeader$w_cn748_saldos_ctacte_x_grupo_mm.srw
forward
global type w_cn748_saldos_ctacte_x_grupo_mm from w_report_smpl
end type
type sle_grupo from singlelineedit within w_cn748_saldos_ctacte_x_grupo_mm
end type
type sle_descripcion from singlelineedit within w_cn748_saldos_ctacte_x_grupo_mm
end type
type pb_1 from picturebutton within w_cn748_saldos_ctacte_x_grupo_mm
end type
type sle_ano from singlelineedit within w_cn748_saldos_ctacte_x_grupo_mm
end type
type sle_mes from singlelineedit within w_cn748_saldos_ctacte_x_grupo_mm
end type
type cb_1 from commandbutton within w_cn748_saldos_ctacte_x_grupo_mm
end type
type st_1 from statictext within w_cn748_saldos_ctacte_x_grupo_mm
end type
type st_2 from statictext within w_cn748_saldos_ctacte_x_grupo_mm
end type
type st_3 from statictext within w_cn748_saldos_ctacte_x_grupo_mm
end type
type gb_1 from groupbox within w_cn748_saldos_ctacte_x_grupo_mm
end type
end forward
...
global w_cn748_saldos_ctacte_x_grupo_mm w_cn748_saldos_ctacte_x_grupo_mm

on w_cn748_saldos_ctacte_x_grupo_mm.create
int iCurrent
call super::create
...
on w_cn748_saldos_ctacte_x_grupo_mm.destroy
call super::destroy
...
DECLARE PB_USP_CNT_RPT_SALDOS_CTACTE_CR PROCEDURE FOR USP_CNT_RPT_SALDOS_CTACTE_CR
        ( :ls_ano, :ls_mes ) ;
...
type dw_report from w_report_smpl`dw_report within w_cn748_saldos_ctacte_x_grupo_mm
integer x = 46
integer y = 308
integer height = 1544
