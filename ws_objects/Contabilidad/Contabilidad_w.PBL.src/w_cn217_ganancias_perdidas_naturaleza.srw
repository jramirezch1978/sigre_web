$PBExportHeader$w_cn217_ganancias_perdidas_naturaleza.srw
forward
global type w_cn217_ganancias_perdidas_naturaleza from w_abc_mid
end type
end forward
...
integer width = 3246
integer height = 2212
string title = "(CN217) Ganancias y Pérdidas por Naturaleza"
string menuname = "m_master_smpl"
end type
global w_cn217_ganancias_perdidas_naturaleza w_cn217_ganancias_perdidas_naturaleza

on w_cn217_ganancias_perdidas_naturaleza.create
call super::create
if this.MenuName = "m_master_smpl" then this.MenuID = create m_master_smpl
end on

on w_cn217_ganancias_perdidas_naturaleza.destroy
call super::destroy
...
type dw_master from w_abc_mid`dw_master within w_cn217_ganancias_perdidas_naturaleza
integer x = 0
integer y = 0
integer width = 3109
integer height = 616
string dataobject = "d_cuentas_balance_n_tbl"
...
event dw_master::ue_insert_pre;call super::ue_insert_pre;this.setitem(al_row,"reporte","GYPNATUR")

end event

type dw_detail from w_abc_mid`dw_detail within w_cn217_ganancias_perdidas_naturaleza
integer x = 0
integer y = 1260
integer width = 3109
integer height = 672
...
type dw_detmast from w_abc_mid`dw_detmast within w_cn217_ganancias_perdidas_naturaleza
integer x = 0
integer y = 632
integer width = 3109
integer height = 616
