$PBExportHeader$w_cn966_asientos_lbs.srw
forward
global type w_cn966_asientos_lbs from w_prc
end type
type cbx_mes from checkbox within w_cn966_asientos_lbs
end type
type st_7 from statictext within w_cn966_asientos_lbs
end type
type dw_origen from datawindow within w_cn966_asientos_lbs
end type
type sle_libro from singlelineedit within w_cn966_asientos_lbs
end type
type st_5 from statictext within w_cn966_asientos_lbs
end type
type sle_mes from singlelineedit within w_cn966_asientos_lbs
end type
type sle_ano from singlelineedit within w_cn966_asientos_lbs
end type
type cb_cancelar from commandbutton within w_cn966_asientos_lbs
end type
type cb_generar from commandbutton within w_cn966_asientos_lbs
end type
type st_4 from statictext within w_cn966_asientos_lbs
end type
type st_2 from statictext within w_cn966_asientos_lbs
end type
type st_1 from statictext within w_cn966_asientos_lbs
end type
type gb_1 from groupbox within w_cn966_asientos_lbs
end type
end forward
...
integer width = 1646
integer height = 1072
string title = "[CN966] Generación de asientos de LBS"
...
global w_cn966_asientos_lbs w_cn966_asientos_lbs

on w_cn966_asientos_lbs.create
int iCurrent
call super::create
...
on w_cn966_asientos_lbs.destroy
call super::destroy
...
try 
	...
	sle_ano.text = ls_ano
	sle_mes.text = ls_mes
	sle_libro.text = gnvo_app.of_get_parametro( 'LIBRO_DEVENGADO_LBS', '50')
...
long textcolor = 33554432
long backcolor = 67108864
string text = "de Liquidación de Beneficios Sociales"
...
//CREATE OR REPLACE PROCEDURE usp_cnt_asiento_lbs(
...
DECLARE usp_cnt_asiento_lbs PROCEDURE FOR 
	usp_cnt_asiento_lbs ( :ls_origen,
								 :ll_year, 
								 :ll_mes, 
								 :ll_nro_libro, 
								 :gs_user ) ;

EXECUTE usp_cnt_asiento_lbs  ;

IF sqlca.sqlcode = -1 THEN
	ls_msj = sqlca.sqlerrtext
	ROLLBACK ;
	MessageBox( 'Error usp_cnt_asiento_lbs', 'Se produjo un error al ejecutar el procedure USP_RH_DEVENGADO_EXTORNO: ' + ls_msj, StopSign! )
	return
END IF

Close usp_cnt_asiento_lbs;
...
long textcolor = 33554432
long backcolor = 67108864
string text = "Generación de asientos"
alignment alignment = center!
boolean focusrectangle = false
end type
