$PBExportHeader$w_cn820_f61_libro_mayor.srw
forward
global type w_cn820_f61_libro_mayor from w_report_smpl
end type
type sle_ano from singlelineedit within w_cn820_f61_libro_mayor
end type
type sle_mes from singlelineedit within w_cn820_f61_libro_mayor
end type
type cb_1 from commandbutton within w_cn820_f61_libro_mayor
end type
type st_3 from statictext within w_cn820_f61_libro_mayor
end type
type st_4 from statictext within w_cn820_f61_libro_mayor
end type
type cbx_fecha from checkbox within w_cn820_f61_libro_mayor
end type
type gb_1 from groupbox within w_cn820_f61_libro_mayor
end type
end forward
...
integer width = 3369
integer height = 1604
string title = "[CN820] Formato 6.1. Libro Mayor"
...
global w_cn820_f61_libro_mayor w_cn820_f61_libro_mayor

on w_cn820_f61_libro_mayor.create
int iCurrent
call super::create
...
on w_cn820_f61_libro_mayor.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_cn820_f61_libro_mayor
integer x = 0
integer y = 188
integer width = 3291
integer height = 1020
integer taborder = 40
string dataobject = "d_f61_LIBRO_MAYOR_tbl"
end type
