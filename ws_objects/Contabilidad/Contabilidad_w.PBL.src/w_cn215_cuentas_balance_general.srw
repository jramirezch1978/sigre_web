$PBExportHeader$w_cn215_cuentas_balance_general.srw
forward
global type w_cn215_cuentas_balance_general from w_abc_mid
end type
end forward
...
integer width = 3246
integer height = 2016
string title = "(CN215) Cuentas del Balance General"
string menuname = "m_master_smpl"
end type
global w_cn215_cuentas_balance_general w_cn215_cuentas_balance_general

on w_cn215_cuentas_balance_general.create
call super::create
if this.MenuName = "m_master_smpl" then this.MenuID = create m_master_smpl
end on

on w_cn215_cuentas_balance_general.destroy
call super::destroy
...
type dw_master from w_abc_mid`dw_master within w_cn215_cuentas_balance_general
integer x = 0
integer y = 0
integer width = 3109
integer height = 592
string dataobject = "d_cuentas_balance_1_tbl"
...
event dw_master::ue_insert_pre;call super::ue_insert_pre;this.setitem(al_row,"reporte","BALANCE")

end event

type dw_detail from w_abc_mid`dw_detail within w_cn215_cuentas_balance_general
integer x = 0
integer y = 1160
integer width = 3109
integer height = 672
...
choose case dwo.name 
	...
	case 'cnta_ctbl'
		...
		if ls_flag <> 'I' then
			MessageBox('Aviso','Cuenta Contable NO es de Inventario')
			return
		end if
...
type dw_detmast from w_abc_mid`dw_detmast within w_cn215_cuentas_balance_general
integer x = 0
integer y = 608
integer width = 3109
integer height = 532
