$PBExportHeader$w_cn819_f11_libro_caja_efectivo.srw
forward
global type w_cn819_f11_libro_caja_efectivo from w_report_smpl
end type
type sle_ano from singlelineedit within w_cn819_f11_libro_caja_efectivo
end type
type sle_mes from singlelineedit within w_cn819_f11_libro_caja_efectivo
end type
type cb_1 from commandbutton within w_cn819_f11_libro_caja_efectivo
end type
type st_3 from statictext within w_cn819_f11_libro_caja_efectivo
end type
type st_4 from statictext within w_cn819_f11_libro_caja_efectivo
end type
type cbx_fecha from checkbox within w_cn819_f11_libro_caja_efectivo
end type
type gb_1 from groupbox within w_cn819_f11_libro_caja_efectivo
end type
end forward
...
integer width = 3369
integer height = 1604
string title = "[CN819] Formato 1.1. Libro de Caja: Detalle de Mov de efectivo"
...
global w_cn819_f11_libro_caja_efectivo w_cn819_f11_libro_caja_efectivo

on w_cn819_f11_libro_caja_efectivo.create
int iCurrent
call super::create
...
on w_cn819_f11_libro_caja_efectivo.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_cn819_f11_libro_caja_efectivo
integer x = 0
integer y = 188
integer width = 3291
integer height = 1020
integer taborder = 40
string dataobject = "d_f11_LIBRO_caja_tbl"
end type
...
event clicked;if this.checked then
	...
	dw_report.object.t_usuario.visible 	= '0'
	
else
	dw_report.object.t_paginas.visible 	= 'yes'
	dw_report.object.t_fecha.visible 	= 'yes'
	dw_report.object.t_usuario.visible 	= 'yes'
end if
