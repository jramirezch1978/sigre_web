$PBExportHeader$w_cn951_pre_asnt_costos_vta_az.srw
forward
global type w_cn951_pre_asnt_costos_vta_az from w_prc
end type
type cb_revertir from commandbutton within w_cn951_pre_asnt_costos_vta_az
end type
type st_5 from statictext within w_cn951_pre_asnt_costos_vta_az
end type
type sle_libro from singlelineedit within w_cn951_pre_asnt_costos_vta_az
end type
type sle_mes from singlelineedit within w_cn951_pre_asnt_costos_vta_az
end type
type sle_ano from singlelineedit within w_cn951_pre_asnt_costos_vta_az
end type
type cb_cancelar from commandbutton within w_cn951_pre_asnt_costos_vta_az
end type
type cb_generar from commandbutton within w_cn951_pre_asnt_costos_vta_az
end type
type cb_test from commandbutton within w_cn951_pre_asnt_costos_vta_az
end type
type st_4 from statictext within w_cn951_pre_asnt_costos_vta_az
end type
type st_3 from statictext within w_cn951_pre_asnt_costos_vta_az
end type
type st_2 from statictext within w_cn951_pre_asnt_costos_vta_az
end type
type st_1 from statictext within w_cn951_pre_asnt_costos_vta_az
end type
type r_1 from rectangle within w_cn951_pre_asnt_costos_vta_az
end type
end forward
...
integer width = 1477
integer height = 1116
string title = "Generacion de pre asientos de costos de venta de azucar (CN951)"
...
global w_cn951_pre_asnt_costos_vta_az w_cn951_pre_asnt_costos_vta_az

on w_cn951_pre_asnt_costos_vta_az.create
int iCurrent
call super::create
...
on w_cn951_pre_asnt_costos_vta_az.destroy
call super::destroy
...
string text = "Costos de venta de azúcar"
