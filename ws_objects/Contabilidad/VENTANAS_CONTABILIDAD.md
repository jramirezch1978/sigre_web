# Ventanas PowerBuilder del Módulo Contabilidad

Análisis completo de todas las ventanas (.srw) del módulo Contabilidad.
...
| w_cn974_elimina_asiento_diario | CN974 | Elimina diario totalmente físicamente |
