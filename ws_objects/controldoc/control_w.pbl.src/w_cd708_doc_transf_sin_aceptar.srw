$PBExportHeader$w_cd708_doc_transf_sin_aceptar.srw
forward
global type w_cd708_doc_transf_sin_aceptar from w_report_smpl
end type
type cb_1 from commandbutton within w_cd708_doc_transf_sin_aceptar
end type
type sle_origen from singlelineedit within w_cd708_doc_transf_sin_aceptar
end type
type sle_nombre from singlelineedit within w_cd708_doc_transf_sin_aceptar
end type
type pb_2 from picturebutton within w_cd708_doc_transf_sin_aceptar
end type
type rb_1 from radiobutton within w_cd708_doc_transf_sin_aceptar
end type
type rb_2 from radiobutton within w_cd708_doc_transf_sin_aceptar
end type
type gb_1 from groupbox within w_cd708_doc_transf_sin_aceptar
end type
end forward
...
integer width = 3515
integer height = 2276
string title = "[CD708] Documentos transferidos sin aceptar"
...
global w_cd708_doc_transf_sin_aceptar w_cd708_doc_transf_sin_aceptar

on w_cd708_doc_transf_sin_aceptar.create
int iCurrent
call super::create
...
on w_cd708_doc_transf_sin_aceptar.destroy
call super::destroy
...
type dw_report from w_report_smpl`dw_report within w_cd708_doc_transf_sin_aceptar
integer x = 32
integer y = 272
integer width = 3374
integer height = 1664
string dataobject = "d_rpt_docum_transfer_pendientes_grd"
end type
