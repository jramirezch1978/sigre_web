...
type sle_nro_doc from singlelineedit within w_get_tipo_doc_amp
end type
...
is_oper_cons_interno = lstr_param.oper_cons_interno
...
ls_sql = "SELECT distinct a.tipo_doc AS tipo_documento, " &
		 ...
		 + "and c.flag_inventariable = '1' " &
		 + "and a.tipo_mov = '" + is_oper_cons_interno + "' " &
		 + "and a.flag_estado = '1' " &
