$PBExportHeader$w_cm773_rpt_dscto_materiales.srw
forward
global type w_cm773_rpt_dscto_materiales from w_rpt_list
end type
type uo_1 from u_ingreso_rango_fechas_v within w_cm773_rpt_dscto_materiales
end type
type rb_prov from radiobutton within w_cm773_rpt_dscto_materiales
end type
type rb_art from radiobutton within w_cm773_rpt_dscto_materiales
end type
type gb_1 from groupbox within w_cm773_rpt_dscto_materiales
end type
end forward
...
integer width = 2638
integer height = 1592
string title = "Reporte de Descuentos Materiales (CM773)"
...
global w_cm773_rpt_dscto_materiales w_cm773_rpt_dscto_materiales
...
on w_cm773_rpt_dscto_materiales.create
int iCurrent
call super::create
...
on w_cm773_rpt_dscto_materiales.destroy
call super::destroy
...
type dw_report from w_rpt_list`dw_report within w_cm773_rpt_dscto_materiales
...
type dw_1 from w_rpt_list`dw_1 within w_cm773_rpt_dscto_materiales
integer width = 1115
...
type pb_1 from w_rpt_list`pb_1 within w_cm773_rpt_dscto_materiales
integer x = 1152
integer y = 428
end type
...
type pb_2 from w_rpt_list`pb_2 within w_cm773_rpt_dscto_materiales
integer x = 1152
integer y = 848
end type
...
type dw_2 from w_rpt_list`dw_2 within w_cm773_rpt_dscto_materiales
integer x = 1326
integer y = 284
integer width = 1106
boolean hscrollbar = true
...
event dw_2::ue_selected_row_pro;call super::ue_selected_row_pro;// Ancestor Script has been Override
Long	ll_row, ll_rc, ll_count
Any	la_id
Integer	li_x
...
type cb_report from w_rpt_list`cb_report within w_cm773_rpt_dscto_materiales
integer x = 1477
integer y = 72
