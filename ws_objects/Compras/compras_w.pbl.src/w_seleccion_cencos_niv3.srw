$PBExportHeader$w_seleccion_cencos_niv3.srw
forward
global type w_seleccion_cencos_niv3 from w_abc_list
end type
type cb_1 from commandbutton within w_seleccion_cencos_niv3
end type
end forward
...
integer width = 3058
integer height = 1444
string title = "Seleccione Centro Costo Nivel 3"
...
global w_seleccion_cencos_niv3 w_seleccion_cencos_niv3

on w_seleccion_cencos_niv3.create
int iCurrent
call super::create
...
on w_seleccion_cencos_niv3.destroy
call super::destroy
destroy(this.cb_1)
end on
...
type dw_1 from w_abc_list`dw_1 within w_seleccion_cencos_niv3
integer x = 32
integer y = 32
integer width = 1385
integer height = 1188
string dataobject = "d_lis_cencos_niv3"
...
ii_dk[2] = 2
ii_dk[3] = 3				// Deploy key
ii_dk[4] = 4

ii_rk[1] = 1				// Receive key
ii_rk[2] = 2
ii_rk[3] = 3				// Receive key
ii_rk[4] = 4
...
type dw_2 from w_abc_list`dw_2 within w_seleccion_cencos_niv3
integer x = 1623
integer y = 32
integer width = 1385
integer height = 1188
...
type pb_1 from w_abc_list`pb_1 within w_seleccion_cencos_niv3
integer x = 1449
integer y = 396
end type

type pb_2 from w_abc_list`pb_2 within w_seleccion_cencos_niv3
integer x = 1449
integer y = 532
end type
...
integer i
string ls_cod_n1, ls_cod_n2, ls_cod_n3, ls_desc
...
if ll_nbrow > 0 then
	for i=1 to ll_nbrow
		...
		ls_cod_n3 = dw_2.object.cod_n3[i]
		insert into tt_cencos_niv3(cod_n1, cod_n2, cod_n3) values (:ls_cod_n1, :ls_cod_n2, :ls_cod_n3);
	next
end if
close(parent)
end event
