$PBExportHeader$w_cm772_art_serv_x_comprador.srw
forward
global type w_cm772_art_serv_x_comprador from w_abc_list
end type
type st_campo from statictext within w_cm772_art_serv_x_comprador
end type
type dw_text from datawindow within w_cm772_art_serv_x_comprador
end type
type cb_1 from commandbutton within w_cm772_art_serv_x_comprador
end type
type sle_origen from singlelineedit within w_cm772_art_serv_x_comprador
end type
type st_1 from statictext within w_cm772_art_serv_x_comprador
end type
type st_2 from statictext within w_cm772_art_serv_x_comprador
end type
type sle_comprador from singlelineedit within w_cm772_art_serv_x_comprador
end type
type cb_2 from commandbutton within w_cm772_art_serv_x_comprador
end type
type rb_art from radiobutton within w_cm772_art_serv_x_comprador
end type
type rb_serv from radiobutton within w_cm772_art_serv_x_comprador
end type
type gb_1 from groupbox within w_cm772_art_serv_x_comprador
end type
type gb_2 from groupbox within w_cm772_art_serv_x_comprador
end type
end forward
...
integer width = 3410
integer height = 1936
string title = "Artículos/Servicios por Comprador"
...
global w_cm772_art_serv_x_comprador w_cm772_art_serv_x_comprador

type variables
String is_col, is_comprador, is_origen
end variables

on w_cm772_art_serv_x_comprador.create
int iCurrent
call super::create
...
on w_cm772_art_serv_x_comprador.destroy
call super::destroy
...
type dw_1 from w_abc_list`dw_1 within w_cm772_art_serv_x_comprador
integer x = 32
integer y = 376
integer width = 1545
integer height = 1356
...
type dw_2 from w_abc_list`dw_2 within w_cm772_art_serv_x_comprador
integer x = 1792
integer y = 376
integer width = 1545
integer height = 1356
...
type pb_1 from w_abc_list`pb_1 within w_cm772_art_serv_x_comprador
integer x = 1614
integer y = 896
...
type pb_2 from w_abc_list`pb_2 within w_cm772_art_serv_x_comprador
integer x = 1614
integer y = 1024
integer height = 112
alignment htextalign = center!
