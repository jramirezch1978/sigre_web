$PBExportHeader$w_cm322_flag_modificacion.srw
forward
global type w_cm322_flag_modificacion from w_abc_master
end type
type st_1 from statictext within w_cm322_flag_modificacion
end type
type st_2 from statictext within w_cm322_flag_modificacion
end type
type sle_tipo_doc from singlelineedit within w_cm322_flag_modificacion
end type
type cb_1 from commandbutton within w_cm322_flag_modificacion
end type
type sle_nro_doc from singlelineedit within w_cm322_flag_modificacion
end type
end forward
...
integer width = 3657
integer height = 1544
string title = "Flag_modificacion en Movimientos Proyectados (CM322)"
...
global w_cm322_flag_modificacion w_cm322_flag_modificacion
...
on w_cm322_flag_modificacion.create
int iCurrent
call super::create
...
on w_cm322_flag_modificacion.destroy
call super::destroy
...
type dw_master from w_abc_master`dw_master within w_cm322_flag_modificacion
integer x = 0
integer y = 284
integer width = 3442
integer height = 820
string dataobject = "d_abc_amp_flag_modificacion"
...
IF This.Object.flag_modificacion [row] = '1' THEN //
	li_opcion = MessageBox('Aviso' ,'Desea no modificar este item?', Question!, YesNo!, 2)
	if li_opcion = 1 then
		This.Object.flag_reservado 	[row] = '1'
		this.object.flag_modificacion [row] = '0'
		This.ii_update = 1
	end if
elseif This.Object.flag_modificacion [row] = '0' THEN //
	li_opcion = MessageBox('Aviso' ,'Desea modificar este item?', Question!, YesNo!, 2)
	if li_opcion = 1 then
		This.Object.flag_reservado 	[row] = '0'
		this.object.flag_modificacion [row] = '1'
		This.ii_update = 1
	end if
end if
end event
...
string text = "ACTIVA EL FLAG_MODIFICACION EN MOVIMIENTOS PROYECTADOS"
