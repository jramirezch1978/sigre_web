$PBExportHeader$w_cm029_clase_categoria_vehiculo.srw
forward
global type w_cm029_clase_categoria_vehiculo from w_abc_mastdet_smpl
end type
type st_1 from statictext within w_cm029_clase_categoria_vehiculo
end type
type st_2 from statictext within w_cm029_clase_categoria_vehiculo
end type
end forward
...
integer width = 3611
integer height = 1964
string title = "[CM029] Maestro de Clases y Categorias de vehiculos"
string menuname = "m_mantto_smpl"
st_1 st_1
st_2 st_2
end type
global w_cm029_clase_categoria_vehiculo w_cm029_clase_categoria_vehiculo

on w_cm029_clase_categoria_vehiculo.create
int iCurrent
call super::create
...
on w_cm029_clase_categoria_vehiculo.destroy
call super::destroy
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_cm029_clase_categoria_vehiculo
integer x = 0
integer y = 112
integer width = 1778
integer height = 1648
string dataobject = "d_abc_clase_vehiculo_tbl"
end type
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_cm029_clase_categoria_vehiculo
integer x = 1787
integer y = 112
integer width = 1742
integer height = 1644
string dataobject = "d_abc_categoria_vehiculo_tbl"
end type

event dw_detail::constructor;call super::constructor;ii_ck[1] = 1			// columnas de lectrua de este dw
ii_rk[1] = 5	      // columnas que recibimos del master
...
event dw_detail::ue_insert_pre;this.object.flag_estado		[al_row] = '1'
end event
...
string text = "Clase de vehiculos"
...
long backcolor = 8388608
boolean enabled = false
string text = "Categorias de vehiculos"
alignment alignment = center!
boolean border = true
borderstyle borderstyle = styleraised!
boolean focusrectangle = false
