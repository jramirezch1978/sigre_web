$PBExportHeader$w_seleccion_cencos_niv1.srw
forward
global type w_seleccion_cencos_niv1 from w_abc_list
end type
type cb_1 from commandbutton within w_seleccion_cencos_niv1
end type
end forward
...
global w_seleccion_cencos_niv1 w_seleccion_cencos_niv1

on w_seleccion_cencos_niv1.create
int iCurrent
call super::create
...
on w_seleccion_cencos_niv1.destroy
call super::destroy
destroy(this.cb_1)
end on
...
type dw_1 from w_abc_list`dw_1 within w_seleccion_cencos_niv1
integer x = 32
integer y = 32
integer width = 1385
integer height = 1188
string dataobject = "d_lis_cencos_niv1"
...
type dw_2 from w_abc_list`dw_2 within w_seleccion_cencos_niv1
integer x = 1623
integer y = 32
integer width = 1385
integer height = 1188
...
type pb_1 from w_abc_list`pb_1 within w_seleccion_cencos_niv1
integer x = 1449
integer y = 396
end type

type pb_2 from w_abc_list`pb_2 within w_seleccion_cencos_niv1
integer x = 1449
integer y = 532
end type
...
delete from tt_cencos_niv1;
delete from tt_cencos_niv2;
delete from tt_cencos_niv3;
ll_nbrow = dw_2.rowcount()
if ll_nbrow > 0 then
	for i=1 to ll_nbrow
		ls_cod  = dw_2.object.cod_n1[i]
		//ls_desc = dw_2.object.descripcion[i]
		insert into tt_cencos_niv1(cod_n1) values (:ls_cod);
	next
end if
close(parent)
end event
