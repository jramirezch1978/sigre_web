$PBExportHeader$w_cm304_solicitud_servicio_aprobacion.srw
forward
global type w_cm304_solicitud_servicio_aprobacion from w_abc
end type
type cb_1 from commandbutton within w_cm304_solicitud_servicio_aprobacion
end type
type rb_2 from radiobutton within w_cm304_solicitud_servicio_aprobacion
end type
type rb_1 from radiobutton within w_cm304_solicitud_servicio_aprobacion
end type
type sle_origen from singlelineedit within w_cm304_solicitud_servicio_aprobacion
end type
type st_1 from statictext within w_cm304_solicitud_servicio_aprobacion
end type
type p_help from picture within w_cm304_solicitud_servicio_aprobacion
end type
type st_help from statictext within w_cm304_solicitud_servicio_aprobacion
end type
type pb_aceptar from picturebutton within w_cm304_solicitud_servicio_aprobacion
end type
type pb_salir from picturebutton within w_cm304_solicitud_servicio_aprobacion
end type
type dw_master from u_dw_abc within w_cm304_solicitud_servicio_aprobacion
end type
end forward
...
integer width = 3589
integer height = 1816
string title = "Aprobacion de Solicitud de servicio (CM304)"
cb_1 cb_1
rb_2 rb_2
rb_1 rb_1
...
global w_cm304_solicitud_servicio_aprobacion w_cm304_solicitud_servicio_aprobacion
...
on w_cm304_solicitud_servicio_aprobacion.create
int iCurrent
call super::create
...
on w_cm304_solicitud_servicio_aprobacion.destroy
call super::destroy
destroy(this.cb_1)
destroy(this.rb_2)
destroy(this.rb_1)
...
event resize;call super::resize;dw_master.width  = newwidth  - dw_master.x - 50
...
integer height = 1212
integer taborder = 20
string dataobject = "d_abc_solicitud_servicio_aprobacion"
...
String  ls_estado_act,ls_estado_pos,ls_aprobacion,ls_user, ls_origen, ls_nro
datetime ld_apro
...
ls_aprobacion = This.Object.usuario_aprob[row]
...
IF li_opcion = 1 THEN
	...
	This.Object.usuario_aprob[row] = ls_user
	This.Object.fecha_aprob[row] = ld_apro
	This.ii_update = 1
	
	// Actualiza detalle
	ls_origen = this.object.cod_origen[row]
	ls_nro = this.object.nro_sol_serv[row]
	Update sol_serv_det set flag_estado = :ls_estado_act where
	   cod_origen = :ls_origen and nro_sol_serv = :ls_nro;
