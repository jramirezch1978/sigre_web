$PBExportHeader$w_cm731_resumen_anual_compras.srw
forward
global type w_cm731_resumen_anual_compras from w_rpt
end type
type rb_4 from radiobutton within w_cm731_resumen_anual_compras
end type
type rb_3 from radiobutton within w_cm731_resumen_anual_compras
end type
type sle_desc_ot_adm from singlelineedit within w_cm731_resumen_anual_compras
end type
type sle_ot_adm from singlelineedit within w_cm731_resumen_anual_compras
end type
type sle_desc_art from singlelineedit within w_cm731_resumen_anual_compras
end type
type sle_cod_art from singlelineedit within w_cm731_resumen_anual_compras
end type
type sle_nro_ot from singlelineedit within w_cm731_resumen_anual_compras
end type
type sle_titulo_ot from singlelineedit within w_cm731_resumen_anual_compras
end type
type sle_desc_almacen from singlelineedit within w_cm731_resumen_anual_compras
end type
type sle_almacen from singlelineedit within w_cm731_resumen_anual_compras
end type
type cbx_ot from checkbox within w_cm731_resumen_anual_compras
end type
type cbx_cod_art from checkbox within w_cm731_resumen_anual_compras
end type
type cbx_almacen from checkbox within w_cm731_resumen_anual_compras
end type
type cbx_ot_adm from checkbox within w_cm731_resumen_anual_compras
end type
type rb_1 from radiobutton within w_cm731_resumen_anual_compras
end type
type cb_1 from commandbutton within w_cm731_resumen_anual_compras
end type
type dw_report from u_dw_rpt within w_cm731_resumen_anual_compras
end type
type em_year from editmask within w_cm731_resumen_anual_compras
end type
type st_1 from statictext within w_cm731_resumen_anual_compras
end type
end forward
...
integer width = 3246
integer height = 1984
string title = "[CM731] Resumen Compras Anual"
...
global w_cm731_resumen_anual_compras w_cm731_resumen_anual_compras
...
on w_cm731_resumen_anual_compras.create
int iCurrent
call super::create
...
on w_cm731_resumen_anual_compras.destroy
call super::destroy
