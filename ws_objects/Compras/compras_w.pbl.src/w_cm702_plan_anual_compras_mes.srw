$PBExportHeader$w_cm702_plan_anual_compras_mes.srw
forward
global type w_cm702_plan_anual_compras_mes from w_rpt_list
end type
type em_anio from editmask within w_cm702_plan_anual_compras_mes
end type
type st_1 from statictext within w_cm702_plan_anual_compras_mes
end type
end forward
...
integer width = 3712
integer height = 2000
string title = "PLAN ANUAL DE COMPRAS (CM702)"
string menuname = "m_impresion"
em_anio em_anio
st_1 st_1
end type
global w_cm702_plan_anual_compras_mes w_cm702_plan_anual_compras_mes

type variables
String is_oper
end variables

on w_cm702_plan_anual_compras_mes.create
int iCurrent
call super::create
...
on w_cm702_plan_anual_compras_mes.destroy
call super::destroy
...
type dw_report from w_rpt_list`dw_report within w_cm702_plan_anual_compras_mes
boolean visible = false
integer x = 32
integer y = 148
integer width = 3040
integer height = 1668
string dataobject = "d_rpt_plan_anual_compras_x_mes"
end type
...
type dw_1 from w_rpt_list`dw_1 within w_cm702_plan_anual_compras_mes
integer x = 27
integer y = 180
integer width = 1609
integer height = 1592
integer taborder = 50
string dataobject = "d_sel_articulos_plan_anual"
...
type pb_1 from w_rpt_list`pb_1 within w_cm702_plan_anual_compras_mes
integer x = 1710
integer y = 608
integer taborder = 60
end type
...
type pb_2 from w_rpt_list`pb_2 within w_cm702_plan_anual_compras_mes
integer x = 1705
integer y = 1008
integer taborder = 80
...
type dw_2 from w_rpt_list`dw_2 within w_cm702_plan_anual_compras_mes
integer x = 1925
integer y = 188
integer width = 1609
integer height = 1592
...
type cb_report from w_rpt_list`cb_report within w_cm702_plan_anual_compras_mes
integer x = 2912
integer y = 36
integer width = 581
integer height = 92
...
//	DECLARE PB_PROC PROCEDURE FOR USP_CMP_PLAN_COMPRAS_X_MES(:is_oper, :ls_anio);
//	EXECUTE PB_PROC;
//	IF SQLCA.SQLCODE = -1 THEN
...
event modified;dw_1.retrieve(is_oper, em_anio.text)
end event
