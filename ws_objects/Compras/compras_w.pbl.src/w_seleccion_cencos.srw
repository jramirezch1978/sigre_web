$PBExportHeader$w_seleccion_cencos.srw
forward
global type w_seleccion_cencos from w_abc_list
end type
type cb_1 from commandbutton within w_seleccion_cencos
end type
end forward
...
global w_seleccion_cencos w_seleccion_cencos

on w_seleccion_cencos.create
int iCurrent
call super::create
...
type dw_1 from w_abc_list`dw_1 within w_seleccion_cencos
integer x = 32
integer y = 32
integer width = 1385
integer height = 1188
string dataobject = "d_lis_cencos"
...
type dw_2 from w_abc_list`dw_2 within w_seleccion_cencos
integer x = 1623
integer y = 32
integer width = 1385
integer height = 1188
...
type pb_1 from w_abc_list`pb_1 within w_seleccion_cencos
integer x = 1449
integer y = 396
end type

type pb_2 from w_abc_list`pb_2 within w_seleccion_cencos
integer x = 1449
integer y = 532
end type
...
if ll_nbrow > 0 then
	for i=1 to ll_nbrow
		ls_cod  = dw_2.object.cencos[i]
		insert into tt_cencos(cencos) values (:ls_cod);
	next
end if
close(parent)
end event
