$PBExportHeader$w_cm030_linea_sublinea.srw
forward
global type w_cm030_linea_sublinea from w_abc_mastdet_smpl
end type
type st_1 from statictext within w_cm030_linea_sublinea
end type
type st_2 from statictext within w_cm030_linea_sublinea
end type
end forward
...
integer width = 3611
integer height = 1964
string title = "[CM030] Maestro de Lineas y Sublineas de calzados"
string menuname = "m_mantto_smpl"
st_1 st_1
st_2 st_2
end type
global w_cm030_linea_sublinea w_cm030_linea_sublinea

on w_cm030_linea_sublinea.create
int iCurrent
call super::create
...
on w_cm030_linea_sublinea.destroy
call super::destroy
...
type dw_master from w_abc_mastdet_smpl`dw_master within w_cm030_linea_sublinea
integer x = 0
integer y = 112
integer width = 1778
integer height = 1648
string dataobject = "d_abc_linea_zapatos_tbl"
end type
...
event dw_master::ue_output;call super::ue_output;string ls_codigo

ls_codigo = this.object.cod_linea [al_row]

idw_det.retrieve( ls_codigo )
end event
...
type dw_detail from w_abc_mastdet_smpl`dw_detail within w_cm030_linea_sublinea
integer x = 1787
integer y = 112
integer width = 1742
integer height = 1644
string dataobject = "d_abc_sublinea_calzado_tbl"
end type
...
event dw_detail::ue_insert_pre;if dw_master.getrow() = 0 then 
	return
end if

this.object.flag_estado		[al_row] = '1'
this.object.cod_linea		[al_Row] = dw_master.object.cod_linea[dw_master.getRow()]
end event
...
long backcolor = 8388608
boolean enabled = false
string text = "Sub linea de Calzados"
alignment alignment = center!
boolean border = true
borderstyle borderstyle = styleraised!
boolean focusrectangle = false
