...
if IsNull(ld_fecha1) then ld_fecha1 = RelativeDate(Date(gnvo_app.of_fecha_Actual()), -15)
if IsNull(ld_fecha2) then ld_fecha2 = RelativeDate(Date(gnvo_app.of_fecha_Actual()), 15)
