$PBExportHeader$w_seleccion_ot_adm.srw
forward
global type w_seleccion_ot_adm from w_abc_list
end type
type cb_1 from commandbutton within w_seleccion_ot_adm
end type
type st_1 from statictext within w_seleccion_ot_adm
end type
end forward
...
integer width = 3081
integer height = 1436
string title = "Seleccione OT ADM"
...
global w_seleccion_ot_adm w_seleccion_ot_adm

on w_seleccion_ot_adm.create
int iCurrent
call super::create
...
type dw_1 from w_abc_list`dw_1 within w_seleccion_ot_adm
integer x = 32
integer y = 32
integer width = 1413
integer height = 1188
string dataobject = "d_sel_ot_adm"
boolean vscrollbar = true
end type

event dw_1::constructor;call super::constructor;ii_ck[1] = 1
ii_ck[2] = 2 // columna, que juega como 
...
type dw_2 from w_abc_list`dw_2 within w_seleccion_ot_adm
integer x = 1627
integer y = 32
integer width = 1413
integer height = 1188
...
type pb_1 from w_abc_list`pb_1 within w_seleccion_ot_adm
integer x = 1467
integer y = 512
alignment htextalign = center!
end type

type pb_2 from w_abc_list`pb_2 within w_seleccion_ot_adm
integer x = 1467
integer y = 648
alignment htextalign = center!
end type
...
if ll_nbrow > 0 then 
	...
	for i=1 to ll_nbrow
		...
		ls_cod  = trim(dw_2.object.ot_adm[i])
		insert into tt_ot_adm (ot_adm) values (:ls_cod);
