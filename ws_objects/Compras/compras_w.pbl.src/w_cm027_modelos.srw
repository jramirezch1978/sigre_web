$PBExportHeader$w_cm027_modelos.srw
forward
global type w_cm027_modelos from w_abc_master_smpl
end type
end forward
...
integer width = 2638
integer height = 1600
string title = "[CM027] Maestro de Modelos de Articulos"
string menuname = "m_mantto_smpl"
end type
global w_cm027_modelos w_cm027_modelos

on w_cm027_modelos.create
call super::create
if this.MenuName = "m_mantto_smpl" then this.MenuID = create m_mantto_smpl
end on

on w_cm027_modelos.destroy
call super::destroy
...
type dw_master from w_abc_master_smpl`dw_master within w_cm027_modelos
event ue_display ( string as_columna,  long al_row )
integer width = 2551
integer height = 1240
string dataobject = "d_abc_modelo_tbl"
end type
