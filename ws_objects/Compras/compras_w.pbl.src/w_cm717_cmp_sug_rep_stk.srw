$PBExportHeader$w_cm717_cmp_sug_rep_stk.srw
forward
global type w_cm717_cmp_sug_rep_stk from w_rpt
end type
type rb_1 from radiobutton within w_cm717_cmp_sug_rep_stk
end type
type rb_2 from radiobutton within w_cm717_cmp_sug_rep_stk
end type
type st_1 from statictext within w_cm717_cmp_sug_rep_stk
end type
type sle_ult_oc from singlelineedit within w_cm717_cmp_sug_rep_stk
end type
type dw_report from u_dw_rpt within w_cm717_cmp_sug_rep_stk
end type
type cb_1 from commandbutton within w_cm717_cmp_sug_rep_stk
end type
type uo_fecha from u_ingreso_fecha within w_cm717_cmp_sug_rep_stk
end type
end forward
...
global w_cm717_cmp_sug_rep_stk w_cm717_cmp_sug_rep_stk

on w_cm717_cmp_sug_rep_stk.create
int iCurrent
call super::create
...
on w_cm717_cmp_sug_rep_stk.destroy
call super::destroy
...
//create or replace procedure USP_CMP_SUG_RES_REP_STK(
//       adi_fecha    in date,
//       asi_origen   in origen.cod_origen%TYPE,
//       ani_nro_oc   in number
//) is	
	
DECLARE USP_CMP_SUG_RES_REP_STK PROCEDURE FOR 
		USP_CMP_SUG_RES_REP_STK( :ld_fecha, 
										 :gs_origen, 
										 :li_ult_oc);
EXECUTE USP_CMP_SUG_RES_REP_STK;

IF SQLCA.SQLCODE = -1 THEN
	ls_msg = SQLCA.SQLErrText
	ROLLBACK;
	Messagebox( "Error USP_CMP_SUG_RES_REP_STK", ls_msg)
	Return
END IF

CLOSE USP_CMP_SUG_RES_REP_STK;
